...
title('Namgang-polynomial tn.','fontsize',16)
grid on
set(gca,'fontsize',16)
ylim([0 4]) 
xlim([1 366])
...
title('Namgang-polynomial no3.','fontsize',16)
grid on
set(gca,'fontsize',16)
ylim([0 3])
xlim([1 366])
...
title('Namgang-polynomial nh4.','fontsize',16)
grid on
set(gca,'fontsize',16)
ylim([0 1.2])
xlim([1 366])
...
title('Namgang-polynomial det.','fontsize',16)
grid on
set(gca,'fontsize',16)
ylim([0 1.2])
xlim([1 366])
...
title('Namgang-polynomial.','fontsize',16)
grid on;
...
title('Namgang- TN, NO3+NH4, diff.','fontsize',16)
legend('TN', 'no3+nh4','diff(det.)')
set(gca,'xtick',[t_tick_all(1:3:end)]);
set(gca,'xticklabel',1989:3:2019,'fontsize',10);
set(gca,'fontsize',16)

save('Namgang_polynomial_climate_to2004_advanced(v4)_3sig_TN.mat'); 
...
title('Namgang-polynomial DO.','fontsize',16)
grid on
set(gca,'fontsize',16)
ylim([2 18]) 
xlim([1 366])
...
title('Namgang-polynomial chl.','fontsize',16)
grid on
set(gca,'fontsize',16)
ylim([0 40])
xlim([1 366])
...
title(['Namgang TN raw  ' num2str(sig) '-sigma'],'fontsize',16)
ylim([0 inf])
...
title(['Namgang do raw  ' num2str(sig) '-sigma'],'fontsize',16)
ylim([0 inf])
set(gca,'xtick',[t_tick_all(1:4:end)]);
set(gca,'xticklabel',1989:4:2019);
set(gca,'xlim',[t_tick_all(4) t_tick_all(end)]);
...
title(['Namgang chl raw  ' num2str(sig) '-sigma'],'fontsize',16)
ylim([0 inf])
set(gca,'xtick',[t_tick_all(1:4:end)]);
set(gca,'xticklabel',1989:4:2019);
set(gca,'xlim',[t_tick_all(4) t_tick_all(end)]);
...
title(['Namgang nh4 raw  ' num2str(sig) '-sigma'],'fontsize',16)
ylim([0 inf])
set(gca,'xtick',[t_tick_all(1:4:end)]);
set(gca,'xticklabel',1989:4:2019);
...
title(['Namgang no3 raw  ' num2str(sig) '-sigma'],'fontsize',16)
ylim([0 inf])
set(gca,'xtick',[t_tick_all(1:4:end)]);
set(gca,'xticklabel',1989:4:2019);
set(gca,'xlim',[t_tick_all(7) t_tick_all(end)]);
