...
%% reigme mean
 plot([1:.1:t_regime],nanmean(temp_s_front_r),'color','c','linew',4);
 plot([t_regime+1:.1:t_regime+length(temp_s_back)],nanmean(temp_s_back_r),'color','c','linew',4);
 plot([1:.1:t_regime],nanmean(temp_b_front_r),'color','m','linew',4);
 plot([t_regime+1:.1:t_regime+length(temp_b_back)],nanmean(temp_b_back_r),'color','m','linew',4); 
...
% print('-dpng',[name_tag{i},' regime DO st.', num2str(i),'.png'])
end
...
for j = 1:3
    plot(no3_sur(j,:).*1000,'+','color','g','linew',2); %% mg/L to ug/L
%         plot(no3_sur(j,:),'+','color','g','linew',2); %% mg/L to ug/L
    hold on;
    plot(no3_bot(j,:).*1000,'<','color','y','linew',2); %% mg/L to ug/L
%         plot(no3_sur(j,:),'+','color','g','linew',2); %% mg/L to ug/L
end

% print('-dpng',[name_tag{i},'compare kodc regime no3 st.', num2str(i),'.png'])
print('-dpng',[name_tag{i},'compare kodc(250) regime no3 st.', num2str(i),'.png'])
end
...
for j = 2:2
%     plot(no3_sur(j,:).*1000,'+','color','g','linew',2); %% mg/L to ug/L
        plot(no3_sur(j,:).*14,'+','color','g','linew',2); %% umol/L to ug/L
    hold on;
%     plot(no3_bot(j,:).*1000,'^','color','y','linew',2); %% mg/L to ug/L
        plot(no3_bot(j,:).*14,'<','color','y','linew',2); %% umol/L to ug/L
end
 
print('-dpng',[name_tag{i},'compare kodc(match) regime no3 st.', num2str(i),'.png'])
end
