...
all_testname2 = {'test53', 'test54', 'test55', 'test56', 'ens01', 'ens02', 'ens03'};
...
load(['E:\Data\Observation\NIFS\xls\',testname,'_nwp_1_20_salt_trend_',num2str(min(inputyear),'%04i'),'_',num2str(max(inputyear),'%04i'),'.mat']);
