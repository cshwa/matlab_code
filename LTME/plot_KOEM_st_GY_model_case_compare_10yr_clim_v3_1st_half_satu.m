...
if case_num == 1 
    ...
    plt_no3 = nanmean(mer_no3_1,1);
    plt_nh4 = nanmean(mer_nh4_1,1);
    plt_po4 = nanmean(mer_po4_1,1);
    
    plt_no3_b = nanmean(mer_no3_b_1,1);
    plt_nh4_b = nanmean(mer_nh4_b_1,1);
    plt_po4_b = nanmean(mer_po4_b_1,1);
