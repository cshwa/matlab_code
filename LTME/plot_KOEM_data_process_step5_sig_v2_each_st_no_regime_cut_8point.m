...
save(['koem_climate_to06to15_v5_sig_gy_8points_no_regime_cut.mat'],'obs*','obm*','spm_obs*','tm_obs*'); % full 9points data (extract_sigma_for_each_st)
...
save(['koem_climate_to06to15_v5_nosig_gy_8points_no_regime_cut.mat'],'obs*','obm*','spm_obs*','tm_obs*'); % full 9points data (no extract_sigma_for_each_st)
end
