...
echo on
       echo on
       % Load the example.
%          load cshwa_1982_time_fix.mat  % this is a local time
        load cshwa_1982_time_v2.mat
%          time(4545:end)=[];
         load('1982_regrid_v3_zeta.mat');
...
%        t1 = datetime(1981,12,31,15,00,00); % 00,00,00 (KST)
%        t2 = datetime(1982,12,31,14,00,00); % 23,00,00  (KST)
%        t = t1:hours(1):t2
%        time = datenum(t)
%        save('cshwa_1982_time_v2.mat','time')
%
...
tidestruc_no_G8 = struct('name', tidestruc.name(no_G8_ind,:), ...
 ...
 save('MODEL_1982_G8_nondet_fix.mat','pout_*','tidestruc*');
 return
