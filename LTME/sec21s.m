...
a = 1 : size(d1,1);
y = find(p(a) == max(p));
b = [52 : y(1)-2]; d6 = d(6) * ones(size(b,2),1);
...
a = 1 : size(d1,1);
y = find(p(a) == max(p));
b = [65 : y(1)-53]; d8 = d(8) * ones(size(b,2),1);
...
a = 1 : size(d1,1);
y = find(p(a) == max(p));
b = [80 : y(1)-10]; d10 = d(10) * ones(size(b,2),1);
...
m21sal1 = [st2_1_1;st3_1;st21_1;st22_1;st23_1;st24_1;st25_1;st26_1;st27_1;st28_1];
fid = fopen('jjsal1.txt','w');
fprintf(fid, '%f %f %f %f\n', m21sal1');
fclose(fid);
...
jsal1 = m21sal1;
jsal1(:,2) = -1 .* jsal1(:,2);
fid = fopen('jsal1.txt','w');
fprintf(fid, '%f %f %f %f\n', jsal1');
fclose(fid);



figure; plot(st2_1_1(:,4),st2_1_1(:,2)); hold on;
plot(st3_1(:,4),st3_1(:,2),'k');
plot(st21_1(:,4),st21_1(:,2),'y');
plot(st22_1(:,4),st22_1(:,2),'r');
plot(st23_1(:,4),st23_1(:,2),'g');
plot(st24_1(:,4),st24_1(:,2),'c');
plot(st25_1(:,4),st25_1(:,2),':b');
plot(st26_1(:,4),st26_1(:,2),'m');
plot(st27_1(:,4),st27_1(:,2),':r');
plot(st28_1(:,4),st28_1(:,2),':k');
