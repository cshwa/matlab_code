...
if exist('gl')~=1
    gl = grd('yjtak');         % (1) Get Larger grid information
end

if exist('gn')~=1
    gn = grd('GY');          % (2) Get Nested grid information
end


% (3) roms data file from a larger domain
% filedir = '.\L_model\2013\';
filedir ='D:\장기생태\Dynamic\07_boundary_ts\yjtak_boundary\2001\';
% head='ocean_avg_mon_';
head='spinup1_monthly';
foot='.nc';
...
ref_year = 2000 ;  %% Model data is 1993, then input 1992
...
out_file = [out_head,'bndy_2001_Gwangyang',foot];
