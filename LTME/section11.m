...
m11 = textread('m11.txt','');
st1 = textread('st1_1.txt',''); pre1 = st1(:,2); temp1 = st1(:,3); temp1 = smooth(pre1,temp1,30,'moving');
st2 = textread('st2_1.txt',''); pre2 = st2(:,2); temp2 = st2(:,3); temp2 = smooth(pre2,temp2,30,'moving');
st4 = textread('st4_1.txt',''); pre4 = st4(:,2); temp4 = st4(:,3); temp4 = smooth(pre4,temp4,30,'moving');
st5 = textread('st5_1.txt',''); pre5 = st5(:,2); temp5 = st5(:,3); temp5 = smooth(pre5,temp5,30,'moving');
st6 = textread('st6_1.txt',''); pre6 = st6(:,2); temp6 = st6(:,3); temp6 = smooth(pre6,temp6,30,'moving');
st7 = textread('st7_1.txt',''); pre7 = st7(:,2); temp7 = st7(:,3); temp7 = smooth(pre7,temp7,30,'moving');
temp = [temp1; temp2; temp4; temp5; temp6; temp7];

dist = m11(:,1); pre = m11(:,2);
