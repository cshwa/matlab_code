...
cd D:\장기생태\Dynamic\result\clim_pic_gy\2nd_2001-2010

interval = 5;
for i = 1:12
figure; hold on;
title_name = strcat('GY-',' 2001~2010.',num2str(i,'%02d'), ' mon. surf.');
...
for i = 1:12
figure; hold on;
title_name = strcat('GY-',' 2001~2010.',num2str(i,'%02d'), ' mon. temp.(^oC) surf.');
pcolor(lon,lat,squeeze(clim_mod_temp(:,:,20,i)).*(mask_r./mask_r)); shading flat;
...
for i = 1:12
figure; hold on;
title_name = strcat('GY-',' 2001~2010.',num2str(i,'%02d'), ' mon. salt.(psu) surf.');
...
for i = 1:12
figure; hold on;
title_name = strcat('GY-',' 2001~2010.',num2str(i,'%02d'), ' mon. chl.(ug/L) surf.');
...
for i = 1:12
figure; hold on;
title_name = strcat('GY-',' 2001~2010.',num2str(i,'%02d'), ' mon. no3.(mmol N m^-^3) surf.');
...
for i = 1:12
figure; hold on;
title_name = strcat('GY-',' 2001~2010.',num2str(i,'%02d'), ' mon. nh4.(mmol N m^-^3) surf.');
...
for i = 1:12
figure; hold on;
title_name = strcat('GY-',' 2001~2010.',num2str(i,'%02d'), ' mon. po4.(mmol P m^-^3) surf.');
...
for i = 1:12
figure; hold on;
title_name = strcat('GY-',' 2001~2010.',num2str(i,'%02d'), ' mon. bot.');
...
for i = 1:12
figure; hold on;
title_name = strcat('GY-',' 2001~2010.',num2str(i,'%02d'), ' mon. temp.(^oC) bot.');
pcolor(lon,lat,squeeze(clim_mod_temp(:,:,1,i)).*(mask_r./mask_r)); shading flat;
...
for i = 1:12
figure; hold on;
title_name = strcat('GY-',' 2001~2010.',num2str(i,'%02d'), ' mon. salt.(psu) bot.');
...
for i = 1:12
figure; hold on;
title_name = strcat('GY-',' 2001~2010.',num2str(i,'%02d'), ' mon. chl.(ug/L) bot.');
...
for i = 1:12
figure; hold on;
title_name = strcat('GY-',' 2001~2010.',num2str(i,'%02d'), ' mon. no3.(mmol N m^-^3) bot.');
...
for i = 1:12
figure; hold on;
title_name = strcat('GY-',' 2001~2010.',num2str(i,'%02d'), ' mon. nh4.(mmol N m^-^3) bot.');
...
for i = 1:12
figure; hold on;
title_name = strcat('GY-',' 2001~2010.',num2str(i,'%02d'), ' mon. po4.(mmol P m^-^3) bot.');
