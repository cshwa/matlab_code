function status=plot_vertical_zonal_meridional(workdir, lonlatdep, year, inputmonth, fast, filename)
...
%     domaxis=[119 127 -100 0]; yellow sea
%     domaxis=[129.5 131.2 -500 0];  east sea
