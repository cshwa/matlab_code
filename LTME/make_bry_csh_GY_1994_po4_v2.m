...
cd D:\장기생태\Dynamic\result\yellow\1994\
for i = 1994:1994
    yeart=i;
bryname=['bndy_',num2str(yeart),'_Gwangyang_P_v2.nc'];
...
%%% load file        
load interp_bnd_fix_1994.mat

load D:\장기생태\Dynamic\KOEM\boundary_bio_input_1994_v2.mat
do_tem=squeeze(do_input(:,:,yeart-1979,:));
do_sn = permute(do_tem,[3 2 1]);
clearvars do_tem
do_tem=squeeze(do_input_we(:,:,yeart-1979,:));
