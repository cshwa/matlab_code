...
for t_year = 1993:1993 %before regime change
...
temp=ncread('river_1991_realts_biofennel_GY_sewer_det.nc','river_temp');
dis=ncread('river_1991_realts_biofennel_GY_sewer_det.nc','river_transport');
...
temp=ncread('river_1991_realts_biofennel_GY_sewer_det.nc','river_Oxyg');
dis=ncread('river_1991_realts_biofennel_GY_sewer_det.nc','river_transport');
figure;plot(dis(1,:));hold on; plot(dis(2,:),'r');
figure;plot(squeeze(temp(1,20,:)));hold on; plot(squeeze(temp(2,20,:)),'r');
...
temp=ncread('river_1991_realts_biofennel_GY_sewer_det.nc','river_NH4');
dis=ncread('river_1991_realts_biofennel_GY_sewer_det.nc','river_transport');
figure;plot(dis(1,:));hold on; plot(dis(2,:),'r');
figure;plot(squeeze(temp(1,20,:)));hold on; plot(squeeze(temp(2,20,:)),'r');
...
temp=ncread('river_1991_realts_biofennel_GY_sewer_det.nc','river_NO3');
dis=ncread('river_1991_realts_biofennel_GY_sewer_det.nc','river_transport');
figure;plot(dis(1,:));hold on; plot(dis(2,:),'r');
figure;plot(squeeze(temp(1,20,:)));hold on; plot(squeeze(temp(2,20,:)),'r');
figure;plot(squeeze(temp(1,20,:)));hold on; plot(squeeze(temp(2,20,:)),'r');plot(squeeze(temp(3,20,:)),'g');plot(squeeze(temp(4,20,:)),'k');
...
temp=ncread('river_1991_realts_biofennel_GY_sewer_det.nc','river_chlorophyll');
dis=ncread('river_1991_realts_biofennel_GY_sewer_det.nc','river_transport');
figure;plot(dis(1,:));hold on; plot(dis(2,:),'r');
figure;plot(squeeze(temp(1,20,:)));hold on; plot(squeeze(temp(2,20,:)),'r');
...
temp=ncread('river_1991_realts_biofennel_GY_sewer_det.nc','river_tPO4');
dis=ncread('river_1991_realts_biofennel_GY_sewer_det.nc','river_transport');
figure;plot(dis(1,:));hold on; plot(dis(2,:),'r');
figure;plot(squeeze(temp(1,20,:)));hold on; plot(squeeze(temp(2,20,:)),'r');
