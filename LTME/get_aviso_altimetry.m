function varargout = get_aviso_altimetry(varargin)
% Gets xxx data.
%
%  Usage:
%
...
% 2009/09/09 R.CLAT and R.CLON order interchanged
%==========================================================================

DSName='AVISO_Altimetry';
...
URLFILE=DSI.URLFILE{j};       
URLCVAR=eval(['DSI.URLCVAR.' FIELD ';']);
CTIME=['[' num2str(kT-1) ':1:' num2str(kT-1) ']']; % Constraint Time
URL=[DSI.URLSITE DSI.URLPATH URLFILE '?' URLCVAR CTIME R.CLON R.CLAT]; % 2D variables       
