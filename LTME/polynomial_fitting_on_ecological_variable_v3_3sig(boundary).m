...
% t_regime = length(1997:2008)*12 + 5; % interped data shift
t_regime = length(1997:2009)*12 + 2; %no interp
...
figure; hold on;
 ...
 if i >= 6
     nh4_mth_2nd(i) = nanmean(temp_ss_3sig_int(t_regime+(i-5):12:end));
     nh4_mth_2nd_c{i} = temp_ss_3sig_int(t_regime+(i-5):12:end);
     nh4_mth_2nd_b_c{i} = temp_bb_3sig_int(t_regime+(i-5):12:end);
 elseif i <= 5 
...
merge_s_adv = [nh4_mm_s_1st; nh4_mm_s_2nd_adv;];
merge_b_adv = [nh4_mm_b_1st; nh4_mm_b_2nd_adv;];
...
y_b_pre = polyfit(xx_mm_b, nh4_mm_b,3)
...
%  plot(y_b_2nd + nanmean(nh4_mm_b_raw_2nd),'+-','color','r','linew',2)
 plot(y_s_adv + nanmean(nh4_mm_s_raw_1st),'+-','color','b','linew',2)
 plot(y_b_adv + nanmean(nh4_mm_b_raw_1st),'+-','color','r','linew',2)  
  for i = 1:12
     plot(i,nh4_mth_full_c{i},'*','color','b','linew',2);
...
% legend('1st-sur','1st-bot');
% legend('2nd-sur','2nd-bot');
...
plot(xx_mm_2nd_raw,nh4_mm_s_raw_2nd - (nanmean(nh4_mm_s_raw_2nd) - nanmean(nh4_mm_s_raw_1st)) - nanmean(nh4_mm_s_raw_1st) + nanmean(nh4_mm_s_raw_1st),'*','color','b','linew',2);
plot(xx_mm_2nd_raw,nh4_mm_b_raw_2nd - (nanmean(nh4_mm_b_raw_2nd) - nanmean(nh4_mm_b_raw_1st)) - nanmean(nh4_mm_b_raw_1st) + nanmean(nh4_mm_b_raw_1st),'+','color','r','linew',2);
...
%  plot(y_b_2nd + nanmean(nh4_mm_b_raw_2nd),'+-','color','r','linew',2)
 ...
 plot(y_s_adv  + nanmean(nh4_mm_s_raw_1st),'+-','color','k','linew',2)
%  plot(y_b_adv  + nanmean(nh4_mm_b_raw_1st),'+-','color','k','linew',2)  
...
y_b_nh4 = y_b_1st + nanmean(nh4_mm_b_raw_1st);
y_s_nh4 = y_s_1st + nanmean(nh4_mm_s_raw_1st);
y_b_nh4_2nd = y_b_2nd + nanmean(nh4_mm_s_raw_2nd);
y_s_nh4_2nd = y_s_2nd + nanmean(nh4_mm_b_raw_2nd);
save('nh4_koem_input.mat','y_b_nh4_2nd','y_s_nh4_2nd','*_nh4','y_b_1st','y_s_1st','nh4_mm_b_raw','nh4_mm_s_raw_1st');
