...
xlabel('time(year)','fontsize',13)
ylabel('DO (mg/L)','fontsize',13)
title(['sumjin(songjung)-regression DO raw-climate ' num2str(i) '-month(daily)'],'fontsize',13)
grid on; 
ylim([-10 5])
...
plot(idx,yCalc2,'--','color','r','linew',2)
gtext(['y = ',num2str(b(2),2),'x + ',num2str(b(1),2)],'Color','k','FontSize',16)
print('-dpng', ['sumjin(songjung)-regression DO_raw-climate ' num2str(i) '-month(daily)']);
end
...
title(['sumjin(songjung)-regression Chla raw-climate ' num2str(i) '-month(daily)'],'fontsize',13)
grid on
set(gca,'fontsize',13)
  ylim([-10 30])
...
plot(idx,yCalc2,'--','color','r','linew',2)
gtext(['y = ',num2str(b(2),2),'x + ',num2str(b(1),2)],'Color','k','FontSize',16)
print('-dpng', ['sumjin(songjung)-regression Chla_raw-climate ' num2str(i) '-month(daily)']);
end
...
plot(idx,yCalc2,'--','color','r','linew',2)
gtext(['y = ',num2str(b(2),2),'x + ',num2str(b(1),2)],'Color','k','FontSize',16)
print('-dpng', ['Namgang_DO_raw-climate']);
...
plot(idx,yCalc2,'--','color','r','linew',2)
gtext(['y = ',num2str(b(2),2),'x + ',num2str(b(1),2)],'Color','k','FontSize',16)
print('-dpng', ['Namgang_chla_raw-climate']);
...
plot(idx,yCalc2,'--','color','r','linew',2)
gtext(['y = ',num2str(b(2),2),'x + ',num2str(b(1),2)],'Color','k','FontSize',16)
print('-dpng', ['Namgang_NH4_raw-climate']);
...
plot(idx,yCalc2,'--','color','r','linew',2)
gtext(['y = ',num2str(b(2),2),'x + ',num2str(b(1),2)],'Color','k','FontSize',16)
print('-dpng', ['Namgang_NO3_raw-climate']);
