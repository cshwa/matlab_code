...
% ylabel('po4 (mg/L)','fontsize',16)
% title('sumjin(songjung)-polynomial po4.','fontsize',16)
% grid on
% set(gca,'fontsize',16)
% ylim([0 0.1]) 
% xlim([1 366])
...
% grid on;
% xlim([1 length(raw_tn)])
% title('sumjin(songjung)- po4 raw.','fontsize',16)
% legend('po4')
% set(gca,'xtick',[t_tick_all(1:3:end)]);
% set(gca,'xticklabel',1989:3:2019,'fontsize',10);
% set(gca,'fontsize',16)
...
save('Namgang_polynomial_climate_to2011_3sig_po4.mat','yp_w_po4_04','yp_w_po4_af'); 
...
xlabel('time(days)','fontsize',16)
ylabel('po4 (mg/L)','fontsize',16)
title('Namgang-polynomial po4.','fontsize',16)
grid on
set(gca,'fontsize',16)
% ylim([2 18])
xlim([1 366])
...
line([tx_tick(11) length(w_po4_04)], [upper_bc(sig) upper_bc(sig)],'color', color_spec(sig),'linew',2)
line([tx_tick(11) length(w_po4_04)], [lower_bc(sig) lower_bc(sig)],'color', color_spec(sig),'linew',2)
yCalc3 = yCalc2{sig};
% plot([1:1:length(w_po4_04)],mean(w_po4_04(idx1)).*ones(length(w_po4_04)),'-.','color',color_spec(sig-1),'linew',2);
line([tx_tick(11) length(w_po4_04)],[mean(w_po4_04(idx1)) mean(w_po4_04(idx1))],'color',color_spec(sig-1),'linew',2);
...
title(['Namgang po4 raw  ' num2str(sig) '-sigma'],'fontsize',16)
ylim([0 inf])
set(gca,'xtick',[tx_tick(12:1:end)]);
set(gca,'xlim',[tx_tick(12) tx_tick(end)]);
set(gca,'xticklabel',1999:1:2019);

set(gca,'xtick',[tx_tick(1:3:end)]);
set(gca,'xlim',[tx_tick(1) tx_tick(end)]);
set(gca,'xticklabel',1989:3:2019);
set(gca,'xlim',[tx_tick(10) tx_tick(end)]);
