...
inputyear = [1991:1991]; % % put year which you want to plot [year year ...]
...
%                     MODEL6.salt75_sta(numyear,numline,numsta,nummon)=mean(MODEL6.salt(numyear,numline,numsta,nummon,1:6),5,'omitnan'); %origin
                    MODEL6.salt75_sta(numyear,numline,numsta,nummon)=mean(MODEL6.salt(numyear,numline,numsta,nummon,1:6),5); %origin
...
save(['model_salt_trend_',num2str(min(inputyear),'%04i'),'_',num2str(max(inputyear),'%04i'),'.mat'], 'MODEL6', 'NIFS6');
