...
a = 1 : size(d1,1);
y = find(p(a) == max(p));
b = [74 : y(1)]; d8 = d(8) * ones(size(b,2),1);
...
m22 = [st2_1_2;st3_2;st21_2;st22_2;st23_2;st24_2;st25_2;st26_2;st27_2;st28_2];
fid = fopen('m22.txt','w');
fprintf(fid, '%f %f %f %f\n', m22');
fclose(fid);


jtem2 = [st2_1_2(1,1) st3_2(size(st3_2,1),2);st21_2(1,1) st21_2(size(st21_2,1),2);st22_2(1,1) st22_2(size(st22_2,1),2);st23_2(1,1) st23_2(size(st23_2,1),2);st24_2(1,1) st24_2(size(st24_2,1),2);st25_2(1,1) st25_2(size(st25_2,1),2);st26_2(1,1) st26_2(size(st26_2,1),2);st27_2(1,1) st27_2(size(st27_2,1),2);st28_2(1,1) st28_2(size(st28_2,1),2)];
jtem2(:,2) = -1 .* jtem2(:,2);
fid = fopen('jtem2.txt','w');
fprintf(fid, '%f %f\n', jtem2');
fclose(fid);


figure; plot(st2_1_2(:,3),st2_1_2(:,2)); hold on;
plot(st3_2(:,3),st3_2(:,2),'k');
plot(st21_2(:,3),st21_2(:,2),'y');
plot(st22_2(:,3),st22_2(:,2),'r');
plot(st23_2(:,3),st23_2(:,2),'g');
plot(st24_2(:,3),st24_2(:,2),'c');
plot(st25_2(:,3),st25_2(:,2),':b');
plot(st26_2(:,3),st26_2(:,2),'m');
plot(st27_2(:,3),st27_2(:,2),':r');
plot(st28_2(:,3),st28_2(:,2),':k');
