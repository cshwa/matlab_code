...
% %  dir_name ={'all_std','t_std','sp_std'};
cd(['D:\장기생태\Dynamic\KOEM\compare_sewer\2nd_10yr\v5_each_st\2nd_10yr_old_vs_new']);
% cd(['D:\장기생태\Dynamic\KOEM\compare_sewer\2nd_10yr\v5_each_st\2nd_10yr_2sig_vs_3sig_allstd']);
    ...
    %         plot(nanmean([c1997.gy_po4_2; c1998.gy_po4_2; c1999.gy_po4_2; c2000.gy_po4_2; c2001.gy_po4_2; c2002.gy_po4_2; c2003.gy_po4_2;],1),'b','linew',2);
            ...
            nonan_data_plt = find(isnan(clim2.obm_gy_po4_ft_2)==0);
            nonan_diff=nonan_data_plt(2:end) - nonan_data_plt(1:end-1);
            discon_p = find(nonan_diff ~= 1); % find discontinuous point
            discon_p(4) = length(nonan_data_plt); %end point
            upper_bound_plt = clim2.obm_gy_po4_ft_2./30.973762 + clim2.obs_std_gy_po4_ft_2./30.973762;
            lower_bound_plt = clim2.obm_gy_po4_ft_2./30.973762 - clim2.obs_std_gy_po4_ft_2./30.973762;
            for i = 1:4
            if i == 1
            ...
            plot(clim2.obm_gy_po4_ft_2./30.973762,'g-','linew',2); 
            plot(1:length(clim2.obm_gy_po4_ft_2),upper_bound_plt,'g-','linew',2);
            plot(1:length(clim2.obm_gy_po4_ft_2),lower_bound_plt,'g-','linew',2);
 ...
 ylim([0 5])
    ...
    %         plot(nanmean([c1997.gy_no3_2; c1998.gy_no3_2; c1999.gy_no3_2; c2000.gy_no3_2; c2001.gy_no3_2; c2002.gy_no3_2; c2003.gy_no3_2;],1),'b','linew',2);
            ...
            clearvars *_bound_plt nonan_data_plt discon_p
            nonan_data_plt = find(isnan(clim2.obm_gy_no3_ft_2)==0);
            nonan_diff=nonan_data_plt(2:end) - nonan_data_plt(1:end-1);
            discon_p = find(nonan_diff ~= 1); % find discontinuous point
            discon_p(4) = length(nonan_data_plt); %end point
            upper_bound_plt = clim2.obm_gy_no3_ft_2./14 + clim2.obs_std_gy_no3_ft_2./14;
            lower_bound_plt = clim2.obm_gy_no3_ft_2./14 - clim2.obs_std_gy_no3_ft_2./14;
            for i = 1:4
            if i == 1
            patch([nonan_data_plt(1:discon_p(1)) fliplr(nonan_data_plt(1:discon_p(1)))], [upper_bound_plt(nonan_data_plt(1:discon_p(1))) fliplr(lower_bound_plt(nonan_data_plt(1:discon_p(1))))],'g');
            else
            ...
            plot(clim2.obm_gy_no3_ft_2./14,'g-','linew',2); 
            plot(1:length(clim2.obm_gy_no3_ft_2),upper_bound_plt,'g-','linew',2);
            plot(1:length(clim2.obm_gy_no3_ft_2),lower_bound_plt,'g-','linew',2);
    ...
    %         plot(nanmean([c1997.gy_nh4_2; c1998.gy_nh4_2; c1999.gy_nh4_2; c2000.gy_nh4_2; c2001.gy_nh4_2; c2002.gy_nh4_2; c2003.gy_nh4_2;],1),'b','linew',2);
                   ...
                   clearvars *_bound_plt nonan_data_plt discon_p
            nonan_data_plt = find(isnan(clim2.obm_gy_nh4_ft_2)==0);
            nonan_diff=nonan_data_plt(2:end) - nonan_data_plt(1:end-1);
            discon_p = find(nonan_diff ~= 1); % find discontinuous point
            discon_p(4) = length(nonan_data_plt); %end point
            upper_bound_plt = clim2.obm_gy_nh4_ft_2./14 + clim2.obs_std_gy_nh4_ft_2./14;
            lower_bound_plt = clim2.obm_gy_nh4_ft_2./14 - clim2.obs_std_gy_nh4_ft_2./14;
            for i = 1:4
            if i == 1
            patch([nonan_data_plt(1:discon_p(1)) fliplr(nonan_data_plt(1:discon_p(1)))], [upper_bound_plt(nonan_data_plt(1:discon_p(1))) fliplr(lower_bound_plt(nonan_data_plt(1:discon_p(1))))],'g');
            else
            ...
            plot(clim2.obm_gy_nh4_ft_2./14,'g-','linew',2); 
            plot(1:length(clim2.obm_gy_nh4_ft_2),upper_bound_plt,'g-','linew',2);
            plot(1:length(clim2.obm_gy_nh4_ft_2),lower_bound_plt,'g-','linew',2);
    ...
    %         plot(nanmean([c1997.gy_chl_2; c1998.gy_chl_2; c1999.gy_chl_2; c2000.gy_chl_2; c2001.gy_chl_2; c2002.gy_chl_2; c2003.gy_chl_2;],1),'b','linew',2);
                   ...
                   clearvars *_bound_plt nonan_data_plt discon_p
            nonan_data_plt = find(isnan(clim2.obm_gy_chl_ft_2)==0);
            nonan_diff=nonan_data_plt(2:end) - nonan_data_plt(1:end-1);
            discon_p = find(nonan_diff ~= 1); % find discontinuous point
            discon_p(4) = length(nonan_data_plt); %end point
            upper_bound_plt = clim2.obm_gy_chl_ft_2 + clim2.obs_std_gy_chl_ft_2;
            lower_bound_plt = clim2.obm_gy_chl_ft_2 - clim2.obs_std_gy_chl_ft_2;
            for i = 1:4
            if i == 1
            patch([nonan_data_plt(1:discon_p(1)) fliplr(nonan_data_plt(1:discon_p(1)))], [upper_bound_plt(nonan_data_plt(1:discon_p(1))) fliplr(lower_bound_plt(nonan_data_plt(1:discon_p(1))))],'g');
            else
            ...
            plot(clim2.obm_gy_chl_ft_2,'g-','linew',2); 
            plot(1:length(clim2.obm_gy_chl_ft_2),upper_bound_plt,'g-','linew',2);
            plot(1:length(clim2.obm_gy_chl_ft_2),lower_bound_plt,'g-','linew',2);
    ...
    %         plot(nanmean([c1997.gy_temp_2; c1998.gy_temp_2; c1999.gy_temp_2; c2000.gy_temp_2; c2001.gy_temp_2; c2002.gy_temp_2; c2003.gy_temp_2;],1),'b','linew',2);
            ...
            clearvars *_bound_plt nonan_data_plt discon_p
            nonan_data_plt = find(isnan(clim2.obm_gy_temp_ft_2)==0);
            nonan_diff=nonan_data_plt(2:end) - nonan_data_plt(1:end-1);
            discon_p = find(nonan_diff ~= 1); % find discontinuous point
            discon_p(4) = length(nonan_data_plt); %end point
            upper_bound_plt = clim2.obm_gy_temp_ft_2 + clim2.obs_std_gy_temp_ft_2;
            lower_bound_plt = clim2.obm_gy_temp_ft_2 - clim2.obs_std_gy_temp_ft_2;
            for i = 1:4
            if i == 1
            patch([nonan_data_plt(1:discon_p(1)) fliplr(nonan_data_plt(1:discon_p(1)))], [upper_bound_plt(nonan_data_plt(1:discon_p(1))) fliplr(lower_bound_plt(nonan_data_plt(1:discon_p(1))))],'g');
            else
            ...
            plot(clim2.obm_gy_temp_ft_2,'g-','linew',2); 
            plot(1:length(clim2.obm_gy_temp_ft_2),upper_bound_plt,'g-','linew',2);
            plot(1:length(clim2.obm_gy_temp_ft_2),lower_bound_plt,'g-','linew',2);
    ...
    %         plot(nanmean([c1997.gy_salt_2; c1998.gy_salt_2; c1999.gy_salt_2; c2000.gy_salt_2; c2001.gy_salt_2; c2002.gy_salt_2; c2003.gy_salt_2;],1),'b','linew',2);
            ...
            clearvars *_bound_plt nonan_data_plt discon_p
            nonan_data_plt = find(isnan(clim2.obm_gy_salt_ft_2)==0);
            nonan_diff=nonan_data_plt(2:end) - nonan_data_plt(1:end-1);
            discon_p = find(nonan_diff ~= 1); % find discontinuous point
            discon_p(4) = length(nonan_data_plt); %end point
            upper_bound_plt = clim2.obm_gy_salt_ft_2 + clim2.obs_std_gy_salt_ft_2;
            lower_bound_plt = clim2.obm_gy_salt_ft_2 - clim2.obs_std_gy_salt_ft_2;
            for i = 1:4
            if i == 1
            patch([nonan_data_plt(1:discon_p(1)) fliplr(nonan_data_plt(1:discon_p(1)))], [upper_bound_plt(nonan_data_plt(1:discon_p(1))) fliplr(lower_bound_plt(nonan_data_plt(1:discon_p(1))))],'g');
            else
            ...
            plot(clim2.obm_gy_salt_ft_2,'g-','linew',2); 
            plot(1:length(clim2.obm_gy_salt_ft_2),upper_bound_plt,'g-','linew',2);
            plot(1:length(clim2.obm_gy_salt_ft_2),lower_bound_plt,'g-','linew',2);
...
fig = figure; hold on;
    ...
    % data(1:length(c2004.gy_po4_b))=c2004.gy_po4_b_2; 
            ...
            clearvars *_bound_plt nonan_data_plt discon_p
            nonan_data_plt = find(isnan(clim2.obm_gy_po4_b_ft_2)==0);
            nonan_diff=nonan_data_plt(2:end) - nonan_data_plt(1:end-1);
            discon_p = find(nonan_diff ~= 1); % find discontinuous point
            discon_p(4) = length(nonan_data_plt); %end point
            upper_bound_plt = clim2.obm_gy_po4_b_ft_2./30.973762 + clim2.obs_std_gy_po4_b_ft_2./30.973762;
            lower_bound_plt = clim2.obm_gy_po4_b_ft_2./30.973762 - clim2.obs_std_gy_po4_b_ft_2./30.973762;
            for i = 1:4
            if i == 1
            patch([nonan_data_plt(1:discon_p(1)) fliplr(nonan_data_plt(1:discon_p(1)))], [upper_bound_plt(nonan_data_plt(1:discon_p(1))) fliplr(lower_bound_plt(nonan_data_plt(1:discon_p(1))))],'g');
            else
            ...
            plot(clim2.obm_gy_po4_b_ft_2./30.973762,'g-','linew',2); 
            plot(1:length(clim2.obm_gy_po4_b_ft_2),upper_bound_plt,'g-','linew',2);
            plot(1:length(clim2.obm_gy_po4_b_ft_2),lower_bound_plt,'g-','linew',2);
 ...
 ylim([0 5])
    ...
    clearvars *_bound_plt nonan_data_plt discon_p
            nonan_data_plt = find(isnan(clim2.obm_gy_no3_b_ft_2)==0);
            nonan_diff=nonan_data_plt(2:end) - nonan_data_plt(1:end-1);
            discon_p = find(nonan_diff ~= 1); % find discontinuous point
            discon_p(4) = length(nonan_data_plt); %end point
            upper_bound_plt = clim2.obm_gy_no3_b_ft_2./14 + clim2.obs_std_gy_no3_b_ft_2./14;
            lower_bound_plt = clim2.obm_gy_no3_b_ft_2./14 - clim2.obs_std_gy_no3_b_ft_2./14;
            for i = 1:4
            if i == 1
            patch([nonan_data_plt(1:discon_p(1)) fliplr(nonan_data_plt(1:discon_p(1)))], [upper_bound_plt(nonan_data_plt(1:discon_p(1))) fliplr(lower_bound_plt(nonan_data_plt(1:discon_p(1))))],'g');
            else
            ...
            plot(clim2.obm_gy_no3_b_ft_2./14,'g-','linew',2); 
            plot(1:length(clim2.obm_gy_no3_b_ft_2),upper_bound_plt,'g-','linew',2);
            plot(1:length(clim2.obm_gy_no3_b_ft_2),lower_bound_plt,'g-','linew',2);
    ...
    %         plot(nanmean([c1997.gy_nh4_b; c1998.gy_nh4_b; c1999.gy_nh4_b; c2000.gy_nh4_b; c2001.gy_nh4_b; c2002.gy_nh4_b; c2003.gy_nh4_b;],1),'b','linew',2);
           ...
           clearvars *_bound_plt nonan_data_plt discon_p
            nonan_data_plt = find(isnan(clim2.obm_gy_nh4_b_ft_2)==0);
            nonan_diff=nonan_data_plt(2:end) - nonan_data_plt(1:end-1);
            discon_p = find(nonan_diff ~= 1); % find discontinuous point
            discon_p(4) = length(nonan_data_plt); %end point
            upper_bound_plt = clim2.obm_gy_nh4_b_ft_2./14 + clim2.obs_std_gy_nh4_b_ft_2./14;
            lower_bound_plt = clim2.obm_gy_nh4_b_ft_2./14 - clim2.obs_std_gy_nh4_b_ft_2./14;
            for i = 1:4
            if i == 1
            patch([nonan_data_plt(1:discon_p(1)) fliplr(nonan_data_plt(1:discon_p(1)))], [upper_bound_plt(nonan_data_plt(1:discon_p(1))) fliplr(lower_bound_plt(nonan_data_plt(1:discon_p(1))))],'g');
            else
            ...
            plot(clim2.obm_gy_nh4_b_ft_2./14,'g-','linew',2); 
            plot(1:length(clim2.obm_gy_nh4_b_ft_2),upper_bound_plt,'g-','linew',2);
            plot(1:length(clim2.obm_gy_nh4_b_ft_2),lower_bound_plt,'g-','linew',2);
...
%         plot(nanmean([c1997.gy_chl_b; c1998.gy_chl_b; c1999.gy_chl_b; c2000.gy_chl_b; c2001.gy_chl_b; c2002.gy_chl_b; c2003.gy_chl_b;],1),'b','linew',2);
          ...
          clearvars *_bound_plt nonan_data_plt discon_p
            nonan_data_plt = find(isnan(clim2.obm_gy_chl_b_ft_2)==0);
            nonan_diff=nonan_data_plt(2:end) - nonan_data_plt(1:end-1);
            discon_p = find(nonan_diff ~= 1); % find discontinuous point
            discon_p(4) = length(nonan_data_plt); %end point
            upper_bound_plt = clim2.obm_gy_chl_b_ft_2 + clim2.obs_std_gy_chl_b_ft_2;
            lower_bound_plt = clim2.obm_gy_chl_b_ft_2 - clim2.obs_std_gy_chl_b_ft_2;
            for i = 1:4
            if i == 1
            patch([nonan_data_plt(1:discon_p(1)) fliplr(nonan_data_plt(1:discon_p(1)))], [upper_bound_plt(nonan_data_plt(1:discon_p(1))) fliplr(lower_bound_plt(nonan_data_plt(1:discon_p(1))))],'g');
            else
            ...
            plot(clim2.obm_gy_chl_b_ft_2,'g-','linew',2); 
            plot(1:length(clim2.obm_gy_chl_b_ft_2),upper_bound_plt,'g-','linew',2);
            plot(1:length(clim2.obm_gy_chl_b_ft_2),lower_bound_plt,'g-','linew',2);
    ...
    % data(1:length(c2004.gy_temp_b))=c2004.gy_temp_b; 
            ...
            clearvars *_bound_plt nonan_data_plt discon_p
            nonan_data_plt = find(isnan(clim2.obm_gy_temp_b_ft_2)==0);
            nonan_diff=nonan_data_plt(2:end) - nonan_data_plt(1:end-1);
            discon_p = find(nonan_diff ~= 1); % find discontinuous point
            discon_p(4) = length(nonan_data_plt); %end point
            upper_bound_plt = clim2.obm_gy_temp_b_ft_2 + clim2.obs_std_gy_temp_b_ft_2;
            lower_bound_plt = clim2.obm_gy_temp_b_ft_2 - clim2.obs_std_gy_temp_b_ft_2;
            for i = 1:4
            if i == 1
            patch([nonan_data_plt(1:discon_p(1)) fliplr(nonan_data_plt(1:discon_p(1)))], [upper_bound_plt(nonan_data_plt(1:discon_p(1))) fliplr(lower_bound_plt(nonan_data_plt(1:discon_p(1))))],'g');
            else
            ...
            plot(clim2.obm_gy_temp_b_ft_2,'g-','linew',2); 
            plot(1:length(clim2.obm_gy_temp_b_ft_2),upper_bound_plt,'g-','linew',2);
            plot(1:length(clim2.obm_gy_temp_b_ft_2),lower_bound_plt,'g-','linew',2);
    ...
    %         plot(nanmean([c1997.gy_salt_b; c1998.gy_salt_b; c1999.gy_salt_b; c2000.gy_salt_b; c2001.gy_salt_b; c2002.gy_salt_b; c2003.gy_salt_b;],1),'b','linew',2);
                   ...
                   clearvars *_bound_plt nonan_data_plt discon_p
            nonan_data_plt = find(isnan(clim2.obm_gy_salt_b_ft_2)==0);
            nonan_diff=nonan_data_plt(2:end) - nonan_data_plt(1:end-1);
            discon_p = find(nonan_diff ~= 1); % find discontinuous point
            discon_p(4) = length(nonan_data_plt); %end point
            upper_bound_plt = clim2.obm_gy_salt_b_ft_2 + clim2.obs_std_gy_salt_b_ft_2;
            lower_bound_plt = clim2.obm_gy_salt_b_ft_2 - clim2.obs_std_gy_salt_b_ft_2;
            for i = 1:4
            if i == 1
            patch([nonan_data_plt(1:discon_p(1)) fliplr(nonan_data_plt(1:discon_p(1)))], [upper_bound_plt(nonan_data_plt(1:discon_p(1))) fliplr(lower_bound_plt(nonan_data_plt(1:discon_p(1))))],'g');
            else
            ...
            plot(clim2.obm_gy_salt_b_ft_2,'g-','linew',2); 
            plot(1:length(clim2.obm_gy_salt_b_ft_2),upper_bound_plt,'g-','linew',2);
            plot(1:length(clim2.obm_gy_salt_b_ft_2),lower_bound_plt,'g-','linew',2);         
