...
mod_file=['D:\장기생태\Dynamic\result\',num2str(refyear),'\',num2str(refyear),'_mp_p_sewer_det_f.nc'];
...
% title('KOEM-표층염분 연평균(공간평균)','fontsize',13)
% grid on
% set(gca,'fontsize',13)
% % ylim([32 35])
% 
...
% set(gca,'xlim',[1 22]);
% set(gca,'xticklabel',1997:2:2018);
% title('KOEM관측-표층질산염 연평균(공간평균)','fontsize',13)
% grid on
% set(gca,'fontsize',13)
% % ylim([32 35])
...
cd(['F:\장기생태\Dynamic\result\',num2str(refyear)])
