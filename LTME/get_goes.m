function varargout = get_goes(varargin)
% Gets Geostationary Operational Environmental Satellite (GOES) 
% 5-km data from NOAA archive.
%
% Gets xxx data.
%
%  Usage:
...
CALT='[0:1:0]'; % altitude constraint
URL=[DSI.URLSITE DSI.URLPATH DSI.URLFILE '?' URLCVAR CTIME CALT R.CLAT R.CLON]; % 2D variables       
