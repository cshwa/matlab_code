...
clim2_2_std = clim1.obs_std_gy_no3_ft_2(:,3);
    ...
    fig = figure; hold on;
            plot(nanmean(regime1_noriv_chl.gy_no3,1),'r','linew',2);
            plot(nanmean(regime2_noriv_chl.gy_no3,1),'g','linew',2);
%             clearvars *_bound_plt nonan_data_plt discon_p temp_d
...
clim2_2_std = clim1.obs_std_gy_nh4_ft_2(:,3);
    ...
    fig = figure; hold on;
            ...
            plot(nanmean(regime1_noriv_chl.gy_nh4,1),'r','linew',2);
...
clim2_2_std = clim1.obs_std_gy_chl_ft_2(:,3);
    ...
    fig = figure; hold on;
            plot(nanmean(regime1_noriv_chl.gy_chl,1),'r','linew',2);
            plot(nanmean(regime2_noriv_chl.gy_chl,1),'g','linew',2);
%             clearvars *_bound_plt nonan_data_plt discon_p temp_d
...
clim2_2_std = clim1.obs_std_gy_temp_ft_2(:,3);
    ...
    fig = figure; hold on;
            plot(nanmean(regime1_noriv_chl.gy_temp,1),'r','linew',2);
             plot(nanmean(regime2_noriv_chl.gy_temp,1),'g','linew',2);
%             clearvars *_bound_plt nonan_data_plt discon_p temp_d
...
clim2_2_std = clim1.obs_std_gy_salt_ft_2(:,3);   
    ...
    fig = figure; hold on; 
            ...
            plot(nanmean(regime2_noriv_chl.gy_salt,1),'g','linew',2);
...
clim2_2_std = clim1.obs_std_gy_no3_b_ft_2(:,3);
     ...
     fig = figure; hold on;
            plot(nanmean(regime1_noriv_chl.gy_no3_b,1),'r','linew',2);
            plot(nanmean(regime2_noriv_chl.gy_no3_b,1),'g','linew',2);
...
clim2_2_std = clim1.obs_std_gy_nh4_b_ft_2(:,3);
    ...
    fig = figure; hold on;
            plot(nanmean(regime1_noriv_chl.gy_nh4_b,1),'r','linew',2);
            plot(nanmean(regime2_noriv_chl.gy_nh4_b,1),'g','linew',2);
...
clim2_2_std = clim1.obs_std_gy_chl_b_ft_2(:,3);
    ...
    fig = figure; hold on;
            plot(nanmean(regime1_noriv_chl.gy_chl_b,1),'r','linew',2);
            plot(nanmean(regime2_noriv_chl.gy_chl_b,1),'g','linew',2);
...
clim2_2_std = clim1.obs_std_gy_temp_b_ft_2(:,3);  
    ...
    fig = figure; hold on;
            plot(nanmean(regime1_noriv_chl.gy_temp_b,1),'r','linew',2);
            plot(nanmean(regime2_noriv_chl.gy_temp_b,1),'g','linew',2);  
...
clim2_2_std = clim1.obs_std_gy_salt_b_ft_2(:,3);   
    ...
    fig = figure; hold on;
            plot(nanmean(regime1_noriv_chl.gy_salt_b,1),'r','linew',2);  
            plot(nanmean(regime2_noriv_chl.gy_salt_b,1),'g','linew',2);
