...
save('songjung_yymm_monthly_data_89to19_nosig.mat','mon*','t_indx','yymmdd_txt_c');
save('songjung_yymm_raw_data_89to19_nosig.mat','com*','t_indx','yymmdd_txt_c');
...
save('namgang_yymm_monthly_data_89to19_nosig.mat','mon*','t_indx','yymmdd_txt_c');
save('namgang_yymm_raw_data_89to19_nosig.mat','com*','t_indx','yymmdd_txt_c');