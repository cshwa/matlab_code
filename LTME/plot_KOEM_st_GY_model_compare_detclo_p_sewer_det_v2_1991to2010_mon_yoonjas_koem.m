...
for i = 1:12
   mod_file=['D:\장기생태\Dynamic\result\',num2str(refyear),'\','mp_p_sewer_det_f_monthly_',num2str(refyear),'_',num2str(i,'%02d'),'.nc'];
if exist(mod_file,'file') ~= 2
    mod_file=[]; 
    mod_file=['D:\장기생태\Dynamic\result\',num2str(refyear),'\','mp_p_sewer_det_monthly_',num2str(refyear),'_',num2str(i,'%02d'),'.nc'];
end
...
save([num2str(refyear),'_monthly_result.mat'],'-v7.3');
end
