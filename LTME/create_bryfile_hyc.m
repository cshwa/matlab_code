function create_bryfile_hyc(bryname,brytype,grdname,year,cycle,time,vtransform)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
...
filename=['.\BRYDATA\',brytype,'_Y',num2str(year),'M1.nc'];
...
for mon=1:1:12
    filename=['.\BRYDATA\',brytype,'_Y',num2str(year),'M',num2str(mon),'.nc'];
