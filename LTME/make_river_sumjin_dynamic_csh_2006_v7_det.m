...
for t_year = 2006:2006 %before regime change
   
grd_file='grid_gy_v11_s.nc';
% Fname='pohang_tide_inout.nc';
Fname =['river_' num2str(t_year) '_realts_biofennel_GY_sewer_det_v7.nc'];
...
sumjin_do = yp_w_do_af'*0.7*44.661;
sumjin_chl = yp_w_chl_af';
sumjin_no3 = yp_w_no3_af'*1000/14;
sumjin_nh4 = yp_w_nh4_af'*1000/14;
...
nam_do = yp_w_do_af'*0.7*44.661;  %% mg/L to mM/m^3;
nam_chl = yp_w_chl_af'; 
% nam_chl(364:366) = nam_chl(363); % negative concen. to be closest sample.
nam_no3 = yp_w_no3_af'*1000/14; %% mg/L to mM/m^3;
nam_nh4 = yp_w_nh4_af'*1000/14; %% mg/L to mM/m^3;
...
if cycle == 365
        ...
        River.Oxyg(:,:,r)=repmat(sumjin_do,1,20);
        River.tPO4(:,:,r)=repmat(riv1_TP_f'.*0.8 .*(1000/30.973762)  ,1,20);
        River.chlorophyll(:,:,r)=repmat(sumjin_chl.* 0,1,20);
        % River.DON(:,:,r)=repmat(riv1_TN_f'*(999724/2/1000000)*(1000/14),1,20);
        River.LDeN(:,:,r)=repmat(riv1_TN_f'*(999724/2/1000000)*(1000/14).*0.7,1,20);
        River.SDeN(:,:,r)=repmat(riv1_TN_f'*(999724/2/1000000)*(1000/14).*0.3,1,20);
        River.vshape(r,1:N)=1/N;
        ...
        River.Oxyg(:,:,r)=repmat(sumjin_do,1,20);
        River.tPO4(:,:,r)=repmat(riv3_TP_f'.*0.8 .*(1000/30.973762)  ,1,20);
        River.chlorophyll(:,:,r)=repmat(sumjin_chl.* 0,1,20);
        River.LDeN(:,:,r)=repmat(riv3_TN_f'*(999724/2/1000000)*(1000/14).*0.7,1,20);
        River.SDeN(:,:,r)=repmat(riv3_TN_f'*(999724/2/1000000)*(1000/14).*0.3,1,20);
        River.vshape(1:N,r) =  1/N;
        ...
        River.Oxyg(:,:,r)=repmat(sumjin_do,1,20);
        River.tPO4(:,:,r)=repmat(riv4_TP_f'.*0.8 .*(1000/30.973762)  ,1,20);
        River.chlorophyll(:,:,r)=repmat(sumjin_chl.* 0,1,20);
        % River.DON(:,:,r)=repmat(riv4_TN_f'*(999724/2/1000000)*(1000/14),1,20);
        River.LDeN(:,:,r)=repmat(riv4_TN_f'*(999724/2/1000000)*(1000/14).*0.7,1,20);
        River.SDeN(:,:,r)=repmat(riv4_TN_f'*(999724/2/1000000)*(1000/14).*0.3,1,20);
        River.vshape(1:N,r) =  1/N;
        %--- 여수월내 -----------------------------------------
        % 1990-12-31
        % r = 7; 
        ...
        River.Oxyg(:,:,r)=repmat(sumjin_do,1,20);
        River.tPO4(:,:,r)=repmat(riv5_TP_f'.*0.8 .*(1000/30.973762)  ,1,20);
        River.chlorophyll(:,:,r)=repmat(sumjin_chl.* 0,1,20);
        % River.DON(:,:,r)=repmat(riv5_TN_f'*(999724/2/1000000)*(1000/14),1,20);
        River.LDeN(:,:,r)=repmat(riv5_TN_f'*(999724/2/1000000)*(1000/14).*0.7,1,20);
        River.SDeN(:,:,r)=repmat(riv5_TN_f'*(999724/2/1000000)*(1000/14).*0.3,1,20);
        River.vshape(1:N,r) =  1/N;
        ...
        River.Oxyg(:,:,r)=repmat(sumjin_do,1,20);
        River.tPO4(:,:,r)=repmat(riv7_TP_f'.*0.8 .*(1000/30.973762)  ,1,20);
        River.chlorophyll(:,:,r)=repmat(sumjin_chl.* 0,1,20);
        % River.DON(:,:,r)=repmat(riv7_TN_f'*(999724/2/1000000)*(1000/14),1,20);
        % River.PON(:,:,r)=repmat(riv7_TN_f'*(999724/2/1000000)*(1000/14),1,20);
        River.LDeN(:,:,r)=repmat(riv7_TN_f'*(999724/2/1000000)*(1000/14).*0.7,1,20);
        River.SDeN(:,:,r)=repmat(riv7_TN_f'*(999724/2/1000000)*(1000/14).*0.3,1,20);
        River.vshape(1:N,r) =  1/N;
        ...
        River.Oxyg(:,:,r)=repmat(sumjin_do,1,20);
        River.tPO4(:,:,r)=repmat(riv8_TP_f'.*0.8 .*(1000/30.973762)  ,1,20);
        River.chlorophyll(:,:,r)=repmat(sumjin_chl.* 0,1,20);
        % River.DON(:,:,r)=repmat(riv8_TN_f'*(999724/2/1000000)*(1000/14),1,20);
        % River.PON(:,:,r)=repmat(riv8_TN_f'*(999724/2/1000000)*(1000/14),1,20);
        River.LDeN(:,:,r)=repmat(riv8_TN_f'*(999724/2/1000000)*(1000/14).*0.7,1,20);
        River.SDeN(:,:,r)=repmat(riv8_TN_f'*(999724/2/1000000)*(1000/14).*0.3,1,20);
        River.vshape(1:N,r) =  1/N;
        ...
        River.lat(r) = 112;
        River.dir(r) = 1; % v-face
        River.trans(:,r)=-([riv1_dis_f riv1_dis_f(end)])/86400;
        River.temp(:,:,r)=repmat(temp_out_sumjin,1,20);
        River.salt(:,:,r)=repmat(salt_out,1,20);
        River.NH4(:,:,r)=repmat(([riv1_TN_f riv1_TN_f(end)])'*(140/1000000)*(1000/14),1,20);
        River.NO3(:,:,r)=repmat(([riv1_TN_f riv1_TN_f(end)])'*(136/1000000)*(1000/14),1,20);
        River.Oxyg(:,:,r)=repmat(sumjin_do,1,20);
        River.tPO4(:,:,r)=repmat(([riv1_TP_f riv1_TP_f(end)])'.*0.8 .*(1000/30.973762)  ,1,20);
        River.chlorophyll(:,:,r)=repmat(sumjin_chl.* 0,1,20);
        % River.DON(:,:,r)=repmat(riv1_TN_f'*(999724/2/1000000)*(1000/14),1,20);
        River.LDeN(:,:,r)=repmat(([riv1_TN_f riv1_TN_f(end)])'*(999724/2/1000000)*(1000/14).*0.7,1,20);
        River.SDeN(:,:,r)=repmat(([riv1_TN_f riv1_TN_f(end)])'*(999724/2/1000000)*(1000/14).*0.3,1,20);
        River.vshape(r,1:N)=1/N;
        ...
        River.lat(r) = 99;  
        River.dir(r) = 0; % u-face
        River.trans(:,r)=([riv2_dis_f riv2_dis_f(end)])/86400;
        River.temp(:,:,r)=repmat(temp_out_sumjin,1,20);
        River.salt(:,:,r)=repmat(salt_out,1,20);
        River.NH4(:,:,r)=repmat(([riv2_TN_f riv2_TN_f(end)])'*(140/1000000)*(1000/14),1,20);
        River.NO3(:,:,r)=repmat(([riv2_TN_f riv2_TN_f(end)])'*(136/1000000)*(1000/14),1,20);
        River.Oxyg(:,:,r)=repmat(sumjin_do,1,20);
        River.tPO4(:,:,r)=repmat(([riv2_TP_f riv2_TP_f(end)])'.*0.8 .*(1000/30.973762)  ,1,20);
        River.chlorophyll(:,:,r)=repmat(sumjin_chl.* 0,1,20);
        % River.DON(:,:,r)=repmat(riv2_TN_f'*(999724/2/1000000)*(1000/14),1,20);
        River.LDeN(:,:,r)=repmat(([riv2_TN_f riv2_TN_f(end)])'*(999724/2/1000000)*(1000/14).*0.7,1,20);
        River.SDeN(:,:,r)=repmat(([riv2_TN_f riv2_TN_f(end)])'*(999724/2/1000000)*(1000/14).*0.3,1,20);
        River.vshape(r,1:N)=1/N;
        ...
        River.lat(r) = 106;  % 행
        River.dir(r) = 1; % v-face
        River.trans(:,r)=-([riv3_dis_f riv3_dis_f(end)])/86400;
        River.temp(:,:,r)=repmat(temp_out_sumjin,1,20);
        River.salt(:,:,r)=repmat(salt_out,1,20);
        River.NH4(:,:,r)=repmat(([riv3_TN_f riv3_TN_f(end)])'*(140/1000000)*(1000/14),1,20);
        River.NO3(:,:,r)=repmat(([riv3_TN_f riv3_TN_f(end)])'*(136/1000000)*(1000/14),1,20);
        River.Oxyg(:,:,r)=repmat(sumjin_do,1,20);
        River.tPO4(:,:,r)=repmat(([riv3_TP_f riv3_TP_f(end)])'.*0.8 .*(1000/30.973762)  ,1,20);
        River.chlorophyll(:,:,r)=repmat(sumjin_chl.* 0,1,20);
        % River.DON(:,:,r)=repmat(riv3_TN_f'*(999724/2/1000000)*(1000/14),1,20);
        River.LDeN(:,:,r)=repmat(([riv3_TN_f riv3_TN_f(end)])'*(999724/2/1000000)*(1000/14).*0.7,1,20);
        River.SDeN(:,:,r)=repmat(([riv3_TN_f riv3_TN_f(end)])'*(999724/2/1000000)*(1000/14).*0.3,1,20);
        River.vshape(1:N,r) =  1/N;
        ...
        River.lat(r) = 121;  % 행
        River.dir(r) = 0; % v-face
        River.trans(:,r)=([riv4_dis_f riv4_dis_f(end)])/86400;
        River.temp(:,:,r)=repmat(temp_out_sumjin,1,20);
        River.salt(:,:,r)=repmat(salt_out,1,20);
        River.NH4(:,:,r)=repmat(([riv4_TN_f riv4_TN_f(end)])'*(140/1000000)*(1000/14),1,20);
        River.NO3(:,:,r)=repmat(([riv4_TN_f riv4_TN_f(end)])'*(136/1000000)*(1000/14),1,20);
        River.Oxyg(:,:,r)=repmat(sumjin_do,1,20);
        River.tPO4(:,:,r)=repmat(([riv4_TP_f riv4_TP_f(end)])'.*0.8 .*(1000/30.973762)  ,1,20);
        River.chlorophyll(:,:,r)=repmat(sumjin_chl.* 0,1,20);
        % River.DON(:,:,r)=repmat(riv4_TN_f'*(999724/2/1000000)*(1000/14),1,20);
        River.LDeN(:,:,r)=repmat(([riv4_TN_f riv4_TN_f(end)])'*(999724/2/1000000)*(1000/14).*0.7,1,20);
        River.SDeN(:,:,r)=repmat(([riv4_TN_f riv4_TN_f(end)])'*(999724/2/1000000)*(1000/14).*0.3,1,20);
        River.vshape(1:N,r) =  1/N;
        %--- 여수월내 -----------------------------------------
        % 1990-12-31
        % r = 7; 
        ...
        River.lat(r) = 63;  % 행
        River.dir(r) = 1; % 0:u-face, 1:v-face
        River.trans(:,r)=([riv5_dis_f riv5_dis_f(end)])/86400;
        River.temp(:,:,r)=repmat(temp_out_sumjin,1,20);
        River.salt(:,:,r)=repmat(salt_out,1,20);
        River.NH4(:,:,r)=repmat(([riv5_TN_f riv5_TN_f(end)])'*(140/1000000)*(1000/14),1,20);
        River.NO3(:,:,r)=repmat(([riv5_TN_f riv5_TN_f(end)])'*(136/1000000)*(1000/14),1,20);
        River.Oxyg(:,:,r)=repmat(sumjin_do,1,20);
        River.tPO4(:,:,r)=repmat(([riv5_TP_f riv5_TP_f(end)])'.*0.8 .*(1000/30.973762)  ,1,20);
        River.chlorophyll(:,:,r)=repmat(sumjin_chl.* 0,1,20);
        % River.DON(:,:,r)=repmat(riv5_TN_f'*(999724/2/1000000)*(1000/14),1,20);
        River.LDeN(:,:,r)=repmat(([riv5_TN_f riv5_TN_f(end)])'*(999724/2/1000000)*(1000/14).*0.7,1,20);
        River.SDeN(:,:,r)=repmat(([riv5_TN_f riv5_TN_f(end)])'*(999724/2/1000000)*(1000/14).*0.3,1,20);
        River.vshape(1:N,r) =  1/N;
        ...
        % River.lat(r) = 84;  % 행
        % River.dir(r) = 1; % 남으로 흐름 -> River.lon(r) 값을 edtimark 값에 +1
%         River.trans(:,r)=-([riv6_dis_f riv6_dis_f(end)])/86400;
%         River.temp(:,:,r)=repmat(temp_out_sumjin,1,20);
%         River.salt(:,:,r)=repmat(salt_out,1,20);
%         River.NH4(:,:,r)=repmat(([riv6_TN_f riv6_TN_f(end)])'*(140/1000000)*(1000/14),1,20);
%         River.NO3(:,:,r)=repmat(([riv6_TN_f riv6_TN_f(end)])'*(136/1000000)*(1000/14),1,20);
%         River.Oxyg(:,:,r)=repmat(sumjin_do,1,20);
%         River.tPO4(:,:,r)=repmat(([riv6_TP_f riv6_TP_f(end)])'.*0.8 .*(1000/30.973762)  ,1,20);
%         River.chlorophyll(:,:,r)=repmat(sumjin_chl.* 0,1,20);
%         % River.DON(:,:,r)=repmat(riv6_TN_f'*(999724/2/1000000)*(1000/14),1,20);
%         River.LDeN(:,:,r)=repmat(([riv6_TN_f riv6_TN_f(end)])'*(999724/2/1000000)*(1000/14).*0.7,1,20);
%         River.SDeN(:,:,r)=repmat(([riv6_TN_f
%         riv6_TN_f(end)])'*(999724/2/1000000)*(1000/14).*0.3,1,20);
        % River.vshape(1:N,r) =  1/N;
        ...
        River.lat(r) = 56;  % 행
        River.dir(r) = 0; % 남으로 흐름 -> River.lon(r) 값을 edtimark 값에 +1
        River.trans(:,r)=([riv7_dis_f riv7_dis_f(end)])/86400;
        River.temp(:,:,r)=repmat(temp_out_sumjin,1,20);
        River.salt(:,:,r)=repmat(salt_out,1,20);
        River.NH4(:,:,r)=repmat(([riv7_TN_f riv7_TN_f(end)])'*(140/1000000)*(1000/14),1,20);
        River.NO3(:,:,r)=repmat(([riv7_TN_f riv7_TN_f(end)])'*(136/1000000)*(1000/14),1,20);
        River.Oxyg(:,:,r)=repmat(sumjin_do,1,20);
        River.tPO4(:,:,r)=repmat(([riv7_TP_f riv7_TP_f(end)])'.*0.8 .*(1000/30.973762)  ,1,20);
        River.chlorophyll(:,:,r)=repmat(sumjin_chl.* 0,1,20);
        % River.DON(:,:,r)=repmat(riv7_TN_f'*(999724/2/1000000)*(1000/14),1,20);
        River.LDeN(:,:,r)=repmat(([riv7_TN_f riv7_TN_f(end)])'*(999724/2/1000000)*(1000/14).*0.7,1,20);
        River.SDeN(:,:,r)=repmat(([riv7_TN_f riv7_TN_f(end)])'*(999724/2/1000000)*(1000/14).*0.3,1,20);
        River.vshape(1:N,r) =  1/N;
        ...
        River.lat(r) = 23;  % 행
        River.dir(r) = 1; % 남으로 흐름 -> River.lon(r) 값을 edtimark 값에 +1
        River.trans(:,r)=-([riv8_dis_f riv8_dis_f(end)])/86400;
        River.temp(:,:,r)=repmat(temp_out_sumjin,1,20);
        River.salt(:,:,r)=repmat(salt_out,1,20);
        River.NH4(:,:,r)=repmat(([riv8_TN_f riv8_TN_f(end)])'*(140/1000000)*(1000/14),1,20);
        River.NO3(:,:,r)=repmat(([riv8_TN_f riv8_TN_f(end)])'*(136/1000000)*(1000/14),1,20);
        River.Oxyg(:,:,r)=repmat(sumjin_do,1,20);
        River.tPO4(:,:,r)=repmat(([riv8_TP_f riv8_TP_f(end)])'.*0.8 .*(1000/30.973762)  ,1,20);
        River.chlorophyll(:,:,r)=repmat(sumjin_chl.* 0,1,20);
        % River.DON(:,:,r)=repmat(riv8_TN_f'*(999724/2/1000000)*(1000/14),1,20);
        River.LDeN(:,:,r)=repmat(([riv8_TN_f riv8_TN_f(end)])'*(999724/2/1000000)*(1000/14).*0.7,1,20);
        River.SDeN(:,:,r)=repmat(([riv8_TN_f riv8_TN_f(end)])'*(999724/2/1000000)*(1000/14).*0.3,1,20);
        River.vshape(1:N,r) =  1/N;
