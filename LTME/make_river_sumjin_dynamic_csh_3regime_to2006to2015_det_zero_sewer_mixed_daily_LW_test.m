...
Fname =['river_' num2str(t_year) 'th_reg_bio_sewer_det_nosew_mixed_daily_LWmvmxy.nc'];
ss = 1:365;
cycle=ss(end);
...
create_river_NH4_LW(grd,Fname,cycle,grd_file,s_rho,river,ntime);
...
%from ykang
sj = load('songjung_climate_days_bio_to07to16_high_airT_mixed_daily.mat'); % 3regime climate (1997~2006, 2007~2015, 2016~2019);
ng = load('namgang_climate_days_bio_to07to16_high_airT.mat');  % 3regime climate (1997~2006, 2007~2015, 2016~2019);
...
River.lon(r) = 11; % 열
River.lat(r) = 174;  % 향
River.dir(r) = 2; % 0:u-face, 1:v-face
