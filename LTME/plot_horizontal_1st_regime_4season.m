...
cd D:\장기생태\Dynamic\result\clim_pic_gy\1st_1991-2000_4season
...
for i = 1:4
figure; hold on;
title_name = strcat('GY-',' 1991~2000.',i_season{i}, ' phy.(mmol N m^-^3) surf.');
...
for i = 1:4
figure; hold on;
title_name = strcat('GY-',' 1991~2000.',i_season{i}, ' zoo.(mmol N m^-^3) surf.');
...
for i = 1:4
figure; hold on;
title_name = strcat('GY-',' 1991~2000.',i_season{i}, ' phy.(mmol N m^-^3) bot.');
...
for i = 1:4
figure; hold on;
title_name = strcat('GY-',' 1991~2000.',i_season{i}, ' zoo.(mmol N m^-^3) bot.');
