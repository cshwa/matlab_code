...
%         plot(1:length(obm_gy_po4),obm_gy_po4./14 - obs_std_gy_po4./14,'m-','linew',2);
        title(['GY 2001 daily KOEM OBS vs. MODEL Zoo & Phy']);
...
%         plot(zeros(365,1),'g--','linew',2); % zero lines
        ...
        obm_gy_no3_in = obm_gy_no3;
        obm_gy_no3_in(isnan(obm_gy_no3_in)) = interp1(nonan_data_plt, obm_gy_no3_in(~isnan(obm_gy_no3_in)), find(isnan(obm_gy_no3_in)==1));
        plot(obm_gy_no3_in./14,'r-','linew',2); hold on;
        plot(obm_gy_no3./14,'k.','linew',2);
...
fig = figure; hold on;
%         plot(zeros(365,1),'g--','linew',2); % zero line
        clearvars *_bound_plt nonan_data_plt discon_p
        
        obm_gy_chl_in = obm_gy_chl;
        nonan_data_ori_plt = find(isnan(obm_gy_chl)==0);
        obm_gy_chl_in(isnan(obm_gy_chl_in)) = interp1(nonan_data_ori_plt, obm_gy_chl_in(~isnan(obm_gy_chl_in)), find(isnan(obm_gy_chl_in)==1));
        
%         nonan_data_plt = find(isnan(obm_gy_chl_in)==0);
% 
%         upper_bound_plt = obm_gy_chl + obs_std_gy_chl;
%         lower_bound_plt = obm_gy_chl - obs_std_gy_chl;
%         
%         upper_bound_plt(isnan(upper_bound_plt)) = interp1(nonan_data_ori_plt, upper_bound_plt(~isnan(upper_bound_plt)), find(isnan(upper_bound_plt)==1));
%         lower_bound_plt(isnan(lower_bound_plt)) = interp1(nonan_data_ori_plt, lower_bound_plt(~isnan(lower_bound_plt)), find(isnan(lower_bound_plt)==1));
%         nonan_data_patch = find(isnan(upper_bound_plt)==0);
%         
%         patch([nonan_data_patch fliplr(nonan_data_patch)], [upper_bound_plt(nonan_data_patch) lower_bound_plt(nonan_data_patch)],'r');
...
for i = 1:12:length(ref_date)
    ...
    ref_plt_t{j}=ref_date{i}(1:4);
        ...
        plot(obm_gy_chl_in,'r-','linew',2); hold on;
        plot(obm_gy_chl,'k.','linew',2);
%         plot(1:length(obm_gy_chl),upper_bound_plt,'r-','linew',2);
%         plot(1:length(obm_gy_chl),lower_bound_plt,'r-','linew',2);
        alpha(0.3) %transparency
        xlim([1 length(ref_date)])
%         errorbar(obm_gy_chl,obs_std_gy_chl,'color','b','linew',1)
        
        title(['GY 2001 daily KOEM OBS Chlorophyll']);
...
% FEB only
figure;        
plot(obm_gy_chl_in(2:12:end),'r-','linew',2); hold on;
plot(obm_gy_chl(2:12:end),'k.','linew',3);
xlim([1 22])
xticks(1:22)
j=0;
for i = 1997:2018; 
...
grid on
ylim([0 17])        
       title(['GY 2001 KOEM OBS Chlorophyll (FEB)']);
        xlabel('time(days on 2001)','fontsize',13)
        ylabel('chl (ug/L)','fontsize',13)
        grid on       
...
% May only
figure;        
plot(obm_gy_chl_in(5:12:end),'r-','linew',2); hold on;
plot(obm_gy_chl(5:12:end),'k.','linew',3);
xlim([1 22])
xticks(1:22)
j=0;
for i = 1997:2018; 
...
grid on
ylim([0 17])        
       title(['GY 2001 KOEM OBS Chlorophyll (MAY)']);
        xlabel('time(days on 2001)','fontsize',13)
        ylabel('chl (ug/L)','fontsize',13)
        grid on               
...
for i = 1:12:length(ref_date)
    ...
    ref_plt_t{j}=ref_date{i}(1:4);
        ...
        plot(obm_gy_no3_in./14,'r-','linew',2); hold on;
        plot(obm_gy_no3./14,'k.','linew',2);
%         plot(1:length(obm_gy_no3./14),upper_bound_plt,'r-','linew',2);
%         plot(1:length(obm_gy_no3./14),lower_bound_plt,'r-','linew',2);
        alpha(0.3) %transparency
        xlim([1 length(ref_date)])
%         errorbar(obm_gy_no3./14,obs_std_gy_no3./14,'color','b','linew',1)
        
        title(['GY 2001 daily KOEM OBS no3']);
        xticks(1:12:length(ref_date))
        xticklabels(ref_plt_t)
        xlabel('time(days on 2001)','fontsize',13)
        ylabel('no3 (umol/m^3)','fontsize',13)
 ...
 obm_gy_nh4_in = obm_gy_nh4;
        obm_gy_nh4_in(isnan(obm_gy_nh4_in)) = interp1(nonan_data_plt, obm_gy_nh4_in(~isnan(obm_gy_nh4_in)), find(isnan(obm_gy_nh4_in)==1));        
figure;
clearvars ref_plt_t
j=0
for i = 1:12:length(ref_date)
    ...
    ref_plt_t{j}=ref_date{i}(1:4);
        ...
        plot(obm_gy_nh4_in./14,'r-','linew',2); hold on;
        plot(obm_gy_nh4./14,'k.','linew',2);
%         plot(1:length(obm_gy_nh4./14),upper_bound_plt,'r-','linew',2);
%         plot(1:length(obm_gy_nh4./14),lower_bound_plt,'r-','linew',2);
        alpha(0.3) %transparency
        xlim([1 length(ref_date)])
%         errorbar(obm_gy_nh4./14,obs_std_gy_nh4./14,'color','b','linew',1)
        
        title(['GY 2001 daily KOEM OBS nh4']);
        xticks(1:12:length(ref_date))
        xticklabels(ref_plt_t)
        xlabel('time(days on 2001)','fontsize',13)
        ylabel('nh4 (umol/m^3)','fontsize',13)
...
save('2002_mp_p_sewer_det_result.mat','jj_*', 'gy_*', 'sgy_*', 'egy_*');     
