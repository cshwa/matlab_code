...
load('gawha_regression_extract_climate.mat','yp','yp_w','b','r_temp','r_date_txt'); 
...
set(gca,'xticklabel',1990:2018);
legend({'recon. water','gahwa-water'})
set(gca,'fontsize',15)
print('-dpng',['recons_gawha_1990~2018']); hold off;
save('gawha_recons_water_temp_present.mat');
...
load('songjung_regression_yeosu_extract_climate.mat','yp','yp_w','b','r_temp','r_date_txt'); 
...
set(gca,'fontsize',15)
print('-dpng',['recons_sumjin_1990~2018']); hold off;
save('sumjin_recons_water_temp_present.mat');
