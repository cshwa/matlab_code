...
% PO4
if t_i == 1
    y_s_po4_205 = kodc205.mon_clim_sur_po4_1_in ./ koem.P_MW; %%% mg/L to mM/m^3;
    y_b_po4_205 = kodc205.mon_clim_bot_po4_1_in ./ koem.P_MW; %%% mg/L to mM/m^3;
elseif t_i == 2
    y_s_po4_205 = kodc205.mon_clim_sur_po4_2_in ./ koem.P_MW; %%% mg/L to mM/m^3;
    y_b_po4_205 = kodc205.mon_clim_bot_po4_2_in ./ koem.P_MW; %%% mg/L to mM/m^3;
elseif t_i == 3
    y_s_po4_205 = kodc205.mon_clim_sur_po4_3_in ./ koem.P_MW; %%% mg/L to mM/m^3;
    y_b_po4_205 = kodc205.mon_clim_bot_po4_3_in ./ koem.P_MW; %%% mg/L to mM/m^3;
end
...
if t_i == 1
    y_s_no3_400 = kodc400.mon_clim_sur_no3_1_in ./ koem.N_MW; %%% ug/L to mM/m^3;
    y_b_no3_400 = kodc400.mon_clim_bot_no3_1_in ./ koem.N_MW; %%% ug/L to mM/m^3;
elseif t_i == 2
    y_s_no3_400 = kodc400.mon_clim_sur_no3_2_in ./ koem.N_MW; %%% ug/L to mM/m^3;
    y_b_no3_400 = kodc400.mon_clim_bot_no3_2_in ./ koem.N_MW; %%% ug/L to mM/m^3;
elseif t_i == 3
    y_s_no3_400 = kodc400.mon_clim_sur_no3_3_in ./ koem.N_MW; %%% ug/L to mM/m^3;
    y_b_no3_400 = kodc400.mon_clim_bot_no3_3_in ./ koem.N_MW; %%% ug/L to mM/m^3;
end

% DO
if t_i == 1
    y_s_do_400 = kodc400.mon_clim_sur_do_1_in .*0.7.*44.661; %%% ug/L to mM/m^3;
    y_b_do_400 = kodc400.mon_clim_bot_do_1_in .*0.7.*44.661; %%% ug/L to mM/m^3;
elseif t_i == 2
    y_s_do_400 = kodc400.mon_clim_sur_do_2_in .*0.7.*44.661; %%% ug/L to mM/m^3;
    y_b_do_400 = kodc400.mon_clim_bot_do_2_in .*0.7.*44.661; %%% ug/L to mM/m^3;
elseif t_i == 3
    y_s_do_400 = kodc400.mon_clim_sur_do_3_in .*0.7.*44.661; %%% ug/L to mM/m^3;
    y_b_do_400 = kodc400.mon_clim_bot_do_3_in .*0.7.*44.661; %%% ug/L to mM/m^3;
end

% PO4
if t_i == 1
    y_s_po4_400 = kodc400.mon_clim_sur_po4_1_in ./ koem.P_MW; %%% ug/L to mM/m^3;
    y_b_po4_400 = kodc400.mon_clim_bot_po4_1_in ./ koem.P_MW; %%% ug/L to mM/m^3;
elseif t_i == 2
    y_s_po4_400 = kodc400.mon_clim_sur_po4_2_in ./ koem.P_MW; %%% ug/L to mM/m^3;
    y_b_po4_400 = kodc400.mon_clim_bot_po4_2_in ./ koem.P_MW; %%% ug/L to mM/m^3;
elseif t_i == 3
    y_s_po4_400 = kodc400.mon_clim_sur_po4_3_in ./ koem.P_MW; %%% ug/L to mM/m^3;
    y_b_po4_400 = kodc400.mon_clim_bot_po4_3_in ./ koem.P_MW; %%% ug/L to mM/m^3;
end
