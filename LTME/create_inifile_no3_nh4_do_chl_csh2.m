...
nc{'oxygen'}.missing_valuencfloat(1.0000e+37);
...
nc{'LdetritusC'}.fields = ncchar('LdetritusC, scalar, series');


nc{'SdetritusC'} = ncdouble('time', 's_rho', 'eta_rho', 'xi_rho'); 
nc{'SdetritusC'}.long_name = ncchar('small fraction small detritus concentration');
nc{'SdetritusC'}.units = ncchar('mMol C m-3');
nc{'SdetritusC'}.fields = ncchar('SdetritusC, scalar, series');


nc{'TIC'} = ncdouble('time', 's_rho', 'eta_rho', 'xi_rho'); 
nc{'TIC'}.long_name = ncchar('total inorganic carbon');
nc{'TIC'}.units = ncchar('mMol Carobn m-3');
nc{'TIC'}.fields = ncchar('TIC, scalar, series');


nc{'alkalinity'} = ncdouble('time', 's_rho', 'eta_rho', 'xi_rho'); 
nc{'alkalinity'}.long_name = ncchar('total alkalinity');
nc{'alkalinity'}.units = ncchar('milliequivalents meter-3');
nc{'alkalinity'}.fields = ncchar('alkalinity, scalar, series');
