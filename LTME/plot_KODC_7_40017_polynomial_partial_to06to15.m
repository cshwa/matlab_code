...
merg_bot(nandx_bot(2:3))=part_bot_jan(nandx_bot(2:3));
merg_bot(nandx_bot([1]))=[34.24];
...
xtickangle(45)
grid on; xlim([1 inf]); title('400-17 NIFS salinity feb')
legend('surf.','bot.');
