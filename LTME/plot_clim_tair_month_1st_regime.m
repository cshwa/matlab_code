...
tem=ncread('auto_ERA5_clim91-00_Tair_monthly.nc','Tair');
...
% plot_google_map('MapType','terrain','Scale',2,'Resize',2)   % overlay google map
saveas(gcf,strcat('monthly_mean_',i_season{i},'m_1st(airt).png'),'png');
% close; 
end
...
plot_google_map('MapType','terrain','Scale',2,'Resize',2)   % overlay google map
xlim([126 129]); ylim([33 35]);
saveas(gcf,strcat('monthly_mean_',i_season{i},'m_part_1st(airt).png'),'png');
% close; 
end
