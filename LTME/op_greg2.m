function [gtime]=op_greg2(yd,yr)
% Converts decimal yearday to standard Gregorian time.
%
% Cannibalisation of Rich Signell's "greg2" function.
%
% gtime = op_greg2(yd,yr)
%
...
% OUTPUT(S):
%
%   gtime -- six-element time vector consisting of gregorian components
%
% EXAMPLE:
%
%   gtime = op_greg2(1/2,1995)
%
% gives
%
%   gtime = [1995 01 01 12 00 00]
%
