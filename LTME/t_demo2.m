...
echo on
       ...
       'start',[2003,1,1,0,0,0],...               % start time is datestr(tuk_time(1))
       'latitude',34+44/60+39/3600,...               % Latitude of obs
...
clf;orient tall;
subplot(411);
plot(tuk_time-datenum(1975,1,0),[t_ele pout]);
line(tuk_time-datenum(1975,1,0),t_ele-pout,'linewi',2,'color','r');
xlabel('Days in 1975');
ylabel('Elevation (m)');
