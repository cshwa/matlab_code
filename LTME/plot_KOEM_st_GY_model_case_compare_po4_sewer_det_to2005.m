...
% % mpdata.gy_temp
cd D:\장기생태\Dynamic\KOEM\compare_sewer\det_2001~5
...
com_eom = [c2001_eom c2002_eom c2003_eom c2004_eom c2005_eom];
...
%% 2002
        ...
        plot(yr1_t+1:yr1_t+length(c2002.gy_no3),c2002.obm_gy_no3./14,'r-','linew',2);
 ...
 %% 2005
        ...
        grid on
        ylim([0 75])
        xlim([1 c2005_eom(1)-1+length(c2005.gy_no3)])
        set(gca,'fontsize',13)
...
%% 2001
        ...
        plot(c2001.obm_gy_nh4./14,'r-','linew',2); 
        plot(1:length(c2001.obm_gy_nh4),upper_bound_plt,'r-','linew',2);
        plot(1:length(c2001.obm_gy_nh4),lower_bound_plt,'r-','linew',2);
...
%% 2002
        ...
        plot(yr1_t+1:yr1_t+length(c2002.gy_nh4),c2002.obm_gy_nh4./14,'r-','linew',2);
...
%% 2001
        ...
        plot(c2001.obm_gy_chl,'r-','linew',2); 
        plot(1:length(c2001.obm_gy_chl),upper_bound_plt,'r-','linew',2);
        plot(1:length(c2001.obm_gy_chl),lower_bound_plt,'r-','linew',2);
...
%% 2002
        ...
        plot(yr1_t+1:yr1_t+length(c2002.gy_chl),c2002.obm_gy_chl,'r-','linew',2);
...
%% 2005
        ...
        plot(c2005_eom(1):c2005_eom(1)-1+length(c2005.obm_gy_chl),lower_bound_plt,'r-','linew',2);4        
...
%% 2001
        ...
        plot(c2001.obm_gy_temp,'r-','linew',2); 
        plot(1:length(c2001.obm_gy_temp),upper_bound_plt,'r-','linew',2);
        plot(1:length(c2001.obm_gy_temp),lower_bound_plt,'r-','linew',2);
...
%% 2002
        ...
        plot(yr1_t+1:yr1_t+length(c2002.gy_temp),c2002.obm_gy_temp,'r-','linew',2);
...
%% 2001
        ...
        plot(c2001.obm_gy_salt,'r-','linew',2); 
        plot(1:length(c2001.obm_gy_salt),upper_bound_plt,'r-','linew',2);
        plot(1:length(c2001.obm_gy_salt),lower_bound_plt,'r-','linew',2);
...
%% 2002
        ...
        plot(yr1_t+1:yr1_t+length(c2002.gy_salt),c2002.obm_gy_salt,'r-','linew',2);
...
%% 2001
        ...
        plot(c2001.obm_gy_no3_b./14,'r-','linew',2); 
        plot(1:length(c2001.obm_gy_no3_b),upper_bound_plt,'r-','linew',2);
        plot(1:length(c2001.obm_gy_no3_b),lower_bound_plt,'r-','linew',2);
...
%% 2002
        ...
        plot(yr1_t+1:yr1_t+length(c2002.gy_no3_b),c2002.obm_gy_no3_b./14,'r-','linew',2);
...
%% 2001
        ...
        plot(c2001.obm_gy_nh4_b./14,'r-','linew',2); 
        plot(1:length(c2001.obm_gy_nh4_b),upper_bound_plt,'r-','linew',2);
        plot(1:length(c2001.obm_gy_nh4_b),lower_bound_plt,'r-','linew',2);
...
%% 2002
        ...
        plot(yr1_t+1:yr1_t+length(c2002.gy_nh4_b),c2002.obm_gy_nh4_b./14,'r-','linew',2);
...
%% 2001
        ...
        plot(c2001.obm_gy_chl_b,'r-','linew',2); 
        plot(1:length(c2001.obm_gy_chl_b),upper_bound_plt,'r-','linew',2);
        plot(1:length(c2001.obm_gy_chl_b),lower_bound_plt,'r-','linew',2);
...
%% 2002
        ...
        plot(yr1_t+1:yr1_t+length(c2002.gy_chl_b),c2002.obm_gy_chl_b,'r-','linew',2);
...
%% 2001
        ...
        plot(c2001.obm_gy_temp_b,'r-','linew',2); 
        plot(1:length(c2001.obm_gy_temp_b),upper_bound_plt,'r-','linew',2);
        plot(1:length(c2001.obm_gy_temp_b),lower_bound_plt,'r-','linew',2);
...
%% 2002
        ...
        plot(yr1_t+1:yr1_t+length(c2002.gy_temp_b),c2002.obm_gy_temp_b,'r-','linew',2);
...
%% 2001
        ...
        plot(c2001.obm_gy_salt_b,'r-','linew',2); 
        plot(1:length(c2001.obm_gy_salt_b),upper_bound_plt,'r-','linew',2);
        plot(1:length(c2001.obm_gy_salt_b),lower_bound_plt,'r-','linew',2);
...
%% 2002
        ...
        plot(yr1_t+1:yr1_t+length(c2002.gy_salt_b),c2002.obm_gy_salt_b,'r-','linew',2);
