...
c2004_eom = [1 (c2004.eom_d_each(1:end-1) + 1)];
...
c2009_eom = [(c2004.eom_d_each(end)+c2005.eom_d_each(end)+c2006.eom_d_each(end)+c2007.eom_d_each(end)+c2008.eom_d_each(end)+1) (c2004.eom_d_each(end)+c2005.eom_d_each(end)+c2006.eom_d_each(end)+c2007.eom_d_each(end) + c2008.eom_d_each(end)+ c2009.eom_d_each(1:end-1)+ 1)];
...
com_eom = [c2004_eom c2005_eom c2006_eom c2007_eom c2008_eom c2009_eom];
...
mer_no3 = [c2004.gy_no3; c2005.gy_no3; c2006.gy_no3; c2007.gy_no3; c2008.gy_no3; ...
    c2009.gy_no3; ];
mer_nh4 = [c2004.gy_nh4; c2005.gy_nh4; c2006.gy_nh4; c2007.gy_nh4; c2008.gy_nh4; ...
    c2009.gy_nh4; ];
mer_chl = [c2004.gy_chl; c2005.gy_chl; c2006.gy_chl; c2007.gy_chl; c2008.gy_chl; ...
    c2009.gy_chl; ];
mer_temp = [c2004.gy_temp; c2005.gy_temp; c2006.gy_temp; c2007.gy_temp; c2008.gy_temp; ...
    c2009.gy_temp; ];
mer_salt = [c2004.gy_salt; c2005.gy_salt; c2006.gy_salt; c2007.gy_salt; c2008.gy_salt; ...
    c2009.gy_salt; ];

%bot merged
mer_no3_b = [c2004.gy_no3_b; c2005.gy_no3_b; c2006.gy_no3_b; c2007.gy_no3_b; c2008.gy_no3_b; ...
    c2009.gy_no3_b; ];
mer_nh4_b = [c2004.gy_nh4_b; c2005.gy_nh4_b; c2006.gy_nh4_b; c2007.gy_nh4_b; c2008.gy_nh4_b; ...
    c2009.gy_nh4_b; ];
mer_chl_b = [c2004.gy_chl_b; c2005.gy_chl_b; c2006.gy_chl_b; c2007.gy_chl_b; c2008.gy_chl_b; ...
    c2009.gy_chl_b;  ];
mer_temp_b = [c2004.gy_temp_b; c2005.gy_temp_b; c2006.gy_temp_b; c2007.gy_temp_b; c2008.gy_temp_b; ...
    c2009.gy_temp_b;  ];
mer_salt_b = [c2004.gy_salt_b; c2005.gy_salt_b; c2006.gy_salt_b; c2007.gy_salt_b; c2008.gy_salt_b; ...
    c2009.gy_salt_b; ];

% sptatial value
%surf merged
mer_sp_no3 = [c2004.sp_gy_no3 c2005.sp_gy_no3 c2006.sp_gy_no3 c2007.sp_gy_no3 c2008.sp_gy_no3 ...
    c2009.sp_gy_no3 ];
mer_sp_nh4 = [c2004.sp_gy_nh4 c2005.sp_gy_nh4 c2006.sp_gy_nh4 c2007.sp_gy_nh4 c2008.sp_gy_nh4 ...
    c2009.sp_gy_nh4 ];
mer_sp_chl = [c2004.sp_gy_chl c2005.sp_gy_chl c2006.sp_gy_chl c2007.sp_gy_chl c2008.sp_gy_chl ...
    c2009.sp_gy_chl ];
mer_sp_temp = [c2004.sp_gy_temp c2005.sp_gy_temp c2006.sp_gy_temp c2007.sp_gy_temp c2008.sp_gy_temp ...
    c2009.sp_gy_temp ];
mer_sp_salt = [c2004.sp_gy_salt c2005.sp_gy_salt c2006.sp_gy_salt c2007.sp_gy_salt c2008.sp_gy_salt ...
    c2009.sp_gy_salt ];
%bot merged
mer_sp_no3_b = [c2004.sp_gy_no3_b c2005.sp_gy_no3_b c2006.sp_gy_no3_b c2007.sp_gy_no3_b c2008.sp_gy_no3_b ...
    c2009.sp_gy_no3_b ];
mer_sp_nh4_b = [c2004.sp_gy_nh4_b c2005.sp_gy_nh4_b c2006.sp_gy_nh4_b c2007.sp_gy_nh4_b c2008.sp_gy_nh4_b ...
    c2009.sp_gy_nh4_b ];
mer_sp_chl_b = [c2004.sp_gy_chl_b c2005.sp_gy_chl_b c2006.sp_gy_chl_b c2007.sp_gy_chl_b c2008.sp_gy_chl_b ...
    c2009.sp_gy_chl_b ];
mer_sp_temp_b = [c2004.sp_gy_temp_b c2005.sp_gy_temp_b c2006.sp_gy_temp_b c2007.sp_gy_temp_b c2008.sp_gy_temp_b ...
    c2009.sp_gy_temp_b ];
mer_sp_salt_b = [c2004.sp_gy_salt_b c2005.sp_gy_salt_b c2006.sp_gy_salt_b c2007.sp_gy_salt_b c2008.sp_gy_salt_b ...
    c2009.sp_gy_salt_b ];

for case_num = 1:3
    for ixx=1:2
        clearvars -except ixx case_num sigsig c2004 c2005 c2006 c2007 c2008 c2009 ltme *_eom dir_name mer_*
        
        sig=sigsig(ixx);
        
cd D:\장기생태\Dynamic\koem
% clim1=load('koem_climate_3regime_v2_04to09.mat'); %from 'plot_KOEM_st_GY_model_compare_horizontal_plt_climate_3regime_v2_2nd.m'
% clim1=load('koem_climate_3regime_v2_2sig_gy_04to09.mat'); %from 'plot_KOEM_st_GY_model_compare_horizontal_plt_climate_3regime_v2_gy_2sig_2nd.m'
% clim1=load('koem_climate_3regime_v2_3sig_gy_04to09.mat'); %from 'plot_KOEM_st_climate_3regime_spatial_sigma_extract_2nd_regime.m'
% 1997~2018 : 22yr
...
clim1=load(['koem_climate_3regime_v2_',num2str(sig),'sig_gy_04to09.mat']);
...
% %          dir_name ={'all_std','t_std','sp_std'};
 cd(['D:\장기생태\Dynamic\KOEM\compare_sewer\2nd_3clim\2nd_3clim_',num2str(sig),'sig_',dir_name{case_num}]);      
