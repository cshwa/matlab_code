...
%divide the data
% 1980 ~ 2000.10.31
t_regime_1 = 7610; % 2000.10.31
% t_regime_b_1 = t_regime_1 - 31; % 2000.09.31
t_regime_b_1 = 7671; % 2000.12.31
...
% t_regime_b_2 = t_regime_2 - 30; % 2010.03.31
t_regime_b_2 = 11413; % 2011.03.31
...
%bot
clearvars idx1
idx1 = find(isnan(po4_bot) == 0);
regime_po4_b=po4_bot;
regime_po4_b(find(po4_bot > mean(po4_bot(idx1)) + sig*std(po4_bot(idx1))))=NaN;
regime_po4_b(find(po4_bot < mean(po4_bot(idx1)) - sig*std(po4_bot(idx1))))=NaN;
...
regime_po4_b = regime_po4_b - regm_po4_b;
...
yp_w_po4_04_b = yp_w_po4_04_b + regm_po4_b;
...
figure;
scatter(1:366,reg_clim_po4_b + regm_po4_b);
hold on
plot(1:366, yp_w_po4_04_b,'--','color','r','linew',2)
xlabel('time(days)','fontsize',13)
ylabel('po4 (ug/L)','fontsize',13)
...
% set(gca,'xticklabel',1980:1:2019);
...
% save('no3_koem_input_205_01_fix.mat','y_s_no3','y_b_no3','yp_w_no3_*','yp_w_no3_b_*');
save('po4_koem_input_204_01.mat','yp_w_po4_04','yp_w_po4_04_b');
