...
for i = 1:length(yoonja.salt_sur)
    isnan(squeeze(yoonja.salt_sur(:,i))) 
pre_salt_int_surf=nangriddata(lon_st,lat_st,squeeze(yoonja.salt_sur(:,i)),x,y);
salt_int_surf(:,:,i)=pre_salt_int_surf;
pre_salt_int_bot=nangriddata(lon_st,lat_st,squeeze(yoonja.salt_bot(:,i)),x,y);
