...
clim1=load('koem_climate_3regime_v2_2sig_gy_04to09.mat');
...
% % mpdata.gy_temp
cd D:\장기생태\Dynamic\KOEM\compare_sewer\det_2008~4_3clim_2sig
...
% %data(60)=[];
        plot(nanmean([c2005.gy_no3; c2006.gy_no3; c2007.gy_no3; data;],1),'b','linew',2);
...
%data(60)=[];
        plot(nanmean([c2005.gy_nh4; c2006.gy_nh4; c2007.gy_nh4; data;],1),'b','linew',2);
               clearvars *_bound_plt nonan_data_plt discon_p
...
%data(60)=[];
        plot(nanmean([c2005.gy_chl; c2006.gy_chl; c2007.gy_chl; data],1),'b','linew',2);
               clearvars *_bound_plt nonan_data_plt discon_p
...
%data(60)=[];
        plot(nanmean([c2005.gy_temp; c2006.gy_temp; c2007.gy_temp; data],1),'b','linew',2);
               clearvars *_bound_plt nonan_data_plt discon_p
...
%data(60)=[];
        plot(nanmean([c2005.gy_salt; c2006.gy_salt; c2007.gy_salt; data],1),'b','linew',2);
               clearvars *_bound_plt nonan_data_plt discon_p
...
%data(60)=[];
        plot(nanmean([c2005.gy_no3_b; c2006.gy_no3_b; c2007.gy_no3_b; data],1),'b','linew',2);
               clearvars *_bound_plt nonan_data_plt discon_p
...
%data(60)=[];
        plot(nanmean([c2005.gy_nh4_b; c2006.gy_nh4_b; c2007.gy_nh4_b; data],1),'b','linew',2);
               clearvars *_bound_plt nonan_data_plt discon_p
...
%data(60)=[];
        plot(nanmean([c2005.gy_chl_b; c2006.gy_chl_b; c2007.gy_chl_b; data],1),'b','linew',2);
               clearvars *_bound_plt nonan_data_plt discon_p
...
%data(60)=[];
        plot(nanmean([c2005.gy_temp_b; c2006.gy_temp_b; c2007.gy_temp_b; data],1),'b','linew',2);
               clearvars *_bound_plt nonan_data_plt discon_p
...
%data(60)=[];
        plot(nanmean([c2005.gy_salt_b; c2006.gy_salt_b; c2007.gy_salt_b; data],1),'b','linew',2);
               clearvars *_bound_plt nonan_data_plt discon_p
