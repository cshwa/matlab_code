...
filename = 'D:\MEPL\project\SSH\1st_year\data\test37\roms_tr_test37_2018_01_09.txt';
startRow = 2;
...
set(gca,'FontSize',15);
saveas(gcf,'D:\MEPL\project\SSH\1st_year\figure\test37\trans_clim.png','png');
...
set(lgd,'FontSize',15);
set(gca,'FontSize',15);
saveas(gcf,'D:\MEPL\project\SSH\1st_year\figure\test37\trans_obs_7y.png','png');


% % % east sea transport
es1plot=plot(korea(1:60),'k');
hold on
es2plot=plot(tsugaru(1:60),'r');
es3plot=plot(soyat(1:60),'b');
diff(1:60)=korea(1:60)-soyat(1:60)-tsugaru(1:60);
...
set(gca,'FontSize',15);
grid on;
saveas(gcf,'D:\MEPL\project\SSH\1st_year\figure\test37\trans_model_5y.png','png');
hold off;


% % % east sea transport difference
% es4plot=plot(diff(1:60),'-o','MarkerSize',5,'Color','k');
es4plot=plot(diff(1:60),'Color','k');
hold on
...
set(gca,'FontSize',15);
grid on;
saveas(gcf,'D:\MEPL\project\SSH\1st_year\figure\test37\trans_model_diff.png','png');
hold off;
...
set(gca,'FontSize',15);
grid on;
saveas(gcf,'D:\MEPL\project\SSH\1st_year\figure\test37\trans_model_diff_5y.png','png');
hold off;
...
es1plot=plot(aiwankur(1:60),'k');
hold on
es2plot=plot((-o_intruy(1:60)),'r');
% es3plot=plot(soyat(1:60),'b');
set(gca,'YLim',[-1 4]);
set(gca,'XLim',[1 60]);
set(es1plot,'LineWidth',4);
...
set(gca,'FontSize',15);
grid on;
saveas(gcf,'D:\MEPL\project\SSH\1st_year\figure\test37\trans_taiwan_model.png','png');
hold off;
...
set(gca,'FontSize',15);
grid on;
saveas(gcf,'D:\MEPL\project\SSH\1st_year\figure\test37\trans_model_cshwa.png','png');
hold off;
