...
% %  dir_name ={'all_std','t_std','sp_std'};
cd(['D:\장기생태\Dynamic\KOEM\compare_sewer\2nd_10yr\2nd_10yr_',num2str(sig),'sig_',dir_name{case_num}]);
...
if case_num == 1 
    ...
    plt_no3 = nanmean(mer_no3_2,1);
    plt_nh4 = nanmean(mer_nh4_2,1);
    plt_po4 = nanmean(mer_po4_2,1);
    
    plt_no3_b = nanmean(mer_no3_b_2,1);
    plt_nh4_b = nanmean(mer_nh4_b_2,1);
    plt_po4_b = nanmean(mer_po4_b_2,1);
    
    save('half_saturation_setting_10yr_2nd.mat','plt_*');
