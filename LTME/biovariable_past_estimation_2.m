...
print('-dpng', ['sumjin(songjung)_DO_raw&recon']);
set(gca,'xlim',[1 t_tick(10)]);
set(gca,'xtick',[1 t_tick(1:1:end)]);
set(gca,'xticklabel',1980:1:2020);
print('-dpng', ['sumjin(songjung)_DO_raw&recon-80s']);
...
set(gca,'xtick',[1 t_tick(1:1:end)]);
set(gca,'xticklabel',1980:1:2020);
print('-dpng', ['sumjin(songjung)_nh4_raw&recon-80s']);
...
set(gca,'xtick',[1 t_tick(1:1:end)]);
set(gca,'xticklabel',1980:1:2020);
print('-dpng', ['sumjin(songjung)_no3_raw&recon-80s']);
...
plot([1:length(w_do_mi)], w_do_recon,'--','color','r','linew',1)
print('-dpng', ['Namgang_DO_raw&recon']);
set(gca,'xlim',[1 t_tick(10)]);
set(gca,'xtick',[1 t_tick(1:1:end)]);
set(gca,'xticklabel',1980:1:2020);
print('-dpng', ['Namgang_DO_raw&recon-80s']);
...
plot([1:length(w_chl_mi)], w_chl_recon,'--','color','r','linew',1)
% plot([1:length(w_chl_mi)],yp_w_chl_raw,'--','color','g','linew',1)
print('-dpng', ['Namgang_chl_raw&recon']);
set(gca,'xlim',[1 t_tick(10)]);
set(gca,'xtick',[1 t_tick(1:1:end)]);
set(gca,'xticklabel',1980:1:2020);
print('-dpng', ['Namgang_chl_raw&recon-80s']);
...
set(gca,'xtick',[1 t_tick(1:1:end)]);
set(gca,'xticklabel',1980:1:2020);
print('-dpng', ['Namgang_nh4_raw&recon-80s']);
...
set(gca,'xtick',[1 t_tick(1:1:end)]);
set(gca,'xticklabel',1980:1:2020);
print('-dpng', ['Namgang_no3_raw&recon-80s']);
