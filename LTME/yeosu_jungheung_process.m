...
[raw txt]=xlsread('환경과학원_여천공단1(여수중흥)_199701-200112.xls','수질(일반측정망)','');
[raw2 txt2]=xlsread('환경과학원_여천공단1(여수중흥)_200201-200612.xls','수질(일반측정망)','');
[raw3 txt3]=xlsread('환경과학원_여천공단1(여수중흥)_200701-201112.xls','수질(일반측정망)','');
[raw4 txt4]=xlsread('환경과학원_여천공단1(여수중흥)_201201-201312.xls','수질(일반측정망)','');
% since 2013.07
[raw5 txt5]=xlsread('환경과학원_중흥천_201301-201712.xls','수질(일반측정망)','');
[raw6 txt6]=xlsread('환경과학원_중흥천_201801-202112.xls','수질(일반측정망)','');
