...
mod_file=['D:\Àå±â»ıÅÂ\Dynamic\result\',num2str(refyear),'\',num2str(refyear),'_mp_2nd.nc'];
...
cd(['D:\Àå±â»ıÅÂ\Dynamic\result\',num2str(refyear)])
% save('2002_mp_p_sewer_det_result.mat','jj_*', 'gy_*', 'sgy_*', 'egy_*','obm*','obs*');     
save([num2str(refyear),'_mp_2nd_result.mat'],'-v7.3');     
