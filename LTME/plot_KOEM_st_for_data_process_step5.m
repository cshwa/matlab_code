...
for i = 1999:1999
    for j = 1:12
        k=k+1;
        ref_date_99{k,1} = [num2str(i) '-' num2str(j,'%02d')];
    end
end

% matched date 'yymm' form
for j = 1:length(indx) % st. axis
    for i = 1:length(ref_date_99) % date axis
       if  sum(strcmp(ref_date_99{i}, merge_yymm(indx{j}))) ~= 0
           indx_date_99{j,i} = find([strcmp(ref_date_99{i}, merge_yymm(indx{j}))] == 1);     
       end
    end
end
...
for i = 1:length(indx)
    ...
    for j = 1:size(indx_date_99,2) %mth
        temp_sur_clim(i,j) = mean(str2num(char(temp(indx_date_99{i,j}))));
    end
end
...
for i = 1:length(indx)
    ...
    for j = 1:size(indx_date_99,2) %mth
        temp_bot_clim(i,j) = mean(str2num(char(temp(indx_date_99{i,j}))));
    end
end
...
for i = 1:length(indx)
    ...
    for j = 1:size(indx_date_99,2) %mth
        salt_sur_clim(i,j) = mean(str2num(char(temp(indx_date_99{i,j}))));
    end
end
...
for i = 1:length(indx)
    ...
    for j = 1:size(indx_date_99,2) %mth
        salt_bot_clim(i,j) = mean(str2num(char(temp(indx_date_99{i,j}))));
    end
end
...
for i = 1:length(indx)
    ...
    for j = 1:size(indx_date_99,2) %mth
        do_sur_clim(i,j) = mean(str2num(char(temp(indx_date_99{i,j}))));
    end
end
...
for i = 1:length(indx)
    ...
    for j = 1:size(indx_date_99,2) %mth
        do_bot_clim(i,j) = mean(str2num(char(temp(indx_date_99{i,j}))));
    end
end
...
for i = 1:length(indx)
    ...
    for j = 1:size(indx_date_99,2) %mth
        nh4_sur_clim(i,j) = mean(str2num(char(temp(indx_date_99{i,j}))));
    end
end
...
for i = 1:length(indx)
    ...
    for j = 1:size(indx_date_99,2) %mth
        nh4_bot_clim(i,j) = mean(str2num(char(temp(indx_date_99{i,j}))));
    end
end
...
for i = 1:length(indx)
    ...
    for j = 1:size(indx_date_99,2) %mth
        no3_sur_clim(i,j) = mean(str2num(char(temp(indx_date_99{i,j}))));
    end
end
...
for i = 1:length(indx)
    ...
    for j = 1:size(indx_date_99,2) %mth
        no3_bot_clim(i,j) = mean(str2num(char(temp(indx_date_99{i,j}))));
    end
end
...
for i = 1:length(indx)
    ...
    for j = 1:size(indx_date_99,2) %mth
        chl_sur_clim(i,j) = mean(str2num(char(temp(indx_date_99{i,j}))));
    end
end
...
for i = 1:length(indx)
    ...
    for j = 1:size(indx_date_99,2) %mth
        chl_bot_clim(i,j) = mean(str2num(char(temp(indx_date_99{i,j}))));
    end
end
...
pcolor(lon,lat,squeeze(temp_sur_clim_g_f(:,:,i)).*(mask./mask));
...
% set(gca,'Position',[0.2 0.17 0.73 0.65]);
hold on;
% [cs,h]=contour(lon,lat,squeeze(temp_bot_clim_g_f(:,:,i)),temp_range,'linecolor',[.01 .01 .01],'linewidth',1);
% clabel(cs,h,'fontsize',17,'labelspacing',700,'fontweight','bold');
pcolor(lon,lat,squeeze(temp_bot_clim_g_f(:,:,i)).*(mask./mask));
% colormap summer(20);xlim([0 0.3])
...
% set(gca,'Position',[0.2 0.17 0.73 0.65]);
hold on;
% [cs,h]=contour(lon,lat,squeeze(temp_sur_clim_g_f(:,:,i)),temp_range,'linecolor',[.01 .01 .01],'linewidth',1);
% clabel(cs,h,'fontsize',17,'labelspacing',700,'fontweight','bold');
pcolor(lon,lat,squeeze(salt_sur_clim_g_f(:,:,i)).*(mask./mask));
% colormap summer(20);xlim([0 0.3])
...
% [cs,h]=contour(lon,lat,squeeze(temp_bot_clim_g_f(:,:,i)),temp_range,'linecolor',[.01 .01 .01],'linewidth',1);
% clabel(cs,h,'fontsize',17,'labelspacing',700,'fontweight','bold');
pcolor(lon,lat,squeeze(salt_bot_clim_g_f(:,:,i)).*(mask./mask));
% colormap summer(20);xlim([0 0.3])
...
% [cs,h]=contour(lon,lat,squeeze(temp_sur_clim_g_f(:,:,i)),temp_range,'linecolor',[.01 .01 .01],'linewidth',1);
% clabel(cs,h,'fontsize',17,'labelspacing',700,'fontweight','bold');
pcolor(lon,lat,squeeze(do_sur_clim_g_f(:,:,i)).*(mask./mask));
% colormap summer(20);xlim([0 0.3])
...
% [cs,h]=contour(lon,lat,squeeze(temp_bot_clim_g_f(:,:,i)),temp_range,'linecolor',[.01 .01 .01],'linewidth',1);
% clabel(cs,h,'fontsize',17,'labelspacing',700,'fontweight','bold');
pcolor(lon,lat,squeeze(do_bot_clim_g_f(:,:,i)).*(mask./mask));
% colormap summer(20);xlim([0 0.3])
...
% [cs,h]=contour(lon,lat,squeeze(temp_sur_clim_g_f(:,:,i)),temp_range,'linecolor',[.01 .01 .01],'linewidth',1);
% clabel(cs,h,'fontsize',17,'labelspacing',700,'fontweight','bold');
pcolor(lon,lat,squeeze(nh4_sur_clim_g_f(:,:,i)).*(mask./mask));
% colormap summer(20);xlim([0 0.3])
...
% [cs,h]=contour(lon,lat,squeeze(temp_bot_clim_g_f(:,:,i)),temp_range,'linecolor',[.01 .01 .01],'linewidth',1);
% clabel(cs,h,'fontsize',17,'labelspacing',700,'fontweight','bold');
pcolor(lon,lat,squeeze(nh4_bot_clim_g_f(:,:,i)).*(mask./mask));
% colormap summer(20);xlim([0 0.3])
...
% [cs,h]=contour(lon,lat,squeeze(temp_sur_clim_g_f(:,:,i)),temp_range,'linecolor',[.01 .01 .01],'linewidth',1);
% clabel(cs,h,'fontsize',17,'labelspacing',700,'fontweight','bold');
pcolor(lon,lat,squeeze(no3_sur_clim_g_f(:,:,i)).*(mask./mask));
% colormap summer(20);xlim([0 0.3])
...
% [cs,h]=contour(lon,lat,squeeze(temp_bot_clim_g_f(:,:,i)),temp_range,'linecolor',[.01 .01 .01],'linewidth',1);
% clabel(cs,h,'fontsize',17,'labelspacing',700,'fontweight','bold');
pcolor(lon,lat,squeeze(no3_bot_clim_g_f(:,:,i)).*(mask./mask));
% colormap summer(20);xlim([0 0.3])
...
% [cs,h]=contour(lon,lat,squeeze(temp_sur_clim_g_f(:,:,i)),temp_range,'linecolor',[.01 .01 .01],'linewidth',1);
% clabel(cs,h,'fontsize',17,'labelspacing',700,'fontweight','bold');
pcolor(lon,lat,squeeze(chl_sur_clim_g_f(:,:,i)).*(mask./mask));
% colormap summer(20);xlim([0 0.3])
...
% [cs,h]=contour(lon,lat,squeeze(temp_bot_clim_g_f(:,:,i)),temp_range,'linecolor',[.01 .01 .01],'linewidth',1);
% clabel(cs,h,'fontsize',17,'labelspacing',700,'fontweight','bold');
pcolor(lon,lat,squeeze(chl_bot_clim_g_f(:,:,i)).*(mask./mask));
% colormap summer(20);xlim([0 0.3])
