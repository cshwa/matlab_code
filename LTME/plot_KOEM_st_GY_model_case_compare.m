...
cd D:\장기생태\Dynamic\KOEM\gy_2001\phymid_half_saturation
phymid= load('phymid_result.mat');

% % mpdata.gy_temp
cd D:\장기생태\Dynamic\KOEM\gy_2001\mpdata_vs_phymin_vs_phymid

fig = figure; hold on;
%         plot(zeros(365,1),'g--','linew',2); % zero lines
        plot(mpdata.gy_no3,'b','linew',2);
        plot(phymin.gy_no3,'k--','linew',2);
        plot(phymid.gy_no3,'g--','linew',2);
...
%         plot(zeros(365,1),'g--','linew',2); % zero lines
        ...
        plot(phymin.gy_nh4,'k--','linew',2);
        plot(phymid.gy_nh4,'g--','linew',2);
...
%         plot(zeros(365,1),'g--','linew',2); % zero lines
        ...
        plot(phymin.gy_chl,'k--','linew',2);
        plot(phymid.gy_chl,'g--','linew',2);
...
%         plot(zeros(365,1),'g--','linew',2); % zero lines
        ...
        plot(phymin.gy_temp,'k--','linew',2);
        plot(phymid.gy_temp,'g--','linew',2);        
...
%         plot(zeros(365,1),'g--','linew',2); % zero lines
        ...
        plot(phymin.gy_salt,'k--','linew',2);
        plot(phymid.gy_salt,'g--','linew',2);     
...
%         plot(zeros(365,1),'g--','linew',2); % zero lines
        ...
        plot(phymin.gy_no3_b,'k--','linew',2);
        plot(phymid.gy_no3_b,'g--','linew',2);              
...
%         plot(zeros(365,1),'g--','linew',2); % zero lines
        ...
        plot(phymin.gy_nh4_b,'k--','linew',2);
        plot(phymid.gy_nh4_b,'g--','linew',2);
...
%         plot(zeros(365,1),'g--','linew',2); % zero lines
        ...
        plot(phymin.gy_chl_b,'k--','linew',2);
        plot(phymid.gy_chl_b,'g--','linew',2);
...
%         plot(zeros(365,1),'g--','linew',2); % zero lines
        ...
        plot(phymin.gy_temp_b,'k--','linew',2);
        plot(phymid.gy_temp_b,'g--','linew',2);        
...
%         plot(zeros(365,1),'g--','linew',2); % zero lines
        ...
        plot(phymin.gy_salt_b,'k--','linew',2);
        plot(phymid.gy_salt_b,'g--','linew',2);
...
%         plot(zeros(365,1),'g--','linew',2); % zero lines
        ...
        plot(phymin.sgy_no3,'k--','linew',2);
        plot(phymid.sgy_no3,'g--','linew',2); 
...
%         plot(zeros(365,1),'g--','linew',2); % zero lines
        ...
        plot(phymin.sgy_nh4,'k--','linew',2);
        plot(phymid.sgy_nh4,'g--','linew',2);
...
%         plot(zeros(365,1),'g--','linew',2); % zero lines
        ...
        plot(phymin.sgy_chl,'k--','linew',2);
        plot(phymid.sgy_chl,'g--','linew',2);
...
%         plot(zeros(365,1),'g--','linew',2); % zero lines
        ...
        plot(phymin.sgy_temp,'k--','linew',2);
        plot(phymid.sgy_temp,'g--','linew',2);
...
%         plot(zeros(365,1),'g--','linew',2); % zero lines
        ...
        plot(phymin.sgy_salt,'k--','linew',2);
        plot(phymid.sgy_salt,'g--','linew',2);   
...
%         plot(zeros(365,1),'g--','linew',2); % zero lines
        ...
        plot(phymin.sgy_no3_b,'k--','linew',2);
        plot(phymid.sgy_no3_b,'g--','linew',2);
...
%         plot(zeros(365,1),'g--','linew',2); % zero lines
        ...
        plot(phymin.sgy_nh4_b,'k--','linew',2);
        plot(phymid.sgy_nh4_b,'g--','linew',2); 
...
%         plot(zeros(365,1),'g--','linew',2); % zero lines
        ...
        plot(phymin.sgy_chl_b,'k--','linew',2);
        plot(phymid.sgy_chl_b,'g--','linew',2);  
...
%         plot(zeros(365,1),'g--','linew',2); % zero lines
        ...
        plot(phymin.sgy_temp_b,'k--','linew',2);
        plot(phymid.sgy_temp_b,'g--','linew',2);        
...
%         plot(zeros(365,1),'g--','linew',2); % zero lines
        ...
        plot(phymin.sgy_salt_b,'k--','linew',2);
        plot(phymid.sgy_salt_b,'g--','linew',2);    
...
%         plot(zeros(365,1),'g--','linew',2); % zero lines
        ...
        plot(phymin.egy_no3,'k--','linew',2);
        plot(phymid.egy_no3,'g--','linew',2);  
...
%         plot(zeros(365,1),'g--','linew',2); % zero lines       
        ...
        plot(phymin.egy_nh4,'k--','linew',2);
        plot(phymid.egy_nh4,'g--','linew',2); 
...
%         plot(zeros(365,1),'g--','linew',2); % zero lines
        ...
        plot(phymin.egy_chl,'k--','linew',2);
        plot(phymid.egy_chl,'g--','linew',2); 
...
%         plot(zeros(365,1),'g--','linew',2); % zero lines
        ...
        plot(phymin.egy_temp,'k--','linew',2);
        plot(phymid.egy_temp,'g--','linew',2); 
...
%         plot(zeros(365,1),'g--','linew',2); % zero lines
        ...
        plot(phymin.egy_salt,'k--','linew',2);
        plot(phymid.egy_salt,'g--','linew',2); 
...
%         plot(zeros(365,1),'g--','linew',2); % zero lines
        ...
        plot(phymin.egy_no3_b,'k--','linew',2);
        plot(phymid.egy_no3_b,'g--','linew',2); 
...
%         plot(zeros(365,1),'g--','linew',2); % zero lines
        ...
        plot(phymin.egy_nh4_b,'k--','linew',2);
        plot(phymid.egy_nh4_b,'g--','linew',2); 
...
%         plot(zeros(365,1),'g--','linew',2); % zero lines
        ...
        plot(phymin.egy_chl_b,'k--','linew',2);
        plot(phymid.egy_chl_b,'g--','linew',2); 
...
%         plot(zeros(365,1),'g--','linew',2); % zero lines
        ...
        plot(phymin.egy_temp_b,'k--','linew',2);
        plot(phymid.egy_temp_b,'g--','linew',2); 
...
%         plot(zeros(365,1),'g--','linew',2); % zero lines
        ...
        plot(phymin.egy_salt_b,'k--','linew',2);
        plot(phymid.egy_salt_b,'g--','linew',2); 
...
%         plot(zeros(365,1),'g--','linew',2); % zero lines
        ...
        plot(phymin.jj_no3,'k--','linew',2);
        plot(phymid.jj_no3,'g--','linew',2); 
...
%         plot(zeros(365,1),'g--','linew',2); % zero lines
        ...
        plot(phymin.jj_nh4,'k--','linew',2);
        plot(phymid.jj_nh4,'g--','linew',2); 
...
%         plot(zeros(365,1),'g--','linew',2); % zero lines
        ...
        plot(phymin.jj_chl,'k--','linew',2);
        plot(phymid.jj_chl,'g--','linew',2); 
...
%         plot(zeros(365,1),'g--','linew',2); % zero lines
        ...
        plot(phymin.jj_temp,'k--','linew',2);
        plot(phymid.jj_temp,'g--','linew',2); 
...
%         plot(zeros(365,1),'g--','linew',2); % zero lines
        ...
        plot(phymin.jj_salt,'k--','linew',2);
        plot(phymid.jj_salt,'g--','linew',2); 
...
%         plot(zeros(365,1),'g--','linew',2); % zero lines
        ...
        plot(phymin.jj_no3_b,'k--','linew',2);
        plot(phymid.jj_no3_b,'g--','linew',2); 
...
%         plot(zeros(365,1),'g--','linew',2); % zero lines
        ...
        plot(phymin.jj_nh4_b,'k--','linew',2);
        plot(phymid.jj_nh4_b,'g--','linew',2); 
...
%         plot(zeros(365,1),'g--','linew',2); % zero lines
        ...
        plot(phymin.jj_chl_b,'k--','linew',2);
        plot(phymid.jj_chl_b,'g--','linew',2); 
...
%         plot(zeros(365,1),'g--','linew',2); % zero lines
        ...
        plot(phymin.jj_temp_b,'k--','linew',2);
        plot(phymid.jj_temp_b,'g--','linew',2); 
...
%         plot(zeros(365,1),'g--','linew',2); % zero lines
        ...
        plot(phymin.jj_salt_b,'k--','linew',2);
        plot(phymid.jj_salt_b,'g--','linew',2); 
