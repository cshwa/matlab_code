...
% regime1_kdc_zerosw=load(['J:\장기생태_2021\Dynamic\result\3regime\daily\2022_run\','2reg_t8.mat'],'obm_*','gy_*','jj_*','sgy_*','egy_*','obs_std_*','eom_d_each','sp_gy_*','name_tag','sp_gy');
% regime2_kdc_zerosw=load(['J:\장기생태_2021\Dynamic\result\3regime\daily\2022_run\','3reg_t8f.mat'],'obm_*','gy_*','jj_*','sgy_*','egy_*','obs_std_*','eom_d_each','sp_gy_*','name_tag','sp_gy');
% regime1_kdc_zerosw=load(['J:\장기생태_2021\Dynamic\result\3regime\daily\2022_run\','2reg_t7_mu_2yr.mat'],'obm_*','gy_*','jj_*','sgy_*','egy_*','obs_std_*','eom_d_each','sp_gy_*','name_tag','sp_gy');
% regime2_kdc_zerosw=load(['J:\장기생태_2021\Dynamic\result\3regime\daily\2022_run\','3reg_t7_mu_2yr.mat'],'obm_*','gy_*','jj_*','sgy_*','egy_*','obs_std_*','eom_d_each','sp_gy_*','name_tag','sp_gy');
regime1_kdc_zerosw=load(['J:\장기생태_2021\Dynamic\result\3regime\daily\2022_run\','2reg_temp_3.mat'],'obm_*','gy_*','jj_*','sgy_*','egy_*','obs_std_*','eom_d_each','sp_gy_*','name_tag','sp_gy');
regime2_kdc_zerosw=load(['J:\장기생태_2021\Dynamic\result\3regime\daily\2022_run\','3reg_temp_3.mat'],'obm_*','gy_*','jj_*','sgy_*','egy_*','obs_std_*','eom_d_each','sp_gy_*','name_tag','sp_gy');
...
plot_dir = 'J:\장기생태_2021\Dynamic\result\3regime\kdc_nosew\t4_case\2&3regime\nocutregime\220702\temp_3'
% plot_dir = 'J:\장기생태_2021\Dynamic\result\3regime\kdc_nosew\t4_case\2&3regime\nocutregime\220702\t8_vs_t8f'
