...
defau = load('2001_mp_p_sewer_det_result.mat','obm_*','gy_*','jj_*','sgy_*','egy_*','obs_std_*');

cd D:\장기생태\Dynamic\result\2001
z02 = load('2001_mp_p_sewer_det_result_wt8.mat','obm_*','gy_*','jj_*','sgy_*','egy_*','obs_std_*');
...
% % mpdata.gy_temp
cd D:\장기생태\Dynamic\KOEM\compare_sewer\det_2001_wt8\

%% GY plot zoo
fig = figure; hold on;
        plot(defau.gy_zoo,'b','linew',2);
        plot(181:365,z02.gy_zoo(2:end),'r','linew',2);
         plot(defau.gy_phy,'m','linew',2);
        plot(181:365,z02.gy_phy(2:end),'g','linew',2);
...
fig = figure; hold on;      
        ...
        plot(181:365,z02.gy_zoo_b(2:end),'r','linew',2);
        plot(defau.gy_phy_b,'m','linew',2);
        plot(181:365,z02.gy_phy_b(2:end),'g','linew',2);
        legend('zoo','zoo_w_t_8','phy','phy_w_t_8')
        xlim([1 365]);
...
%% 2001
        ...
        plot(181:365,z02.gy_no3(2:end),'g','linew',2);
        ...
        xlim([1 365])
        set(gca,'fontsize',13)
        print(fig,strcat('2001_yr_KOEM_OBS_vs_daily_MODEL_no3'),'-dpng')
...
%% 2001
        ...
        plot(181:365,z02.gy_nh4(2:end),'g','linew',2);
        alpha(0.3) %transparency      
        ...
        xlim([1 365])
        set(gca,'fontsize',13)
        print(fig,strcat('2001_yr_KOEM_OBS_vs_daily_MODEL_nh4'),'-dpng')
...
%% 2001
        ...
        plot(181:365,z02.gy_chl(2:end),'g','linew',2);
        alpha(0.3) %transparency      
        ...
        xlim([1 365])
        set(gca,'fontsize',13)
        print(fig,strcat('2001_yr_KOEM_OBS_vs_daily_MODEL_chl'),'-dpng')
...
%% 2001
        ...
        plot(181:365,z02.gy_temp(2:end),'g','linew',2);
        alpha(0.3) %transparency      
        ...
        xlim([1 365])
        set(gca,'fontsize',13)
        print(fig,strcat('2001_yr_KOEM_OBS_vs_daily_MODEL_temp'),'-dpng')
...
%% 2001
        ...
        plot(181:365,z02.gy_salt(2:end),'g','linew',2);
        alpha(0.3) %transparency        
        ...
        xlim([1 365])
        set(gca,'fontsize',13)
        print(fig,strcat('2001_yr_KOEM_OBS_vs_daily_MODEL_salt'),'-dpng')            
 %% bot
...
%% 2001
        ...
        plot(181:365,z02.gy_no3_b(2:end),'g','linew',2);
        alpha(0.3) %transparency
        ...
        set(gca,'fontsize',13)
        xlim([1 365])
        print(fig,strcat('2001_yr_KOEM_OBS_vs_daily_MODEL_no3_bot'),'-dpng')
...
%% 2001
        ...
        plot(181:365,z02.gy_nh4_b(2:end),'g','linew',2);
        alpha(0.3) %transparency        
        ...
        xlim([1 365])
        set(gca,'fontsize',13)
        print(fig,strcat('2001_yr_KOEM_OBS_vs_daily_MODEL_nh4_bot'),'-dpng')
...
%% 2001
        ...
        plot(181:365,z02.gy_chl_b(2:end),'g','linew',2);
        alpha(0.3) %transparency        
        ...
        yticks(1:1:15)
        set(gca,'fontsize',13)
        print(fig,strcat('2001_yr_KOEM_OBS_vs_daily_MODEL_chl_bot'),'-dpng')
...
%% 2001
        ...
        plot(181:365,z02.gy_temp_b(2:end),'g','linew',2);
        alpha(0.3) %transparency        
        ...
        xlim([1 365])
        set(gca,'fontsize',13)
        print(fig,strcat('2001_yr_KOEM_OBS_vs_daily_MODEL_temp_bot'),'-dpng')
...
%% 2001
        ...
        plot(181:365,z02.gy_salt_b(2:end),'g','linew',2);
        alpha(0.3) %transparency
        ...
        xlim([1 365])
        set(gca,'fontsize',13)
        print(fig,strcat('2001_yr_KOEM_OBS_vs_daily_MODEL_salt_bot'),'-dpng')            
return        
