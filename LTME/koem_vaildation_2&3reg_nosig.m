...
clim1=load('D:\장기생태\Dynamic\06_river\koem_climate_to06to15_v5_nosig_gy_9points.mat'); % no-sigma extracted data

cd ('J:\장기생태_2021\Dynamic\result\3regime')
% regime1_kdc
% regime1_kdc_zerosw=load('part_kd_double_2reg.mat','obm_*','gy_*','jj_*','sgy_*','egy_*','obs_std_*','eom_d_each','sp_gy_*','name_tag','sp_gy');
regime1_kdc_zerosw=load('kd_t4_2reg.mat','obm_*','gy_*','jj_*','sgy_*','egy_*','obs_std_*','eom_d_each','sp_gy_*','name_tag','sp_gy');
% regime1_kdc_zerosw=load('part_kd_t4w_2reg.mat','obm_*','gy_*','jj_*','sgy_*','egy_*','obs_std_*','eom_d_each','sp_gy_*','name_tag','sp_gy');
%% $$$$$$$
% regime2_kdc_zerosw=load('part_kd_double_3reg.mat','obm_*','gy_*','jj_*','sgy_*','egy_*','obs_std_*','eom_d_each','sp_gy_*','name_tag','sp_gy');
regime2_kdc_zerosw=load('kd_t4_3reg.mat','obm_*','gy_*','jj_*','sgy_*','egy_*','obs_std_*','eom_d_each','sp_gy_*','name_tag','sp_gy');
% regime2_kdc_zerosw=load('part_kd_t4w_3reg.mat','obm_*','gy_*','jj_*','sgy_*','egy_*','obs_std_*','eom_d_each','sp_gy_*','name_tag','sp_gy');
...
% clearvars clim2*
% clim2=clim1.obm_gy_po4_ft_2;
% clim2_std = clim1.obs_std_gy_po4_ft_2;
% 
% clim2_2=clim1.obm_gy_po4_ft_3;
% clim2_2_std = clim1.obs_std_gy_po4_ft_3;
...
%     print(fig,strcat('multi_yr_KOEM_OBS_vs_daily_MODEL_po4'),'-dpng')
    ...
    clearvars clim2*
clim2=clim1.obm_gy_no3_ft_2;
clim2_std = clim1.obs_std_gy_no3_ft_2;
clim2_2=clim1.obm_gy_no3_ft_3;
clim2_2_std = clim1.obs_std_gy_no3_ft_3;

    fig = figure; hold on;
            plot(nanmean(regime1_kdc_zerosw.gy_no3,1),'g','linew',2);
            plot(nanmean(regime2_kdc_zerosw.gy_no3,1),'b','linew',2);
%             clearvars *_bound_plt nonan_data_plt discon_p temp_d
...
% 1regime
 ...
 % 2regime           
    ...
    print(fig,strcat('multi_yr_KOEM_OBS_vs_daily_MODEL_no3'),'-dpng')
        ...
        clearvars clim2*
clim2=clim1.obm_gy_nh4_ft_2;
clim2_std = clim1.obs_std_gy_nh4_ft_2;
clim2_2=clim1.obm_gy_nh4_ft_3;
clim2_2_std = clim1.obs_std_gy_nh4_ft_3;

    fig = figure; hold on;
            plot(nanmean(regime1_kdc_zerosw.gy_nh4,1),'b','linew',2);
            plot(nanmean(regime1_kdc_zerosw.gy_nh4,1),'g','linew',2);
%             plot(nanmean(regime1_riv_chl.gy_nh4,1),'b','linew',2);
...
%             patch([nonan_data_plt fliplr(nonan_data_plt)], [upper_bound_plt fliplr(lower_bound_plt)],[0.5 0.5 0.5]);
 ...
 % 2regime           
    ...
    clearvars clim2*
clim2=clim1.obm_gy_chl_ft_2;
clim2_std = clim1.obs_std_gy_chl_ft_2;
clim2_2=clim1.obm_gy_chl_ft_3;
clim2_2_std = clim1.obs_std_gy_chl_ft_3;

    fig = figure; hold on;
            plot(nanmean(regime1_kdc_zerosw.gy_chl,1),'g','linew',2);
            plot(nanmean(regime2_kdc_zerosw.gy_chl,1),'b','linew',2);
%             clearvars *_bound_plt nonan_data_plt discon_p temp_d
...
%             patch([nonan_data_plt fliplr(nonan_data_plt)], [upper_bound_plt fliplr(lower_bound_plt)],[0.5 0.5 0.5]);
 ...
 % 2regime           
    ...
    print(fig,strcat('multi_yr_KOEM_OBS_vs_daily_MODEL_chl'),'-dpng')
     ...
     clearvars clim2*
clim2=clim1.obm_gy_temp_ft_2;
clim2_std = clim1.obs_std_gy_temp_ft_2;
clim2_2=clim1.obm_gy_temp_ft_3;
clim2_2_std = clim1.obs_std_gy_temp_ft_3;

    fig = figure; hold on;
            plot(nanmean(regime1_kdc_zerosw.gy_temp,1),'g','linew',2);
             plot(nanmean(regime2_kdc_zerosw.gy_temp,1),'b','linew',2);
%             clearvars *_bound_plt nonan_data_plt discon_p temp_d
...
%             patch([nonan_data_plt fliplr(nonan_data_plt)], [upper_bound_plt fliplr(lower_bound_plt)],[0.5 0.5 0.5]);
 ...
 % 2regime           
    ...
    print(fig,strcat('multi_yr_KOEM_OBS_vs_daily_MODEL_temp'),'-dpng')
         ...
         clearvars clim2*
clim2=clim1.obm_gy_salt_ft_2;
clim2_std = clim1.obs_std_gy_salt_ft_2;
clim2_2=clim1.obm_gy_salt_ft_3;
clim2_2_std = clim1.obs_std_gy_salt_ft_3;   

    fig = figure; hold on; 
            plot(nanmean(regime1_kdc_zerosw.gy_salt,1),'g','linew',2);
            plot(nanmean(regime2_kdc_zerosw.gy_salt,1),'b','linew',2);
...
%             patch([nonan_data_plt fliplr(nonan_data_plt)], [upper_bound_plt fliplr(lower_bound_plt)],[0.5 0.5 0.5]);
    %         plot(nanmean([c1997.gy_salt_1; c1998.gy_salt_1; c1999.gy_salt_1; c2000.gy_salt_1; c2001.gy_salt_1; c2002.gy_salt_1; c2003.gy_salt_1;],1),'g','linew',2);
                 % 1regime
            clearvars *_bound_plt nonan_data_plt discon_p
            nonan_data_plt = find(isnan(clim2)==0);
            nonan_diff=nonan_data_plt(2:end) - nonan_data_plt(1:end-1);
...
%             end
%             end 
%             plot(clim1.obm_gy_po4_b_ft_2./30.973762,'g-','linew',2); 
%             plot(1:length(clim1.obm_gy_po4_b_ft_2),upper_bound_plt,'g-','linew',2);
%             plot(1:length(clim1.obm_gy_po4_b_ft_2),lower_bound_plt,'g-','linew',2);
% 
% 
%             alpha(0.3) %transparency      
% 
...
clearvars clim2*
clim2=clim1.obm_gy_no3_b_ft_2;
clim2_std = clim1.obs_std_gy_no3_b_ft_2;
clim2_2=clim1.obm_gy_no3_b_ft_3;
clim2_2_std = clim1.obs_std_gy_no3_b_ft_3;

     fig = figure; hold on;
            plot(nanmean(regime1_kdc_zerosw.gy_no3_b,1),'g','linew',2);
            plot(nanmean(regime2_kdc_zerosw.gy_no3_b,1),'b','linew',2);
...
% 1regime
 ...
 % 2regime           
    ...
    %         %xtickangle(90)
      ...
      clearvars clim2*
clim2=clim1.obm_gy_nh4_b_ft_2;
clim2_std = clim1.obs_std_gy_nh4_b_ft_2;
clim2_2=clim1.obm_gy_nh4_b_ft_3;
clim2_2_std = clim1.obs_std_gy_nh4_b_ft_3;

                
    fig = figure; hold on;
            plot(nanmean(regime1_kdc_zerosw.gy_nh4_b,1),'g','linew',2);
            plot(nanmean(regime2_kdc_zerosw.gy_nh4_b,1),'b','linew',2);
...
%     %         plot(nanmean([c1997.gy_nh4_b; c1998.gy_nh4_b; c1999.gy_nh4_b; c2000.gy_nh4_b; c2001.gy_nh4_b; c2002.gy_nh4_b; c2003.gy_nh4_b;],1),'g','linew',2);
 ...
 % 2regime           
    ...
    %         %xtickangle(90)
          ...
          clearvars clim2*
clim2=clim1.obm_gy_chl_b_ft_2;
clim2_std = clim1.obs_std_gy_chl_b_ft_2;
clim2_2=clim1.obm_gy_chl_b_ft_3;
clim2_2_std = clim1.obs_std_gy_chl_b_ft_3;
                
    fig = figure; hold on;
            plot(nanmean(regime1_kdc_zerosw.gy_chl_b,1),'g','linew',2);
            plot(nanmean(regime2_kdc_zerosw.gy_chl_b,1),'b','linew',2);
...
%             patch([nonan_data_plt fliplr(nonan_data_plt)], [upper_bound_plt fliplr(lower_bound_plt)],[0.5 0.5 0.5]);
 ...
 % 2regime           
    ...
    %         %xtickangle(90)
            ...
            clearvars clim2*
clim2=clim1.obm_gy_temp_b_ft_2;
clim2_std = clim1.obs_std_gy_temp_b_ft_2;
clim2_2=clim1.obm_gy_temp_b_ft_3;
clim2_2_std = clim1.obs_std_gy_temp_b_ft_3;  
...
%             patch([nonan_data_plt fliplr(nonan_data_plt)], [upper_bound_plt fliplr(lower_bound_plt)],[0.5 0.5 0.5]);
 ...
 % 2regime           
    ...
    %         %xtickangle(90)
            ...
            clearvars clim2*
clim2=clim1.obm_gy_salt_b_ft_2;
clim2_std = clim1.obs_std_gy_salt_b_ft_2;
clim2_2=clim1.obm_gy_salt_b_ft_3;
clim2_2_std = clim1.obs_std_gy_salt_b_ft_3;   
