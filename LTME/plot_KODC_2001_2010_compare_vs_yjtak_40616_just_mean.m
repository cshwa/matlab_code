...
for i = 1:length(mmdd_indx)
    if size(mmdd_indx{i},1) == 0     
        ...
        reg_clim_do_b(i) = nanmean(regime_do_b(mmdd_indx{i}));
        reg_clim_no3_b(i) = nanmean(regime_no3_b(mmdd_indx{i}));
        reg_clim_temp_b(i) = nanmean(regime_temp_b(mmdd_indx{i}));
        reg_clim_salt_b(i) = nanmean(regime_salt_b(mmdd_indx{i}));
    end
end
...
lon_20501 = 127.8083;
lat_20501 = 34.3717;
save('kodc_40016_2001_2010_just_mean.mat','-v7.3');
