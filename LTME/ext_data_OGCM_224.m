function data=ext_data_OGCM_224(nc,X,Y,vname,tndx,lon,lat,k,Roa,interp_method)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
...
%     data=squeeze(nc{vname}(tndx,j,i2));
        data=squeeze(nc{vname}(k,j,i2));  %%soda 2.2.4
  elseif ndims==4
...
%     data=cat(2,squeeze(nc{vname}(tndx,j,i1)),data);
       data=cat(2,squeeze(nc{vname}(k,j,i1)),data);  %%soda 2.2.4
  elseif ndims==4
...
%     data=cat(2,data,squeeze(nc{vname}(tndx,j,i3)));
        data=cat(2,data,squeeze(nc{vname}(k,j,i3)));  %%soda 2.2.4
  elseif ndims==4
