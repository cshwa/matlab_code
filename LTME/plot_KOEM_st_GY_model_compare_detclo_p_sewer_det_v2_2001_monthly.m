...
for i = 1:12
    clearvars mod_file
mod_file=['D:\Àå±â»ıÅÂ\Dynamic\result\',num2str(year_f),'\mp_p_sewer_det_monthly_',num2str(year_f),'_',num2str(i,'%02d'),'.nc'];
...
% %obs_tdx = 61:72; %2002 %year
       ...
       obs_do = regime_do;
       obs_chl = regime_chl;
       obs_temp = regime_temp;
       obs_salt = regime_salt;
       % bot
       obs_no3_b = regime_no3_b;
       obs_nh4_b = regime_nh4_b;
       obs_do_b = regime_do_b;
       obs_chl_b = regime_chl_b;
       obs_temp_b = regime_temp_b;
       obs_salt_b = regime_salt_b;
...
%         plot(obs_no3(i,:)./14,'r-','linew',2); xlim([1 12]);
...
%         set(gca,'fontsize',13)
%         name_gf= name_tag{i};
%         print(fig,strcat('2001_month_KOEM_OBS_vs_MODEL_(',num2str(i),')'),'-dpng')
%         hold off;
%         close;
%    end
% end
...
%         plot(obs_nh4(i,:)./14,'r-','linew',2); xlim([1 12]);
...
%         set(gca,'fontsize',13)
%         name_gf= name_tag{i};
%         print(fig,strcat('2001_month_NH4_KOEM_OBS_vs_MODEL_(',num2str(i),')'),'-dpng')
%         hold off; close;
%    end
% end
% 
...
%         plot(obs_do(i,:).*0.7.*44.661,'r-','linew',2); xlim([1 12]);
...
%         set(gca,'fontsize',13)
%         name_gf= name_tag{i};
%         print(fig,strcat('2001_month_DO_KOEM_OBS_vs_MODEL_(',num2str(i),')'),'-dpng')
%         hold off;close;
%    end
% end
% 
...
%         plot(obs_temp(i,:),'r-','linew',2); xlim([1 12]);
...
%         set(gca,'fontsize',13)
%         name_gf= name_tag{i};
%         print(fig,strcat('2001_month_temp_KOEM_OBS_vs_MODEL_(',num2str(i),')'),'-dpng')
%         hold off;close;
%    end
% end
% 
...
%         plot(obs_salt(i,:),'r-','linew',2); xlim([1 12]);
...
%         set(gca,'fontsize',13)
%         name_gf= name_tag{i};
%         print(fig,strcat('2001_month_salt_KOEM_OBS_vs_MODEL_(',num2str(i),')'),'-dpng')
%         hold off;close;
%    end
% end
% 
...
%         plot(obs_chl(i,:),'r-','linew',2); xlim([1 12]);
...
%         set(gca,'fontsize',13)
%         name_gf= name_tag{i};
%         print(fig,strcat('2001_month_chl_KOEM_OBS_vs_MODEL_(',num2str(i),')'),'-dpng')
%         hold off;
%         close;
%    end
% end
...
%         plot(obs_no3_b(i,:)./14,'r-','linew',2); xlim([1 12]);
%         title([name_tag{i},'- 2001 daily KOEM OBS vs. MODEL NO3']);
%         xlabel('time(month)','fontsize',13)
%         ylabel('NO3 (umol/m^3)','fontsize',13)
%         grid on
%         set(gca,'fontsize',13)
%         name_gf= name_tag{i};
%         print(fig,strcat('2001_month_b_KOEM_OBS_vs_MODEL_(',num2str(i),')'),'-dpng')
%         hold off;
%         close;
%    end
% end
...
%         plot(obs_nh4_b(i,:)./14,'r-','linew',2); xlim([1 12]);
%         title([name_tag{i},'- 2001 daily KOEM OBS vs. MODEL NH4']);
%         xlabel('time(month)','fontsize',13)
%         ylabel('NH4 (umol/m^3)','fontsize',13)
%         grid on
%         set(gca,'fontsize',13)
%         name_gf= name_tag{i};
%         print(fig,strcat('2001_month_b_NH4_KOEM_OBS_vs_MODEL_(',num2str(i),')'),'-dpng')
%         hold off; close;
%    end
% end
% 
...
%         plot(obs_do_b(i,:).*0.7.*44.661,'r-','linew',2); xlim([1 12]);
%         title([name_tag{i},'- 2001 daily KOEM OBS vs. MODEL DO']);
%         xlabel('time(month)','fontsize',13)
%         ylabel('DO (umol/m^3)','fontsize',13)
%         grid on
%         set(gca,'fontsize',13)
%         name_gf= name_tag{i};
%         print(fig,strcat('2001_month_DO_KOEM_b_OBS_vs_MODEL_(',num2str(i),')'),'-dpng')
%         hold off;close;
%    end
% end
% 
...
%         plot(obs_temp_b(i,:),'r-','linew',2); xlim([1 12]);
%         title([name_tag{i},'- 2001 daily KOEM OBS vs. MODEL temp']);
%         xlabel('time(month)','fontsize',13)
%         ylabel('temp (^oC)','fontsize',13)
%         grid on
%         set(gca,'fontsize',13)
%         name_gf= name_tag{i};
%         print(fig,strcat('2001_month_temp_b_KOEM_OBS_vs_MODEL_(',num2str(i),')'),'-dpng')
%         hold off;close;
%    end
% end
% 
...
%         plot(obs_salt_b(i,:),'r-','linew',2); xlim([1 12]);
%         title([name_tag{i},'- 2001 daily KOEM OBS vs. MODEL salt']);
%         xlabel('time(month)','fontsize',13)
%         ylabel('salt (psu)','fontsize',13)
%         grid on
%         set(gca,'fontsize',13)
%         name_gf= name_tag{i};
%         print(fig,strcat('2001_month_salt_b_KOEM_OBS_vs_MODEL_(',num2str(i),')'),'-dpng')
%         hold off;close;
%    end
% end
% 
...
%         plot(obs_chl_b(i,:),'r-','linew',2); xlim([1 12]);
%         title([name_tag{i},'- 2001 daily KOEM OBS vs. MODEL chla']);
%         xlabel('time(month)','fontsize',13)
%         ylabel('chl (ug/L)','fontsize',13)
%         grid on
%         set(gca,'fontsize',13)
%         name_gf= name_tag{i};
%         print(fig,strcat('2001_month_chl_b_KOEM_OBS_vs_MODEL_(',num2str(i),')'),'-dpng')
%         hold off;
%         close;
%    end
% end
...
%% obs 
clearvars sp_std_* obs_gy_* obs_sgy_* obs_egy_* obs_jj_* 
for j = 1:length(sp_gy)
...
%         plot(zeros(365,1),'g--','linew',2); % zero lines
        ...
        plot(obm_gy_temp,'b-','linew',2); xlim([1 12]);
...
%         plot(zeros(365,1),'g--','linew',2); % zero lines
        ...
        nonan_data_plt = find(isnan(obm_gy_no3(obs_tdx))==0);
        nonan_diff=nonan_data_plt(2:end) - nonan_data_plt(1:end-1);
        discon_p = find(nonan_diff ~= 1); % find discontinuous point
        discon_p(4) = length(nonan_data_plt); %end point

        errorbar(obm_gy_no3(obs_tdx)./14,obs_std_gy_no3(obs_tdx)./14,'color','r','linew',2);
        plot(obm_gy_no3(obs_tdx)./14,'ro','linew',2); xlim([1 12]);
        alpha(0.3) %transparency
        ...
        ylim([0 30])
        set(gca,'fontsize',13)
        print(fig,strcat('2001_month_KOEM_OBS_vs_MODEL_no3'),'-dpng')
...
%         plot(zeros(365,1),'g--','linew',2); % zero lines
        ...
        clearvars *_bound_plt nonan_data_plt discon_p
        nonan_data_plt = find(isnan(obm_gy_nh4(obs_tdx))==0);
        nonan_diff=nonan_data_plt(2:end) - nonan_data_plt(1:end-1);
        discon_p = find(nonan_diff ~= 1); % find discontinuous point
        discon_p(4) = length(nonan_data_plt); %end point
        
        errorbar(obm_gy_nh4(obs_tdx)./14,obs_std_gy_nh4(obs_tdx)./14,'color','r','linew',2);
        plot(obm_gy_nh4(obs_tdx)./14,'ro','linew',2); xlim([1 12]);
        alpha(0.3) %transparency
        ...
        ylim([0 12])
        set(gca,'fontsize',13)
        print(fig,strcat('2001_month_KOEM_OBS_vs_MODEL_NH4'),'-dpng')
...
%         plot(zeros(365,1),'g--','linew',2); % zero lines
        ...
        clearvars *_bound_plt nonan_data_plt discon_p
        nonan_data_plt = find(isnan(obm_gy_chl(obs_tdx))==0);
        nonan_diff=nonan_data_plt(2:end) - nonan_data_plt(1:end-1);
        discon_p = find(nonan_diff ~= 1); % find discontinuous point
        discon_p(4) = length(nonan_data_plt); %end point
        
        errorbar(obm_gy_chl(obs_tdx),obs_std_gy_chl(obs_tdx),'color','r','linew',2);
        plot(obm_gy_chl(obs_tdx),'ro','linew',2); xlim([1 12]);
        alpha(0.3) %transparency
        ...
        ylim([0 15])
        set(gca,'fontsize',13)
        print(fig,strcat('2001_month_KOEM_OBS_vs_MODEL_chl'),'-dpng') 
...
%         plot(zeros(365,1),'g--','linew',2); % zero lines
        ...
        clearvars *_bound_plt nonan_data_plt discon_p
        nonan_data_plt = find(isnan(obm_gy_temp(obs_tdx))==0);
        nonan_diff=nonan_data_plt(2:end) - nonan_data_plt(1:end-1);
        discon_p = find(nonan_diff ~= 1); % find discontinuous point
        discon_p(4) = length(nonan_data_plt); %end point
        
        errorbar(obm_gy_temp(obs_tdx),obs_std_gy_temp(obs_tdx),'color','r','linew',2);
        plot(obm_gy_temp(obs_tdx),'ro','linew',2); xlim([1 12]);
        alpha(0.3) %transparency
        ...
        grid on
        set(gca,'fontsize',13)
        print(fig,strcat('2001_month_KOEM_OBS_vs_MODEL_temp'),'-dpng')    
...
%         plot(zeros(365,1),'g--','linew',2); % zero lines
        ...
        errorbar(obm_gy_salt(obs_tdx),obs_std_gy_salt(obs_tdx),'color','r','linew',2);
        plot(obm_gy_salt(obs_tdx),'ro','linew',2); xlim([1 12]);
        alpha(0.3) %transparency
        ...
        grid on
        set(gca,'fontsize',13)
        print(fig,strcat('2001_month_KOEM_OBS_vs_MODEL_salt'),'-dpng')            
 %% bot
...
%         plot(zeros(365,1),'g--','linew',2); % zero lines
        ...
        clearvars *_bound_plt nonan_data_plt discon_p
        nonan_data_plt = find(isnan(obm_gy_no3_b(obs_tdx))==0);
        nonan_diff=nonan_data_plt(2:end) - nonan_data_plt(1:end-1);
        discon_p = find(nonan_diff ~= 1); % find discontinuous point
        discon_p(4) = length(nonan_data_plt); %end point
        
        errorbar(obm_gy_no3_b(obs_tdx)./14,obs_std_gy_no3_b(obs_tdx)./14,'color','r','linew',2);
        plot(obm_gy_no3_b(obs_tdx)./14,'ro','linew',2); xlim([1 12]);
        alpha(0.3) %transparency
        ...
        ylim([0 30])
        set(gca,'fontsize',13)
        print(fig,strcat('2001_month_KOEM_OBS_vs_MODEL_no3_bot'),'-dpng')
...
%         plot(zeros(365,1),'g--','linew',2); % zero lines
        plot(gy_nh4_b,'b','linew',2);
                ...
                clearvars *_bound_plt nonan_data_plt discon_p
        nonan_data_plt = find(isnan(obm_gy_nh4_b(obs_tdx))==0);
        nonan_diff=nonan_data_plt(2:end) - nonan_data_plt(1:end-1);
        discon_p = find(nonan_diff ~= 1); % find discontinuous point
        discon_p(4) = length(nonan_data_plt); %end point

        errorbar(obm_gy_nh4_b(obs_tdx)./14,obs_std_gy_nh4_b(obs_tdx)./14,'color','r','linew',2);
        plot(obm_gy_nh4_b(obs_tdx)./14,'ro','linew',2); xlim([1 12]);
        alpha(0.3) %transparency
        ...
        ylim([0 12])
        set(gca,'fontsize',13)
        print(fig,strcat('2001_month_KOEM_OBS_vs_MODEL_NH4_bot'),'-dpng')
...
%         plot(zeros(365,1),'g--','linew',2); % zero lines
        plot(gy_chl_b,'b','linew',2);
                ...
                clearvars *_bound_plt nonan_data_plt discon_p
        nonan_data_plt = find(isnan(obm_gy_chl_b(obs_tdx))==0);
        nonan_diff=nonan_data_plt(2:end) - nonan_data_plt(1:end-1);
        discon_p = find(nonan_diff ~= 1); % find discontinuous point
        discon_p(4) = length(nonan_data_plt); %end point
        
        errorbar(obm_gy_chl_b(obs_tdx),obs_std_gy_chl_b(obs_tdx),'color','r','linew',2);
        plot(obm_gy_chl_b(obs_tdx),'r-','linew',2); xlim([1 12]);
        alpha(0.3) %transparency
        ...
        ylim([0 15])
        set(gca,'fontsize',13)
        print(fig,strcat('2001_month_KOEM_OBS_vs_MODEL_chl_bot'),'-dpng') 
...
%         plot(zeros(365,1),'g--','linew',2); % zero lines
        plot(gy_temp_b,'b','linew',2);
                ...
                clearvars *_bound_plt nonan_data_plt discon_p
        nonan_data_plt = find(isnan(obm_gy_temp_b(obs_tdx))==0);
        nonan_diff=nonan_data_plt(2:end) - nonan_data_plt(1:end-1);
        discon_p = find(nonan_diff ~= 1); % find discontinuous point
        discon_p(4) = length(nonan_data_plt); %end point

        errorbar(obm_gy_temp_b(obs_tdx),obs_std_gy_temp_b(obs_tdx),'color','r','linew',2);        
        plot(obm_gy_temp_b(obs_tdx),'ro','linew',2); xlim([1 12]);
        alpha(0.3) %transparency
        ...
        grid on
        set(gca,'fontsize',13)
        print(fig,strcat('2001_month_KOEM_OBS_vs_MODEL_temp_bot'),'-dpng')    
...
%         plot(zeros(365,1),'g--','linew',2); % zero lines
        ...
        errorbar(obm_gy_salt_b(obs_tdx),obs_std_gy_salt_b(obs_tdx),'color','r','linew',2);
        plot(obm_gy_salt_b(obs_tdx),'ro','linew',2); xlim([1 12]);
        alpha(0.3) %transparency
        ...
        grid on
        set(gca,'fontsize',13)
        print(fig,strcat('2001_month_KOEM_OBS_vs_MODEL_salt_bot'),'-dpng')    
...
%         plot(1:length(obm_gy_po4),obm_gy_po4./14 - obs_std_gy_po4./14,'m-','linew',2);
        ...
        grid on
        set(gca,'fontsize',13)
        print(fig,strcat('2001_month_KOEM_OBS_vs_MODEL_po4_gy'),'-dpng')
...
%         plot(zeros(365,1),'g--','linew',2); % zero lines
        ...
        grid on;
        set(gca,'fontsize',13)
        print(fig,strcat('2001_month_KOEM_OBS_vs_MODEL_no3_gy'),'-dpng')
...
%         plot(zeros(365,1),'g--','linew',2); % zero lines
        ...
        grid on;
        set(gca,'fontsize',13)
        print(fig,strcat('2001_month_KOEM_OBS_vs_MODEL_NH4_gy'),'-dpng')
...
%         plot(zeros(365,1),'g--','linew',2); % zero lines
        ...
        grid on
        set(gca,'fontsize',13)
        print(fig,strcat('2001_month_KOEM_OBS_vs_MODEL_chl_gy'),'-dpng') 
...
%         plot(zeros(365,1),'g--','linew',2); % zero lines
        ...
        grid on
        set(gca,'fontsize',13)
        print(fig,strcat('2001_month_KOEM_OBS_vs_MODEL_temp_gy'),'-dpng')    
...
%         plot(zeros(365,1),'g--','linew',2); % zero lines
        ...
        grid on
        set(gca,'fontsize',13)
        print(fig,strcat('2001_month_KOEM_OBS_vs_MODEL_salt_gy'),'-dpng')            
 %% bot
  fig = figure; hold on;
%         plot(zeros(365,1),'g--','linew',2); % zero lines
...
%         plot(1:length(obm_gy_po4_b),obm_gy_po4_b./14 - obs_std_gy_po4_b./14,'m-','linew',2);
        ...
        grid on
        set(gca,'fontsize',13)
        print(fig,strcat('2001_month_KOEM_OBS_vs_MODEL_po4_bot_gy'),'-dpng')
...
%         plot(zeros(365,1),'g--','linew',2); % zero lines
        ...
        grid on;
        set(gca,'fontsize',13)
        print(fig,strcat('2001_month_KOEM_OBS_vs_MODEL_no3_bot_gy'),'-dpng')
...
%         plot(zeros(365,1),'g--','linew',2); % zero lines
        ...
        grid on
        set(gca,'fontsize',13)
        print(fig,strcat('2001_month_KOEM_OBS_vs_MODEL_NH4_bot_gy'),'-dpng')
...
%         plot(zeros(365,1),'g--','linew',2); % zero lines
        ...
        grid on
        set(gca,'fontsize',13)
        print(fig,strcat('2001_month_KOEM_OBS_vs_MODEL_chl_bot_gy'),'-dpng') 
...
%         plot(zeros(365,1),'g--','linew',2); % zero lines
        ...
        grid on
        set(gca,'fontsize',13)
        print(fig,strcat('2001_month_KOEM_OBS_vs_MODEL_temp_bot_gy'),'-dpng')    
...
%         plot(zeros(365,1),'g--','linew',2); % zero lines
        ...
        grid on
        set(gca,'fontsize',13)
        print(fig,strcat('2001_month_KOEM_OBS_vs_MODEL_salt_bot_gy'),'-dpng')    
        
%%south gy plot

fig = figure; hold on;
%         plot(zeros(365,1),'g--','linew',2); % zero lines
        plot(sgy_po4,'b','linew',2); xlim([1 12]);
%         plot(obm_sgy_po4./14,'r-','linew',2); xlim([1 12]);
...
%         plot(1:length(obm_sgy_po4),obm_sgy_po4./14 - obs_std_sgy_po4./14,'m-','linew',2);
        ...
        grid on
        set(gca,'fontsize',13)
        print(fig,strcat('2001_month_KOEM_OBS_vs_MODEL_po4_south_sgy'),'-dpng')


fig = figure; hold on;
%         plot(zeros(365,1),'g--','linew',2); % zero lines
        plot(sgy_no3,'b','linew',2);
        plot(obm_sgy_no3./14,'r-','linew',2); xlim([1 12]);
        ...
        grid on
        set(gca,'fontsize',13)
        print(fig,strcat('2001_month_KOEM_OBS_vs_MODEL_no3_south_sgy'),'-dpng')

fig = figure; hold on;
%         plot(zeros(365,1),'g--','linew',2); % zero lines
        plot(sgy_nh4,'b','linew',2);
        plot(obm_sgy_nh4./14,'r-','linew',2); xlim([1 12]);
        ...
        grid on
        set(gca,'fontsize',13)
        print(fig,strcat('2001_month_KOEM_OBS_vs_MODEL_NH4_south_sgy'),'-dpng')
        
        
fig = figure; hold on;
%         plot(zeros(365,1),'g--','linew',2); % zero lines
        plot(sgy_chl,'b','linew',2);
        plot(obm_sgy_chl,'r-','linew',2); xlim([1 12]);
        ...
        grid on
        set(gca,'fontsize',13)
        print(fig,strcat('2001_month_KOEM_OBS_vs_MODEL_chl_south_sgy'),'-dpng') 
        
        
 fig = figure; hold on;
%         plot(zeros(365,1),'g--','linew',2); % zero lines
        plot(sgy_temp,'b','linew',2);
        plot(obm_sgy_temp,'r-','linew',2); xlim([1 12]);
        ...
        grid on
        set(gca,'fontsize',13)
        print(fig,strcat('2001_month_KOEM_OBS_vs_MODEL_temp_south_sgy'),'-dpng')    
        
        
fig = figure; hold on;
%         plot(zeros(365,1),'g--','linew',2); % zero lines
        plot(sgy_salt,'b','linew',2);
        plot(obm_sgy_salt,'r-','linew',2); xlim([1 12]);
        ...
        grid on
        set(gca,'fontsize',13)
        print(fig,strcat('2001_month_KOEM_OBS_vs_MODEL_salt_south_sgy'),'-dpng')            
 %% bot
 
 fig = figure; hold on;
%         plot(zeros(365,1),'g--','linew',2); % zero lines
        plot(sgy_po4_b,'b','linew',2);xlim([1 12]);
%         plot(obm_sgy_po4_b./14,'r-','linew',2); xlim([1 12]);
...
%         plot(1:length(obm_sgy_po4_b),obm_sgy_po4_b./14 - obs_std_sgy_po4_b./14,'m-','linew',2);
        ...
        grid on
        set(gca,'fontsize',13)
        print(fig,strcat('2001_month_KOEM_OBS_vs_MODEL_po4_bot_south_sgy'),'-dpng')
 
 fig = figure; hold on;
%         plot(zeros(365,1),'g--','linew',2); % zero lines
        plot(sgy_no3_b,'b','linew',2);
        plot(obm_sgy_no3_b./14,'r-','linew',2); xlim([1 12]);
        ...
        grid on
        set(gca,'fontsize',13)
        print(fig,strcat('2001_month_KOEM_OBS_vs_MODEL_no3_bot_south_sgy'),'-dpng')

fig = figure; hold on;
%         plot(zeros(365,1),'g--','linew',2); % zero lines
        plot(sgy_nh4_b,'b','linew',2);
        plot(obm_sgy_nh4_b./14,'r-','linew',2); xlim([1 12]);
        ...
        grid on
        set(gca,'fontsize',13)
        print(fig,strcat('2001_month_KOEM_OBS_vs_MODEL_NH4_bot_south_sgy'),'-dpng')
        
        
fig = figure; hold on;
%         plot(zeros(365,1),'g--','linew',2); % zero lines
        plot(sgy_chl_b,'b','linew',2);
        plot(obm_sgy_chl_b,'r-','linew',2); xlim([1 12]);
        ...
        grid on
        set(gca,'fontsize',13)
        print(fig,strcat('2001_month_KOEM_OBS_vs_MODEL_chl_bot_south_sgy'),'-dpng') 
        
        
 fig = figure; hold on;
%         plot(zeros(365,1),'g--','linew',2); % zero lines
        plot(sgy_temp_b,'b','linew',2);
        plot(obm_sgy_temp_b,'r-','linew',2); xlim([1 12]);
        ...
        grid on
        set(gca,'fontsize',13)
        print(fig,strcat('2001_month_KOEM_OBS_vs_MODEL_temp_bot_south_sgy'),'-dpng')    
        
        
fig = figure; hold on;
%         plot(zeros(365,1),'g--','linew',2); % zero lines
        plot(sgy_salt_b,'b','linew',2);
        plot(obm_sgy_salt_b,'r-','linew',2); xlim([1 12]);
        ...
        grid on
        set(gca,'fontsize',13)
        print(fig,strcat('2001_month_KOEM_OBS_vs_MODEL_salt_bot_south_sgy'),'-dpng')    
        
%%east gy plot
fig = figure; hold on;
%         plot(zeros(365,1),'g--','linew',2); % zero lines
        plot(egy_po4,'b','linew',2); xlim([1 12]);
...
%         plot(1:length(obm_egy_po4),obm_egy_po4./14 - obs_std_egy_po4./14,'m-','linew',2);
        ...
        grid on
        set(gca,'fontsize',13)
        print(fig,strcat('2001_month_KOEM_OBS_vs_MODEL_po4_egy'),'-dpng')


fig = figure; hold on;
%         plot(zeros(365,1),'g--','linew',2); % zero lines
        plot(egy_no3,'b','linew',2);
        plot(obm_egy_no3./14,'r-','linew',2); xlim([1 12]);
        ...
        grid on
        set(gca,'fontsize',13)
        print(fig,strcat('2001_month_KOEM_OBS_vs_MODEL_no3_egy'),'-dpng')

fig = figure; hold on;
%         plot(zeros(365,1),'g--','linew',2); % zero lines
        plot(egy_nh4,'b','linew',2);
        plot(obm_egy_nh4./14,'r-','linew',2); xlim([1 12]);
        ...
        grid on
        set(gca,'fontsize',13)
        print(fig,strcat('2001_month_KOEM_OBS_vs_MODEL_NH4_egy'),'-dpng')
        
        
fig = figure; hold on;
%         plot(zeros(365,1),'g--','linew',2); % zero lines
        plot(egy_chl,'b','linew',2);
        plot(obm_egy_chl,'r-','linew',2); xlim([1 12]);
        ...
        grid on
        set(gca,'fontsize',13)
        print(fig,strcat('2001_month_KOEM_OBS_vs_MODEL_chl_egy'),'-dpng') 
        
        
 fig = figure; hold on;
%         plot(zeros(365,1),'g--','linew',2); % zero lines
        plot(egy_temp,'b','linew',2);
        plot(obm_egy_temp,'r-','linew',2); xlim([1 12]);
        ...
        grid on
        set(gca,'fontsize',13)
        print(fig,strcat('2001_month_KOEM_OBS_vs_MODEL_temp_egy'),'-dpng')    
        
        
fig = figure; hold on;
%         plot(zeros(365,1),'g--','linew',2); % zero lines
        plot(egy_salt,'b','linew',2);
        plot(obm_egy_salt,'r-','linew',2); xlim([1 12]);
        ...
        grid on
        set(gca,'fontsize',13)
        print(fig,strcat('2001_month_KOEM_OBS_vs_MODEL_salt_egy'),'-dpng')            
 %% bot
 
  fig = figure; hold on;
%         plot(zeros(365,1),'g--','linew',2); % zero lines
        plot(egy_po4_b,'b','linew',2);xlim([1 12]);
%         plot(obm_egy_po4_b./14,'r-','linew',2); xlim([1 12]);
...
%         plot(1:length(obm_egy_po4_b),obm_egy_po4_b./14 - obs_std_egy_po4_b./14,'m-','linew',2);
        ...
        grid on
        set(gca,'fontsize',13)
        print(fig,strcat('2001_month_KOEM_OBS_vs_MODEL_po4_bot_egy'),'-dpng')
 
 fig = figure; hold on;
%         plot(zeros(365,1),'g--','linew',2); % zero lines
        plot(egy_no3_b,'b','linew',2);
        plot(obm_egy_no3_b./14,'r-','linew',2); xlim([1 12]);
        ...
        grid on
        set(gca,'fontsize',13)
        print(fig,strcat('2001_month_KOEM_OBS_vs_MODEL_no3_bot_egy'),'-dpng')

fig = figure; hold on;
%         plot(zeros(365,1),'g--','linew',2); % zero lines
        plot(egy_nh4_b,'b','linew',2);
        plot(obm_egy_nh4_b./14,'r-','linew',2); xlim([1 12]);
        ...
        grid on
        set(gca,'fontsize',13)
        print(fig,strcat('2001_month_KOEM_OBS_vs_MODEL_NH4_bot_egy'),'-dpng')
        
        
fig = figure; hold on;
%         plot(zeros(365,1),'g--','linew',2); % zero lines
        plot(egy_chl_b,'b','linew',2);
        plot(obm_egy_chl_b,'r-','linew',2); xlim([1 12]);
        ...
        grid on
        set(gca,'fontsize',13)
        print(fig,strcat('2001_month_KOEM_OBS_vs_MODEL_chl_bot_egy'),'-dpng') 
        
        
 fig = figure; hold on;
%         plot(zeros(365,1),'g--','linew',2); % zero lines
        plot(egy_temp_b,'b','linew',2);
        plot(obm_egy_temp_b,'r-','linew',2); xlim([1 12]);
        ...
        grid on
        set(gca,'fontsize',13)
        print(fig,strcat('2001_month_KOEM_OBS_vs_MODEL_temp_bot_egy'),'-dpng')    
        
        
fig = figure; hold on;
%         plot(zeros(365,1),'g--','linew',2); % zero lines
        plot(egy_salt_b,'b','linew',2);
        plot(obm_egy_salt_b,'r-','linew',2); xlim([1 12]);
        ...
        grid on
        set(gca,'fontsize',13)
        print(fig,strcat('2001_month_KOEM_OBS_vs_MODEL_salt_bot_egy'),'-dpng')    
        
%% jinju
fig = figure; hold on;
%         plot(zeros(365,1),'g--','linew',2); % zero lines
        plot(jj_po4,'b','linew',2);xlim([1 12]);
%         plot(obm_jj_po4./14,'r-','linew',2); xlim([1 12]);
...
%         plot(1:length(obm_jj_po4),obm_jj_po4./14 - obs_std_jj_po4./14,'m-','linew',2);
        ...
        grid on
        set(gca,'fontsize',13)
        print(fig,strcat('2001_month_KOEM_OBS_vs_MODEL_po4_jj'),'-dpng')
...
%         plot(zeros(365,1),'g--','linew',2); % zero lines
        ...
        plot(obm_jj_no3./14,'r-','linew',2); xlim([1 12]);
        ...
        grid on
        set(gca,'fontsize',13)
        print(fig,strcat('2001_month_KOEM_OBS_vs_MODEL_no3_jj'),'-dpng')

fig = figure; hold on;
%         plot(zeros(365,1),'g--','linew',2); % zero lines
        plot(jj_nh4,'b','linew',2);
        plot(obm_jj_nh4./14,'r-','linew',2); xlim([1 12]);
        ...
        grid on
        set(gca,'fontsize',13)
        print(fig,strcat('2001_month_KOEM_OBS_vs_MODEL_NH4_jj'),'-dpng')
        
        
fig = figure; hold on;
%         plot(zeros(365,1),'g--','linew',2); % zero lines
        plot(jj_chl,'b','linew',2);
        plot(obm_jj_chl,'r-','linew',2); xlim([1 12]);
        ...
        grid on
        set(gca,'fontsize',13)
        print(fig,strcat('2001_month_KOEM_OBS_vs_MODEL_chl_jj'),'-dpng') 
        
        
 fig = figure; hold on;
%         plot(zeros(365,1),'g--','linew',2); % zero lines
        plot(jj_temp,'b','linew',2);
        plot(obm_jj_temp,'r-','linew',2); xlim([1 12]);
        ...
        grid on
        set(gca,'fontsize',13)
        print(fig,strcat('2001_month_KOEM_OBS_vs_MODEL_temp_jj'),'-dpng')    
        
        
fig = figure; hold on;
%         plot(zeros(365,1),'g--','linew',2); % zero lines
        plot(jj_salt,'b','linew',2);
        plot(obm_jj_salt,'r-','linew',2); xlim([1 12]);
        ...
        grid on
        set(gca,'fontsize',13)
        print(fig,strcat('2001_month_KOEM_OBS_vs_MODEL_salt_jj'),'-dpng')            
 %% bot
 fig = figure; hold on;
%         plot(zeros(365,1),'g--','linew',2); % zero lines
        plot(jj_po4_b,'b','linew',2);xlim([1 12]);
%         plot(obm_jj_po4_b./14,'r-','linew',2); xlim([1 12]);
...
%         plot(1:length(obm_jj_po4_b),obm_jj_po4_b./14 - obs_std_jj_po4_b./14,'m-','linew',2);
        ...
        grid on
        set(gca,'fontsize',13)
        print(fig,strcat('2001_month_KOEM_OBS_vs_MODEL_po4_bot_jj'),'-dpng')
 
 
 fig = figure; hold on;
%         plot(zeros(365,1),'g--','linew',2); % zero lines
        plot(jj_no3_b,'b','linew',2);
        plot(obm_jj_no3_b./14,'r-','linew',2); xlim([1 12]);
        ...
        grid on
        set(gca,'fontsize',13)
        print(fig,strcat('2001_month_KOEM_OBS_vs_MODEL_no3_bot_jj'),'-dpng')

fig = figure; hold on;
%         plot(zeros(365,1),'g--','linew',2); % zero lines
        plot(jj_nh4_b,'b','linew',2);
        plot(obm_jj_nh4_b./14,'r-','linew',2); xlim([1 12]);
        ...
        grid on
        set(gca,'fontsize',13)
        print(fig,strcat('2001_month_KOEM_OBS_vs_MODEL_NH4_bot_jj'),'-dpng')
        
        
fig = figure; hold on;
%         plot(zeros(365,1),'g--','linew',2); % zero lines
        plot(jj_chl_b,'b','linew',2);
        plot(obm_jj_chl_b,'r-','linew',2); xlim([1 12]);
        ...
        grid on
        set(gca,'fontsize',13)
        print(fig,strcat('2001_month_KOEM_OBS_vs_MODEL_chl_bot_jj'),'-dpng') 
        
        
 fig = figure; hold on;
%         plot(zeros(365,1),'g--','linew',2); % zero lines
        plot(jj_temp_b,'b','linew',2);
        plot(obm_jj_temp_b,'r-','linew',2); xlim([1 12]);
        ...
        grid on
        set(gca,'fontsize',13)
        print(fig,strcat('2001_month_KOEM_OBS_vs_MODEL_temp_bot_jj'),'-dpng')    
        
        
fig = figure; hold on;
%         plot(zeros(365,1),'g--','linew',2); % zero lines
        plot(jj_salt_b,'b','linew',2);
        plot(obm_jj_salt_b,'r-','linew',2); xlim([1 12]);
        ...
        grid on
        set(gca,'fontsize',13)
        print(fig,strcat('2001_month_KOEM_OBS_vs_MODEL_salt_bot_jj'),'-dpng')    
        
        
cd D:\Àå±â»ıÅÂ\Dynamic\result\2002
...
%         plot(zeros(365,1),'g--','linew',2); % zero lines
        plot(gy_no3,'b','linew',2);
        plot(obs_gy_no3(i,:)./14,'r-','linew',2); xlim([1 12]);
        title([name_tag{i},'- 2001 daily KOEM OBS vs. MODEL NO3']);
        xlabel('time(month)','fontsize',13)
        ylabel('NO3 (umol/m^3)','fontsize',13)
        grid on
