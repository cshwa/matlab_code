...
clearvars tempd
tempd=chl_sur_2;
tempd(tempd > nanmean(chl_sur_2) + sig*nanstd(chl_sur_2)) =NaN;
tempd(tempd < nanmean(chl_sur_2) - sig*nanstd(chl_sur_2)) =NaN;
chl_sur_2_s = tempd;

clearvars tempd
tempd=chl_sur_3;
tempd(tempd > nanmean(chl_sur_3) + sig*nanstd(chl_sur_3)) =NaN;
tempd(tempd < nanmean(chl_sur_3) - sig*nanstd(chl_sur_3)) =NaN;
chl_sur_3_s = tempd;
...
clearvars tempd
tempd=chl_bot_2;
tempd(tempd > nanmean(chl_bot_2) + sig*nanstd(chl_bot_2)) =NaN;
tempd(tempd < nanmean(chl_bot_2) - sig*nanstd(chl_bot_2)) =NaN;
chl_bot_2_s = tempd;

clearvars tempd
tempd=chl_bot_3;
tempd(tempd > nanmean(chl_bot_3) + sig*nanstd(chl_bot_3)) =NaN;
tempd(tempd < nanmean(chl_bot_3) - sig*nanstd(chl_bot_3)) =NaN;
chl_bot_3_s = tempd;
...
clearvars tempd
tempd=nh4_sur_2;
tempd(tempd > nanmean(nh4_sur_2) + sig*nanstd(nh4_sur_2)) =NaN;
tempd(tempd < nanmean(nh4_sur_2) - sig*nanstd(nh4_sur_2)) =NaN;
nh4_sur_2_s = tempd;

clearvars tempd
tempd=nh4_sur_3;
tempd(tempd > nanmean(nh4_sur_3) + sig*nanstd(nh4_sur_3)) =NaN;
tempd(tempd < nanmean(nh4_sur_3) - sig*nanstd(nh4_sur_3)) =NaN;
nh4_sur_3_s = tempd;
...
clearvars tempd
tempd=nh4_bot_2;
tempd(tempd > nanmean(nh4_bot_2) + sig*nanstd(nh4_bot_2)) =NaN;
tempd(tempd < nanmean(nh4_bot_2) - sig*nanstd(nh4_bot_2)) =NaN;
nh4_bot_2_s = tempd;

clearvars tempd
tempd=nh4_bot_3;
tempd(tempd > nanmean(nh4_bot_3) + sig*nanstd(nh4_bot_3)) =NaN;
tempd(tempd < nanmean(nh4_bot_3) - sig*nanstd(nh4_bot_3)) =NaN;
nh4_bot_3_s = tempd;
...
mon_clim_sur_chl_2(i) = nanmean(chl_sur_2_s(i:12:end));
mon_clim_sur_chl_3(i) = nanmean(chl_sur_3_s(i:12:end)); 

mon_clim_bot_chl_1(i) = nanmean(chl_bot_1_s(i:12:end));
mon_clim_bot_chl_2(i) = nanmean(chl_bot_2_s(i:12:end));
mon_clim_bot_chl_3(i) = nanmean(chl_bot_3_s(i:12:end)); 

mon_clim_sur_nh4_1(i) = nanmean(nh4_sur_1_s(i:12:end));
mon_clim_sur_nh4_2(i) = nanmean(nh4_sur_2_s(i:12:end));
mon_clim_sur_nh4_3(i) = nanmean(nh4_sur_3_s(i:12:end)); 

mon_clim_bot_nh4_1(i) = nanmean(nh4_bot_1_s(i:12:end));
mon_clim_bot_nh4_2(i) = nanmean(nh4_bot_2_s(i:12:end));
mon_clim_bot_nh4_3(i) = nanmean(nh4_bot_3_s(i:12:end)); 
...
mon_clim_sur_chl_2 = [mon_clim_sur_chl_2, mon_clim_sur_chl_2, mon_clim_sur_chl_2]
mon_clim_sur_chl_3 = [mon_clim_sur_chl_3, mon_clim_sur_chl_3, mon_clim_sur_chl_3]

mon_clim_bot_chl_1 = [mon_clim_bot_chl_1, mon_clim_bot_chl_1, mon_clim_bot_chl_1]
mon_clim_bot_chl_2 = [mon_clim_bot_chl_2, mon_clim_bot_chl_2, mon_clim_bot_chl_2]
mon_clim_bot_chl_3 = [mon_clim_bot_chl_3, mon_clim_bot_chl_3, mon_clim_bot_chl_3]
...
mon_clim_sur_nh4_2 = [mon_clim_sur_nh4_2, mon_clim_sur_nh4_2, mon_clim_sur_nh4_2]
mon_clim_sur_nh4_3 = [mon_clim_sur_nh4_3, mon_clim_sur_nh4_3, mon_clim_sur_nh4_3]

mon_clim_bot_nh4_1 = [mon_clim_bot_nh4_1, mon_clim_bot_nh4_1, mon_clim_bot_nh4_1]
mon_clim_bot_nh4_2 = [mon_clim_bot_nh4_2, mon_clim_bot_nh4_2, mon_clim_bot_nh4_2]
mon_clim_bot_nh4_3 = [mon_clim_bot_nh4_3, mon_clim_bot_nh4_3, mon_clim_bot_nh4_3]
...
t=1:length(mon_clim_sur_chl_2);
mon_clim_sur_chl_2(isnan(mon_clim_sur_chl_2)) = interp1(t(~isnan(mon_clim_sur_chl_2)),mon_clim_sur_chl_2(~isnan(mon_clim_sur_chl_2)),t(isnan(mon_clim_sur_chl_2)));
t=1:length(mon_clim_sur_chl_3);
mon_clim_sur_chl_3(isnan(mon_clim_sur_chl_3)) = interp1(t(~isnan(mon_clim_sur_chl_3)),mon_clim_sur_chl_3(~isnan(mon_clim_sur_chl_3)),t(isnan(mon_clim_sur_chl_3)));
...
t=1:length(mon_clim_bot_chl_2);
mon_clim_bot_chl_2(isnan(mon_clim_bot_chl_2)) = interp1(t(~isnan(mon_clim_bot_chl_2)),mon_clim_bot_chl_2(~isnan(mon_clim_bot_chl_2)),t(isnan(mon_clim_bot_chl_2)));
t=1:length(mon_clim_bot_chl_3);
mon_clim_bot_chl_3(isnan(mon_clim_bot_chl_3)) = interp1(t(~isnan(mon_clim_bot_chl_3)),mon_clim_bot_chl_3(~isnan(mon_clim_bot_chl_3)),t(isnan(mon_clim_bot_chl_3)));
...
t=1:length(mon_clim_sur_nh4_2);
mon_clim_sur_nh4_2(isnan(mon_clim_sur_nh4_2)) = interp1(t(~isnan(mon_clim_sur_nh4_2)),mon_clim_sur_nh4_2(~isnan(mon_clim_sur_nh4_2)),t(isnan(mon_clim_sur_nh4_2)));
t=1:length(mon_clim_sur_nh4_3);
mon_clim_sur_nh4_3(isnan(mon_clim_sur_nh4_3)) = interp1(t(~isnan(mon_clim_sur_nh4_3)),mon_clim_sur_nh4_3(~isnan(mon_clim_sur_nh4_3)),t(isnan(mon_clim_sur_nh4_3)));
...
t=1:length(mon_clim_bot_nh4_2);
mon_clim_bot_nh4_2(isnan(mon_clim_bot_nh4_2)) = interp1(t(~isnan(mon_clim_bot_nh4_2)),mon_clim_bot_nh4_2(~isnan(mon_clim_bot_nh4_2)),t(isnan(mon_clim_bot_nh4_2)));
t=1:length(mon_clim_bot_nh4_3);
mon_clim_bot_nh4_3(isnan(mon_clim_bot_nh4_3)) = interp1(t(~isnan(mon_clim_bot_nh4_3)),mon_clim_bot_nh4_3(~isnan(mon_clim_bot_nh4_3)),t(isnan(mon_clim_bot_nh4_3)));
...
mon_clim_sur_chl_1_in= mon_clim_sur_chl_1(13:24); mon_clim_sur_chl_2_in= mon_clim_sur_chl_2(13:24); mon_clim_sur_chl_3_in= mon_clim_sur_chl_3(13:24);
mon_clim_bot_chl_1_in= mon_clim_bot_chl_1(13:24); mon_clim_bot_chl_2_in= mon_clim_bot_chl_2(13:24); mon_clim_bot_chl_3_in= mon_clim_bot_chl_3(13:24);
...
mon_clim_sur_nh4_1_in= mon_clim_sur_nh4_1(13:24); mon_clim_sur_nh4_2_in= mon_clim_sur_nh4_2(13:24); mon_clim_sur_nh4_3_in= mon_clim_sur_nh4_3(13:24);
mon_clim_bot_nh4_1_in= mon_clim_bot_nh4_1(13:24); mon_clim_bot_nh4_2_in= mon_clim_bot_nh4_2(13:24); mon_clim_bot_nh4_3_in= mon_clim_bot_nh4_3(13:24);
...
save('koem_input_fix_to06to15_3sig(3regime)_v7.mat');
