...
if t_i == 1
    y_s_temp_205 = kodc205.mon_clim_sur_temp_1_in; %%% mg/L to mM/m^3;
    y_b_temp_205 = kodc205.mon_clim_bot_temp_1_in; %%% mg/L to mM/m^3;
elseif t_i == 2
    y_s_temp_205 = kodc205.mon_clim_sur_temp_2_in; %%% mg/L to mM/m^3;
    y_b_temp_205 = kodc205.mon_clim_bot_temp_2_in; %%% mg/L to mM/m^3;
elseif t_i == 3
    y_s_temp_205 = kodc205.mon_clim_sur_temp_3_in; %%% mg/L to mM/m^3;
    y_b_temp_205 = kodc205.mon_clim_bot_temp_3_in; %%% mg/L to mM/m^3;
end

if t_i == 1
    y_s_no3_205 = kodc205.mon_clim_sur_no3_1_in; %%% mg/L to mM/m^3;
    y_b_no3_205 = kodc205.mon_clim_bot_no3_1_in; %%% mg/L to mM/m^3;
elseif t_i == 2
...
if t_i == 1
    y_s_temp_400 = kodc400.mon_clim_sur_temp_1_in; %%% mg/L to mM/m^3;
    y_b_temp_400 = kodc400.mon_clim_bot_temp_1_in; %%% mg/L to mM/m^3;
elseif t_i == 2
    y_s_temp_400 = kodc400.mon_clim_sur_temp_2_in; %%% mg/L to mM/m^3;
    y_b_temp_400 = kodc400.mon_clim_bot_temp_2_in; %%% mg/L to mM/m^3;
elseif t_i == 3
    y_s_temp_400 = kodc400.mon_clim_sur_temp_3_in; %%% mg/L to mM/m^3;
    y_b_temp_400 = kodc400.mon_clim_bot_temp_3_in; %%% mg/L to mM/m^3;
end


if t_i == 1
    y_s_no3_400 = kodc400.mon_clim_sur_no3_1_in; %%% mg/L to mM/m^3;
    y_b_no3_400 = kodc400.mon_clim_bot_no3_1_in; %%% mg/L to mM/m^3;
elseif t_i == 2
...
%%
y_s_temp_205_m=y_s_temp_205;
y_b_temp_205_m=y_b_temp_205;
y_s_temp_400_m=y_s_temp_400;
y_b_temp_400_m=y_b_temp_400;
