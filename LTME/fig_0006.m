...
tempmonth = 2;
var = 'vert_v';
section = [129.6 130.15 35.5 35.5 -200 0];
shadlev = [-0.5 0.5];
conlev = -0.5:0.1:0.5;
...
set(gca,'yTickLabel',{'-200m', '-100m', '0m'}, ...
    'YTick', [-200, -100, -0])
set(gca,'xTickLabel',{'129.7^oE','129.9^oE','130.1^oE', ' '}, ...
    'XTick', (129.7:0.2:130.1))
...
fig=gcf;
set(gcf,'PaperPosition', [paper_position_hor, paper_position_ver, 500, 312.5]) ;
saveas(gcf,'D:\OneDrive - 서울대학교\research\Master_course\for_publish\new_figure\fig_0006','jpg');