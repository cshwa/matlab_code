...
load songjung_yymm_monthly_data_89to19_nosig.mat  % polynomial_fitting_on_ecological_variable_to2004_new_v6_nosigma.m
...
figure; hold on; 
plot((monthly_po4./1000 .*14.006720).* monthly_trans(t_s+1:end))
...
save('songjung_climate_days_bio_to07to16_nosig.mat','clim_day_*','day_clim_*');
...
cd D:\장기생태\Dynamic\06_river\환경과학원
% load songjung_yymm_koem_data_89to19_3sig.mat  % polynomial_fitting_on_ecological_variable_to2004_new_v6_3sigma.m
load namgang_yymm_monthly_data_89to19_nosig.mat  % polynomial_fitting_on_ecological_variable_to2004_new_v6_nosigma.m
% addP=load('songjung_bio_v3_day_koem_yr.mat'); % 2004_regime_v3.m
...
save('namgang_climate_days_bio_to07to16_nosig.mat','clim_day_*','day_clim_*');
