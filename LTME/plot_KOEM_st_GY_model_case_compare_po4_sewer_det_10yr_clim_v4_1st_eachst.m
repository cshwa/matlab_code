...
% % save(['plot_model_10yr_v5_',num2str(sig),'sig_',dir_name{case_num},'_gy_each_st.mat'],'regm_*','spm_*','tm_*','mer_*')
% % end
% % end

% %  dir_name ={'all_std','t_std','sp_std'};
cd(['D:\장기생태\Dynamic\KOEM\compare_sewer\1st_10yr\v5_each_st\1st_10yr_',num2str(sig),'sig_',dir_name{case_num}]);
