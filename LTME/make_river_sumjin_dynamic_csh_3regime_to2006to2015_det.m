...
Fname =['river_' num2str(t_year) 'th_regime_bioGY_sewer_det.nc'];
ss = 1:365;
cycle=ss(end);
...
if cycle == 365
        ...
        River.temp(:,:,r)=repmat(temp_out_sumjin,1,20);
        River.salt(:,:,r)=repmat(salt_out,1,20);
        River.NH4(:,:,r)=repmat(clim_tn_g_ns_d'*(0.3)*(1000/14),1,20);
        River.NO3(:,:,r)=repmat(clim_tn_g_ns_d'*(0.6)*(1000/14),1,20);
        River.Oxyg(:,:,r)=repmat(do_out_sumjin,1,20);
        ...
        River.LDeN(:,:,r)=repmat(clim_tn_g_ns_d'*(0.07)*(1000/14).*0.7,1,20);
        River.SDeN(:,:,r)=repmat(clim_tn_g_ns_d'*(0.03)*(1000/14).*0.3,1,20);
        River.vshape(r,1:N)=1/N;
...
%         % r = 4; 
        ...
        River.Chlo(:,:,r)=repmat(chl_out_sumjin.* 0,1,20);
        % River.DON(:,:,r)=repmat(riv1_TN_f'*(999724/2/1000000)*(1000/14),1,20);
        River.LDeN(:,:,r)=repmat(clim_tn_gc_ns_d'*(0.07)*(1000/14).*0.7,1,20);
        River.SDeN(:,:,r)=repmat(clim_tn_gc_ns_d'*(0.03)*(1000/14).*0.3,1,20);
        River.vshape(r,1:N)=1/N;
...
%         % r = 5; 
        ...
        River.Chlo(:,:,r)=repmat(chl_out_sumjin.* 0,1,20);
        River.LDeN(:,:,r)=repmat(clim_tn_gh_ns_d'*(0.07)*(1000/14).*0.7,1,20);
        River.SDeN(:,:,r)=repmat(clim_tn_gh_ns_d'*(0.03)*(1000/14).*0.3,1,20);
        River.vshape(r,1:N)=1/N;
...
%         r = 4;
        ...
        River.LDeN(:,:,r)=repmat(clim_tn_gh2_ns_d'*(0.07)*(1000/14).*0.7,1,20);
        River.SDeN(:,:,r)=repmat(clim_tn_gh2_ns_d'*(0.03)*(1000/14).*0.3,1,20);
        River.vshape(r,1:N)=1/N;
        %--- 여수월내 -----------------------------------------
        % 1990-12-31
        r = 7;     
%         r = 5; 
        ...
        River.temp(:,:,r)=repmat(temp_out_sumjin,1,20);
        River.salt(:,:,r)=repmat(salt_out,1,20);
        River.NH4(:,:,r)=repmat(wout_clim_tn'*(0.3)*(1000/14),1,20);
        River.NO3(:,:,r)=repmat(wout_clim_tn'*(0.6)*(1000/14),1,20);
        River.Oxyg(:,:,r)=repmat(do_out_sumjin,1,20);
        River.tPO4(:,:,r)=repmat(wout_clim_tp'.*0.8 .*(1000/30.973762)  ,1,20);
        River.Chlo(:,:,r)=repmat(chl_out_sumjin.* 0,1,20);
        % River.DON(:,:,r)=repmat(riv5_TN_f'*(999724/2/1000000)*(1000/14),1,20);
        River.LDeN(:,:,r)=repmat(wout_clim_tn'*(0.07)*(1000/14).*0.7,1,20);
        River.SDeN(:,:,r)=repmat(wout_clim_tn'*(0.03)*(1000/14).*0.3,1,20);
        River.vshape(r,1:N)=1/N;
        ...
        River.Chlo(:,:,r)=repmat(chl_out_sumjin.* 0,1,20);
        % River.DON(:,:,r)=repmat(riv5_TN_f'*(999724/2/1000000)*(1000/14),1,20);
        River.LDeN(:,:,r)=repmat(clim_tn_y_ns_d'*(0.07)*(1000/14).*0.7,1,20);
        River.SDeN(:,:,r)=repmat(clim_tn_y_ns_d'*(0.03)*(1000/14).*0.3,1,20);
        River.vshape(r,1:N)=1/N;
...
%         r =6;
        ...
        River.temp(:,:,r)=repmat(temp_out_sumjin,1,20);
        River.salt(:,:,r)=repmat(salt_out,1,20);
        River.NH4(:,:,r)=repmat(jout_clim_tn'*(0.3)*(1000/14),1,20);
        River.NO3(:,:,r)=repmat(jout_clim_tn'*(0.6)*(1000/14),1,20);
        River.Oxyg(:,:,r)=repmat(do_out_sumjin,1,20);
        ...
        River.LDeN(:,:,r)=repmat(jout_clim_tn'*(0.07)*(1000/14).*0.7,1,20);
        River.SDeN(:,:,r)=repmat(jout_clim_tn'*(0.03)*(1000/14).*0.3,1,20);
        River.vshape(r,1:N)=1/N;
        ...
        % River.DON(:,:,r)=repmat(temp_clim_tn'*(999724/2/1000000)*(1000/14),1,20);
        % River.PON(:,:,r)=repmat(riv7_TN_f'*(999724/2/1000000)*(1000/14),1,20);
        River.LDeN(:,:,r)=repmat(clim_tn_ye_ns_d'*(0.07)*(1000/14).*0.7,1,20);
        River.SDeN(:,:,r)=repmat(clim_tn_ye_ns_d'*(0.03)*(1000/14).*0.3,1,20);
        River.vshape(r,1:N)=1/N;
        ...
        % River.DON(:,:,r)=repmat(temp_clim_tn'*(999724/2/1000000)*(1000/14),1,20);
        % River.PON(:,:,r)=repmat(riv7_TN_f'*(999724/2/1000000)*(1000/14),1,20);
        River.LDeN(:,:,r)=repmat(clim_tn_jw_ns_d'*(0.07)*(1000/14).*0.7,1,20);
        River.SDeN(:,:,r)=repmat(clim_tn_jw_ns_d'*(0.03)*(1000/14).*0.3,1,20);
        River.vshape(r,1:N)=1/N;
