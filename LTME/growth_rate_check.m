...
kd_3reg=ncread('C:\Users\user\Desktop\GY_메타\day_clim_ERA5_3regime_AttFac.nc','AttFac');
...
Lno3_3reg = (regime3_kdc_zerosw.sp_gy_no3_mid./((Kno3^-1) + regime3_kdc_zerosw.sp_gy_no3_mid)) .* (1./(1+regime3_kdc_zerosw.sp_gy_nh4_mid./(Knh4^-1)));
LNH4_3reg = (regime3_kdc_zerosw.sp_gy_nh4_mid./((Knh4^-1) + regime3_kdc_zerosw.sp_gy_nh4_mid));
