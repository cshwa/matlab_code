...
jjsal2 = textread('jjsal2.txt','');
st2_1 = textread('st2_1_2.txt',''); pre2_1 = st2_1(:,2); salt2_1 = st2_1(:,3); salt2_1 = smooth(pre2_1,salt2_1,30,'moving');
st3 = textread('st3_2.txt',''); pre3 = st3(:,2); salt3 = st3(:,3); salt3 = smooth(pre3,salt3,30,'moving');
st21 = textread('st21_2.txt',''); pre21 = st21(:,2); salt21 = st21(:,3); salt21 = smooth(pre21,salt21,30,'moving');
st22 = textread('st22_2.txt',''); pre22 = st22(:,2); salt22 = st22(:,3); salt22 = smooth(pre22,salt22,30,'moving');
st23 = textread('st23_2.txt',''); pre23 = st23(:,2); salt23 = st23(:,3); salt23 = smooth(pre23,salt23,30,'moving');
st24 = textread('st24_2.txt',''); pre24 = st24(:,2); salt24 = st24(:,3); salt24 = smooth(pre24,salt24,30,'moving');
st25 = textread('st25_2.txt',''); pre25 = st25(:,2); salt25 = st25(:,3); salt25 = smooth(pre25,salt25,30,'moving');
st26 = textread('st26_2.txt',''); pre26 = st26(:,2); salt26 = st26(:,3); salt26 = smooth(pre26,salt26,30,'moving');
st27 = textread('st27_2.txt',''); pre27 = st27(:,2); salt27 = st27(:,3); salt27 = smooth(pre27,salt27,30,'moving');
st28 = textread('st28_2.txt',''); pre28 = st28(:,2); salt28 = st28(:,3); salt28 = smooth(pre28,salt28,30,'moving');

salt = [salt2_1; salt3; salt21; salt22; salt23; salt24; salt25; salt26; salt27; salt28];


dist = jjsal2(:,1); pre = jjsal2(:,2);
