function create_roms_file_month_dye(fname,temp,salt,zeta,ubar,vbar,u,v,dye_01)%,tframe,cycle)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
...
% case 'v'
 ...
 % case 'dye_01'
 nw{'dye_01'} = ncfloat('level', 'eta_rho', 'xi_rho');
 nw{'dye_01'}.long_name = ncchar('dye concentration');
 nw{'dye_01'}.units = ncchar('kilogram meter-3');
 nw{'dye_01'}(:)= dye_01;
