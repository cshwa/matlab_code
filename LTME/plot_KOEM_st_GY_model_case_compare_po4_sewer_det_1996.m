...
% cd D:\장기생태\Dynamic\KOEM\gy_1996\gy_1996_koem_daily\spmean
% load('koem_result_processed_std_spmean.mat'); % KOEM obs.
% % mpdata= load('mpdata_result.mat');

cd D:\장기생태\Dynamic\result\1996
defau = load('1996_mp_p_sewer_det_f_result.mat','obm_*','gy_*','jj_*','sgy_*','egy_*','obs_std_*');
z02 = load('1996_mp_2nd_result','obm_*','gy_*','jj_*','sgy_*','egy_*','obs_std_*');



% cd D:\장기생태\Dynamic\KOEM\gy_1996\phymin_half_saturation
% phymin= load('phymin_result.mat');
% 
% cd D:\장기생태\Dynamic\KOEM\gy_1996\mp_p_ws_half_saturation
% mp_p_ws= load('mp_p_ws_result.mat');

% % mpdata.gy_temp
cd D:\장기생태\Dynamic\KOEM\compare_sewer\det_1996_compare\

%% GY plot zoo
fig = figure; hold on;
        plot(defau.gy_zoo,'b','linew',2);
        plot(z02.gy_zoo(2:end),'r','linew',2);
         plot(defau.gy_phy,'m','linew',2);
        plot(z02.gy_phy,'g','linew',2);
        legend('zoo','zoo_w_t_8','phy','phy_w_t_8')
        xlim([1 365]);
        title(['GY 1996 daily KOEM OBS vs. MODEL Zoo & Phy surface']);
        xlabel('time(days on 1996)','fontsize',13)
...
fig = figure; hold on;      
        ...
        plot(z02.gy_zoo_b(2:end),'r','linew',2);
        plot(defau.gy_phy_b,'m','linew',2);
        plot(z02.gy_phy_b,'g','linew',2);
        legend('zoo','zoo_w_t_8','phy','phy_w_t_8')
        xlim([1 365]);
        title(['GY 1996 daily KOEM OBS vs. MODEL Zoo & Phy bottom']);
        xlabel('time(days on 1996)','fontsize',13)
        ylabel('concentration (umol/m^3)','fontsize',13)
        grid on
        set(gca,'fontsize',13)              
...
%         plot(1:length(defau.obm_gy_no3),lower_bound_plt,'r-','linew',2);
        ...
        xlim([1 365])
        set(gca,'fontsize',13)
        print(fig,strcat('1996_yr_KOEM_OBS_vs_daily_MODEL_no3'),'-dpng')
...
%         plot(1:length(defau.obm_gy_nh4),lower_bound_plt,'r-','linew',2);
        ...
        xlim([1 365])
        set(gca,'fontsize',13)
        print(fig,strcat('1996_yr_KOEM_OBS_vs_daily_MODEL_nh4'),'-dpng')
...
%         plot(1:length(defau.obm_gy_chl),lower_bound_plt,'r-','linew',2);
        ...
        xlim([1 365])
        set(gca,'fontsize',13)
        print(fig,strcat('1996_yr_KOEM_OBS_vs_daily_MODEL_chl'),'-dpng')
...
%         
        ...
        xlim([1 365])
        set(gca,'fontsize',13)
        print(fig,strcat('1996_yr_KOEM_OBS_vs_daily_MODEL_temp'),'-dpng')
...
%         plot(1:length(defau.obm_gy_salt),lower_bound_plt,'r-','linew',2);
        ...
        xlim([1 365])
        set(gca,'fontsize',13)
        print(fig,strcat('1996_yr_KOEM_OBS_vs_daily_MODEL_salt'),'-dpng')            
 %% bot
...
%         plot(1:length(defau.obm_gy_no3_b),lower_bound_plt,'r-','linew',2);
        ...
        set(gca,'fontsize',13)
        xlim([1 365])
        print(fig,strcat('1996_yr_KOEM_OBS_vs_daily_MODEL_no3_bot'),'-dpng')
...
%         plot(1:length(defau.obm_gy_nh4_b),lower_bound_plt,'r-','linew',2);
        ...
        xlim([1 365])
        set(gca,'fontsize',13)
        print(fig,strcat('1996_yr_KOEM_OBS_vs_daily_MODEL_nh4_bot'),'-dpng')
...
%         plot(1:length(defau.obm_gy_chl_b),lower_bound_plt,'r-','linew',2);
        ...
        yticks(1:1:15)
        set(gca,'fontsize',13)
        print(fig,strcat('1996_yr_KOEM_OBS_vs_daily_MODEL_chl_bot'),'-dpng')
...
%         plot(1:length(defau.obm_gy_temp_b),lower_bound_plt,'r-','linew',2);
        ...
        xlim([1 365])
        set(gca,'fontsize',13)
        print(fig,strcat('1996_yr_KOEM_OBS_vs_daily_MODEL_temp_bot'),'-dpng')
...
%         plot(1:length(defau.obm_gy_salt_b),lower_bound_plt,'r-','linew',2);
        ...
        xlim([1 365])
        set(gca,'fontsize',13)
        print(fig,strcat('1996_yr_KOEM_OBS_vs_daily_MODEL_salt_bot'),'-dpng')            
return        
...
%         plot(zeros(365,1),'g','linew',2); % zero lines
        ...
        plot(1:length(obm_sgy_no3),obm_sgy_no3./14 - obs_std_sgy_no3./14,'m-','linew',2);
        title(['GY 1996 daily KOEM OBS vs. MODEL NO3']);
        xlabel('time(days on 1996)','fontsize',16)
        ylabel('NO3 (umol/m^3)','fontsize',16)
        grid on
        set(gca,'fontsize',16,'fontweight','bold')
        ylim([0 inf])
        print(fig,strcat('1996_daily_KOEM_OBS_vs_MODEL_no3_south_sgy'),'-dpng')
...
%         plot(zeros(365,1),'g','linew',2); % zero lines
        ...
        plot(1:length(obm_sgy_nh4),obm_sgy_nh4./14 - obs_std_sgy_nh4./14,'m-','linew',2);
        title(['GY 1996 daily KOEM OBS vs. MODEL NH4']);
        xlabel('time(days on 1996)','fontsize',16)
        ...
        set(gca,'fontsize',16,'fontweight','bold')
        ylim([0 inf])
        print(fig,strcat('1996_daily_KOEM_OBS_vs_MODEL_NH4_south_sgy'),'-dpng')
...
%         plot(zeros(365,1),'g','linew',2); % zero lines
        ...
        plot(1:length(obm_sgy_chl),obm_sgy_chl - obs_std_sgy_chl,'m-','linew',2);
        title(['GY 1996 daily KOEM OBS vs. MODEL chl']);
        xlabel('time(days on 1996)','fontsize',16)
        ylabel('chl (ug/L)','fontsize',16)
        grid on
        set(gca,'fontsize',16,'fontweight','bold')
        ylim([0 inf])
        print(fig,strcat('1996_daily_KOEM_OBS_vs_MODEL_chl_south_sgy'),'-dpng') 
...
%         plot(zeros(365,1),'g','linew',2); % zero lines
        ...
        plot(1:length(obm_sgy_temp),obm_sgy_temp - obs_std_sgy_temp,'m-','linew',2);
        title(['GY 1996 daily KOEM OBS vs. MODEL temp']);
        xlabel('time(days on 1996)','fontsize',16)
        ylabel('temp (o^C)','fontsize',16)
        grid on
        set(gca,'fontsize',16,'fontweight','bold')
        print(fig,strcat('1996_daily_KOEM_OBS_vs_MODEL_temp_south_sgy'),'-dpng')    
...
%         plot(zeros(365,1),'g','linew',2); % zero lines
        ...
        plot(1:length(obm_sgy_salt),obm_sgy_salt - obs_std_sgy_salt,'m-','linew',2);
        title(['GY 1996 daily KOEM OBS vs. MODEL salt']);
        xlabel('time(days on 1996)','fontsize',16)
        ylabel('salt (psu)','fontsize',16)
        grid on
        set(gca,'fontsize',16,'fontweight','bold')
        print(fig,strcat('1996_daily_KOEM_OBS_vs_MODEL_salt_south_sgy'),'-dpng')            
 %% bot
...
%         plot(zeros(365,1),'g','linew',2); % zero lines
        ...
        plot(1:length(obm_sgy_no3_b),obm_sgy_no3_b./14 - obs_std_sgy_no3_b./14,'m-','linew',2);
        title(['GY 1996 daily KOEM OBS vs. MODEL NO3 bot']);
        xlabel('time(days on 1996)','fontsize',16)
        ylabel('NO3 (umol/m^3)','fontsize',16)
        grid on
        set(gca,'fontsize',16,'fontweight','bold'); ylim([0 inf])
        print(fig,strcat('1996_daily_KOEM_OBS_vs_MODEL_no3_bot_south_sgy'),'-dpng')
...
%         plot(zeros(365,1),'g','linew',2); % zero lines
        ...
        plot(1:length(obm_sgy_nh4_b),obm_sgy_nh4_b./14 - obs_std_sgy_nh4_b./14,'m-','linew',2);
        title(['GY 1996 daily KOEM OBS vs. MODEL NH4 bot']);
        xlabel('time(days on 1996)','fontsize',16)
        ylabel('NH4 (umol/m^3)','fontsize',16)
        xticks([0:50:366])
        grid on
        set(gca,'fontsize',16,'fontweight','bold'); ylim([0 inf])
        print(fig,strcat('1996_daily_KOEM_OBS_vs_MODEL_NH4_bot_south_sgy'),'-dpng')
...
%         plot(zeros(365,1),'g','linew',2); % zero lines
        ...
        plot(1:length(obm_sgy_chl_b),obm_sgy_chl_b - obs_std_sgy_chl_b,'m-','linew',2);
        title(['GY 1996 daily KOEM OBS vs. MODEL chl bot']);
        xlabel('time(days on 1996)','fontsize',16)
        ylabel('chl (ug/L)','fontsize',16)
        grid on
        set(gca,'fontsize',16,'fontweight','bold'); ylim([0 inf])
        print(fig,strcat('1996_daily_KOEM_OBS_vs_MODEL_chl_bot_south_sgy'),'-dpng') 
...
%         plot(zeros(365,1),'g','linew',2); % zero lines
        ...
        plot(1:length(obm_sgy_temp_b),obm_sgy_temp_b - obs_std_sgy_temp_b,'m-','linew',2);
        title(['GY 1996 daily KOEM OBS vs. MODEL temp bot']);
        xlabel('time(days on 1996)','fontsize',16)
        ylabel('temp (o^C)','fontsize',16)
        grid on
        set(gca,'fontsize',16,'fontweight','bold')
        print(fig,strcat('1996_daily_KOEM_OBS_vs_MODEL_temp_bot_south_sgy'),'-dpng')    
...
%         plot(zeros(365,1),'g','linew',2); % zero lines
        ...
        plot(1:length(obm_sgy_salt_b),obm_sgy_salt_b - obs_std_sgy_salt_b,'m-','linew',2);
        title(['GY 1996 daily KOEM OBS vs. MODEL salt bot']);
        xlabel('time(days on 1996)','fontsize',16)
        ylabel('salt (psu)','fontsize',16)
        xticks([0:50:366])
        grid on
        set(gca,'fontsize',16,'fontweight','bold')
        print(fig,strcat('1996_daily_KOEM_OBS_vs_MODEL_salt_bot_south_sgy'),'-dpng')    
...
%         plot(zeros(365,1),'g','linew',2); % zero lines
        ...
        grid on
        set(gca,'fontsize',16,'fontweight','bold'); ylim([0 inf])
        print(fig,strcat('1996_daily_KOEM_OBS_vs_MODEL_no3_egy'),'-dpng')
...
%         plot(zeros(365,1),'g','linew',2); % zero lines       
        ...
        grid on
        set(gca,'fontsize',16,'fontweight','bold'); ylim([0 inf])
        print(fig,strcat('1996_daily_KOEM_OBS_vs_MODEL_NH4_egy'),'-dpng')
...
%         plot(zeros(365,1),'g','linew',2); % zero lines
        ...
        grid on
        set(gca,'fontsize',16,'fontweight','bold'); ylim([0 inf])
        print(fig,strcat('1996_daily_KOEM_OBS_vs_MODEL_chl_egy'),'-dpng') 
...
%         plot(zeros(365,1),'g','linew',2); % zero lines
        ...
        grid on
        set(gca,'fontsize',16,'fontweight','bold')
        print(fig,strcat('1996_daily_KOEM_OBS_vs_MODEL_temp_egy'),'-dpng')    
...
%         plot(zeros(365,1),'g','linew',2); % zero lines
        ...
        grid on
        set(gca,'fontsize',16,'fontweight','bold')
        print(fig,strcat('1996_daily_KOEM_OBS_vs_MODEL_salt_egy'),'-dpng')            
 %% bot
...
%         plot(zeros(365,1),'g','linew',2); % zero lines
        ...
        grid on
        set(gca,'fontsize',16,'fontweight','bold'); ylim([0 inf])
        print(fig,strcat('1996_daily_KOEM_OBS_vs_MODEL_no3_bot_egy'),'-dpng')
...
%         plot(zeros(365,1),'g','linew',2); % zero lines
        ...
        grid on
        set(gca,'fontsize',16,'fontweight','bold'); ylim([0 inf])
        print(fig,strcat('1996_daily_KOEM_OBS_vs_MODEL_NH4_bot_egy'),'-dpng')
...
%         plot(zeros(365,1),'g','linew',2); % zero lines
        ...
        grid on
        set(gca,'fontsize',16,'fontweight','bold'); ylim([0 inf])
        print(fig,strcat('1996_daily_KOEM_OBS_vs_MODEL_chl_bot_egy'),'-dpng') 
...
%         plot(zeros(365,1),'g','linew',2); % zero lines
        ...
        grid on
        set(gca,'fontsize',16,'fontweight','bold')
        print(fig,strcat('1996_daily_KOEM_OBS_vs_MODEL_temp_bot_egy'),'-dpng')    
...
%         plot(zeros(365,1),'g','linew',2); % zero lines
        ...
        grid on
        set(gca,'fontsize',16,'fontweight','bold')
        print(fig,strcat('1996_daily_KOEM_OBS_vs_MODEL_salt_bot_egy'),'-dpng')    
...
%         plot(zeros(365,1),'g','linew',2); % zero lines
        ...
        grid on
        set(gca,'fontsize',16,'fontweight','bold'); ylim([0 inf])
        print(fig,strcat('1996_daily_KOEM_OBS_vs_MODEL_no3_jj'),'-dpng')
...
%         plot(zeros(365,1),'g','linew',2); % zero lines
        ...
        grid on
        set(gca,'fontsize',16,'fontweight','bold'); ylim([0 inf])
        print(fig,strcat('1996_daily_KOEM_OBS_vs_MODEL_NH4_jj'),'-dpng')
...
%         plot(zeros(365,1),'g','linew',2); % zero lines
        ...
        grid on
        set(gca,'fontsize',16,'fontweight','bold'); ylim([0 inf])
        print(fig,strcat('1996_daily_KOEM_OBS_vs_MODEL_chl_jj'),'-dpng') 
...
%         plot(zeros(365,1),'g','linew',2); % zero lines
        ...
        grid on
        set(gca,'fontsize',16,'fontweight','bold')
        print(fig,strcat('1996_daily_KOEM_OBS_vs_MODEL_temp_jj'),'-dpng')    
...
%         plot(zeros(365,1),'g','linew',2); % zero lines
        ...
        grid on
        set(gca,'fontsize',16,'fontweight','bold')
        print(fig,strcat('1996_daily_KOEM_OBS_vs_MODEL_salt_jj'),'-dpng')            
 %% bot
...
%         plot(zeros(365,1),'g','linew',2); % zero lines
        ...
        grid on
        set(gca,'fontsize',16,'fontweight','bold'); ylim([0 inf])
        print(fig,strcat('1996_daily_KOEM_OBS_vs_MODEL_no3_bot_jj'),'-dpng')
...
%         plot(zeros(365,1),'g','linew',2); % zero lines
        ...
        grid on
        set(gca,'fontsize',16,'fontweight','bold'); ylim([0 inf])
        print(fig,strcat('1996_daily_KOEM_OBS_vs_MODEL_NH4_bot_jj'),'-dpng')
...
%         plot(zeros(365,1),'g','linew',2); % zero lines
        ...
        grid on
        set(gca,'fontsize',16,'fontweight','bold'); ylim([0 inf])
        print(fig,strcat('1996_daily_KOEM_OBS_vs_MODEL_chl_bot_jj'),'-dpng') 
...
%         plot(zeros(365,1),'g','linew',2); % zero lines
        ...
        grid on
        set(gca,'fontsize',16,'fontweight','bold')
        print(fig,strcat('1996_daily_KOEM_OBS_vs_MODEL_temp_bot_jj'),'-dpng')    
...
%         plot(zeros(365,1),'g','linew',2); % zero lines
        ...
        grid on
        set(gca,'fontsize',16,'fontweight','bold')
        print(fig,strcat('1996_daily_KOEM_OBS_vs_MODEL_salt_bot_jj'),'-dpng')    
