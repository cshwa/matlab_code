...
figdir ='/scratch/snu02/roms_nwp/output/test32/';
workdir = '/scratch/snu02/roms_nwp/output/test32/';
inputdir = '/scratch/snu02/roms_nwp/output/test32/';
outfile =[figdir, 'model_nwp_KE_nwp_1_20']
lonlat = [115 164 15 52]; % [lon_start lon_end lat_start lat_end] (NWP)
year = [1992 1997] % [year_start year_end]
