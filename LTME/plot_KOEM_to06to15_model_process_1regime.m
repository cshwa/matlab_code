...
refyear=1
ncf_name=['part_res_2regime_kdc_zerosw'];
...
mod_file=['C:\Users\user\Desktop\GY_¸ŞÅ¸','\',ncf_name,'.nc'];
...
%     clearvars tempo_d
% tempo_d=zlevs(z, squeeze(mod_z(:,:,i)),theta_s,theta_b, hc, N, 'r');
% sig2z_co(:,:,:,i) = permute(tempo_d,[2 3 1]);
% end
