...
% %  dir_name ={'all_std','t_std','sp_std'};
cd(['D:\장기생태\Dynamic\KOEM\compare_sewer\3rd_5yr\3rd_5yr_',num2str(sig),'sig_',dir_name{case_num}]);
...
if case_num == 1 
    ...
    %data=NaN(1,365);        
    %data(1:length(c2004.gy_no3))=c2004.gy_no3_3; 
    %         plot(nanmean([c1997.gy_no3_3; c1998.gy_no3_3; c1999.gy_no3_3; c2000.gy_no3_3; c2001.gy_no3_3; c2002.gy_no3_3; c2003.gy_no3_3;],1),'b','linew',2);
            plot(nanmean(mer_no3_3,1),'b','linew',2);
            clearvars *_bound_plt nonan_data_plt discon_p temp_d
            temp_d=nanmean(mer_no3_3,1);
            nonan_data_plt = find(isnan(temp_d)==0);
            nonan_diff=nonan_data_plt(2:end) - nonan_data_plt(1:end-1);
            upper_bound_plt = temp_d + regm_std_no3_3;
            lower_bound_plt = temp_d - regm_std_no3_3;
            ...
            nonan_data_plt = find(isnan(clim1.obm_gy_no3_ft_3)==0);
            nonan_diff=nonan_data_plt(2:end) - nonan_data_plt(1:end-1);
            discon_p = find(nonan_diff ~= 1); % find discontinuous point
            discon_p(4) = length(nonan_data_plt); %end point
            upper_bound_plt = clim1.obm_gy_no3_ft_3./14 + clim1.obs_std_gy_no3_ft_3./14;
            lower_bound_plt = clim1.obm_gy_no3_ft_3./14 - clim1.obs_std_gy_no3_ft_3./14;
            for i = 1:4
            if i == 1
            ...
            plot(clim1.obm_gy_no3_ft_3./14,'r-','linew',2); 
            plot(1:length(clim1.obm_gy_no3_ft_3),upper_bound_plt,'r-','linew',2);
            plot(1:length(clim1.obm_gy_no3_ft_3),lower_bound_plt,'r-','linew',2);
    ...
    %data=NaN(1,365);        
    % data(1:length(c2004.gy_nh4))=c2004.gy_nh4_3; 
            plot(nanmean(mer_nh4_3,1),'b','linew',2);
            clearvars *_bound_plt nonan_data_plt discon_p temp_d
            temp_d=nanmean(mer_nh4_3,1);
            nonan_data_plt = find(isnan(temp_d)==0);
            nonan_diff=nonan_data_plt(2:end) - nonan_data_plt(1:end-1);
            upper_bound_plt = temp_d + regm_std_nh4_3;
            lower_bound_plt = temp_d - regm_std_nh4_3;
            patch([nonan_data_plt fliplr(nonan_data_plt)], [upper_bound_plt fliplr(lower_bound_plt)],[0.5 0.5 0.5]);
    %         plot(nanmean([c1997.gy_nh4_3; c1998.gy_nh4_3; c1999.gy_nh4_3; c2000.gy_nh4_3; c2001.gy_nh4_3; c2002.gy_nh4_3; c2003.gy_nh4_3;],1),'b','linew',2);
                   clearvars *_bound_plt nonan_data_plt discon_p
            nonan_data_plt = find(isnan(clim1.obm_gy_nh4_ft_3)==0);
            nonan_diff=nonan_data_plt(2:end) - nonan_data_plt(1:end-1);
            discon_p = find(nonan_diff ~= 1); % find discontinuous point
            discon_p(4) = length(nonan_data_plt); %end point
            upper_bound_plt = clim1.obm_gy_nh4_ft_3./14 + clim1.obs_std_gy_nh4_ft_3./14;
            lower_bound_plt = clim1.obm_gy_nh4_ft_3./14 - clim1.obs_std_gy_nh4_ft_3./14;
            for i = 1:4
            if i == 1
            patch([nonan_data_plt(1:discon_p(1)) fliplr(nonan_data_plt(1:discon_p(1)))], [upper_bound_plt(nonan_data_plt(1:discon_p(1))) fliplr(lower_bound_plt(nonan_data_plt(1:discon_p(1))))],'r');
            else
            ...
            plot(clim1.obm_gy_nh4_ft_3./14,'r-','linew',2); 
            plot(1:length(clim1.obm_gy_nh4_ft_3),upper_bound_plt,'r-','linew',2);
            plot(1:length(clim1.obm_gy_nh4_ft_3),lower_bound_plt,'r-','linew',2);
    ...
    % data=NaN(1,366);        
    % data(1:length(c2004.gy_chl))=c2004.gy_chl_3; 
            plot(nanmean(mer_chl_3,1),'b','linew',2);
            clearvars *_bound_plt nonan_data_plt discon_p temp_d
            temp_d=nanmean(mer_chl_3,1);
            nonan_data_plt = find(isnan(temp_d)==0);
            nonan_diff=nonan_data_plt(2:end) - nonan_data_plt(1:end-1);
            upper_bound_plt = temp_d + regm_std_chl_3;
            lower_bound_plt = temp_d - regm_std_chl_3;
            patch([nonan_data_plt fliplr(nonan_data_plt)], [upper_bound_plt fliplr(lower_bound_plt)],[0.5 0.5 0.5]);
    %         plot(nanmean([c1997.gy_chl_3; c1998.gy_chl_3; c1999.gy_chl_3; c2000.gy_chl_3; c2001.gy_chl_3; c2002.gy_chl_3; c2003.gy_chl_3;],1),'b','linew',2);
                   clearvars *_bound_plt nonan_data_plt discon_p
            nonan_data_plt = find(isnan(clim1.obm_gy_chl_ft_3)==0);
            nonan_diff=nonan_data_plt(2:end) - nonan_data_plt(1:end-1);
            discon_p = find(nonan_diff ~= 1); % find discontinuous point
            discon_p(4) = length(nonan_data_plt); %end point
            upper_bound_plt = clim1.obm_gy_chl_ft_3 + clim1.obs_std_gy_chl_ft_3;
            lower_bound_plt = clim1.obm_gy_chl_ft_3 - clim1.obs_std_gy_chl_ft_3;
            for i = 1:4
            if i == 1
            patch([nonan_data_plt(1:discon_p(1)) fliplr(nonan_data_plt(1:discon_p(1)))], [upper_bound_plt(nonan_data_plt(1:discon_p(1))) fliplr(lower_bound_plt(nonan_data_plt(1:discon_p(1))))],'r');
            else
            ...
            plot(clim1.obm_gy_chl_ft_3,'r-','linew',2); 
            plot(1:length(clim1.obm_gy_chl_ft_3),upper_bound_plt,'r-','linew',2);
            plot(1:length(clim1.obm_gy_chl_ft_3),lower_bound_plt,'r-','linew',2);
    ...
    %data=NaN(1,365);        
    % data(1:length(c2004.gy_temp))=c2004.gy_temp_3;
            plot(nanmean(mer_temp_3,1),'b','linew',2);
            clearvars *_bound_plt nonan_data_plt discon_p temp_d
            temp_d=nanmean(mer_temp_3,1);
            nonan_data_plt = find(isnan(temp_d)==0);
            nonan_diff=nonan_data_plt(2:end) - nonan_data_plt(1:end-1);
            upper_bound_plt = temp_d + regm_std_temp_3;
            lower_bound_plt = temp_d - regm_std_temp_3;
            patch([nonan_data_plt fliplr(nonan_data_plt)], [upper_bound_plt fliplr(lower_bound_plt)],[0.5 0.5 0.5]);
    %         plot(nanmean([c1997.gy_temp_3; c1998.gy_temp_3; c1999.gy_temp_3; c2000.gy_temp_3; c2001.gy_temp_3; c2002.gy_temp_3; c2003.gy_temp_3;],1),'b','linew',2);
                   clearvars *_bound_plt nonan_data_plt discon_p
            nonan_data_plt = find(isnan(clim1.obm_gy_temp_ft_3)==0);
            nonan_diff=nonan_data_plt(2:end) - nonan_data_plt(1:end-1);
            discon_p = find(nonan_diff ~= 1); % find discontinuous point
            discon_p(4) = length(nonan_data_plt); %end point
            upper_bound_plt = clim1.obm_gy_temp_ft_3 + clim1.obs_std_gy_temp_ft_3;
            lower_bound_plt = clim1.obm_gy_temp_ft_3 - clim1.obs_std_gy_temp_ft_3;
            for i = 1:4
            if i == 1
            patch([nonan_data_plt(1:discon_p(1)) fliplr(nonan_data_plt(1:discon_p(1)))], [upper_bound_plt(nonan_data_plt(1:discon_p(1))) fliplr(lower_bound_plt(nonan_data_plt(1:discon_p(1))))],'r');
            else
            ...
            plot(clim1.obm_gy_temp_ft_3,'r-','linew',2); 
            plot(1:length(clim1.obm_gy_temp_ft_3),upper_bound_plt,'r-','linew',2);
            plot(1:length(clim1.obm_gy_temp_ft_3),lower_bound_plt,'r-','linew',2);
    ...
    %data=NaN(1,365);        
    % data(1:length(c2004.gy_salt))=c2004.gy_salt_3; 
            plot(nanmean(mer_salt_3,1),'b','linew',2);
            clearvars *_bound_plt nonan_data_plt discon_p salt_d
            salt_d=nanmean(mer_salt_3,1);
            nonan_data_plt = find(isnan(salt_d)==0);
            nonan_diff=nonan_data_plt(2:end) - nonan_data_plt(1:end-1);
            upper_bound_plt = salt_d + regm_std_salt_3;
            lower_bound_plt = salt_d - regm_std_salt_3;
            patch([nonan_data_plt fliplr(nonan_data_plt)], [upper_bound_plt fliplr(lower_bound_plt)],[0.5 0.5 0.5]);
    %         plot(nanmean([c1997.gy_salt_3; c1998.gy_salt_3; c1999.gy_salt_3; c2000.gy_salt_3; c2001.gy_salt_3; c2002.gy_salt_3; c2003.gy_salt_3;],1),'b','linew',2);
                   clearvars *_bound_plt nonan_data_plt discon_p
            nonan_data_plt = find(isnan(clim1.obm_gy_salt_ft_3)==0);
            nonan_diff=nonan_data_plt(2:end) - nonan_data_plt(1:end-1);
            discon_p = find(nonan_diff ~= 1); % find discontinuous point
            discon_p(4) = length(nonan_data_plt); %end point
            upper_bound_plt = clim1.obm_gy_salt_ft_3 + clim1.obs_std_gy_salt_ft_3;
            lower_bound_plt = clim1.obm_gy_salt_ft_3 - clim1.obs_std_gy_salt_ft_3;
            for i = 1:4
            if i == 1
            patch([nonan_data_plt(1:discon_p(1)) fliplr(nonan_data_plt(1:discon_p(1)))], [upper_bound_plt(nonan_data_plt(1:discon_p(1))) fliplr(lower_bound_plt(nonan_data_plt(1:discon_p(1))))],'r');
            else
            ...
            plot(clim1.obm_gy_salt_ft_3,'r-','linew',2); 
            plot(1:length(clim1.obm_gy_salt_ft_3),upper_bound_plt,'r-','linew',2);
            plot(1:length(clim1.obm_gy_salt_ft_3),lower_bound_plt,'r-','linew',2);
    ...
    %data=NaN(1,365);        
    % data(1:length(c2004.gy_no3_b))=c2004.gy_no3_b_3; 
            plot(nanmean(mer_no3_b_3,1),'b','linew',2);
            clearvars *_bound_plt nonan_data_plt discon_p no3_b_d
            no3_b_d=nanmean(mer_no3_b_3,1);
            nonan_data_plt = find(isnan(no3_b_d)==0);
            nonan_diff=nonan_data_plt(2:end) - nonan_data_plt(1:end-1);
            upper_bound_plt = no3_b_d + regm_std_no3_b_3;
            lower_bound_plt = no3_b_d - regm_std_no3_b_3;
            patch([nonan_data_plt fliplr(nonan_data_plt)], [upper_bound_plt fliplr(lower_bound_plt)],[0.5 0.5 0.5]);
    %         plot(nanmean([c1997.gy_no3_b_3; c1998.gy_no3_b_3; c1999.gy_no3_b_3; c2000.gy_no3_b_3; c2001.gy_no3_b_3; c2002.gy_no3_b_3; c2003.gy_no3_b_3;],1),'b','linew',2);
                   clearvars *_bound_plt nonan_data_plt discon_p
            nonan_data_plt = find(isnan(clim1.obm_gy_no3_b_ft_3)==0);
            nonan_diff=nonan_data_plt(2:end) - nonan_data_plt(1:end-1);
            discon_p = find(nonan_diff ~= 1); % find discontinuous point
            discon_p(4) = length(nonan_data_plt); %end point
            upper_bound_plt = clim1.obm_gy_no3_b_ft_3./14 + clim1.obs_std_gy_no3_b_ft_3./14;
            lower_bound_plt = clim1.obm_gy_no3_b_ft_3./14 - clim1.obs_std_gy_no3_b_ft_3./14;
            for i = 1:4
            if i == 1
            patch([nonan_data_plt(1:discon_p(1)) fliplr(nonan_data_plt(1:discon_p(1)))], [upper_bound_plt(nonan_data_plt(1:discon_p(1))) fliplr(lower_bound_plt(nonan_data_plt(1:discon_p(1))))],'r');
            else
            ...
            plot(clim1.obm_gy_no3_b_ft_3./14,'r-','linew',2); 
            plot(1:length(clim1.obm_gy_no3_b_ft_3),upper_bound_plt,'r-','linew',2);
            plot(1:length(clim1.obm_gy_no3_b_ft_3),lower_bound_plt,'r-','linew',2);
    ...
    % data(1:length(c2004.gy_nh4_b))=c2004.gy_nh4_b; 
            plot(nanmean(mer_nh4_b_3,1),'b','linew',2);
            clearvars *_bound_plt nonan_data_plt discon_p nh4_b_d
            nh4_b_d=nanmean(mer_nh4_b_3,1);
            nonan_data_plt = find(isnan(nh4_b_d)==0);
            nonan_diff=nonan_data_plt(2:end) - nonan_data_plt(1:end-1);
            upper_bound_plt = nh4_b_d + regm_std_nh4_b_3;
            lower_bound_plt = nh4_b_d - regm_std_nh4_b_3;
            patch([nonan_data_plt fliplr(nonan_data_plt)], [upper_bound_plt fliplr(lower_bound_plt)],[0.5 0.5 0.5]);
    %         plot(nanmean([c1997.gy_nh4_b; c1998.gy_nh4_b; c1999.gy_nh4_b; c2000.gy_nh4_b; c2001.gy_nh4_b; c2002.gy_nh4_b; c2003.gy_nh4_b;],1),'b','linew',2);
                   clearvars *_bound_plt nonan_data_plt discon_p
            nonan_data_plt = find(isnan(clim1.obm_gy_nh4_b_ft_3)==0);
            nonan_diff=nonan_data_plt(2:end) - nonan_data_plt(1:end-1);
            discon_p = find(nonan_diff ~= 1); % find discontinuous point
            discon_p(4) = length(nonan_data_plt); %end point
            upper_bound_plt = clim1.obm_gy_nh4_b_ft_3./14 + clim1.obs_std_gy_nh4_b_ft_3./14;
            lower_bound_plt = clim1.obm_gy_nh4_b_ft_3./14 - clim1.obs_std_gy_nh4_b_ft_3./14;
            for i = 1:4
            if i == 1
            patch([nonan_data_plt(1:discon_p(1)) fliplr(nonan_data_plt(1:discon_p(1)))], [upper_bound_plt(nonan_data_plt(1:discon_p(1))) fliplr(lower_bound_plt(nonan_data_plt(1:discon_p(1))))],'r');
            else
            ...
            plot(clim1.obm_gy_nh4_b_ft_3./14,'r-','linew',2); 
            plot(1:length(clim1.obm_gy_nh4_b_ft_3),upper_bound_plt,'r-','linew',2);
            plot(1:length(clim1.obm_gy_nh4_b_ft_3),lower_bound_plt,'r-','linew',2);
    ...
    % data(1:length(c2004.gy_chl_b))=c2004.gy_chl_b; 
            plot(nanmean(mer_chl_b_3,1),'b','linew',2);
            clearvars *_bound_plt nonan_data_plt discon_p chl_b_d
            chl_b_d=nanmean(mer_chl_b_3,1);
            nonan_data_plt = find(isnan(chl_b_d)==0);
            nonan_diff=nonan_data_plt(2:end) - nonan_data_plt(1:end-1);
            upper_bound_plt = chl_b_d + regm_std_chl_b_3;
            lower_bound_plt = chl_b_d - regm_std_chl_b_3;
            patch([nonan_data_plt fliplr(nonan_data_plt)], [upper_bound_plt fliplr(lower_bound_plt)],[0.5 0.5 0.5]);
    %         plot(nanmean([c1997.gy_chl_b; c1998.gy_chl_b; c1999.gy_chl_b; c2000.gy_chl_b; c2001.gy_chl_b; c2002.gy_chl_b; c2003.gy_chl_b;],1),'b','linew',2);
                   clearvars *_bound_plt nonan_data_plt discon_p
            nonan_data_plt = find(isnan(clim1.obm_gy_chl_b_ft_3)==0);
            nonan_diff=nonan_data_plt(2:end) - nonan_data_plt(1:end-1);
            discon_p = find(nonan_diff ~= 1); % find discontinuous point
            discon_p(4) = length(nonan_data_plt); %end point
            upper_bound_plt = clim1.obm_gy_chl_b_ft_3 + clim1.obs_std_gy_chl_b_ft_3;
            lower_bound_plt = clim1.obm_gy_chl_b_ft_3 - clim1.obs_std_gy_chl_b_ft_3;
            for i = 1:4
            if i == 1
            patch([nonan_data_plt(1:discon_p(1)) fliplr(nonan_data_plt(1:discon_p(1)))], [upper_bound_plt(nonan_data_plt(1:discon_p(1))) fliplr(lower_bound_plt(nonan_data_plt(1:discon_p(1))))],'r');
            else
            ...
            plot(clim1.obm_gy_chl_b_ft_3,'r-','linew',2); 
            plot(1:length(clim1.obm_gy_chl_b_ft_3),upper_bound_plt,'r-','linew',2);
            plot(1:length(clim1.obm_gy_chl_b_ft_3),lower_bound_plt,'r-','linew',2);
    ...
    % data(1:length(c2004.gy_temp_b))=c2004.gy_temp_b; 
            plot(nanmean(mer_temp_b_3,1),'b','linew',2);
            clearvars *_bound_plt nonan_data_plt discon_p temp_b_d
            temp_b_d=nanmean(mer_temp_b_3,1);
            nonan_data_plt = find(isnan(temp_b_d)==0);
            nonan_diff=nonan_data_plt(2:end) - nonan_data_plt(1:end-1);
            upper_bound_plt = temp_b_d + regm_std_temp_b_3;
            lower_bound_plt = temp_b_d - regm_std_temp_b_3;
            patch([nonan_data_plt fliplr(nonan_data_plt)], [upper_bound_plt fliplr(lower_bound_plt)],[0.5 0.5 0.5]);
    % plot(nanmean([c1997.gy_temp_b; c1998.gy_temp_b; c1999.gy_temp_b; c2000.gy_temp_b; c2001.gy_temp_b; c2002.gy_temp_b; c2003.gy_temp_b;],1),'b','linew',2);
                   clearvars *_bound_plt nonan_data_plt discon_p
            nonan_data_plt = find(isnan(clim1.obm_gy_temp_b_ft_3)==0);
            nonan_diff=nonan_data_plt(2:end) - nonan_data_plt(1:end-1);
            discon_p = find(nonan_diff ~= 1); % find discontinuous point
            discon_p(4) = length(nonan_data_plt); %end point
            upper_bound_plt = clim1.obm_gy_temp_b_ft_3 + clim1.obs_std_gy_temp_b_ft_3;
            lower_bound_plt = clim1.obm_gy_temp_b_ft_3 - clim1.obs_std_gy_temp_b_ft_3;
            for i = 1:4
            if i == 1
            patch([nonan_data_plt(1:discon_p(1)) fliplr(nonan_data_plt(1:discon_p(1)))], [upper_bound_plt(nonan_data_plt(1:discon_p(1))) fliplr(lower_bound_plt(nonan_data_plt(1:discon_p(1))))],'r');
            else
            ...
            plot(clim1.obm_gy_temp_b_ft_3,'r-','linew',2); 
            plot(1:length(clim1.obm_gy_temp_b_ft_3),upper_bound_plt,'r-','linew',2);
            plot(1:length(clim1.obm_gy_temp_b_ft_3),lower_bound_plt,'r-','linew',2);
    ...
    % data(1:length(c2004.gy_salt_b))=c2004.gy_salt_b; 
            plot(nanmean(mer_salt_b_3,1),'b','linew',2);
            clearvars *_bound_plt nonan_data_plt discon_p salt_b_d
            salt_b_d=nanmean(mer_salt_b_3,1);
            nonan_data_plt = find(isnan(salt_b_d)==0);
            nonan_diff=nonan_data_plt(2:end) - nonan_data_plt(1:end-1);
            upper_bound_plt = salt_b_d + regm_std_salt_b_3;
            lower_bound_plt = salt_b_d - regm_std_salt_b_3;
            patch([nonan_data_plt fliplr(nonan_data_plt)], [upper_bound_plt fliplr(lower_bound_plt)],[0.5 0.5 0.5]);
    %         plot(nanmean([c1997.gy_salt_b; c1998.gy_salt_b; c1999.gy_salt_b; c2000.gy_salt_b; c2001.gy_salt_b; c2002.gy_salt_b; c2003.gy_salt_b;],1),'b','linew',2);
                   clearvars *_bound_plt nonan_data_plt discon_p
            nonan_data_plt = find(isnan(clim1.obm_gy_salt_b_ft_3)==0);
            nonan_diff=nonan_data_plt(2:end) - nonan_data_plt(1:end-1);
            discon_p = find(nonan_diff ~= 1); % find discontinuous point
            discon_p(4) = length(nonan_data_plt); %end point
            upper_bound_plt = clim1.obm_gy_salt_b_ft_3 + clim1.obs_std_gy_salt_b_ft_3;
            lower_bound_plt = clim1.obm_gy_salt_b_ft_3 - clim1.obs_std_gy_salt_b_ft_3;
            for i = 1:4
            if i == 1
            patch([nonan_data_plt(1:discon_p(1)) fliplr(nonan_data_plt(1:discon_p(1)))], [upper_bound_plt(nonan_data_plt(1:discon_p(1))) fliplr(lower_bound_plt(nonan_data_plt(1:discon_p(1))))],'r');
            else
            ...
            plot(clim1.obm_gy_salt_b_ft_3,'r-','linew',2); 
            plot(1:length(clim1.obm_gy_salt_b_ft_3),upper_bound_plt,'r-','linew',2);
            plot(1:length(clim1.obm_gy_salt_b_ft_3),lower_bound_plt,'r-','linew',2);
...
elseif case_num==2
    ...
    %         plot(nanmean([c1997.gy_no3_3; c1998.gy_no3_3; c1999.gy_no3_3; c2000.gy_no3_3; c2001.gy_no3_3; c2002.gy_no3_3; c2003.gy_no3_3;],1),'b','linew',2);
            ...
            nonan_data_plt = find(isnan(temp_d)==0);
            nonan_diff=nonan_data_plt(2:end) - nonan_data_plt(1:end-1);
            upper_bound_plt = temp_d + spm_regm_std_no3_3;
            lower_bound_plt = temp_d - spm_regm_std_no3_3;
            patch([nonan_data_plt fliplr(nonan_data_plt)], [upper_bound_plt fliplr(lower_bound_plt)],[0.5 0.5 0.5]);
            ...
            discon_p = find(nonan_diff ~= 1); % find discontinuous point
            discon_p(4) = length(nonan_data_plt); %end point
            upper_bound_plt = clim1.obm_gy_no3_ft_3./14 + clim1.spm_obs_std_gy_no3_ft_3./14;
            lower_bound_plt = clim1.obm_gy_no3_ft_3./14 - clim1.spm_obs_std_gy_no3_ft_3./14;
            for i = 1:4
            if i == 1
            patch([nonan_data_plt(1:discon_p(1)) fliplr(nonan_data_plt(1:discon_p(1)))], [upper_bound_plt(nonan_data_plt(1:discon_p(1))) fliplr(lower_bound_plt(nonan_data_plt(1:discon_p(1))))],'r');
            else
    ...
    % data(1:length(c2004.gy_nh4))=c2004.gy_nh4_3; 
            ...
            nonan_data_plt = find(isnan(temp_d)==0);
            nonan_diff=nonan_data_plt(2:end) - nonan_data_plt(1:end-1);
            upper_bound_plt = temp_d + spm_regm_std_nh4_3;
            lower_bound_plt = temp_d - spm_regm_std_nh4_3;
            patch([nonan_data_plt fliplr(nonan_data_plt)], [upper_bound_plt fliplr(lower_bound_plt)],[0.5 0.5 0.5]);
    %         plot(nanmean([c1997.gy_nh4_3; c1998.gy_nh4_3; c1999.gy_nh4_3; c2000.gy_nh4_3; c2001.gy_nh4_3; c2002.gy_nh4_3; c2003.gy_nh4_3;],1),'b','linew',2);
                   clearvars *_bound_plt nonan_data_plt discon_p
            nonan_data_plt = find(isnan(clim1.obm_gy_nh4_ft_3)==0);
            ...
            discon_p = find(nonan_diff ~= 1); % find discontinuous point
            discon_p(4) = length(nonan_data_plt); %end point
            upper_bound_plt = clim1.obm_gy_nh4_ft_3./14 + clim1.spm_obs_std_gy_nh4_ft_3./14;
            lower_bound_plt = clim1.obm_gy_nh4_ft_3./14 - clim1.spm_obs_std_gy_nh4_ft_3./14;
            for i = 1:4
            if i == 1
            patch([nonan_data_plt(1:discon_p(1)) fliplr(nonan_data_plt(1:discon_p(1)))], [upper_bound_plt(nonan_data_plt(1:discon_p(1))) fliplr(lower_bound_plt(nonan_data_plt(1:discon_p(1))))],'r');
            else
    ...
    % data(1:length(c2004.gy_chl))=c2004.gy_chl_3; 
            ...
            nonan_data_plt = find(isnan(temp_d)==0);
            nonan_diff=nonan_data_plt(2:end) - nonan_data_plt(1:end-1);
            upper_bound_plt = temp_d + spm_regm_std_chl_3;
            lower_bound_plt = temp_d - spm_regm_std_chl_3;
            patch([nonan_data_plt fliplr(nonan_data_plt)], [upper_bound_plt fliplr(lower_bound_plt)],[0.5 0.5 0.5]);
    %         plot(nanmean([c1997.gy_chl_3; c1998.gy_chl_3; c1999.gy_chl_3; c2000.gy_chl_3; c2001.gy_chl_3; c2002.gy_chl_3; c2003.gy_chl_3;],1),'b','linew',2);
                   clearvars *_bound_plt nonan_data_plt discon_p
            nonan_data_plt = find(isnan(clim1.obm_gy_chl_ft_3)==0);
            ...
            discon_p = find(nonan_diff ~= 1); % find discontinuous point
            discon_p(4) = length(nonan_data_plt); %end point
            upper_bound_plt = clim1.obm_gy_chl_ft_3 + clim1.spm_obs_std_gy_chl_ft_3;
            lower_bound_plt = clim1.obm_gy_chl_ft_3 - clim1.spm_obs_std_gy_chl_ft_3;
            for i = 1:4
            if i == 1
            patch([nonan_data_plt(1:discon_p(1)) fliplr(nonan_data_plt(1:discon_p(1)))], [upper_bound_plt(nonan_data_plt(1:discon_p(1))) fliplr(lower_bound_plt(nonan_data_plt(1:discon_p(1))))],'r');
            else
    ...
    % data(1:length(c2004.gy_temp))=c2004.gy_temp_3;
            ...
            nonan_data_plt = find(isnan(temp_d)==0);
            nonan_diff=nonan_data_plt(2:end) - nonan_data_plt(1:end-1);
            upper_bound_plt = temp_d + spm_regm_std_temp_3;
            lower_bound_plt = temp_d - spm_regm_std_temp_3;
            patch([nonan_data_plt fliplr(nonan_data_plt)], [upper_bound_plt fliplr(lower_bound_plt)],[0.5 0.5 0.5]);
    %         plot(nanmean([c1997.gy_temp_3; c1998.gy_temp_3; c1999.gy_temp_3; c2000.gy_temp_3; c2001.gy_temp_3; c2002.gy_temp_3; c2003.gy_temp_3;],1),'b','linew',2);
                   clearvars *_bound_plt nonan_data_plt discon_p
            nonan_data_plt = find(isnan(clim1.obm_gy_temp_ft_3)==0);
            ...
            discon_p = find(nonan_diff ~= 1); % find discontinuous point
            discon_p(4) = length(nonan_data_plt); %end point
            upper_bound_plt = clim1.obm_gy_temp_ft_3 + clim1.spm_obs_std_gy_temp_ft_3;
            lower_bound_plt = clim1.obm_gy_temp_ft_3 - clim1.spm_obs_std_gy_temp_ft_3;
            for i = 1:4
            if i == 1
            patch([nonan_data_plt(1:discon_p(1)) fliplr(nonan_data_plt(1:discon_p(1)))], [upper_bound_plt(nonan_data_plt(1:discon_p(1))) fliplr(lower_bound_plt(nonan_data_plt(1:discon_p(1))))],'r');
            else
    ...
    % data(1:length(c2004.gy_salt))=c2004.gy_salt_3; 
            ...
            nonan_data_plt = find(isnan(salt_d)==0);
            nonan_diff=nonan_data_plt(2:end) - nonan_data_plt(1:end-1);
            upper_bound_plt = salt_d + spm_regm_std_salt_3;
            lower_bound_plt = salt_d - spm_regm_std_salt_3;
            patch([nonan_data_plt fliplr(nonan_data_plt)], [upper_bound_plt fliplr(lower_bound_plt)],[0.5 0.5 0.5]);
    %         plot(nanmean([c1997.gy_salt_3; c1998.gy_salt_3; c1999.gy_salt_3; c2000.gy_salt_3; c2001.gy_salt_3; c2002.gy_salt_3; c2003.gy_salt_3;],1),'b','linew',2);
                   clearvars *_bound_plt nonan_data_plt discon_p
            nonan_data_plt = find(isnan(clim1.obm_gy_salt_ft_3)==0);
            ...
            discon_p = find(nonan_diff ~= 1); % find discontinuous point
            discon_p(4) = length(nonan_data_plt); %end point
            upper_bound_plt = clim1.obm_gy_salt_ft_3 + clim1.spm_obs_std_gy_salt_ft_3;
            lower_bound_plt = clim1.obm_gy_salt_ft_3 - clim1.spm_obs_std_gy_salt_ft_3;
            for i = 1:4
            if i == 1
            patch([nonan_data_plt(1:discon_p(1)) fliplr(nonan_data_plt(1:discon_p(1)))], [upper_bound_plt(nonan_data_plt(1:discon_p(1))) fliplr(lower_bound_plt(nonan_data_plt(1:discon_p(1))))],'r');
            else
    ...
    % data(1:length(c2004.gy_no3_b))=c2004.gy_no3_b_3; 
            ...
            nonan_data_plt = find(isnan(no3_b_d)==0);
            nonan_diff=nonan_data_plt(2:end) - nonan_data_plt(1:end-1);
            upper_bound_plt = no3_b_d + spm_regm_std_no3_b_3;
            lower_bound_plt = no3_b_d - spm_regm_std_no3_b_3;
            patch([nonan_data_plt fliplr(nonan_data_plt)], [upper_bound_plt fliplr(lower_bound_plt)],[0.5 0.5 0.5]);
    %         plot(nanmean([c1997.gy_no3_b_3; c1998.gy_no3_b_3; c1999.gy_no3_b_3; c2000.gy_no3_b_3; c2001.gy_no3_b_3; c2002.gy_no3_b_3; c2003.gy_no3_b_3;],1),'b','linew',2);
                   clearvars *_bound_plt nonan_data_plt discon_p
            nonan_data_plt = find(isnan(clim1.obm_gy_no3_b_ft_3)==0);
            ...
            discon_p = find(nonan_diff ~= 1); % find discontinuous point
            discon_p(4) = length(nonan_data_plt); %end point
            upper_bound_plt = clim1.obm_gy_no3_b_ft_3./14 + clim1.spm_obs_std_gy_no3_b_ft_3./14;
            lower_bound_plt = clim1.obm_gy_no3_b_ft_3./14 - clim1.spm_obs_std_gy_no3_b_ft_3./14;
            for i = 1:4
            if i == 1
            patch([nonan_data_plt(1:discon_p(1)) fliplr(nonan_data_plt(1:discon_p(1)))], [upper_bound_plt(nonan_data_plt(1:discon_p(1))) fliplr(lower_bound_plt(nonan_data_plt(1:discon_p(1))))],'r');
            else
    ...
    % data(1:length(c2004.gy_nh4_b))=c2004.gy_nh4_b; 
            ...
            nonan_data_plt = find(isnan(nh4_b_d)==0);
            nonan_diff=nonan_data_plt(2:end) - nonan_data_plt(1:end-1);
            upper_bound_plt = nh4_b_d + spm_regm_std_nh4_b_3;
            lower_bound_plt = nh4_b_d - spm_regm_std_nh4_b_3;
            patch([nonan_data_plt fliplr(nonan_data_plt)], [upper_bound_plt fliplr(lower_bound_plt)],[0.5 0.5 0.5]);
    %         plot(nanmean([c1997.gy_nh4_b; c1998.gy_nh4_b; c1999.gy_nh4_b; c2000.gy_nh4_b; c2001.gy_nh4_b; c2002.gy_nh4_b; c2003.gy_nh4_b;],1),'b','linew',2);
                   clearvars *_bound_plt nonan_data_plt discon_p
            nonan_data_plt = find(isnan(clim1.obm_gy_nh4_b_ft_3)==0);
            ...
            discon_p = find(nonan_diff ~= 1); % find discontinuous point
            discon_p(4) = length(nonan_data_plt); %end point
            upper_bound_plt = clim1.obm_gy_nh4_b_ft_3./14 + clim1.spm_obs_std_gy_nh4_b_ft_3./14;
            lower_bound_plt = clim1.obm_gy_nh4_b_ft_3./14 - clim1.spm_obs_std_gy_nh4_b_ft_3./14;
            for i = 1:4
            if i == 1
            patch([nonan_data_plt(1:discon_p(1)) fliplr(nonan_data_plt(1:discon_p(1)))], [upper_bound_plt(nonan_data_plt(1:discon_p(1))) fliplr(lower_bound_plt(nonan_data_plt(1:discon_p(1))))],'r');
            else
    ...
    % data(1:length(c2004.gy_chl_b))=c2004.gy_chl_b; 
            ...
            nonan_data_plt = find(isnan(chl_b_d)==0);
            nonan_diff=nonan_data_plt(2:end) - nonan_data_plt(1:end-1);
            upper_bound_plt = chl_b_d + spm_regm_std_chl_b_3;
            lower_bound_plt = chl_b_d - spm_regm_std_chl_b_3;
            patch([nonan_data_plt fliplr(nonan_data_plt)], [upper_bound_plt fliplr(lower_bound_plt)],[0.5 0.5 0.5]);
    %         plot(nanmean([c1997.gy_chl_b; c1998.gy_chl_b; c1999.gy_chl_b; c2000.gy_chl_b; c2001.gy_chl_b; c2002.gy_chl_b; c2003.gy_chl_b;],1),'b','linew',2);
                   clearvars *_bound_plt nonan_data_plt discon_p
            nonan_data_plt = find(isnan(clim1.obm_gy_chl_b_ft_3)==0);
            ...
            discon_p = find(nonan_diff ~= 1); % find discontinuous point
            discon_p(4) = length(nonan_data_plt); %end point
            upper_bound_plt = clim1.obm_gy_chl_b_ft_3 + clim1.spm_obs_std_gy_chl_b_ft_3;
            lower_bound_plt = clim1.obm_gy_chl_b_ft_3 - clim1.spm_obs_std_gy_chl_b_ft_3;
            for i = 1:4
            if i == 1
            patch([nonan_data_plt(1:discon_p(1)) fliplr(nonan_data_plt(1:discon_p(1)))], [upper_bound_plt(nonan_data_plt(1:discon_p(1))) fliplr(lower_bound_plt(nonan_data_plt(1:discon_p(1))))],'r');
            else
    ...
    % data(1:length(c2004.gy_temp_b))=c2004.gy_temp_b; 
            ...
            nonan_data_plt = find(isnan(temp_b_d)==0);
            nonan_diff=nonan_data_plt(2:end) - nonan_data_plt(1:end-1);
            upper_bound_plt = temp_b_d + spm_regm_std_temp_b_3;
            lower_bound_plt = temp_b_d - spm_regm_std_temp_b_3;
            patch([nonan_data_plt fliplr(nonan_data_plt)], [upper_bound_plt fliplr(lower_bound_plt)],[0.5 0.5 0.5]);
    % plot(nanmean([c1997.gy_temp_b; c1998.gy_temp_b; c1999.gy_temp_b; c2000.gy_temp_b; c2001.gy_temp_b; c2002.gy_temp_b; c2003.gy_temp_b;],1),'b','linew',2);
                   clearvars *_bound_plt nonan_data_plt discon_p
            nonan_data_plt = find(isnan(clim1.obm_gy_temp_b_ft_3)==0);
            ...
            discon_p = find(nonan_diff ~= 1); % find discontinuous point
            discon_p(4) = length(nonan_data_plt); %end point
            upper_bound_plt = clim1.obm_gy_temp_b_ft_3 + clim1.spm_obs_std_gy_temp_b_ft_3;
            lower_bound_plt = clim1.obm_gy_temp_b_ft_3 - clim1.spm_obs_std_gy_temp_b_ft_3;
            for i = 1:4
            if i == 1
            patch([nonan_data_plt(1:discon_p(1)) fliplr(nonan_data_plt(1:discon_p(1)))], [upper_bound_plt(nonan_data_plt(1:discon_p(1))) fliplr(lower_bound_plt(nonan_data_plt(1:discon_p(1))))],'r');
            else
    ...
    % data(1:length(c2004.gy_salt_b))=c2004.gy_salt_b; 
            ...
            nonan_data_plt = find(isnan(salt_b_d)==0);
            nonan_diff=nonan_data_plt(2:end) - nonan_data_plt(1:end-1);
            upper_bound_plt = salt_b_d + spm_regm_std_salt_b_3;
            lower_bound_plt = salt_b_d - spm_regm_std_salt_b_3;
            patch([nonan_data_plt fliplr(nonan_data_plt)], [upper_bound_plt fliplr(lower_bound_plt)],[0.5 0.5 0.5]);
    %         plot(nanmean([c1997.gy_salt_b; c1998.gy_salt_b; c1999.gy_salt_b; c2000.gy_salt_b; c2001.gy_salt_b; c2002.gy_salt_b; c2003.gy_salt_b;],1),'b','linew',2);
                   clearvars *_bound_plt nonan_data_plt discon_p
            nonan_data_plt = find(isnan(clim1.obm_gy_salt_b_ft_3)==0);
            ...
            discon_p = find(nonan_diff ~= 1); % find discontinuous point
            discon_p(4) = length(nonan_data_plt); %end point
            upper_bound_plt = clim1.obm_gy_salt_b_ft_3 + clim1.spm_obs_std_gy_salt_b_ft_3;
            lower_bound_plt = clim1.obm_gy_salt_b_ft_3 - clim1.spm_obs_std_gy_salt_b_ft_3;
            for i = 1:4
            if i == 1
            patch([nonan_data_plt(1:discon_p(1)) fliplr(nonan_data_plt(1:discon_p(1)))], [upper_bound_plt(nonan_data_plt(1:discon_p(1))) fliplr(lower_bound_plt(nonan_data_plt(1:discon_p(1))))],'r');
            else
...
elseif case_num == 3
    ...
    %         plot(nanmean([c1997.gy_no3_3; c1998.gy_no3_3; c1999.gy_no3_3; c2000.gy_no3_3; c2001.gy_no3_3; c2002.gy_no3_3; c2003.gy_no3_3;],1),'b','linew',2);
            ...
            nonan_data_plt = find(isnan(temp_d)==0);
            nonan_diff=nonan_data_plt(2:end) - nonan_data_plt(1:end-1);
            upper_bound_plt = temp_d + tm_regm_std_no3_3;
            lower_bound_plt = temp_d - tm_regm_std_no3_3;
            patch([nonan_data_plt fliplr(nonan_data_plt)], [upper_bound_plt fliplr(lower_bound_plt)],[0.5 0.5 0.5]);
            ...
            discon_p = find(nonan_diff ~= 1); % find discontinuous point
            discon_p(4) = length(nonan_data_plt); %end point
            upper_bound_plt = clim1.obm_gy_no3_ft_3./14 + clim1.tm_obs_std_gy_no3_ft_3./14;
            lower_bound_plt = clim1.obm_gy_no3_ft_3./14 - clim1.tm_obs_std_gy_no3_ft_3./14;
            for i = 1:4
            if i == 1
            patch([nonan_data_plt(1:discon_p(1)) fliplr(nonan_data_plt(1:discon_p(1)))], [upper_bound_plt(nonan_data_plt(1:discon_p(1))) fliplr(lower_bound_plt(nonan_data_plt(1:discon_p(1))))],'r');
            else
    ...
    % data(1:length(c2004.gy_nh4))=c2004.gy_nh4_3; 
            ...
            nonan_data_plt = find(isnan(temp_d)==0);
            nonan_diff=nonan_data_plt(2:end) - nonan_data_plt(1:end-1);
            upper_bound_plt = temp_d + tm_regm_std_nh4_3;
            lower_bound_plt = temp_d - tm_regm_std_nh4_3;
            patch([nonan_data_plt fliplr(nonan_data_plt)], [upper_bound_plt fliplr(lower_bound_plt)],[0.5 0.5 0.5]);
    %         plot(nanmean([c1997.gy_nh4_3; c1998.gy_nh4_3; c1999.gy_nh4_3; c2000.gy_nh4_3; c2001.gy_nh4_3; c2002.gy_nh4_3; c2003.gy_nh4_3;],1),'b','linew',2);
                   clearvars *_bound_plt nonan_data_plt discon_p
            nonan_data_plt = find(isnan(clim1.obm_gy_nh4_ft_3)==0);
            ...
            discon_p = find(nonan_diff ~= 1); % find discontinuous point
            discon_p(4) = length(nonan_data_plt); %end point
            upper_bound_plt = clim1.obm_gy_nh4_ft_3./14 + clim1.tm_obs_std_gy_nh4_ft_3./14;
            lower_bound_plt = clim1.obm_gy_nh4_ft_3./14 - clim1.tm_obs_std_gy_nh4_ft_3./14;
            for i = 1:4
            if i == 1
            patch([nonan_data_plt(1:discon_p(1)) fliplr(nonan_data_plt(1:discon_p(1)))], [upper_bound_plt(nonan_data_plt(1:discon_p(1))) fliplr(lower_bound_plt(nonan_data_plt(1:discon_p(1))))],'r');
            else
    ...
    % data(1:length(c2004.gy_chl))=c2004.gy_chl_3; 
            ...
            nonan_data_plt = find(isnan(temp_d)==0);
            nonan_diff=nonan_data_plt(2:end) - nonan_data_plt(1:end-1);
            upper_bound_plt = temp_d + tm_regm_std_chl_3;
            lower_bound_plt = temp_d - tm_regm_std_chl_3;
            patch([nonan_data_plt fliplr(nonan_data_plt)], [upper_bound_plt fliplr(lower_bound_plt)],[0.5 0.5 0.5]);
    %         plot(nanmean([c1997.gy_chl_3; c1998.gy_chl_3; c1999.gy_chl_3; c2000.gy_chl_3; c2001.gy_chl_3; c2002.gy_chl_3; c2003.gy_chl_3;],1),'b','linew',2);
                   clearvars *_bound_plt nonan_data_plt discon_p
            nonan_data_plt = find(isnan(clim1.obm_gy_chl_ft_3)==0);
            ...
            discon_p = find(nonan_diff ~= 1); % find discontinuous point
            discon_p(4) = length(nonan_data_plt); %end point
            upper_bound_plt = clim1.obm_gy_chl_ft_3 + clim1.tm_obs_std_gy_chl_ft_3;
            lower_bound_plt = clim1.obm_gy_chl_ft_3 - clim1.tm_obs_std_gy_chl_ft_3;
            for i = 1:4
            if i == 1
            patch([nonan_data_plt(1:discon_p(1)) fliplr(nonan_data_plt(1:discon_p(1)))], [upper_bound_plt(nonan_data_plt(1:discon_p(1))) fliplr(lower_bound_plt(nonan_data_plt(1:discon_p(1))))],'r');
            else
    ...
    % data(1:length(c2004.gy_temp))=c2004.gy_temp_3;
            ...
            nonan_data_plt = find(isnan(temp_d)==0);
            nonan_diff=nonan_data_plt(2:end) - nonan_data_plt(1:end-1);
            upper_bound_plt = temp_d + tm_regm_std_temp_3;
            lower_bound_plt = temp_d - tm_regm_std_temp_3;
            patch([nonan_data_plt fliplr(nonan_data_plt)], [upper_bound_plt fliplr(lower_bound_plt)],[0.5 0.5 0.5]);
    %         plot(nanmean([c1997.gy_temp_3; c1998.gy_temp_3; c1999.gy_temp_3; c2000.gy_temp_3; c2001.gy_temp_3; c2002.gy_temp_3; c2003.gy_temp_3;],1),'b','linew',2);
                   clearvars *_bound_plt nonan_data_plt discon_p
            nonan_data_plt = find(isnan(clim1.obm_gy_temp_ft_3)==0);
            ...
            discon_p = find(nonan_diff ~= 1); % find discontinuous point
            discon_p(4) = length(nonan_data_plt); %end point
            upper_bound_plt = clim1.obm_gy_temp_ft_3 + clim1.tm_obs_std_gy_temp_ft_3;
            lower_bound_plt = clim1.obm_gy_temp_ft_3 - clim1.tm_obs_std_gy_temp_ft_3;
            for i = 1:4
            if i == 1
            patch([nonan_data_plt(1:discon_p(1)) fliplr(nonan_data_plt(1:discon_p(1)))], [upper_bound_plt(nonan_data_plt(1:discon_p(1))) fliplr(lower_bound_plt(nonan_data_plt(1:discon_p(1))))],'r');
            else
    ...
    % data(1:length(c2004.gy_salt))=c2004.gy_salt_3; 
            ...
            nonan_data_plt = find(isnan(salt_d)==0);
            nonan_diff=nonan_data_plt(2:end) - nonan_data_plt(1:end-1);
            upper_bound_plt = salt_d + tm_regm_std_salt_3;
            lower_bound_plt = salt_d - tm_regm_std_salt_3;
            patch([nonan_data_plt fliplr(nonan_data_plt)], [upper_bound_plt fliplr(lower_bound_plt)],[0.5 0.5 0.5]);
    %         plot(nanmean([c1997.gy_salt_3; c1998.gy_salt_3; c1999.gy_salt_3; c2000.gy_salt_3; c2001.gy_salt_3; c2002.gy_salt_3; c2003.gy_salt_3;],1),'b','linew',2);
                   clearvars *_bound_plt nonan_data_plt discon_p
            nonan_data_plt = find(isnan(clim1.obm_gy_salt_ft_3)==0);
            ...
            discon_p = find(nonan_diff ~= 1); % find discontinuous point
            discon_p(4) = length(nonan_data_plt); %end point
            upper_bound_plt = clim1.obm_gy_salt_ft_3 + clim1.tm_obs_std_gy_salt_ft_3;
            lower_bound_plt = clim1.obm_gy_salt_ft_3 - clim1.tm_obs_std_gy_salt_ft_3;
            for i = 1:4
            if i == 1
            patch([nonan_data_plt(1:discon_p(1)) fliplr(nonan_data_plt(1:discon_p(1)))], [upper_bound_plt(nonan_data_plt(1:discon_p(1))) fliplr(lower_bound_plt(nonan_data_plt(1:discon_p(1))))],'r');
            else
    ...
    % data(1:length(c2004.gy_no3_b))=c2004.gy_no3_b_3; 
            ...
            nonan_data_plt = find(isnan(no3_b_d)==0);
            nonan_diff=nonan_data_plt(2:end) - nonan_data_plt(1:end-1);
            upper_bound_plt = no3_b_d + tm_regm_std_no3_b_3;
            lower_bound_plt = no3_b_d - tm_regm_std_no3_b_3;
            patch([nonan_data_plt fliplr(nonan_data_plt)], [upper_bound_plt fliplr(lower_bound_plt)],[0.5 0.5 0.5]);
    %         plot(nanmean([c1997.gy_no3_b_3; c1998.gy_no3_b_3; c1999.gy_no3_b_3; c2000.gy_no3_b_3; c2001.gy_no3_b_3; c2002.gy_no3_b_3; c2003.gy_no3_b_3;],1),'b','linew',2);
                   clearvars *_bound_plt nonan_data_plt discon_p
            nonan_data_plt = find(isnan(clim1.obm_gy_no3_b_ft_3)==0);
            ...
            discon_p = find(nonan_diff ~= 1); % find discontinuous point
            discon_p(4) = length(nonan_data_plt); %end point
            upper_bound_plt = clim1.obm_gy_no3_b_ft_3./14 + clim1.tm_obs_std_gy_no3_b_ft_3./14;
            lower_bound_plt = clim1.obm_gy_no3_b_ft_3./14 - clim1.tm_obs_std_gy_no3_b_ft_3./14;
            for i = 1:4
            if i == 1
            patch([nonan_data_plt(1:discon_p(1)) fliplr(nonan_data_plt(1:discon_p(1)))], [upper_bound_plt(nonan_data_plt(1:discon_p(1))) fliplr(lower_bound_plt(nonan_data_plt(1:discon_p(1))))],'r');
            else
    ...
    % data(1:length(c2004.gy_nh4_b))=c2004.gy_nh4_b; 
            ...
            nonan_data_plt = find(isnan(nh4_b_d)==0);
            nonan_diff=nonan_data_plt(2:end) - nonan_data_plt(1:end-1);
            upper_bound_plt = nh4_b_d + tm_regm_std_nh4_b_3;
            lower_bound_plt = nh4_b_d - tm_regm_std_nh4_b_3;
            patch([nonan_data_plt fliplr(nonan_data_plt)], [upper_bound_plt fliplr(lower_bound_plt)],[0.5 0.5 0.5]);
    %         plot(nanmean([c1997.gy_nh4_b; c1998.gy_nh4_b; c1999.gy_nh4_b; c2000.gy_nh4_b; c2001.gy_nh4_b; c2002.gy_nh4_b; c2003.gy_nh4_b;],1),'b','linew',2);
                   clearvars *_bound_plt nonan_data_plt discon_p
            nonan_data_plt = find(isnan(clim1.obm_gy_nh4_b_ft_3)==0);
            ...
            discon_p = find(nonan_diff ~= 1); % find discontinuous point
            discon_p(4) = length(nonan_data_plt); %end point
            upper_bound_plt = clim1.obm_gy_nh4_b_ft_3./14 + clim1.tm_obs_std_gy_nh4_b_ft_3./14;
            lower_bound_plt = clim1.obm_gy_nh4_b_ft_3./14 - clim1.tm_obs_std_gy_nh4_b_ft_3./14;
            for i = 1:4
            if i == 1
            patch([nonan_data_plt(1:discon_p(1)) fliplr(nonan_data_plt(1:discon_p(1)))], [upper_bound_plt(nonan_data_plt(1:discon_p(1))) fliplr(lower_bound_plt(nonan_data_plt(1:discon_p(1))))],'r');
            else
    ...
    % data(1:length(c2004.gy_chl_b))=c2004.gy_chl_b; 
            ...
            nonan_data_plt = find(isnan(chl_b_d)==0);
            nonan_diff=nonan_data_plt(2:end) - nonan_data_plt(1:end-1);
            upper_bound_plt = chl_b_d + tm_regm_std_chl_b_3;
            lower_bound_plt = chl_b_d - tm_regm_std_chl_b_3;
            patch([nonan_data_plt fliplr(nonan_data_plt)], [upper_bound_plt fliplr(lower_bound_plt)],[0.5 0.5 0.5]);
    %         plot(nanmean([c1997.gy_chl_b; c1998.gy_chl_b; c1999.gy_chl_b; c2000.gy_chl_b; c2001.gy_chl_b; c2002.gy_chl_b; c2003.gy_chl_b;],1),'b','linew',2);
                   clearvars *_bound_plt nonan_data_plt discon_p
            nonan_data_plt = find(isnan(clim1.obm_gy_chl_b_ft_3)==0);
            ...
            discon_p = find(nonan_diff ~= 1); % find discontinuous point
            discon_p(4) = length(nonan_data_plt); %end point
            upper_bound_plt = clim1.obm_gy_chl_b_ft_3 + clim1.tm_obs_std_gy_chl_b_ft_3;
            lower_bound_plt = clim1.obm_gy_chl_b_ft_3 - clim1.tm_obs_std_gy_chl_b_ft_3;
            for i = 1:4
            if i == 1
            patch([nonan_data_plt(1:discon_p(1)) fliplr(nonan_data_plt(1:discon_p(1)))], [upper_bound_plt(nonan_data_plt(1:discon_p(1))) fliplr(lower_bound_plt(nonan_data_plt(1:discon_p(1))))],'r');
            else
    ...
    % data(1:length(c2004.gy_temp_b))=c2004.gy_temp_b; 
            ...
            nonan_data_plt = find(isnan(temp_b_d)==0);
            nonan_diff=nonan_data_plt(2:end) - nonan_data_plt(1:end-1);
            upper_bound_plt = temp_b_d + tm_regm_std_temp_b_3;
            lower_bound_plt = temp_b_d - tm_regm_std_temp_b_3;
            patch([nonan_data_plt fliplr(nonan_data_plt)], [upper_bound_plt fliplr(lower_bound_plt)],[0.5 0.5 0.5]);
    % plot(nanmean([c1997.gy_temp_b; c1998.gy_temp_b; c1999.gy_temp_b; c2000.gy_temp_b; c2001.gy_temp_b; c2002.gy_temp_b; c2003.gy_temp_b;],1),'b','linew',2);
                   clearvars *_bound_plt nonan_data_plt discon_p
            nonan_data_plt = find(isnan(clim1.obm_gy_temp_b_ft_3)==0);
            ...
            discon_p = find(nonan_diff ~= 1); % find discontinuous point
            discon_p(4) = length(nonan_data_plt); %end point
            upper_bound_plt = clim1.obm_gy_temp_b_ft_3 + clim1.tm_obs_std_gy_temp_b_ft_3;
            lower_bound_plt = clim1.obm_gy_temp_b_ft_3 - clim1.tm_obs_std_gy_temp_b_ft_3;
            for i = 1:4
            if i == 1
            patch([nonan_data_plt(1:discon_p(1)) fliplr(nonan_data_plt(1:discon_p(1)))], [upper_bound_plt(nonan_data_plt(1:discon_p(1))) fliplr(lower_bound_plt(nonan_data_plt(1:discon_p(1))))],'r');
            else
    ...
    % data(1:length(c2004.gy_salt_b))=c2004.gy_salt_b; 
            ...
            nonan_data_plt = find(isnan(salt_b_d)==0);
            nonan_diff=nonan_data_plt(2:end) - nonan_data_plt(1:end-1);
            upper_bound_plt = salt_b_d + tm_regm_std_salt_b_3;
            lower_bound_plt = salt_b_d - tm_regm_std_salt_b_3;
            patch([nonan_data_plt fliplr(nonan_data_plt)], [upper_bound_plt fliplr(lower_bound_plt)],[0.5 0.5 0.5]);
    %         plot(nanmean([c1997.gy_salt_b; c1998.gy_salt_b; c1999.gy_salt_b; c2000.gy_salt_b; c2001.gy_salt_b; c2002.gy_salt_b; c2003.gy_salt_b;],1),'b','linew',2);
                   clearvars *_bound_plt nonan_data_plt discon_p
            nonan_data_plt = find(isnan(clim1.obm_gy_salt_b_ft_3)==0);
            ...
            discon_p = find(nonan_diff ~= 1); % find discontinuous point
            discon_p(4) = length(nonan_data_plt); %end point
            upper_bound_plt = clim1.obm_gy_salt_b_ft_3 + clim1.tm_obs_std_gy_salt_b_ft_3;
            lower_bound_plt = clim1.obm_gy_salt_b_ft_3 - clim1.tm_obs_std_gy_salt_b_ft_3;
            for i = 1:4
            if i == 1
            patch([nonan_data_plt(1:discon_p(1)) fliplr(nonan_data_plt(1:discon_p(1)))], [upper_bound_plt(nonan_data_plt(1:discon_p(1))) fliplr(lower_bound_plt(nonan_data_plt(1:discon_p(1))))],'r');
            else
