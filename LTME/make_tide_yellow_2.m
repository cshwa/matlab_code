...
%
tidename=['F:\ROMS\roms_tools\TPXO7\TPXO7.nc'];
frcname=['D:\장기생태\yellow_sea\yellow_tide_1991.nc'];
%
...
Yorig         = 1991;               % reference time for vector time
                                    % in roms initial and forcing files
%===================================================================
%
Ymin          = 1991;               % first forcing year
Ymax          = 1991;               % last  forcing year
...
% if (exist('tide_frc_name')==1)
    nc_make_tides(frcname,Ntides,date_mjd,components)
