...
Fname =['river_' num2str(t_year) 'th_reg_bio_sewer_det_nosew_highairT.nc'];
ss = 1:365;
cycle=ss(end);
...
%from ykang
sj = load('songjung_climate_days_bio_to07to16_high_airT.mat'); % 3regime climate (1997~2006, 2007~2015, 2016~2019);
