...
yr10_filter(find_date+1:find_date2 -1) = 1; % remove 2004~2018
yr10_filter(find_date2:length(ref_date)) = NaN; % remove 2004~2018
...
save('koem_climate_3regime_v2_2sig_gy_04to09.mat','obs*','obm*');
