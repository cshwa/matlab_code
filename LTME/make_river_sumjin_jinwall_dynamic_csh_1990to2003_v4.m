...
Fname =['river_' num2str(t_year) '_realts_biofennel_GY_jinwall.nc'];
...
sumjin_do = yp_est_do_adv'*0.7*44.661;
sumjin_chl = yp_est_chl_adv';
sumjin_no3 = yp_est_no3_adv';
sumjin_nh4 = yp_est_nh4_adv';
