...
for i = 1997:2019
    ...
    temp_sur=NaN(9,length(ref_date));
    temp_bot=NaN(9,length(ref_date));
    salt_sur=NaN(9,length(ref_date));
    salt_bot=NaN(9,length(ref_date));
    no3_sur=NaN(9,length(ref_date));
    no3_bot=NaN(9,length(ref_date));
    nh4_sur=NaN(9,length(ref_date));
    nh4_bot=NaN(9,length(ref_date));
    DIN_sur=NaN(9,length(ref_date));
    DIN_bot=NaN(9,length(ref_date));
    chl_sur=NaN(9,length(ref_date));
    chl_bot=NaN(9,length(ref_date));
    po4_sur=NaN(9,length(ref_date));
    po4_bot=NaN(9,length(ref_date));
    do_sur=NaN(9,length(ref_date));
    do_bot=NaN(9,length(ref_date)); 
    ss_sur=NaN(9,length(ref_date));
    ss_bot=NaN(9,length(ref_date)); 
    si_sur=NaN(9,length(ref_date));
    si_bot=NaN(9,length(ref_date)); 
    secchi_sur=NaN(9,length(ref_date));
...
for i = 1997:2019
    ...
    if i <= 2010
        ...
        col_si=[31. 32];
        col_secchi=[37];
        row_pick = [314, 136:140, 145:147]' - 2;
        sheet_tail = '_ppb';
    ...
    elseif i == 2013
        ...
        col_si=[37. 38];
        col_secchi=[43];
        row_pick = [354, 159:163, 171:173]'- 2;
        sheet_tail = [];
    elseif i >= 2014
        col_temp = [13, 14];
        col_salt = [15, 16];
        ...
        col_si=[37. 38];
        col_secchi=[43];
        row_pick = [384, 174:178, 186:188]'- 2;
        sheet_tail = [];
    end
...
%         ss_bot(:,obs_tdx(4))=NaN(9,1);
%         secchi_sur(:,obs_tdx(4))=NaN(9,1);
%     else
...
save('yoonjakangs_koem_data_monthly.mat');
