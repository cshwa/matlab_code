...
%% KOEM
%  from polynomial_fitting_on_ecological_variable_v3_3sig(boundary)_chl_2020.m
% there are 2 regimes for nh4 (KOEM 7st.)
koem=load('koem_input_fix_to06to15_3sig(3regime)_v7.mat'); 
if t_i == 1
...
%% it's kodc
%% from plot_KODC_7_20501_polynomial_to06to15.m
...
kodc205 = load('kodc_input_fix_to06to15_3sig(3regime)_20501_v7.mat');
...
%%  plot_KODC_7_40016_polynomial_to06to15.m
%  there are 3 regimes for no3 (KODC)
%  1997~2006, 2007~2015, 2016~2019
% kodc400=load('kodc_input_fix_to06to15_3sig(3regime)_40016.mat');
%  1997~2006, 2007~2015, 2016~2020
kodc400=load('kodc_input_fix_to06to15_3sig(3regime)_40016_v7.mat'); 
...
save(['boundary_bio_input_to06to15_',num2str(t_i),'regime_v7.mat'],'*_input*');
save(['boundary_bio_input_for_ini_to06to15_',num2str(t_i),'regime_v7.mat'],'*_in');
save(['check_boundary_no3_input_to06to15_',num2str(t_i),'regime_v7.mat'],'y_s_no3_205','y_b_no3_205');
end
