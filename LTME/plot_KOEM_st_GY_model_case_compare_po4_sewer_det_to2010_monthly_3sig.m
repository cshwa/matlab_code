...
c1997 = load('1997_monthly_result.mat','gy_*','jj_*','sgy_*','egy_*','std_*');
cd D:\장기생태\Dynamic\result\1998
c1998 = load('1998_monthly_result.mat','gy_*','jj_*','sgy_*','egy_*','std_*');
cd D:\장기생태\Dynamic\result\1999
c1999 = load('1999_monthly_result.mat','gy_*','jj_*','sgy_*','egy_*','std_*');
cd D:\장기생태\Dynamic\result\2000
c2000 = load('2000_monthly_result.mat','gy_*','jj_*','sgy_*','egy_*','std_*');
cd D:\장기생태\Dynamic\result\2001
c2001 = load('2001_monthly_result.mat','gy_*','jj_*','sgy_*','egy_*','std_*');
cd D:\장기생태\Dynamic\result\2002
c2002 = load('2002_monthly_result.mat','gy_*','jj_*','sgy_*','egy_*','std_*');
cd D:\장기생태\Dynamic\result\2003
c2003 = load('2003_monthly_result.mat','gy_*','jj_*','sgy_*','egy_*','std_*');
cd D:\장기생태\Dynamic\result\2004
c2004 = load('2004_monthly_result.mat','gy_*','jj_*','sgy_*','egy_*','std_*');
cd D:\장기생태\Dynamic\result\2005
c2005 = load('2005_monthly_result.mat','gy_*','jj_*','sgy_*','egy_*','std_*');
cd D:\장기생태\Dynamic\result\2006
c2006 = load('2006_monthly_result.mat','gy_*','jj_*','sgy_*','egy_*','std_*');
cd D:\장기생태\Dynamic\result\2007
c2007 = load('2007_monthly_result.mat','gy_*','jj_*','sgy_*','egy_*','std_*');
cd D:\장기생태\Dynamic\result\2008
c2008 = load('2008_monthly_result.mat','gy_*','jj_*','sgy_*','egy_*','std_*');
cd D:\장기생태\Dynamic\result\2009
c2009 = load('2009_monthly_result.mat','gy_*','jj_*','sgy_*','egy_*','std_*');
cd D:\장기생태\Dynamic\result\2010
c2010 = load('2010_monthly_result.mat','gy_*','jj_*','sgy_*','egy_*','std_*');
...
% % mpdata.gy_temp
cd D:\장기생태\Dynamic\KOEM\compare_sewer\det_1997~2010_monthly_3sig
...
%         plot(zeros(365,1),'g--','linew',2); % zero lines
        plot(mer_no3,'b','linew',2);
        clearvars *_bound_plt nonan_data_plt discon_p
        nonan_data_plt = find(isnan(mer_no3)==0);
        ...
        upper_bound_plt = mer_no3 + mer_std_no3;
        lower_bound_plt = mer_no3 - mer_std_no3;
...
%         end
        ...
        errorbar(clim1.obm_gy_no3./14,clim1.obs_std_gy_no3./14,'color','r','linew',1.5);
        plot(clim1.obm_gy_no3./14,'r+','linew',1.5); xlim([1 168]);
        ...
        ylim([0 70])
        set(gca,'fontsize',13)
        print(fig,strcat('1997~2010_month_KOEM_OBS_vs_MODEL_no3'),'-dpng')

fig = figure; hold on;
%         plot(zeros(365,1),'g--','linew',2); % zero lines
        plot(mer_nh4,'b','linew',2);
        clearvars *_bound_plt nonan_data_plt discon_p
        nonan_data_plt = find(isnan(mer_nh4)==0);
        nonan_diff=nonan_data_plt(2:end) - nonan_data_plt(1:end-1);
        discon_p = find(nonan_diff ~= 1); % find discontinuous point
        discon_p(end+1) = length(nonan_data_plt); %end point_ %end point
        upper_bound_plt = mer_nh4 + mer_std_nh4;
        lower_bound_plt = mer_nh4 - mer_std_nh4;
...
%         end
        ...
        errorbar(clim1.obm_gy_nh4./14,clim1.obs_std_gy_nh4./14,'color','r','linew',1.5);
        plot(clim1.obm_gy_nh4./14,'r+','linew',1.5); xlim([1 168]);
        alpha(0.3) %transparency
        ...
        ylim([0 14])
        set(gca,'fontsize',13)
        print(fig,strcat('1997~2010_month_KOEM_OBS_vs_MODEL_nh4'),'-dpng')
        
        
fig = figure; hold on;
%         plot(zeros(365,1),'g--','linew',2); % zero lines
        plot(mer_chl,'b','linew',2);
        clearvars *_bound_plt nonan_data_plt discon_p
        nonan_data_plt = find(isnan(mer_chl)==0);
        nonan_diff=nonan_data_plt(2:end) - nonan_data_plt(1:end-1);
        discon_p = find(nonan_diff ~= 1); % find discontinuous point
        discon_p(end+1) = length(nonan_data_plt); %end point_ %end point
        upper_bound_plt = mer_chl + mer_std_chl;
        lower_bound_plt = mer_chl - mer_std_chl;
...
%         end
        ...
        errorbar(clim1.obm_gy_chl,clim1.obs_std_gy_chl,'color','r','linew',1.5);
        plot(clim1.obm_gy_chl,'r+','linew',1.5); xlim([1 168]);
        alpha(0.3) %transparency
        ...
        ylim([0 15])
        set(gca,'fontsize',13)
        print(fig,strcat('1997~2010_month_KOEM_OBS_vs_MODEL_chl'),'-dpng')
        
        
 fig = figure; hold on;
%         plot(zeros(365,1),'g--','linew',2); % zero lines
        plot(mer_temp,'b','linew',2);
        clearvars *_bound_plt nonan_data_plt discon_p
        nonan_data_plt = find(isnan(mer_temp)==0);
        nonan_diff=nonan_data_plt(2:end) - nonan_data_plt(1:end-1);
        discon_p = find(nonan_diff ~= 1); % find discontinuous point
        discon_p(end+1) = length(nonan_data_plt); %end point_ %end point
        upper_bound_plt = mer_temp + mer_std_temp;
        lower_bound_plt = mer_temp - mer_std_temp;
...
%         end
        ...
        errorbar(clim1.obm_gy_temp,clim1.obs_std_gy_temp,'color','r','linew',1.5);
        plot(clim1.obm_gy_temp,'r+','linew',1.5); xlim([1 168]);
        alpha(0.3) %transparency
        ...
        ylim([0 35])
        set(gca,'fontsize',13)
        print(fig,strcat('1997~2010_month_KOEM_OBS_vs_MODEL_temp'),'-dpng')
        
        
fig = figure; hold on;
%         plot(zeros(365,1),'g--','linew',2); % zero lines
        plot(mer_salt,'b','linew',2);
        clearvars *_bound_plt nonan_data_plt discon_p
        nonan_data_plt = find(isnan(mer_salt)==0);
        nonan_diff=nonan_data_plt(2:end) - nonan_data_plt(1:end-1);
        discon_p = find(nonan_diff ~= 1); % find discontinuous point
        discon_p(end+1) = length(nonan_data_plt); %end point_ %end point
        upper_bound_plt = mer_salt + mer_std_salt;
        lower_bound_plt = mer_salt - mer_std_salt;
...
%         end
        ...
        errorbar(clim1.obm_gy_salt,clim1.obs_std_gy_salt,'color','r','linew',1.5);
        plot(clim1.obm_gy_salt,'r+','linew',1.5); xlim([1 168]);
        alpha(0.3) %transparency
        ...
        ylim([0 35])
        set(gca,'fontsize',13)
        print(fig,strcat('1997~2010_month_KOEM_OBS_vs_MODEL_salt'),'-dpng') 
        
        %% bot
 
 fig = figure; hold on;
%         plot(zeros(365,1),'g--','linew',2); % zero lines
        plot(mer_no3_b,'b','linew',2);
        clearvars *_bound_plt nonan_data_plt discon_p
        nonan_data_plt = find(isnan(mer_no3_b)==0);
        nonan_diff=nonan_data_plt(2:end) - nonan_data_plt(1:end-1);
        discon_p = find(nonan_diff ~= 1); % find discontinuous point
        discon_p(end+1) = length(nonan_data_plt); %end point_ %end point
        upper_bound_plt = mer_no3_b + mer_std_no3_b;
        lower_bound_plt = mer_no3_b - mer_std_no3_b;
...
%         end
        ...
        errorbar(clim1.obm_gy_no3_b./14,clim1.obs_std_gy_no3_b./14,'color','r','linew',1.5);
        plot(clim1.obm_gy_no3_b./14,'r+','linew',1.5); xlim([1 168]);
        alpha(0.3) %transparency
        ...
        ylim([0 70])
        set(gca,'fontsize',13)
        print(fig,strcat('1997~2010_month_KOEM_OBS_vs_MODEL_no3_b'),'-dpng')

fig = figure; hold on;
%         plot(zeros(365,1),'g--','linew',2); % zero lines
        plot(mer_nh4_b,'b','linew',2);
        clearvars *_bound_plt nonan_data_plt discon_p
        nonan_data_plt = find(isnan(mer_nh4_b)==0);
        nonan_diff=nonan_data_plt(2:end) - nonan_data_plt(1:end-1);
        discon_p = find(nonan_diff ~= 1); % find discontinuous point
        discon_p(end+1) = length(nonan_data_plt); %end point_ %end point
        upper_bound_plt = mer_nh4_b + mer_std_nh4_b;
        lower_bound_plt = mer_nh4_b - mer_std_nh4_b;
...
%         end
        ...
        errorbar(clim1.obm_gy_nh4_b./14,clim1.obs_std_gy_nh4_b./14,'color','r','linew',1.5);
        plot(clim1.obm_gy_nh4_b./14,'r+','linew',1.5); xlim([1 168]);
        alpha(0.3) %transparency
        ...
        ylim([0 14])
        set(gca,'fontsize',13)
        print(fig,strcat('1997~2010_month_KOEM_OBS_vs_MODEL_nh4_b'),'-dpng')
        
        
fig = figure; hold on;
%         plot(zeros(365,1),'g--','linew',2); % zero lines
        plot(mer_chl_b,'b','linew',2);
        clearvars *_bound_plt nonan_data_plt discon_p
        nonan_data_plt = find(isnan(mer_chl_b)==0);
        nonan_diff=nonan_data_plt(2:end) - nonan_data_plt(1:end-1);
        discon_p = find(nonan_diff ~= 1); % find discontinuous point
        discon_p(end+1) = length(nonan_data_plt); %end point_ %end point
        upper_bound_plt = mer_chl_b + mer_std_chl_b;
        lower_bound_plt = mer_chl_b - mer_std_chl_b;
...
%         end
        ...
        errorbar(clim1.obm_gy_chl_b,clim1.obs_std_gy_chl_b,'color','r','linew',1.5);
        plot(clim1.obm_gy_chl_b,'r+','linew',1.5); xlim([1 168]);
        alpha(0.3) %transparency
        ...
        ylim([0 15])
        set(gca,'fontsize',13)
        print(fig,strcat('1997~2010_month_KOEM_OBS_vs_MODEL_chl_b'),'-dpng')
        
        
 fig = figure; hold on;
%         plot(zeros(365,1),'g--','linew',2); % zero lines
        plot(mer_temp_b,'b','linew',2);
        clearvars *_bound_plt nonan_data_plt discon_p
        nonan_data_plt = find(isnan(mer_temp_b)==0);
        nonan_diff=nonan_data_plt(2:end) - nonan_data_plt(1:end-1);
        discon_p = find(nonan_diff ~= 1); % find discontinuous point
        discon_p(end+1) = length(nonan_data_plt); %end point_ %end point
        upper_bound_plt = mer_temp_b + mer_std_temp_b;
        lower_bound_plt = mer_temp_b - mer_std_temp_b;
...
%         end
        ...
        errorbar(clim1.obm_gy_temp_b,clim1.obs_std_gy_temp_b,'color','r','linew',1.5);
        plot(clim1.obm_gy_temp_b,'r+','linew',1.5); xlim([1 168]);
        alpha(0.3) %transparency
        ...
        ylim([0 35])
        set(gca,'fontsize',13)
        print(fig,strcat('1997~2010_month_KOEM_OBS_vs_MODEL_temp_b'),'-dpng')
        
        
fig = figure; hold on;
%         plot(zeros(365,1),'g--','linew',2); % zero lines
        plot(mer_salt_b,'b','linew',2);
        clearvars *_bound_plt nonan_data_plt discon_p
        nonan_data_plt = find(isnan(mer_salt_b)==0);
        nonan_diff=nonan_data_plt(2:end) - nonan_data_plt(1:end-1);
        discon_p = find(nonan_diff ~= 1); % find discontinuous point
        discon_p(end+1) = length(nonan_data_plt); %end point_ %end point
        upper_bound_plt = mer_salt_b + mer_std_salt_b;
        lower_bound_plt = mer_salt_b - mer_std_salt_b;
...
%         end
        ...
        errorbar(clim1.obm_gy_salt_b,clim1.obs_std_gy_salt_b,'color','r','linew',1.5);
        plot(clim1.obm_gy_salt_b,'r+','linew',1.5); xlim([1 168]);
        alpha(0.3) %transparency
        ...
        ylim([0 35])
        set(gca,'fontsize',13)
        print(fig,strcat('1997~2010_month_KOEM_OBS_vs_MODEL_salt_b'),'-dpng') 
