function status=vec_ROMS_monthly_surface_UV(testname, outfile, filedir, lonlat, tempyear, inputmonth, var, regionflag, param_script)
...
%                 num2str(tempmonth,'%02i'), '.nc');  ~ test37
        ...
        uvplot=m_quiver(lon(1:m_quiver_x_interval:end,1:m_quiver_y_interval:end), ...
                        ...
                        'color',m_quiver_vector_color, 'AutoScale',m_quiver_AutoScale,'LineWidth', m_quiver_LineWidth);
