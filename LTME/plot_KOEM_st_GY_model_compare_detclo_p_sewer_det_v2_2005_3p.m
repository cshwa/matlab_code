...
mod_file='D:\Àå±â»ıÅÂ\Dynamic\result\2005\2005_mp_p_sewer_det_f_part.nc';
...
cd D:\Àå±â»ıÅÂ\Dynamic\result\2005
% save('2002_mp_p_sewer_det_result.mat','jj_*', 'gy_*', 'sgy_*', 'egy_*','obm*','obs*');     
save('2005_mp_p_sewer_det_f_result_part_3p.mat','-v7.3');     
