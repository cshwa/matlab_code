...
clim1=load(['koem_climate_10yr_v5_',num2str(sig),'sig_gy_in_bay.mat']);
...
% %  dir_name ={'all_std','t_std','sp_std'};
cd(['D:\장기생태\Dynamic\KOEM\compare_sewer\2nd_10yr\v5_in_bay\2nd_10yr_',num2str(sig),'sig_',dir_name{case_num}]);
