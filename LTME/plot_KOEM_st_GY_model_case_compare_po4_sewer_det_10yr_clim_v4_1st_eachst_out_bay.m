...
clim1=load(['koem_climate_10yr_v5_',num2str(sig),'sig_gy_each_st_out_bay.mat']);
...
% %  dir_name ={'all_std','t_std','sp_std'};
cd(['D:\장기생태\Dynamic\KOEM\compare_sewer\1st_10yr\v5_each_st_out_bay\1st_10yr_',num2str(sig),'sig_',dir_name{case_num}]);
