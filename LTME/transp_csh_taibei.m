...
t_point= 3;  %test1
point_name={'taibei'};
kts = [119.8000 25.4972 120.4000 23.9526]; %% cshwa from editmask
...
%     outfile = ['roms_transport_monthly.txt'];
    outfile = ['taibei_transport_monthly_csh_1.txt'];
    fid = fopen(outfile,'w+');
    fprintf(fid,'%%taibei\n');
    fprintf(fid,'%8.3f\n', trans');
    fclose(fid);
...
point_name={'taibei'}; kts = [119.8000 25.4972 120.4000 23.9526]; %% cshwa from editmask
...
%     trans(:,7)=trans(:,7)*(-1);
%     outfile = ['roms_transport_monthly.txt'];
    outfile = ['taibei_transport_monthly_csh_2.txt'];
    fid = fopen(outfile,'w+');
    fprintf(fid,'%%taibei\n');
    fprintf(fid,'%8.3f\n', trans');
    fclose(fid);
...
%     trans(:,7)=trans(:,7)*(-1);
%     outfile = ['roms_transport_monthly.txt'];
    outfile = ['taibei_transport_monthly_csh_3.txt'];
    fid = fopen(outfile,'w+');
    fprintf(fid,'%%taibei\n');
    fprintf(fid,'%8.3f\n', trans');
    fclose(fid);
...
%     trans(:,7)=trans(:,7)*(-1);
%     outfile = ['roms_transport_monthly.txt'];
    outfile = ['taibei_transport_monthly_csh_4.txt'];
    fid = fopen(outfile,'w+');
    fprintf(fid,'%%taibei\n');
    fprintf(fid,'%8.3f\n', trans');
    fclose(fid);
...
%     trans(:,7)=trans(:,7)*(-1);
%     outfile = ['roms_transport_monthly.txt'];
    outfile = ['taibei_transport_monthly_csh_5.txt'];
    fid = fopen(outfile,'w+');
    fprintf(fid,'%%taibei\n');
    fprintf(fid,'%8.3f\n', trans');
    fclose(fid);
...
%     trans(:,7)=trans(:,7)*(-1);
%     outfile = ['roms_transport_monthly.txt'];
    outfile = ['taibei_transport_monthly_csh_6.txt'];
    fid = fopen(outfile,'w+');
    fprintf(fid,'%%taibei\n');
    fprintf(fid,'%8.3f\n', trans');
    fclose(fid);
...
%     trans(:,7)=trans(:,7)*(-1);
%     outfile = ['roms_transport_monthly.txt'];
    outfile = ['taibei_transport_monthly_csh_7.txt'];
    fid = fopen(outfile,'w+');
    fprintf(fid,'%%taibei\n');
    fprintf(fid,'%8.3f\n', trans');
    fclose(fid);
...
%     trans(:,7)=trans(:,7)*(-1);
%     outfile = ['roms_transport_monthly.txt'];
    outfile = ['taibei_transport_monthly_csh_8.txt'];
    fid = fopen(outfile,'w+');
    fprintf(fid,'%%taibei\n');
    fprintf(fid,'%8.3f\n', trans');
    fclose(fid);
...
%     trans(:,7)=trans(:,7)*(-1);
%     outfile = ['roms_transport_monthly.txt'];
    outfile = ['taibei_transport_monthly_csh_9.txt'];
    fid = fopen(outfile,'w+');
    fprintf(fid,'%%taibei\n');
    fprintf(fid,'%8.3f\n', trans');
    fclose(fid);
...
%     trans(:,7)=trans(:,7)*(-1);
%     outfile = ['roms_transport_monthly.txt'];
    outfile = ['taibei_transport_monthly_csh_10.txt'];
    fid = fopen(outfile,'w+');
    fprintf(fid,'%%taibei\n');
    fprintf(fid,'%8.3f\n', trans');
    fclose(fid);
...
%     trans(:,7)=trans(:,7)*(-1);
%     outfile = ['roms_transport_monthly.txt'];
    outfile = ['taibei_transport_monthly_csh_11.txt'];
    fid = fopen(outfile,'w+');
    fprintf(fid,'%%taibei\n');
    fprintf(fid,'%8.3f\n', trans');
    fclose(fid);
...
%     trans(:,7)=trans(:,7)*(-1);
%     outfile = ['roms_transport_monthly.txt'];
    outfile = ['taibei_transport_monthly_csh_12.txt'];
    fid = fopen(outfile,'w+');
    fprintf(fid,'%%taibei\n');
    fprintf(fid,'%8.3f\n', trans');
    fclose(fid);
