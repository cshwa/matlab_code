...
regime1_kdc_zerosw=load('part_kd_t4_2reg.mat','obm_*','gy_*','jj_*','sgy_*','egy_*','obs_std_*','eom_d_each','sp_gy_*','name_tag','sp_gy');
...
regime2_kdc_zerosw=load('part_kd_t4_3reg.mat','obm_*','gy_*','jj_*','sgy_*','egy_*','obs_std_*','eom_d_each','sp_gy_*','name_tag','sp_gy');
...
clim2_2_std = clim1.obs_std_gy_salt_ft_3(:,sigma);   
