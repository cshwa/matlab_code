...
r_temp = [r_temp; raw_n1(22:end,14); raw_n2(:,14);]; % concaternate (merge)
...
save('gawha_regression_extract_climate_2019.mat'); 
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
close all; clear; clc; 
cd D:\장기생태\Dynamic\06_river_physics
[raw txt]=xlsread('섬진강_수온_염분_DO.xls','sheet','');
[raw_n1 txt_n1]=xlsread('하동_2018.xls','수질(일반측정망)','');
[raw_n2 txt_n2]=xlsread('하동_2019.xls','수질(일반측정망)','');
...
n_2018 =char(txt_n1(3:end,3)); % 2018 date
n_2019 =char(txt_n2(3:end,3)); % 2018 date
n_2018_ymd = [n_2018(29:end,1:4) repmat(dash_c,length(n_2018(29:end,1:4)),1) n_2018(29:end,6:7) repmat(dash_c,length(n_2018(29:end,1:4)),1) n_2018(29:end,9:10)];
n_2019_ymd = [n_2019(:,1:4) repmat(dash_c,length(n_2019(:,1:4)),1) n_2019(:,6:7) repmat(dash_c,length(n_2019(:,1:4)),1) n_2019(:,9:10)];
...
r_temp_txt=[r_txt_ud(1:end-2,8)];
r_temp=str2num(char(r_temp_txt));
r_temp = [r_temp; raw_n1(29:end,14); raw_n2(:,14);]; % concaternate (merge)
...
save('songjung_regression_yeosu_extract_climate_2019.mat'); 
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
