...
defau = load('2004_mp_p_sewer_det_f_result.mat','obm_*','gy_*','jj_*','sgy_*','egy_*','obs_std_*');
tunn1=load('2004_tunn1.mat','obm_*','gy_*','jj_*','sgy_*','egy_*','obs_std_*');
tunn2 = load('2004_tunn2.mat','obm_*','gy_*','jj_*','sgy_*','egy_*','obs_std_*');
tunn3 = load('2004_tunn3.mat','obm_*','gy_*','jj_*','sgy_*','egy_*','obs_std_*');
tunn4=load('2004_tunn4.mat','obm_*','gy_*','jj_*','sgy_*','egy_*','obs_std_*');
tunn5 = load('2004_tunn5.mat','obm_*','gy_*','jj_*','sgy_*','egy_*','obs_std_*');
tunn6 = load('2004_tunn6.mat','obm_*','gy_*','jj_*','sgy_*','egy_*','obs_std_*');
tunn7=load('2004_tunn7.mat','obm_*','gy_*','jj_*','sgy_*','egy_*','obs_std_*');
...
% % mpdata.gy_temp
cd D:\장기생태\Dynamic\KOEM\compare_sewer\2004
...
fig = figure; hold on;
        ...
        xlim([1 365]);
        title(['GY 2004 daily KOEM OBS vs. MODEL Zoo & Phy surface']);
...
fig = figure; hold on;      
        ...
        legend('zoo','zoo_w_t_8','phy','phy_w_t_8')
        xlim([1 365]);
        title(['GY 2004 daily KOEM OBS vs. MODEL Zoo & Phy bottom']);
        xlabel('time(days on 2001)','fontsize',13)
        ylabel('concentration (umol/m^3)','fontsize',13)
        grid on
        set(gca,'fontsize',13)              
...
%         plot(tunn2.gy_po4,'g','linew',2);
        ...
        xlim([1 365])
        set(gca,'fontsize',13)
        print(fig,strcat('2004_yr_KOEM_OBS_vs_daily_MODEL_po4'),'-dpng')
...
%         plot(tunn2.gy_no3,'g','linew',2);
        ...
        xlim([1 365])
        set(gca,'fontsize',13)
        print(fig,strcat('2004_yr_KOEM_OBS_vs_daily_MODEL_no3'),'-dpng')
...
%         plot(tunn2.gy_nh4,'g','linew',2);
        ...
        xlim([1 365])
        set(gca,'fontsize',13)
        print(fig,strcat('2004_yr_KOEM_OBS_vs_daily_MODEL_nh4'),'-dpng')
...
%         plot(tunn2.gy_chl,'g','linew',2);
        ...
        xlim([1 365])
        set(gca,'fontsize',13)
        print(fig,strcat('2004_yr_KOEM_OBS_vs_daily_MODEL_chl'),'-dpng')
...
%         plot(tunn2.gy_temp,'g','linew',2);
        ...
        xlim([1 365])
        set(gca,'fontsize',13)
        print(fig,strcat('2004_yr_KOEM_OBS_vs_daily_MODEL_temp'),'-dpng')
...
%         plot(tunn2.gy_salt,'g','linew',2);
        ...
        xlim([1 365])
        set(gca,'fontsize',13)
        print(fig,strcat('2004_yr_KOEM_OBS_vs_daily_MODEL_salt'),'-dpng')            
 %% bot
 fig = figure; hold on;
%         plot(zeros(365,1),'g--','linew',2); % zero lines
%% 2001
...
%         plot(tunn2.gy_po4,'g','linew',2);
        ...
        set(gca,'fontsize',13)
        xlim([1 365])
        print(fig,strcat('2004_yr_KOEM_OBS_vs_daily_MODEL_po4_bot'),'-dpng')
...
%         plot(tunn2.gy_no3,'g','linew',2);
        ...
        set(gca,'fontsize',13)
        xlim([1 365])
        print(fig,strcat('2004_yr_KOEM_OBS_vs_daily_MODEL_no3_bot'),'-dpng')
...
%         plot(tunn2.gy_nh4,'g','linew',2);
        ...
        xlim([1 365])
        set(gca,'fontsize',13)
        print(fig,strcat('2004_yr_KOEM_OBS_vs_daily_MODEL_nh4_bot'),'-dpng')
...
%         plot(tunn2.gy_chl,'g','linew',2);
        ...
        yticks(1:1:15)
        set(gca,'fontsize',13)
        print(fig,strcat('2004_yr_KOEM_OBS_vs_daily_MODEL_chl_bot'),'-dpng')
...
%         plot(tunn2.gy_temp,'g','linew',2);
        ...
        xlim([1 365])
        set(gca,'fontsize',13)
        print(fig,strcat('2004_yr_KOEM_OBS_vs_daily_MODEL_temp_bot'),'-dpng')
...
%         plot(tunn2.gy_salt,'g','linew',2);
        ...
        xlim([1 365])
        set(gca,'fontsize',13)
        print(fig,strcat('2004_yr_KOEM_OBS_vs_daily_MODEL_salt_bot'),'-dpng')            
return        
...
%         plot(zeros(365,1),'g','linew',2); % zero lines
        ...
        plot(1:length(obm_sgy_no3),obm_sgy_no3./14 - obs_std_sgy_no3./14,'m-','linew',2);
        title(['GY 2004 daily KOEM OBS vs. MODEL NO3']);
...
%         plot(zeros(365,1),'g','linew',2); % zero lines
        ...
        plot(1:length(obm_sgy_nh4),obm_sgy_nh4./14 - obs_std_sgy_nh4./14,'m-','linew',2);
        title(['GY 2004 daily KOEM OBS vs. MODEL NH4']);
        xlabel('time(days on 2001)','fontsize',16)
...
%         plot(zeros(365,1),'g','linew',2); % zero lines
        ...
        plot(1:length(obm_sgy_chl),obm_sgy_chl - obs_std_sgy_chl,'m-','linew',2);
        title(['GY 2004 daily KOEM OBS vs. MODEL chl']);
        xlabel('time(days on 2001)','fontsize',16)
...
%         plot(zeros(365,1),'g','linew',2); % zero lines
        ...
        plot(1:length(obm_sgy_temp),obm_sgy_temp - obs_std_sgy_temp,'m-','linew',2);
        title(['GY 2004 daily KOEM OBS vs. MODEL temp']);
        xlabel('time(days on 2001)','fontsize',16)
...
%         plot(zeros(365,1),'g','linew',2); % zero lines
        ...
        plot(1:length(obm_sgy_salt),obm_sgy_salt - obs_std_sgy_salt,'m-','linew',2);
        title(['GY 2004 daily KOEM OBS vs. MODEL salt']);
        xlabel('time(days on 2001)','fontsize',16)
...
%         plot(zeros(365,1),'g','linew',2); % zero lines
        ...
        plot(1:length(obm_sgy_no3_b),obm_sgy_no3_b./14 - obs_std_sgy_no3_b./14,'m-','linew',2);
        title(['GY 2004 daily KOEM OBS vs. MODEL NO3 bot']);
        xlabel('time(days on 2001)','fontsize',16)
        ylabel('NO3 (umol/m^3)','fontsize',16)
        grid on
...
%         plot(zeros(365,1),'g','linew',2); % zero lines
        ...
        plot(1:length(obm_sgy_nh4_b),obm_sgy_nh4_b./14 - obs_std_sgy_nh4_b./14,'m-','linew',2);
        title(['GY 2004 daily KOEM OBS vs. MODEL NH4 bot']);
        xlabel('time(days on 2001)','fontsize',16)
        ylabel('NH4 (umol/m^3)','fontsize',16)
        xticks([0:50:366])
        grid on
...
%         plot(zeros(365,1),'g','linew',2); % zero lines
        ...
        plot(1:length(obm_sgy_chl_b),obm_sgy_chl_b - obs_std_sgy_chl_b,'m-','linew',2);
        title(['GY 2004 daily KOEM OBS vs. MODEL chl bot']);
        xlabel('time(days on 2001)','fontsize',16)
        ylabel('chl (ug/L)','fontsize',16)
        grid on
        set(gca,'fontsize',16,'fontweight','bold'); ylim([0 inf])
...
%         plot(zeros(365,1),'g','linew',2); % zero lines
        ...
        plot(1:length(obm_sgy_temp_b),obm_sgy_temp_b - obs_std_sgy_temp_b,'m-','linew',2);
        title(['GY 2004 daily KOEM OBS vs. MODEL temp bot']);
        xlabel('time(days on 2001)','fontsize',16)
        ylabel('temp (o^C)','fontsize',16)
        grid on
        set(gca,'fontsize',16,'fontweight','bold')
...
%         plot(zeros(365,1),'g','linew',2); % zero lines
        ...
        plot(1:length(obm_sgy_salt_b),obm_sgy_salt_b - obs_std_sgy_salt_b,'m-','linew',2);
        title(['GY 2004 daily KOEM OBS vs. MODEL salt bot']);
        xlabel('time(days on 2001)','fontsize',16)
        ylabel('salt (psu)','fontsize',16)
        xticks([0:50:366])
        grid on
