...
for i = 1:12
    r_tran_c_80(1,i)= nanmean(r_trans_clim_80(1,em{i}));
    r_tran_c_80(2,i)= nanmean(r_trans_clim_80(2,em{i}));
    r_nh4_c_80(1,i)= nanmean(r_nh4_clim_80(1,em{i}));
    r_nh4_c_80(2,i)= nanmean(r_nh4_clim_80(2,em{i}));
    r_no3_c_80(1,i)= nanmean(r_no3_clim_80(1,em{i}));
    r_no3_c_80(2,i)= nanmean(r_no3_clim_80(2,em{i}));
end
...
%NO3 flux
figure; hold on;
plot(r_tran_c_80(1,:).*(r_no3_c_80(1,:).*14),'b','linew',2); plot(r_tran_c_80(2,:).*(r_no3_c_80(2,:).*14),'r','linew',2); 
plot(1:366, repmat(mean((r_tran_c_80(1,:).*(r_no3_c_80(1,:).*14))),366,1),'--','color','b','linew',2);
plot(1:366, repmat(mean((r_tran_c_80(2,:).*(r_no3_c_80(1,:).*14))),366,1),'--','color','r','linew',2);
legend('sumjin_1_9_8_0_~_1_9_8_5', 'Nam_1_9_8_0_~_1_9_8_5');
ylabel(gca,'NO3 flux (mg/s)','fontsize',15,'fontweight','bold'); xlabel(gca,'days','fontsize',15,'fontweight','bold');
set(gca,'fontsize',15,'fontweight','bold');
grid on; xlim([1 12]); 

%NH4 flux
figure; hold on;
plot(r_tran_c_80(1,:).*(r_nh4_c_80(1,:).*14),'b','linew',2); plot(r_tran_c_80(2,:).*(r_nh4_c_80(2,:).*14),'r','linew',2); 
plot(1:366, repmat(mean((r_tran_c_80(1,:).*(r_nh4_c_80(1,:).*14))),366,1),'--','color','b','linew',2);
plot(1:366, repmat(mean((r_tran_c_80(2,:).*(r_nh4_c_80(1,:).*14))),366,1),'--','color','r','linew',2);
legend('sumjin_1_9_8_0_~_1_9_8_5', 'Nam_1_9_8_0_~_1_9_8_5');
ylabel(gca,'NH4 flux (mg/s)','fontsize',15,'fontweight','bold'); xlabel(gca,'days','fontsize',15,'fontweight','bold');
set(gca,'fontsize',15,'fontweight','bold');
grid on; xlim([1 12]); 
% ylim([0 1000])

figure; hold on;
plot(r_tran_c_80(1,:),'b','linew',2); plot(r_tran_c_80(2,:),'r','linew',2); 
plot(1:366, repmat(mean(r_tran_c_80(1,:)),366,1),'--','color','b','linew',2);
plot(1:366, repmat(mean(r_tran_c_80(2,:)),366,1),'--','color','r','linew',2);
legend('sumjin_1_9_8_0_~_1_9_8_5', 'Nam_1_9_8_0_~_1_9_8_5');
ylabel(gca,'River discharge (m^3/s)','fontsize',15,'fontweight','bold'); xlabel(gca,'month','fontsize',15,'fontweight','bold');
set(gca,'fontsize',15,'fontweight','bold');
grid on; xlim([1 12]);
