...
save('sumjin_recons_water_temp_present_2021_high_airT.mat');
...
xlim([1466 length(temp_air)]);
ylim([-5 35]); xtickangle(45)
save('sumjin_recons_water_temp(hadong)_present_2021_high_airT.mat');
...
xlim([1466 length(temp_air)]);
ylim([-5 35]); xtickangle(45)
save('sumjin_recons_water_temp(jinwal)_present_2021_high_airT.mat');
...
xlim([1466 length(temp_air)]);
ylim([-5 35]); xtickangle(45)
save('sumjin_recons_water_temp(agyang)_present_2021_high_airT.mat');
