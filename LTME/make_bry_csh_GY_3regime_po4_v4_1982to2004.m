...
%     '2061','2071','2081','2091'};
period = {'1982to1986','1987to1992','1993to2004'};

for i = 1:length(period)
    yeart=i;
% bryname=['bndy_auto_NWP_1_10_test6_clim_',num2str(i),'regime.nc'];
% bryname=['bndy_csh_RCM_clim_test66_',char(period{i}),'.nc'];
bryname=['D:\장기생태\Dynamic\07_boundary_ts\bndy_auto_NWP_1_10_test6_clim_',char(period{i}),'.nc'];
% bryname=['bndy_auto_NWP_1_10_test6_clim_16to20.nc']; % 3regime
switch period{i}
    case '1982to1986'
        grdname=['D:\장기생태\Dynamic\KOEM\grid_sumjin_v1970_fix_3m_v3.nc'];      
    case {'1987to1992','1993to2004'}
...
load(['D:\장기생태\Dynamic\KOEM\boundary_bio_input_1982to2004_',char(period{i}),'regime_v7.mat']);
do_tem=do_input;
