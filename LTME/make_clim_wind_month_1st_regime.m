...
outfileu='auto_ERA5_clim91-00_Uwind_monthly.nc';
outfilev='auto_ERA5_clim91-00_Vwind_monthly.nc';
...
for tt=1:1:length(wtime)
        yyc=yyc+1;
        filenameu=['auto_ERA5_clim91-00_Uwind.nc'];
        filenamev=['auto_ERA5_clim91-00_Vwind.nc'];
...
%% test
u=ncread('auto_ERA5_clim91-00_Uwind_monthly.nc','Uwind');
v=ncread('auto_ERA5_clim91-00_Vwind_monthly.nc','Vwind');
