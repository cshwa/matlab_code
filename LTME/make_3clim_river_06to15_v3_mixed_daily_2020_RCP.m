...
sjtemp=load('D:\장기생태\Dynamic\06_river_physics\환경과학원\sumjin_recons_water_temp(agyang)_present_2100_high_airT_mixed_daily.mat');
...
order_i = 0
for i = t_year_temp(1):t_year_temp(end) % 1990~2100
    order_i = order_i+1
    clearvars tempo_temp tempo_trans
tempo_temp=sumjin_re_w_c{t_year_temp(order_i)-1989};
if order_i == 1
...
t_day_cut3=365*length(1989:2020);
t_day_cut4=365*length(1989:2030);
t_day_cut5=365*length(1989:2040);
t_day_cut6=365*length(1989:2050);
t_day_cut7=365*length(1989:2060);
t_day_cut8=365*length(1989:2070);
t_day_cut9=365*length(1989:2080);
t_day_cut10=365*length(1989:2090);
% t_day_cut11=365*length(1989:2100);
