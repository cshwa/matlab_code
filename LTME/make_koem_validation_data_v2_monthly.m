...
% koem data
% load koem_timeseires_monthly_gy_only_2sig.mat % 2sig (spatial std :gy pt. & time)
% load koem_timeseires_monthly_3sig.mat % 3sig (spatial std :all pt. & time)
load koem_timeseires_monthly_gy_only_3sig.mat% 3sig (spatial std :gy pt. & time)
% location
...
% save(['koem_compare_data_gy_2sig_monthly_spatial_mean.mat'],'-v7.3'); %2sig
% save(['koem_compare_data_full_3sig_monthly_spatial_mean.mat'],'-v7.3'); %3sig
save(['koem_compare_data_gy_3sig_monthly_spatial_mean.mat'],'-v7.3'); %3sig
return
