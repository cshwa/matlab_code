...
c2004 = load('2004_mp_p_sewer_det_f_result_part.mat','obm_*','gy_*','jj_*','sgy_*','egy_*','obs_std_*','eom_d_each');
...
% % mpdata.gy_temp
cd D:\장기생태\Dynamic\KOEM\compare_sewer\det_2001~4
...
com_eom = [c2001_eom c2002_eom c2003_eom c2004_eom];
...
%% 2002
 ...
 %% 2004
        ...
        grid on
        ylim([0 75])
        xlim([1 c2004_eom(1)-1+length(c2004.gy_no3)])
        set(gca,'fontsize',13)
