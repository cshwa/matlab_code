...
for i = 1997:1997
    for j = 1:12
        k=k+1;
        ref_date_97{k,1} = [num2str(i) '-' num2str(j,'%02d')];
    end
end

% matched date 'yymm' form
for j = 1:length(indx) % st. axis
    for i = 1:length(ref_date_97) % date axis
       if  sum(strcmp(ref_date_97{i}, merge_yymm(indx{j}))) ~= 0
           indx_date_97{j,i} = find([strcmp(ref_date_97{i}, merge_yymm(indx{j}))] == 1);     
       end
    end
end
...
for i = 1:length(indx)
    ...
    for j = 1:size(indx_date_97,2) %mth
        temp_sur_clim(i,j) = mean(str2num(char(temp(indx_date_97{i,j}))));
    end
end
...
for i = 1:length(indx)
    ...
    for j = 1:size(indx_date_97,2) %mth
        temp_bot_clim(i,j) = mean(str2num(char(temp(indx_date_97{i,j}))));
    end
end
...
for i = 1:length(indx)
    ...
    for j = 1:size(indx_date_97,2) %mth
        salt_sur_clim(i,j) = mean(str2num(char(temp(indx_date_97{i,j}))));
    end
end
...
for i = 1:length(indx)
    ...
    for j = 1:size(indx_date_97,2) %mth
        salt_bot_clim(i,j) = mean(str2num(char(temp(indx_date_97{i,j}))));
    end
end
...
for i = 1:length(indx)
    ...
    for j = 1:size(indx_date_97,2) %mth
        do_sur_clim(i,j) = mean(str2num(char(temp(indx_date_97{i,j}))));
    end
end
...
for i = 1:length(indx)
    ...
    for j = 1:size(indx_date_97,2) %mth
        do_bot_clim(i,j) = mean(str2num(char(temp(indx_date_97{i,j}))));
    end
end
...
for i = 1:length(indx)
    ...
    for j = 1:size(indx_date_97,2) %mth
        nh4_sur_clim(i,j) = mean(str2num(char(temp(indx_date_97{i,j}))));
    end
end
...
for i = 1:length(indx)
    ...
    for j = 1:size(indx_date_97,2) %mth
        nh4_bot_clim(i,j) = mean(str2num(char(temp(indx_date_97{i,j}))));
    end
end
...
for i = 1:length(indx)
    ...
    for j = 1:size(indx_date_97,2) %mth
        no3_sur_clim(i,j) = mean(str2num(char(temp(indx_date_97{i,j}))));
    end
end
...
for i = 1:length(indx)
    ...
    for j = 1:size(indx_date_97,2) %mth
        no3_bot_clim(i,j) = mean(str2num(char(temp(indx_date_97{i,j}))));
    end
end
...
for i = 1:length(indx)
    ...
    for j = 1:size(indx_date_97,2) %mth
        chl_sur_clim(i,j) = mean(str2num(char(temp(indx_date_97{i,j}))));
    end
end
...
for i = 1:length(indx)
    ...
    for j = 1:size(indx_date_97,2) %mth
        chl_bot_clim(i,j) = mean(str2num(char(temp(indx_date_97{i,j}))));
    end
end
