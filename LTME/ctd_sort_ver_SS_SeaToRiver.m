...
data = load('D:\SilverStar\data\01_Sumjin_yeosu_camp\2015_spring_ys\CTD\150519_CTD_spring\am_flood\am_flood_all.dat');
...
save spring_flood_den.dat den -ascii
save spring_flood_sal.dat sal -ascii
save spring_flood_temp.dat temp -ascii
%%
...
set(gca,'xtick',[st:3:en],'xticklabel',[st:3:en]);
% grid on; 
...
set(gca,'xtick',[st:3:en],'xticklabel',[st:3:en],'xlim',[en st]);
set(gca,'ylim',[14 20]);
