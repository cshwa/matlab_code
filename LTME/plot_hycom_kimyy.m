...
figdir =strcat('D:\OneDrive - 서울대학교\research\Ph_D_course\Figure\Reanalysis\HYCOM\',testname,'\'); % % where figure files will be saved
...
%     status=plot_HYCOM_monthly_surface_data(testname, sstfile, inputdir, lonlat_NWP, tempyear, month, ...
%                                     [0 35], 0:5:35, 'SST', 'fig_param_HYCOM_kyy_NWP');
% 
%     % %  plot SSS (NWP)
...
%     status=plot_HYCOM_monthly_surface_data(testname, sssfile, inputdir, lonlat_NWP, tempyear, month, ...
%                                     [30 35], 0:0:0, 'SSS', 'fig_param_HYCOM_kyy_NWP');
%                                 
%     % %  plot SSH (NWP)
...
%     status=plot_HYCOM_monthly_surface_data(testname, sshfile, inputdir, lonlat_NWP, tempyear, month, ...
%                                     [-1 1], 0:0:0, 'SSH', 'fig_param_HYCOM_kyy_NWP');
% 
...
%     status=vec_HYCOM_monthly_surface_UV(testname, suvfile, inputdir, lonlat_NWP, tempyear, month, ...
%                                     'UV', 'NWP', 'fig_param_HYCOM_kyy_NWP');
...
%     status=plot_HYCOM_monthly_surface_data(testname, sstfile, inputdir, lonlat_YS, tempyear, month, ...
%                                     [0 35], 0:5:35, 'SST', 'fig_param_HYCOM_kyy_YS');
%                                 
%     % %  plot YSBCW (YS)
...
%     status=plot_HYCOM_monthly_surface_data(testname, sstfile, inputdir, lonlat_YS, tempyear, month, ...
%                                     [0 35], 6:2:10, 'YSBCW', 'fig_param_HYCOM_kyy_YS');
% 
%     % %  plot SSS (YS)
...
%     status=plot_HYCOM_monthly_surface_data(testname, sssfile, inputdir, lonlat_YS, tempyear, month, ...
%                                     [30 35], 0:0:0, 'SSS', 'fig_param_HYCOM_kyy_YS');
%                                 
%     % %  plot SSH (YS)
...
%     status=plot_HYCOM_monthly_surface_data(testname, sshfile, inputdir, lonlat_YS, tempyear, month, ...
%                                     [-1 1], 0:0:0, 'SSH', 'fig_param_HYCOM_kyy_YS');
% 
%     % %  plot Surface Current (SUV)
...
%     status=vec_HYCOM_monthly_surface_UV(testname, suvfile, inputdir, lonlat_YS, tempyear, month, ...
%                                     'UV', 'YS', 'fig_param_HYCOM_kyy_YS');
%                           
% end
...
%     status=plot_HYCOM_monthly_surface_data(testname, sstfile, inputdir, lonlat_EJS, tempyear, month, ...
%                                     [0 35], 0:5:35, 'SST', 'fig_param_HYCOM_kyy_EJS');                                
...
%     status=plot_HYCOM_monthly_surface_data(testname, sssfile, inputdir, lonlat_EJS, tempyear, month, ...
%                                     [30 35], 0:0:0, 'SSS', 'fig_param_HYCOM_kyy_EJS');
%                                 
%     % %  plot SSH (EJS)
...
%     status=plot_HYCOM_monthly_surface_data(testname, sshfile, inputdir, lonlat_EJS, tempyear, month, ...
%                                     [-1 1], 0:0:0, 'SSH', 'fig_param_HYCOM_kyy_EJS');
% 
    % %  plot Surface Current (SUV)
...
%     suvfile =[figdir, 'EJS\', 'SUV\', 'EKWC_SUV']; % % ~/SUV_EJS_testname_year_month.jpg
%     status=vec_HYCOM_monthly_surface_UV(testname, suvfile, inputdir, lonlat_EKWC, tempyear, month, ...
%                                     'UV', 'EJS', 'fig_param_HYCOM_kyy_EKWC');

%     suvfile =[figdir, 'EJS\', 'SUV\', 'EJS_SUV_temp']; % % ~/SUV_EJS_testname_year_month.jpg
%     status=plot_HYCOM_monthly_surface_UV_data(testname, suvfile, inputdir, [129.8 131 36.0767 39], tempyear, month, ...
%                                     [4 12], 0:8:10, 'temp', 'EJS', 'fig_param_HYCOM_kyy_schematic');
...
%     status=plot_HYCOM_monthly_vertical_data(testname, vert_temp_file, inputdir, [132 132 35 43 -1000 0], tempyear, month, ...
%                                     [0 15], 0:1:15, 'vert_temp', 'fig_param_HYCOM_kyy_EJS');
%                                 
%     vert_temp_file =[figdir, 'EJS\', 'vert_temp\', 'EJS_vert_temp_ykang_lon']; % % ~/SUV_EJS_testname_year_month.jpg
%     status=plot_HYCOM_monthly_vertical_data(testname, vert_temp_file, inputdir, [129 136 38 38 -1000 0], tempyear, month, ...
%                                     [0 30], 0:1:35, 'vert_temp', 'fig_param_HYCOM_kyy_EJS');
% 
%     vert_temp_file =[figdir, 'EJS\', 'vert_temp\', 'EJS_vert_temp_102']; % % ~/SUV_EJS_testname_year_month.jpg
%     status=plot_HYCOM_monthly_vertical_data(testname, vert_temp_file, inputdir, [129.8 131 36.0767 36.0767 -200 0], tempyear, month, ...
%                                     [0 25], 0:5:25, 'vert_temp', 'fig_param_HYCOM_kyy_EJS');  %% for 102 line

%     vert_temp_file =[figdir, 'EJS\', 'vert_temp\', 'EJS_vert_temp_107']; % % ~/SUV_EJS_testname_year_month.jpg
%     status=plot_HYCOM_monthly_vertical_data(testname, vert_temp_file, inputdir, [128.6233 132.313	38.126 38.126 -500 0], tempyear, month, ...
%                                     [0 25], 0:5:25, 'vert_temp', 'fig_param_HYCOM_kyy_EJS');  %% for 107 line

%     vert_temp_file =[figdir, 'EJS\', 'vert_temp\', 'EJS_vert_temp_bwr_102']; % % ~/SUV_EJS_testname_year_month.jpg
%     status=plot_HYCOM_monthly_vertical_data(testname, vert_temp_file, inputdir, [129.8 131 36.0767 36.0767 -200 0], tempyear, month, ...
%                                     [4 12], 0:8:10, 'vert_temp', 'fig_param_HYCOM_kyy_schematic');  %% for 102 line
%     vert_temp_file =[figdir, 'EJS\', 'vert_temp\', 'EJS_vert_temp_bwr_ns_102']; % % ~/SUV_EJS_testname_year_month.jpg
%     status=plot_HYCOM_monthly_vertical_data(testname, vert_temp_file, inputdir, [129.8 129.8 36.0767 39 -200 0], tempyear, month, ...
%                                     [4 12], 0:8:10, 'vert_temp', 'fig_param_HYCOM_kyy_schematic');  %% for 102 line
% 
...
%                                     [0 30], 0:5:30, 'vert_temp', 'fig_param_HYCOM_kyy_EJS');  %% 35.5N
                                
%     vert_temp_file =[figdir, 'EJS\', 'vert_temp\', 'EKWC_vert_temp_35_5']; % % ~/SUV_EJS_testname_year_month.jpg
%     status=plot_HYCOM_monthly_vertical_data(testname, vert_temp_file, inputdir, [129 131 35.5 35.5 -200 0], tempyear, month, ...
%                                     [0 30], 0:5:30, 'vert_temp', 'fig_param_HYCOM_kyy_EKWC');  %% 35.5N
%                                 
%     vert_temp_file =[figdir, 'EJS\', 'vert_temp\', 'EJS_vert_temp_WOA']; % % ~/SUV_EJS_testname_year_month.jpg
%     status=plot_HYCOM_monthly_vertical_data(testname, vert_temp_file, inputdir, [130 130 35 39 -200 0], tempyear, month, ...
%                                     [2 20], 0:5:20, 'vert_temp', 'fig_param_HYCOM_kyy_EJS');   %% for WOA
...
%     status=plot_HYCOM_monthly_vertical_data(testname, vert_temp_file, inputdir, [132 132 35 43 -1000 0], tempyear, month, ...
%                                     [33 34.5], 33:0.1:34.5, 'vert_salt', 'fig_param_HYCOM_kyy_EJS');
%     
...
%     status=plot_HYCOM_monthly_vertical_data(testname, vert_v_file, inputdir, [129.8 131 36.0767 36.0767 -200 0], tempyear, month, ...
%                                     [-1.0 1.0], -1.0:0.1:1.0, 'vert_v', 'fig_param_HYCOM_kyy_EJS');  %% for 102 line
%                                 
%     vert_v_file =[figdir, 'EJS\', 'vert_v\', 'EJS_vert_v_35_5']; % % ~/SUV_EJS_testname_year_month.jpg
%     status=plot_HYCOM_monthly_vertical_data(testname, vert_v_file, inputdir, [129 131 35.5 35.5 -200 0], tempyear, month, ...
%                                     [-1.0 1.0], -1.0:0.1:1.0, 'vert_v', 'fig_param_HYCOM_kyy_EJS');  %% for 35.5N
                                   
end
    % %  get isothermal depth
    reftemp=10;
%     status=get_HYCOM_temp_iso_depth(testname, inputdir, [129 131 35.5 35.5 -200 0], year, month, ...
%                                     'vert_temp', reftemp, 'fig_param_HYCOM_kyy_EJS');  %% for 35.5N
                                
%     reftemp=10;
%     status=get_HYCOM_temp_iso_depth(testname, inputdir, [129.8 131 36.0767 36.0767 -200 0], year, month, ...
%                                     'vert_temp', reftemp, 'fig_param_HYCOM_kyy_EJS');  %% for 102
     
%     status=get_HYCOM_section_data(testname, inputdir, [129 131 35.5 35.5 -200 0], year, month, ...
%                                     'vert_v', 'fig_param_HYCOM_kyy_EJS');  %% for 35.5N
                                
%     status=get_HYCOM_section_data(testname, inputdir, [129.8 131 36.0767 36.0767 -200 0], year, month, ...
%                                     'vert_v', 'fig_param_HYCOM_kyy_EJS');  %% for 102
...
% % %     status=scatter_isodepth_v_HYCOM(testname, scat_file, inputdir, [129.8 131 36.0767 36.0767 -200 0], [129.8 130.1], year, month, reftemp, ...
% % %                                      'fig_param_HYCOM_kyy_EJS', 1);  %% for 102
