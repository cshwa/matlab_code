function create_roms_file_month_ep(fname,temp,salt,zeta,ubar,vbar,u,v,rain,evaporation,mm)%,tframe,cycle)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
...
% case 'rain'
 nw{'rain'} = ncfloat(  'eta_rho', 'xi_rho');
 nw{'rain'}.long_name = ncchar('time-averaged rain fall rate');
 nw{'rain'}.units = ncchar('kilogram meter-2 second-1');
%  nw{'rain'}.time = ncchar('level');
 nw{'rain'}(:)= rain;

% case 'evaporation'
 nw{'evaporation'} = ncfloat(  'eta_rho', 'xi_rho');
 nw{'evaporation'}.long_name = ncchar('time-averaged evaporation rate');
 nw{'evaporation'}.units = ncchar('kilogram meter-2 second-1');
 nw{'evaporation'}(:)= evaporation;
...
% % case 'omega'
%  nw{'omega'} = ncfloat (level_1, 'eta_rho', 'xi_rho');
