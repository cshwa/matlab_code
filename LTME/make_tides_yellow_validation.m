...
grdname=['/data1/cshwa/auto_fennel/grid/roms_grd_auto_rdrg2_new8_smooth.nc'];
...
%
tidename=['/home/cshwa/Dropbox/source/matlab/Model/ROMS/Roms_tools/TPXO7/TPXO7.nc'];
frcname=['/data1/cshwa/auto_fennel/input/yellow_tide_1996.nc'];
%
