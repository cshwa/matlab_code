...
clim1=load('D:\장기생태\Dynamic\06_river\koem_climate_to06to15_v5_sig_gy_9points_no_regime_cut_monthly.mat'); %monthly_extracted [2, 5, 8, 11] data
...
% regime1_kdc_zerosw=load('part_kdc_t6_2reg.mat','obm_*','gy_*','jj_*','sgy_*','egy_*','obs_std_*','eom_d_each','sp_gy_*','name_tag','sp_gy');
...
% regime2_kdc_zerosw=load('part_kdc_t6_3reg.mat','obm_*','gy_*','jj_*','sgy_*','egy_*','obs_std_*','eom_d_each','sp_gy_*','name_tag','sp_gy');
...
% plot_dir = 'J:\장기생태_2021\Dynamic\result\3regime\kdc_nosew\t4_case\2&3regime\nocutregime\monthly_extracted'
% plot_dir = 'J:\장기생태_2021\Dynamic\result\3regime\kdc_nosew\t4_case\2&3regime\nocutregime\monthly_extracted\3sig'
