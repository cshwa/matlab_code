...
y_s_no3_205 = yp_w_no3_2 .*0.001.*1000./14; %%% ug/L to mM/m^3;
...
y_s_no3_400 = yp_w_no3_2 .*0.001.*1000./14; %%% ug/L to mM/m^3;  % 2003 
...
save('boundary_bio_input_2006_v2.mat','*_input*');
save('boundary_bio_input_for_ini_2006_v2.mat','*_in');

save('check_boundary_no3_input_2006_v2.mat','y_s_no3_205','y_b_no3_205');
