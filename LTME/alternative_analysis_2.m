...
print('-dpng', ['sumjin(songjung)_DO_raw-climate']);
...
plot(idx,yCalc2,'--','color','r','linew',2)
gtext(['y = ',num2str(b(2),2),'x + ',num2str(b(1),2)],'Color','k','FontSize',16)
print('-dpng', ['sumjin(songjung)_chla_raw-climate']);
...
plot(idx,yCalc2,'--','color','r','linew',2)
gtext(['y = ',num2str(b(2),2),'x + ',num2str(b(1),2)],'Color','k','FontSize',16)
print('-dpng', ['sumjin(songjung)_NH4_raw-climate']);
...
plot(idx,yCalc2,'--','color','r','linew',2)
gtext(['y = ',num2str(b(2),2),'x + ',num2str(b(1),2)],'Color','k','FontSize',16)
print('-dpng', ['sumjin(songjung)_NO3_raw-climate']);
...
xlabel('time(year)','fontsize',13)
ylabel('DO (mg/L)','fontsize',13)
title(['sumjin(songjung)-regression DO ' num2str(i) '-month'],'fontsize',13)
grid on; 
ylim([0 22])
set(gca,'fontsize',13)
...
plot(idx,yCalc2,'--','color','r','linew',2)
gtext(['y = ',num2str(b(2),2),'x + ',num2str(b(1),2)],'Color','k','FontSize',16)
print('-dpng', ['sumjin(songjung)-regression DO ' num2str(i) '-month']);
end
...
title(['sumjin(songjung)-regression Chla ' num2str(i) '-month'],'fontsize',13)
grid on
set(gca,'fontsize',13)
  ylim([0 145])
set(gca,'xtick',[1:3:32]);
...
plot(idx,yCalc2,'--','color','r','linew',2)
gtext(['y = ',num2str(b(2),2),'x + ',num2str(b(1),2)],'Color','k','FontSize',16)
print('-dpng', ['sumjin(songjung)-regression Chla ' num2str(i) '-month']);
end
...
xlabel('time(year)','fontsize',13)
ylabel('NH4 (mg/L)','fontsize',13)
title(['sumjin(songjung)-regression NH4 ' num2str(i) '-month'],'fontsize',13)
grid on
set(gca,'fontsize',13)
    ylim([0 2.5])
set(gca,'xtick',[1:3:32]);
...
plot(idx,yCalc2,'--','color','r','linew',2)
gtext(['y = ',num2str(b(2),2),'x + ',num2str(b(1),2)],'Color','k','FontSize',16)
print('-dpng', ['sumjin(songjung)-regression NH4 ' num2str(i) '-month']);
end
...
figure; hold on;
  ...
  xlabel('time(year)','fontsize',13)
ylabel('NO3 (mg/L)','fontsize',13)
title(['sumjin(songjung)-regression NO3 ' num2str(i) '-month'],'fontsize',13)
grid on
set(gca,'fontsize',13)
set(gca,'xtick',[1:3:32]);
set(gca,'xlim',[1 32]);
...
plot(idx,yCalc2,'--','color','r','linew',2)
gtext(['y = ',num2str(b(2),2),'x + ',num2str(b(1),2)],'Color','k','FontSize',16)
print('-dpng', ['sumjin(songjung)-regression NO3 ' num2str(i) '-month']);
end
...
xlabel('time(year)','fontsize',13)
ylabel('DO (mg/L)','fontsize',13)
title(['sumjin(songjung)-polynomial DO monthly'],'fontsize',13)
grid on; set(gca,'fontsize',13)
...
plot(idx,yCalc2,'--','color','r','linew',2)
gtext(['y = ',num2str(b(2),2),'x + ',num2str(b(1),2)],'Color','k','FontSize',16)
print('-dpng', ['sumjin(songjung)-polynomial DO monthly']);
...
xlabel('time(year)','fontsize',13)
ylabel('Chla (mg/m^3)','fontsize',13)
title(['sumjin(songjung)-polynomial Chla monthly'],'fontsize',13)
grid on; set(gca,'fontsize',13);
set(gca,'xtick',[1:36:12*31]);
set(gca,'xlim',[1 12*31]);
set(gca,'xticklabel',1989:3:2019);
...
plot(idx,yCalc2,'--','color','r','linew',2)
gtext(['y = ',num2str(b(2),2),'x + ',num2str(b(1),2)],'Color','k','FontSize',16)
print('-dpng', ['sumjin(songjung)-regression Chla monthly']);
...
xlabel('time(year)','fontsize',13)
ylabel('NH4 (mg/L)','fontsize',13)
title(['sumjin(songjung)-polynomial NH4 monthly'],'fontsize',13)
grid on; set(gca,'fontsize',13);
set(gca,'xtick',[1:36:12*31]);
set(gca,'xlim',[1 12*31]);
set(gca,'xticklabel',1989:3:2019);
...
plot(idx,yCalc2,'--','color','r','linew',2)
gtext(['y = ',num2str(b(2),2),'x + ',num2str(b(1),2)],'Color','k','FontSize',16)
print('-dpng', ['sumjin(songjung)-regression NH4 monthly']);
...
xlabel('time(year)','fontsize',13)
ylabel('NO3 (mg/L)','fontsize',13)
title(['sumjin(songjung)-regression NO3 monthly'],'fontsize',13)
grid on
set(gca,'fontsize',13)
set(gca,'xtick',[1:36:12*31]);
set(gca,'xlim',[1 12*31]);
...
plot(idx,yCalc2,'--','color','r','linew',2)
gtext(['y = ',num2str(b(2),2),'x + ',num2str(b(1),2)],'Color','k','FontSize',16)
print('-dpng', ['sumjin(songjung)-regression NO3 monthly']);
...
xlabel('time(year)','fontsize',13)
ylabel('DO (mg/L)','fontsize',13)
title(['Namgang-regression DO ' num2str(i) '-month'],'fontsize',13)
grid on
ylim([0 22])
set(gca,'xtick',[1:3:32]);
set(gca,'xlim',[1 32]);
...
plot(idx,yCalc2,'--','color','r','linew',2)
gtext(['y = ',num2str(b(2),2),'x + ',num2str(b(1),2)],'Color','k','FontSize',16)
print('-dpng', ['Namgang-regression DO ' num2str(i) '-month']);
end
...
w_chl_mth_f = w_chl_mth(i:12:end); 
 figure; hold on;
  ...
  xlabel('time(year)','fontsize',13)
ylabel('Chla (mg/m^3)','fontsize',13)
title(['Namgang-regression Chla ' num2str(i) '-month'],'fontsize',13)
grid on
set(gca,'fontsize',13)
set(gca,'xtick',[1:3:32]);
set(gca,'xlim',[1 32]);
...
gtext(['y = ',num2str(b(2),2),'x + ',num2str(b(1),2)],'Color','k','FontSize',16)
print('-dpng', ['Namgang-regression Chla ' num2str(i) '-month']);
end
...
xlabel('time(year)','fontsize',13)
ylabel('NH4 (mg/L)','fontsize',13)
title(['Namgang-regression NH4 ' num2str(i) '-month'],'fontsize',13)
grid on
set(gca,'fontsize',13)
set(gca,'xtick',[1:3:32]);
set(gca,'xlim',[1 32]);
...
gtext(['y = ',num2str(b(2),2),'x + ',num2str(b(1),2)],'Color','k','FontSize',16)
print('-dpng', ['Namgang-regression NH4 ' num2str(i) '-month']);
end
...
xlabel('time(year)','fontsize',13)
ylabel('NO3 (mg/L)','fontsize',13)
title(['Namgang-regression NO3 ' num2str(i) '-month'],'fontsize',13)
grid on
set(gca,'fontsize',13)
set(gca,'xtick',[1:3:32]);
set(gca,'xlim',[1 32]);
...
plot(idx,yCalc2,'--','color','r','linew',2)
gtext(['y = ',num2str(b(2),2),'x + ',num2str(b(1),2)],'Color','k','FontSize',16)
print('-dpng', ['Namgang-regression NO3 ' num2str(i) '-month']);
end
...
xlabel('time(year)','fontsize',13)
ylabel('DO (mg/L)','fontsize',13)
title(['Namgang-polynomial DO monthly'],'fontsize',13)
grid on; set(gca,'fontsize',13)
set(gca,'xtick',[1:36:12*31]);
set(gca,'xlim',[1 12*31]);
set(gca,'xticklabel',1989:3:2019);
...
gtext(['y = ',num2str(b(2),2),'x + ',num2str(b(1),2)],'Color','k','FontSize',16)
print('-dpng', ['Namgang-polynomial DO monthly']);
...
xlabel('time(year)','fontsize',13)
ylabel('Chla (mg/m^3)','fontsize',13)
title(['Namgang-polynomial Chla monthly'],'fontsize',13)
grid on; set(gca,'fontsize',13);
set(gca,'xtick',[1:36:12*31]);
set(gca,'xlim',[1 12*31]);
set(gca,'xticklabel',1989:3:2019);
...
plot(idx,yCalc2,'--','color','r','linew',2)
gtext(['y = ',num2str(b(2),2),'x + ',num2str(b(1),2)],'Color','k','FontSize',16)
print('-dpng', ['Namgang-regression Chla monthly']);
...
xlabel('time(year)','fontsize',13)
ylabel('NH4 (mg/L)','fontsize',13)
title(['Namgang-polynomial NH4 monthly'],'fontsize',13)
grid on; set(gca,'fontsize',13);
set(gca,'xtick',[1:36:12*31]);
set(gca,'xlim',[1 12*31]);
set(gca,'xticklabel',1989:3:2019);
...
plot(idx,yCalc2,'--','color','r','linew',2)
gtext(['y = ',num2str(b(2),2),'x + ',num2str(b(1),2)],'Color','k','FontSize',16)
print('-dpng', ['Namgang-regression NH4 monthly']);
...
xlabel('time(year)','fontsize',13)
ylabel('NO3 (mg/L)','fontsize',13)
title(['Namgang-regression NO3 monthly'],'fontsize',13)
grid on
set(gca,'fontsize',13)
set(gca,'xtick',[1:36:12*31]);
set(gca,'xlim',[1 12*31]);
...
plot(idx,yCalc2,'--','color','r','linew',2)
gtext(['y = ',num2str(b(2),2),'x + ',num2str(b(1),2)],'Color','k','FontSize',16)
print('-dpng', ['Namgang-regression NO3 monthly']);
