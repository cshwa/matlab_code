...
grdname=['/data2/yjtak/roms_grid_combine2_0p02.nc'];
...
clmname=['/data2/yjtak/','roms_nwp_clim.nc'];
% ininame=[ROMS_files_dir,'roms_nwp_ini2_test27.nc'];
ininame=['/data2/yjtak/','roms_nwp2_ini_0p02_n10.nc'];
oaname =['/data2/yjtak/','roms_nwp2_oa.nc'];    % oa file  : intermediate file not used
                                             %            in roms simulations
...
%  in the same format)
%
topofile = ['/home/yjtak/topo/etopo5.nc'];
%
...
%
%  Level of reference for geostrophy calculatione
%
zref = -1000;
%
...
%
woa_dir=['/home/yjtak/Dropbox/source/matlab/Model/ROMS/Roms_tools/WOA1998/'];
%
...
%
tidename=['/home/yjtak/Dropbox/source/matlab/Model/ROMS/Roms_tools/TPXO7/TPXO7.nc'];
%
...
%===================================================================
%
frcname=['/data2/yjtak/Pair_NWP_0p04_ECMWF_2010.nc'];
