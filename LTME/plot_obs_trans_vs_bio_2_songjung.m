...
load songjung_yymm_raw_data_89to19_3sig.mat
...
raw_chl=com_chl(1:t_indx(360));
raw_do=com_do(1:t_indx(360));
raw_no3=com_no3(1:t_indx(360));
raw_nh4=com_nh4(1:t_indx(360));
...
t_tick =[1 t_indx(12:12:end)+1]; %1989.01.01~2020.01.01
t_tick(end) = []; %1989.01.01~2019.01.01
%% chl
fig = figure; hold on;
