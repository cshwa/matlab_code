...
load no3_koem_input_400_16.mat %originaly upper line is right but last 2yrs i did it  and quite well;
...
save('boundary_bio_input_2003.mat','*_input*');
save('boundary_bio_input_for_ini_2003.mat','*_in');

save('check_boundary_no3_input_2003.mat','y_s_no3_205','y_b_no3_205');
