...
title('bias plot for songjung discharge'); grid on; xlim([1 yr_last(end)]);
ylabel('Bias (CMS)');
xticks([1 yr_last(1:end-1)+1]); xticklabels(2011:1:2018); set(gca,'fontsize',13);


figure; plot((sj_trans_out_2),'b');  hold on;  plot((Y_AI'),'r'); plot((f),'k');
title('songjung discharge compare'); grid on; xlim([1 yr_last(end)]);
...
ylim([80 100]); grid on; set(gca,'fontsize',13);
xticks(1:8); yticks(80:2:100);
...
xlabel('year'); xticks(1:8); yticks(0:10:100);
