...
% yr5_filter_1(1:168) = 1;
% yr5_filter_1(168+1:size(regime_no3,2)) = 1;
% ref_date{36} = ~1999-12'  1st cut
...
find_t_ind3 = {'2009-12'};
find_date3=find(strcmp(ref_date,find_t_ind3) == 1);

yr5_filter_1(1:find_date) = 1; % pass to ~1999-12'  1st cut
yr5_filter_1(find_date+1:find_date2) = NaN; % remove 2000-01~2004-12'  2nd cut
yr5_filter_1(find_date2+1:find_date3) = NaN; % remove 2005-01~2009-12'  3rd cut
yr5_filter_1(find_date3+1:length(ref_date)) = NaN; % extra

yr5_filter_2(1:find_date) = NaN; % pass to ~1999-12'  1st cut
yr5_filter_2(find_date+1:find_date2) = 1; % remove 2000-01~2004-12'  2nd cut
yr5_filter_2(find_date2+1:find_date3) = NaN; % remove 2005-01~2009-12'  3rd cut
yr5_filter_2(find_date3+1:length(ref_date)) = NaN; % extra

yr5_filter_3(1:find_date) = NaN; % pass to ~1999-12'  1st cut
yr5_filter_3(find_date+1:find_date2) = NaN; % remove 2000-01~2004-12'  2nd cut
yr5_filter_3(find_date2+1:find_date3) = 1; % remove 2005-01~2009-12'  3rd cut
yr5_filter_3(find_date3+1:length(ref_date)) = NaN; % extra

for i = 1:65
regime_no3_1(i,:) = regime_no3(i,:) .* yr5_filter_1; 
regime_nh4_1(i,:) = regime_nh4(i,:) .* yr5_filter_1; 
regime_do_1(i,:) = regime_do(i,:) .* yr5_filter_1; 
regime_chl_1(i,:) = regime_chl(i,:) .* yr5_filter_1; 
regime_temp_1(i,:) = regime_temp(i,:) .* yr5_filter_1; 
regime_salt_1(i,:) = regime_salt(i,:) .* yr5_filter_1; 
regime_no3_b_1(i,:) = regime_no3_b(i,:) .* yr5_filter_1; 
regime_nh4_b_1(i,:) = regime_nh4_b(i,:) .* yr5_filter_1; 
regime_do_b_1(i,:) = regime_do_b(i,:) .* yr5_filter_1; 
regime_chl_b_1(i,:) = regime_chl_b(i,:) .* yr5_filter_1; 
regime_temp_b_1(i,:) = regime_temp_b(i,:) .* yr5_filter_1; 
regime_salt_b_1(i,:) = regime_salt_b(i,:) .* yr5_filter_1;

regime_no3_2(i,:) = regime_no3(i,:) .* yr5_filter_2; 
regime_nh4_2(i,:) = regime_nh4(i,:) .* yr5_filter_2; 
regime_do_2(i,:) = regime_do(i,:) .* yr5_filter_2; 
regime_chl_2(i,:) = regime_chl(i,:) .* yr5_filter_2; 
regime_temp_2(i,:) = regime_temp(i,:) .* yr5_filter_2; 
regime_salt_2(i,:) = regime_salt(i,:) .* yr5_filter_2; 
regime_no3_b_2(i,:) = regime_no3_b(i,:) .* yr5_filter_2; 
regime_nh4_b_2(i,:) = regime_nh4_b(i,:) .* yr5_filter_2; 
regime_do_b_2(i,:) = regime_do_b(i,:) .* yr5_filter_2; 
regime_chl_b_2(i,:) = regime_chl_b(i,:) .* yr5_filter_2; 
regime_temp_b_2(i,:) = regime_temp_b(i,:) .* yr5_filter_2; 
regime_salt_b_2(i,:) = regime_salt_b(i,:) .* yr5_filter_2;

regime_no3_3(i,:) = regime_no3(i,:) .* yr5_filter_3; 
regime_nh4_3(i,:) = regime_nh4(i,:) .* yr5_filter_3; 
regime_do_3(i,:) = regime_do(i,:) .* yr5_filter_3; 
regime_chl_3(i,:) = regime_chl(i,:) .* yr5_filter_3; 
regime_temp_3(i,:) = regime_temp(i,:) .* yr5_filter_3; 
regime_salt_3(i,:) = regime_salt(i,:) .* yr5_filter_3; 
regime_no3_b_3(i,:) = regime_no3_b(i,:) .* yr5_filter_3; 
regime_nh4_b_3(i,:) = regime_nh4_b(i,:) .* yr5_filter_3; 
regime_do_b_3(i,:) = regime_do_b(i,:) .* yr5_filter_3; 
regime_chl_b_3(i,:) = regime_chl_b(i,:) .* yr5_filter_3; 
regime_temp_b_3(i,:) = regime_temp_b(i,:) .* yr5_filter_3; 
regime_salt_b_3(i,:) = regime_salt_b(i,:) .* yr5_filter_3;
end
...
%sp_gy 3rd
    obs_gy_no3_ft_3=squeeze(regime_no3_3(sp_gy,:));
    obs_gy_no3_b_ft_3=squeeze(regime_no3_b_3(sp_gy,:));
    obs_gy_nh4_ft_3=squeeze(regime_nh4_3(sp_gy,:));
    obs_gy_nh4_b_ft_3=squeeze(regime_nh4_b_3(sp_gy,:));
    obs_gy_chl_ft_3=squeeze(regime_chl_3(sp_gy,:));
    obs_gy_chl_b_ft_3=squeeze(regime_chl_b_3(sp_gy,:));
    obs_gy_temp_ft_3=squeeze(regime_temp_3(sp_gy,:));
    obs_gy_temp_b_ft_3=squeeze(regime_temp_b_3(sp_gy,:));
    obs_gy_salt_ft_3=squeeze(regime_salt_3(sp_gy,:));
    obs_gy_salt_b_ft_3=squeeze(regime_salt_b_3(sp_gy,:));
    obs_gy_do_ft_3=squeeze(regime_do_3(sp_gy,:));
    obs_gy_do_b_ft_3=squeeze(regime_do_b_3(sp_gy,:));     
...
for i = 1:12
   ...
   save(['koem_climate_5yr_v2_',num2str(sig),'sig_gy.mat'],'obs*','obm*','spm_obs*','tm_obs*'); 
end
