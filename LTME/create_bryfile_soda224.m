function create_bryfile_soda224(bryname,brytype,grdname,year,cycle,time)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
...
filename=['roms_bry_SODA-Y2008M1.nc'];
...
nc{'sc_r'}.formula_terms = ncchar('s: sc_r C: Cs_r eta: zeta depth: h depth_c: hc');
nc{'sc_r'}.formula_terms = 's: sc_r C: Cs_r eta: zeta depth: h depth_c: hc';
%
nc{'Cs_r'} = ncdouble('s_rho') ;
nc{'Cs_r'}.long_name = ncchar('S-coordinate stretching curves at RHO-points');
nc{'Cs_r'}.long_name = 'S-coordinate stretching curves at RHO-points';
...
nc{'Cs_w'}(:) = Cs_w;
    ...
    for mon=1:1:12
      filename=['SODA_2.2.4_',num2str(year),num2char(mon,2),'.cdf'];
      disp(filename);
