...
cd D:\장기생태\Dynamic\result\clim_pic_gy\2nd_2001-2010_4season
...
for i = 1:4
figure; hold on;
title_name = strcat('GY-',' 2001-2010.',i_season{i}, ' surf.');
...
for i = 1:4
figure; hold on;
title_name = strcat('GY-',' 2001-2010.',i_season{i}, ' temp.(^oC) surf.');
pcolor(lon,lat,squeeze(clim_mod_temp(:,:,20,i)).*(mask_r./mask_r)); shading flat;
...
for i = 1:4
figure; hold on;
title_name = strcat('GY-',' 2001-2010.',i_season{i}, ' salt.(psu) surf.');
...
for i = 1:4
figure; hold on;
title_name = strcat('GY-',' 2001-2010.',i_season{i}, ' chl.(ug/L) surf.');
...
for i = 1:4
figure; hold on;
title_name = strcat('GY-',' 2001-2010.',i_season{i}, ' no3.(mmol N m^-^3) surf.');
...
for i = 1:4
figure; hold on;
title_name = strcat('GY-',' 2001-2010.',i_season{i}, ' nh4.(mmol N m^-^3) surf.');
...
for i = 1:4
figure; hold on;
title_name = strcat('GY-',' 2001-2010.',i_season{i}, ' po4.(mmol P m^-^3) surf.');
...
for i = 1:4
figure; hold on;
title_name = strcat('GY-',' 2001~2010.',i_season{i}, ' phy.(mmol N m^-^3) surf.');
pcolor(lon,lat,squeeze(clim_mod_phy(:,:,20,i)).*(mask_r./mask_r)); shading flat;
[cs,h]=contour(lon,lat,squeeze(clim_mod_phy(:,:,20,i)),phy_range,'linecolor',[.01 .01 .01],'linewidth',1);
clabel(cs,h,'fontsize',11,'labelspacing',700,'fontweight','bold');
...
for i = 1:4
figure; hold on;
title_name = strcat('GY-',' 2001~2010.',i_season{i}, ' zoo.(mmol N m^-^3) surf.');
pcolor(lon,lat,squeeze(clim_mod_zoo(:,:,20,i)).*(mask_r./mask_r)); shading flat;
[cs,h]=contour(lon,lat,squeeze(clim_mod_zoo(:,:,20,i)),zoo_range,'linecolor',[.01 .01 .01],'linewidth',1);
clabel(cs,h,'fontsize',11,'labelspacing',700,'fontweight','bold');
...
for i = 1:4
figure; hold on;
title_name = strcat('GY-',' 2001-2010.',i_season{i}, ' bot.');
...
for i = 1:4
figure; hold on;
title_name = strcat('GY-',' 2001-2010.',i_season{i}, ' temp.(^oC) bot.');
pcolor(lon,lat,squeeze(clim_mod_temp(:,:,1,i)).*(mask_r./mask_r)); shading flat;
...
for i = 1:4
figure; hold on;
title_name = strcat('GY-',' 2001-2010.',i_season{i}, ' salt.(psu) bot.');
...
for i = 1:4
figure; hold on;
title_name = strcat('GY-',' 2001-2010.',i_season{i}, ' chl.(ug/L) bot.');
...
for i = 1:4
figure; hold on;
title_name = strcat('GY-',' 2001-2010.',i_season{i}, ' no3.(mmol N m^-^3) bot.');
...
for i = 1:4
figure; hold on;
title_name = strcat('GY-',' 2001-2010.',i_season{i}, ' nh4.(mmol N m^-^3) bot.');
...
for i = 1:4
figure; hold on;
title_name = strcat('GY-',' 2001-2010.',i_season{i}, ' po4.(mmol P m^-^3) bot.');
...
for i = 1:4
figure; hold on;
title_name = strcat('GY-',' 2001~2010.',i_season{i}, ' phy.(mmol N m^-^3) bot.');
...
for i = 1:4
figure; hold on;
title_name = strcat('GY-',' 2001~2010.',i_season{i}, ' zoo.(mmol N m^-^3) bot.');
