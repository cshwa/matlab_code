...
mod_file='D:\Àå±â»ıÅÂ\Dynamic\result\2001\2001_mp_p_sewer_det_z02.nc';
...
if leapyear(2001) ==  0
    ...
    mod_no3(:,:,:,38) =mod_no3(:,:,:,37); 
    mod_nh4(:,:,:,38) =mod_nh4(:,:,:,37); 
    mod_do(:,:,:,38) = mod_do(:,:,:,37); 
    mod_chl(:,:,:,38) =mod_chl(:,:,:,37);  
    mod_temp(:,:,:,38) =mod_temp(:,:,:,37);  
    mod_salt(:,:,:,38) =mod_salt(:,:,:,37);  
    mod_po4(:,:,:,38) =mod_po4(:,:,:,37); 
    mod_zoo(:,:,:,38) =mod_zoo(:,:,:,37);  
    mod_phy(:,:,:,38) =mod_phy(:,:,:,37);  
...
cd D:\Àå±â»ıÅÂ\Dynamic\result\2001
% save('2001_mp_p_sewer_det_result.mat','jj_*', 'gy_*', 'sgy_*', 'egy_*','obm*');   
save('2001_mp_p_sewer_det_z02_result.mat','-v7.3');          
