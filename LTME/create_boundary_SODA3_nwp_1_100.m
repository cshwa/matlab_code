...
if (windows ==1)
    % % for windows
    dropboxpath='C:\Users\KY\Dropbox'; %% SNU_desktop\
...
%     dropboxpath='/home01/kimyy/Dropbox'; %% ROMS server
    ...
    addpath(genpath([dropboxpath '/source/matlab/Model/ROMS/Roms_tools/Preprocessing_tools']));
    OGCM_path = '/data1/temp/SODA_3_4_2/';
    bry_prefix='/home/yjtak/Dropbox/source/matlab/Model/ROMS/OBC_SODA/SODA_';
end
...
ROMS_compile_bndy_SODA_nwp_1_100;