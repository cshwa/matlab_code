...
for t_year = 2001:2001 %before regime change
...
% River.flag(r) = 3; %temp, salt
if t_year < 1992;
River.trans(:,r)=sj_trans_out.*0.7; % ~1991 : .* 0.7 
elseif t_year >= 1992;
River.trans(:,r)=sj_trans_out; % ~1991 : .* 0.7 
end
...
temp=ncread('river_2001_realts_biofennel_GY_sewer_det_v7.nc','river_temp');
dis=ncread('river_2001_realts_biofennel_GY_sewer_det_v7.nc','river_transport');
figure;plot(dis(1,:));hold on; plot(dis(2,:),'r');
figure;plot(dis(1,:)-dis(2,:),'r');
