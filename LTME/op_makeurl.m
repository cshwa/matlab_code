function op_makeurl(h,url,varargin)
% Makes a "clickable" url from a uicontrol text.
%
% Written by Jordan Rosenthal, jr@ll.mit.edu
%
% op_makeurl(h,url)
%
...
% INPUT(S):
%
%   h -- handle to uicontrol object, must be a text object
%   url -- address of site to link to
%
% OUTPUT(S):
%
%   [none]
...
%            Rev., 18-Dec-2001 Added -browser switch and changed email
%            contact.
%----------------------------------------------------------------------------
% Default Parameters
%----------------------------------------------------------------------------
