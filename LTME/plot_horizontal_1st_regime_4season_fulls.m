...
for i = 1:4
   mod_file=['/data1/cshwa/ext_hdd/gwangyang/model/result/',num2str(refyear),'/','mp_p_sewer_det_f_monthly_',num2str(refyear),'_',i_season{i},'.nc'];
if exist(mod_file,'file') ~= 2
    mod_file=[]; 
    mod_file=['/data1/cshwa/ext_hdd/gwangyang/model/result/',num2str(refyear),'/','mp_p_sewer_det_monthly_',num2str(refyear),'_',i_season{i},'.nc'];
if exist(mod_file,'file') ~= 2
    mod_file=[]; 
    mod_file=['/data1/cshwa/ext_hdd/gwangyang/model/result/',num2str(refyear),'/','mp_p_sewer_det_f_2nd_monthly_',num2str(refyear),'_',i_season{i},'.nc'];
end
end
...
cd /data1/cshwa/ext_hdd/gwangyang/model/result/clim_pic_gy/1st_1991-2000_4season_fulls
