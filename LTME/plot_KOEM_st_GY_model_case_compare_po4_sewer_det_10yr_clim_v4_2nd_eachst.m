...
% clim1=load(['koem_climate_10yr_v5_',num2str(sig),'sig_gy_each_st.mat']); % # 9point
clim1=load(['koem_climate_10yr_v5_',num2str(sig),'sig_gy_8point.mat']); % # 8point extract GY-port
...
% % save(['plot_model_10yr_2nd_v5_',num2str(sig),'sig_',dir_name{case_num},'_gy_each_st.mat'],'regm_*','spm_*','tm_*','mer_*')
% % end
% % end

% %  dir_name ={'all_std','t_std','sp_std'};
cd(['D:\장기생태\Dynamic\KOEM\compare_sewer\2nd_10yr\v5_each_st\2nd_10yr_',num2str(sig),'sig_',dir_name{case_num}]);
