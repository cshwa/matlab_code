...
for i = 1:12
       fig = figure; hold on;
        pcolor(x,y,squeeze(mod_m_temp(:,:,20,i))); 
        shading flat; hold on;
        [cs,h]=contour(x,y,squeeze(mod_m_temp(:,:,20,i)),temp_range,'linecolor',[.01 .01 .01],'linewidth',1);
        clabel(cs,h,'fontsize',13,'labelspacing',700,'fontweight','bold');
        title(['2001-' num2str(i) '¿ùÆò±Õ ¸ğµ¨ ¼ö¿Â']);
        xlabel('°æµµ','fontsize',13)
        ylabel('À§µµ','fontsize',13)
        grid on
        set(gca,'fontsize',13)
        xlim([min(min(x)) max(max(x))])
        ylim([min(min(y)) max(max(y))])
        h = colorbar;
        set(get(h,'label'),'string','¼ö¿Â (^oC)');
        caxis([0 31])
        print(fig,strcat('2001_daily_MODEL_(',num2str(i),')-mon_temp'),'-dpng')
        hold off;
%         close;
   end
...
for i = 1:12
       fig = figure; hold on;
        pcolor(x,y,squeeze(mod_m_salt(:,:,20,i))); 
        shading flat; hold on;
        [cs,h]=contour(x,y,squeeze(mod_m_salt(:,:,20,i)),salt_range,'linecolor',[.01 .01 .01],'linewidth',1);
        clabel(cs,h,'fontsize',13,'labelspacing',700,'fontweight','bold');
        title(['2001-' num2str(i) '¿ùÆò±Õ ¸ğµ¨ ¿°ºĞ']);
        xlabel('°æµµ','fontsize',13)
        ylabel('À§µµ','fontsize',13)
        grid on
        set(gca,'fontsize',13)
        ...
        ylim([min(min(y)) max(max(y))])
        h = colorbar;
        set(get(h,'label'),'string','¿°ºĞ (psu)');
        caxis([28 35])
        print(fig,strcat('2001_daily_MODEL_(',num2str(i),')-mon_salt'),'-dpng')
        hold off;
%         close;
end
...
for i = 1:12
       fig = figure; hold on;
        pcolor(x,y,squeeze(mod_m_nh4(:,:,20,i))); 
        shading flat; hold on;
        [cs,h]=contour(x,y,squeeze(mod_m_nh4(:,:,20,i)),nh4_range,'linecolor',[.01 .01 .01],'linewidth',1);
        clabel(cs,h,'fontsize',13,'labelspacing',700,'fontweight','bold');
        title(['2001-' num2str(i) '¿ùÆò±Õ ¸ğµ¨ ¾Ï¸ğ´½']);
        xlabel('°æµµ','fontsize',13)
        ylabel('À§µµ','fontsize',13)
        grid on
        set(gca,'fontsize',13)
        ...
        ylim([min(min(y)) max(max(y))])
        h = colorbar;
        set(get(h,'label'),'string','¾Ï¸ğ´½ (mmol N / m^3)');
        caxis([0 5])
        print(fig,strcat('2001_daily_MODEL_(',num2str(i),')-mon_nh4'),'-dpng')
        hold off;
%         close;
end
...
for i = 1:12
       fig = figure; hold on;
        pcolor(x,y,squeeze(mod_m_no3(:,:,20,i))); 
        shading flat; hold on;
        [cs,h]=contour(x,y,squeeze(mod_m_no3(:,:,20,i)),no3_range,'linecolor',[.01 .01 .01],'linewidth',1);
        clabel(cs,h,'fontsize',13,'labelspacing',700,'fontweight','bold');
        title(['2001-' num2str(i) '¿ùÆò±Õ ¸ğµ¨ Áú»ê¿°']);
        xlabel('°æµµ','fontsize',13)
        ylabel('À§µµ','fontsize',13)
        grid on
        set(gca,'fontsize',13)
        ...
        ylim([min(min(y)) max(max(y))])
        h = colorbar;
        set(get(h,'label'),'string','Áú»ê¿° (mmol N / m^3)');
        caxis([0 10])
        print(fig,strcat('2001_daily_MODEL_(',num2str(i),')-mon_no3'),'-dpng')
        hold off;
%         close;
end
...
for i = 1:12
       fig = figure; hold on;
        pcolor(x,y,squeeze(mod_m_temp(:,:,1,i))); 
        shading flat; hold on;
        [cs,h]=contour(x,y,squeeze(mod_m_temp(:,:,1,i)),temp_range,'linecolor',[.01 .01 .01],'linewidth',1);
        clabel(cs,h,'fontsize',13,'labelspacing',700,'fontweight','bold');
        title(['2001-' num2str(i) '¿ùÆò±Õ ¸ğµ¨ ¹Ù´ÚÃş ¼ö¿Â']);
        xlabel('°æµµ','fontsize',13)
        ylabel('À§µµ','fontsize',13)
        grid on
        set(gca,'fontsize',13)
        ...
        set(get(h,'label'),'string','¼ö¿Â (^oC)');
        caxis([0 31])
        print(fig,strcat('2001_daily_MODEL_(',num2str(i),')-mon_bot_temp'),'-dpng')
        hold off;
%         close;
   end
...
for i = 1:12
       fig = figure; hold on;
        pcolor(x,y,squeeze(mod_m_salt(:,:,1,i))); 
        shading flat; hold on;
        [cs,h]=contour(x,y,squeeze(mod_m_salt(:,:,1,i)),salt_range,'linecolor',[.01 .01 .01],'linewidth',1);
        clabel(cs,h,'fontsize',13,'labelspacing',700,'fontweight','bold');
        title(['2001-' num2str(i) '¿ùÆò±Õ ¸ğµ¨ ¹Ù´ÚÃş ¿°ºĞ']);
        xlabel('°æµµ','fontsize',13)
        ylabel('À§µµ','fontsize',13)
        grid on
        set(gca,'fontsize',13)
        ...
        set(get(h,'label'),'string','¿°ºĞ (psu)');
        caxis([28 35])
        print(fig,strcat('2001_daily_MODEL_(',num2str(i),')-mon_bot_salt'),'-dpng')
        hold off;
%         close;
end
...
for i = 1:12
       fig = figure; hold on;
        pcolor(x,y,squeeze(mod_m_nh4(:,:,1,i))); 
        shading flat; hold on;
        [cs,h]=contour(x,y,squeeze(mod_m_nh4(:,:,1,i)),nh4_range,'linecolor',[.01 .01 .01],'linewidth',1);
        clabel(cs,h,'fontsize',13,'labelspacing',700,'fontweight','bold');
        title(['2001-' num2str(i) '¿ùÆò±Õ ¸ğµ¨ ¹Ù´ÚÃş ¾Ï¸ğ´½']);
        xlabel('°æµµ','fontsize',13)
        ylabel('À§µµ','fontsize',13)
        grid on
        set(gca,'fontsize',13)
        ...
        set(get(h,'label'),'string','¾Ï¸ğ´½ (mmol N / m^3)');
        caxis([0 5])
        print(fig,strcat('2001_daily_MODEL_(',num2str(i),')-mon_bot_nh4'),'-dpng')
        hold off;
%         close;
end
...
for i = 1:12
       fig = figure; hold on;
        pcolor(x,y,squeeze(mod_m_no3(:,:,1,i))); 
        shading flat; hold on;
        [cs,h]=contour(x,y,squeeze(mod_m_no3(:,:,1,i)),no3_range,'linecolor',[.01 .01 .01],'linewidth',1);
        clabel(cs,h,'fontsize',13,'labelspacing',700,'fontweight','bold');
        title(['2001-' num2str(i) '¿ùÆò±Õ ¸ğµ¨ ¹Ù´ÚÃş Áú»ê¿°']);
        xlabel('°æµµ','fontsize',13)
        ylabel('À§µµ','fontsize',13)
        grid on
        set(gca,'fontsize',13)
        ...
        set(get(h,'label'),'string','Áú»ê¿° (mmol N / m^3)');
        caxis([0 10])
        print(fig,strcat('2001_daily_MODEL_(',num2str(i),')-mon_bot_no3'),'-dpng')
        hold off;
%         close;
end
