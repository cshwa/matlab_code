...
%% ¼ÛÁ¤ À¯·®, ±Ý°­´ï ¹æ·ù·® load
load E:\Àå±â»ýÅÂ\Dynamic\06_river\data\sj_00_16_year\to_rd.mat
...
%--- 2015 ±îÁö 
fn = ['E:\Àå±â»ýÅÂ\Dynamic\06_river\data\nam_',num2str(t_year),'.xls'];
...
fn2 = ['E:\Àå±â»ýÅÂ\Dynamic\06_river\data\±â»óÃ»±â¿Â\gy_airtemp\³²ÇØ_2009.xlsx']
[num2,txt2,raw2] = xlsread(fn2);
temp_out=num2(:,3);
% temp_out = temp_out(1:31*12);
temp_out(isnan(temp_out))=[];
temp_out = temp_out(1:365);
salt_out = 1*ones(1,365); %silver
% salt_out = 0*ones(1,365);  
