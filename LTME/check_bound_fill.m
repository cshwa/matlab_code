...
% % mpdata.gy_temp
cd D:\장기생태\Dynamic\KOEM\compare_sewer\det_1997~2010_re
...
%         plot(zeros(365,1),'g--','linew',2); % zero lines
 %% 1997
        ...
        if i == 1
        patch([c1997_eom(1)-1+nonan_data_plt(1:discon_p(1)) fliplr(c1997_eom(1)-1+nonan_data_plt(1:discon_p(1)))], [upper_bound_plt(nonan_data_plt(1:discon_p(1))) fliplr(lower_bound_plt(nonan_data_plt(1:discon_p(1))))],'r');
        else
        patch([c1997_eom(1)-1+nonan_data_plt(discon_p(i-1)+1:discon_p(i)) fliplr(c1997_eom(1)-1+nonan_data_plt(discon_p(i-1)+1:discon_p(i)))], [upper_bound_plt(nonan_data_plt(discon_p(i-1)+1:discon_p(i))) fliplr(lower_bound_plt(nonan_data_plt(discon_p(i-1)+1:discon_p(i))))],'r');
        end
        end 
 ...
 %% 1998
        ...
        for i = 1:length(discon_p)
        if i == 1
        patch([c1998_eom(1)-1+nonan_data_plt(1:discon_p(1)) fliplr(c1998_eom(1)-1+nonan_data_plt(1:discon_p(1)))], [upper_bound_plt(nonan_data_plt(1:discon_p(1))) fliplr(lower_bound_plt(nonan_data_plt(1:discon_p(1))))],'r');
        else
        patch([c1998_eom(1)-1+nonan_data_plt(discon_p(i-1)+1:discon_p(i)) fliplr(c1998_eom(1)-1+nonan_data_plt(discon_p(i-1)+1:discon_p(i)))], [upper_bound_plt(nonan_data_plt(discon_p(i-1)+1:discon_p(i))) fliplr(lower_bound_plt(nonan_data_plt(discon_p(i-1)+1:discon_p(i))))],'r');
        end
        end 
 ...
 %% 1999
        ...
        for i = 1:length(discon_p)
        if i == 1
        patch([c1999_eom(1)-1+nonan_data_plt(1:discon_p(1)) fliplr(c1999_eom(1)-1+nonan_data_plt(1:discon_p(1)))], [upper_bound_plt(nonan_data_plt(1:discon_p(1))) fliplr(lower_bound_plt(nonan_data_plt(1:discon_p(1))))],'r');
        else
        patch([c1999_eom(1)-1+nonan_data_plt(discon_p(i-1)+1:discon_p(i)) fliplr(c1999_eom(1)-1+nonan_data_plt(discon_p(i-1)+1:discon_p(i)))], [upper_bound_plt(nonan_data_plt(discon_p(i-1)+1:discon_p(i))) fliplr(lower_bound_plt(nonan_data_plt(discon_p(i-1)+1:discon_p(i))))],'r');
        end
        end 
 ...
 %% 2000
        ...
        for i = 1:length(discon_p)
        if i == 1
        patch([c2000_eom(1)-1+nonan_data_plt(1:discon_p(1)) fliplr(c2000_eom(1)-1+nonan_data_plt(1:discon_p(1)))], [upper_bound_plt(nonan_data_plt(1:discon_p(1))) fliplr(lower_bound_plt(nonan_data_plt(1:discon_p(1))))],'r');
        else
        patch([c2000_eom(1)-1+nonan_data_plt(discon_p(i-1)+1:discon_p(i)) fliplr(c2000_eom(1)-1+nonan_data_plt(discon_p(i-1)+1:discon_p(i)))], [upper_bound_plt(nonan_data_plt(discon_p(i-1)+1:discon_p(i))) fliplr(lower_bound_plt(nonan_data_plt(discon_p(i-1)+1:discon_p(i))))],'r');
        end
        end 
 ...
 %% 2001
        ...
        for i = 1:length(discon_p)
        if i == 1
        patch([c2001_eom(1)-1+nonan_data_plt(1:discon_p(1)) fliplr(c2001_eom(1)-1+nonan_data_plt(1:discon_p(1)))], [upper_bound_plt(nonan_data_plt(1:discon_p(1))) fliplr(lower_bound_plt(nonan_data_plt(1:discon_p(1))))],'r');
        else
        patch([c2001_eom(1)-1+nonan_data_plt(discon_p(i-1)+1:discon_p(i)) fliplr(c2001_eom(1)-1+nonan_data_plt(discon_p(i-1)+1:discon_p(i)))], [upper_bound_plt(nonan_data_plt(discon_p(i-1)+1:discon_p(i))) fliplr(lower_bound_plt(nonan_data_plt(discon_p(i-1)+1:discon_p(i))))],'r');
        end
        end 
 ...
 %% 2002
        ...
        for i = 1:length(discon_p)
        if i == 1
        patch([c2002_eom(1)-1+nonan_data_plt(1:discon_p(1)) fliplr(c2002_eom(1)-1+nonan_data_plt(1:discon_p(1)))], [upper_bound_plt(nonan_data_plt(1:discon_p(1))) fliplr(lower_bound_plt(nonan_data_plt(1:discon_p(1))))],'r');
        else
        patch([c2002_eom(1)-1+nonan_data_plt(discon_p(i-1)+1:discon_p(i)) fliplr(c2002_eom(1)-1+nonan_data_plt(discon_p(i-1)+1:discon_p(i)))], [upper_bound_plt(nonan_data_plt(discon_p(i-1)+1:discon_p(i))) fliplr(lower_bound_plt(nonan_data_plt(discon_p(i-1)+1:discon_p(i))))],'r');
        end
        end 
 ...
 %% 2003
        ...
        for i = 1:length(discon_p)
        if i == 1
        patch([c2003_eom(1)-1+nonan_data_plt(1:discon_p(1)) fliplr(c2003_eom(1)-1+nonan_data_plt(1:discon_p(1)))], [upper_bound_plt(nonan_data_plt(1:discon_p(1))) fliplr(lower_bound_plt(nonan_data_plt(1:discon_p(1))))],'r');
        else
        patch([c2003_eom(1)-1+nonan_data_plt(discon_p(i-1)+1:discon_p(i)) fliplr(c2003_eom(1)-1+nonan_data_plt(discon_p(i-1)+1:discon_p(i)))], [upper_bound_plt(nonan_data_plt(discon_p(i-1)+1:discon_p(i))) fliplr(lower_bound_plt(nonan_data_plt(discon_p(i-1)+1:discon_p(i))))],'r');
        end
        end 
 ...
 %% 2004
        ...
        for i = 1:length(discon_p)
        if i == 1
        patch([c2004_eom(1)-1+nonan_data_plt(1:discon_p(1)) fliplr(c2004_eom(1)-1+nonan_data_plt(1:discon_p(1)))], [upper_bound_plt(nonan_data_plt(1:discon_p(1))) fliplr(lower_bound_plt(nonan_data_plt(1:discon_p(1))))],'r');
        else
        patch([c2004_eom(1)-1+nonan_data_plt(discon_p(i-1)+1:discon_p(i)) fliplr(c2004_eom(1)-1+nonan_data_plt(discon_p(i-1)+1:discon_p(i)))], [upper_bound_plt(nonan_data_plt(discon_p(i-1)+1:discon_p(i))) fliplr(lower_bound_plt(nonan_data_plt(discon_p(i-1)+1:discon_p(i))))],'r');
        end
        end 
 ...
 %% 2005
        ...
        for i = 1:length(discon_p)
        if i == 1
        patch([c2005_eom(1)-1+nonan_data_plt(1:discon_p(1)) fliplr(c2005_eom(1)-1+nonan_data_plt(1:discon_p(1)))], [upper_bound_plt(nonan_data_plt(1:discon_p(1))) fliplr(lower_bound_plt(nonan_data_plt(1:discon_p(1))))],'r');
        else
        patch([c2005_eom(1)-1+nonan_data_plt(discon_p(i-1)+1:discon_p(i)) fliplr(c2005_eom(1)-1+nonan_data_plt(discon_p(i-1)+1:discon_p(i)))], [upper_bound_plt(nonan_data_plt(discon_p(i-1)+1:discon_p(i))) fliplr(lower_bound_plt(nonan_data_plt(discon_p(i-1)+1:discon_p(i))))],'r');
        end
        end 
...
%% 2006
        ...
        for i = 1:length(discon_p)
        if i == 1
        patch([c2006_eom(1)-1+nonan_data_plt(1:discon_p(1)) fliplr(c2006_eom(1)-1+nonan_data_plt(1:discon_p(1)))], [upper_bound_plt(nonan_data_plt(1:discon_p(1))) fliplr(lower_bound_plt(nonan_data_plt(1:discon_p(1))))],'r');
        else
        patch([c2006_eom(1)-1+nonan_data_plt(discon_p(i-1)+1:discon_p(i)) fliplr(c2006_eom(1)-1+nonan_data_plt(discon_p(i-1)+1:discon_p(i)))], [upper_bound_plt(nonan_data_plt(discon_p(i-1)+1:discon_p(i))) fliplr(lower_bound_plt(nonan_data_plt(discon_p(i-1)+1:discon_p(i))))],'r');
        end
        end 
...
%% 2007
        ...
        for i = 1:length(discon_p)
        if i == 1
        patch([c2007_eom(1)-1+nonan_data_plt(1:discon_p(1)) fliplr(c2007_eom(1)-1+nonan_data_plt(1:discon_p(1)))], [upper_bound_plt(nonan_data_plt(1:discon_p(1))) fliplr(lower_bound_plt(nonan_data_plt(1:discon_p(1))))],'r');
        else
        patch([c2007_eom(1)-1+nonan_data_plt(discon_p(i-1)+1:discon_p(i)) fliplr(c2007_eom(1)-1+nonan_data_plt(discon_p(i-1)+1:discon_p(i)))], [upper_bound_plt(nonan_data_plt(discon_p(i-1)+1:discon_p(i))) fliplr(lower_bound_plt(nonan_data_plt(discon_p(i-1)+1:discon_p(i))))],'r');
        end
        end 
...
%% 2008
        ...
        for i = 1:length(discon_p)
        if i == 1
        patch([c2008_eom(1)-1+nonan_data_plt(1:discon_p(1)) fliplr(c2008_eom(1)-1+nonan_data_plt(1:discon_p(1)))], [upper_bound_plt(nonan_data_plt(1:discon_p(1))) fliplr(lower_bound_plt(nonan_data_plt(1:discon_p(1))))],'r');
        else
        patch([c2008_eom(1)-1+nonan_data_plt(discon_p(i-1)+1:discon_p(i)) fliplr(c2008_eom(1)-1+nonan_data_plt(discon_p(i-1)+1:discon_p(i)))], [upper_bound_plt(nonan_data_plt(discon_p(i-1)+1:discon_p(i))) fliplr(lower_bound_plt(nonan_data_plt(discon_p(i-1)+1:discon_p(i))))],'r');
        end
        end 
 ...
 %% 2009
        ...
        for i = 1:length(discon_p)
        if i == 1
        patch([c2009_eom(1)-1+nonan_data_plt(1:discon_p(1)) fliplr(c2009_eom(1)-1+nonan_data_plt(1:discon_p(1)))], [upper_bound_plt(nonan_data_plt(1:discon_p(1))) fliplr(lower_bound_plt(nonan_data_plt(1:discon_p(1))))],'r');
        else
        patch([c2009_eom(1)-1+nonan_data_plt(discon_p(i-1)+1:discon_p(i)) fliplr(c2009_eom(1)-1+nonan_data_plt(discon_p(i-1)+1:discon_p(i)))], [upper_bound_plt(nonan_data_plt(discon_p(i-1)+1:discon_p(i))) fliplr(lower_bound_plt(nonan_data_plt(discon_p(i-1)+1:discon_p(i))))],'r');
        end
        end 
 ...
 %% 2010
        ...
        for i = 1:length(discon_p)
        if i == 1
        patch([c2010_eom(1)-1+nonan_data_plt(1:discon_p(1)) fliplr(c2010_eom(1)-1+nonan_data_plt(1:discon_p(1)))], [upper_bound_plt(nonan_data_plt(1:discon_p(1))) fliplr(lower_bound_plt(nonan_data_plt(1:discon_p(1))))],'r');
        else
        patch([c2010_eom(1)-1+nonan_data_plt(discon_p(i-1)+1:discon_p(i)) fliplr(c2010_eom(1)-1+nonan_data_plt(discon_p(i-1)+1:discon_p(i)))], [upper_bound_plt(nonan_data_plt(discon_p(i-1)+1:discon_p(i))) fliplr(lower_bound_plt(nonan_data_plt(discon_p(i-1)+1:discon_p(i))))],'r');
        end
        end 
