function [j]=op_julianmd(y,m,d,h)
% Converts standard Gregorian time to decimal Julian day.
%
% j = op_julianmd(y,m,d,h)
%
...
% OUTPUT(S):
%
%   j -- decimal julian day (e.g., 0000 UT Jan 1 is 0.0)
%
% EXAMPLE:
%
