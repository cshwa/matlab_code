...
for i = 2003:2003
    yeart=i;
bryname=['bndy_',num2str(yeart),'_Gwangyang_P.nc'];
...
frcname=['sumjin_v11_tide_larged2_csh.nc'];
...
%%% load file        
load interp_bnd_fix_2003.mat

load D:\장기생태\Dynamic\KOEM\boundary_bio_input_2003.mat
