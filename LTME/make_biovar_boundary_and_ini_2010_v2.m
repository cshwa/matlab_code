...
load chl_koem_input_fix.mat %  y_s_chl, y_b_chl (mon) / y_s_chl_2nd
...
y_s_nh4 = y_s_nh4_2nd .*0.001.*1000./14; %%% ug/L to mM/m^3;
y_b_nh4 = y_b_nh4_2nd .*0.001.*1000./14; %%% ug/L to mM/m^3;
...
%%  plot_KODC_4_40616_polynomial_partial.m
...
y_s_no3_205 = yp_w_no3_3 .*0.001.*1000./14; %%% ug/L to mM/m^3;
y_b_no3_205 = yp_w_no3_b_2 .*0.001.*1000./14; %%% ug/L to mM/m^3;
...
y_s_no3_400 = yp_w_no3_3 .*0.001.*1000./14; %%% ug/L to mM/m^3;  % 2003 
y_b_no3_400 = yp_w_no3_b_2 .*0.001.*1000./14; %%% ug/L to mM/m^3;
...
%% chl
chl_in = NaN(12,20); chl_in(1:12,20)=y_s_chl_2nd; % 2nd reigme
...
save('boundary_bio_input_2010_v2.mat','*_input*');
save('boundary_bio_input_for_ini_2010_v2.mat','*_in');

save('check_boundary_no3_input_2010_v2.mat','y_s_no3_205','y_b_no3_205');
