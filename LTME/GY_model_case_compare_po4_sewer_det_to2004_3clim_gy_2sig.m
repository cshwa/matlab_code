...
clim1=load('koem_climate_3regime_v2_2sig_gy_to_2003_12.mat');
...
% % mpdata.gy_temp
cd D:\장기생태\Dynamic\KOEM\compare_sewer\det_2001~4_3clim_2sig
...
data(60)=[];
        plot(nanmean([c2001.gy_no3; c2002.gy_no3; c2003.gy_no3; data;],1),'b','linew',2);
...
data(60)=[];
        plot(nanmean([c2001.gy_nh4; c2002.gy_nh4; c2003.gy_nh4; data;],1),'b','linew',2);
               clearvars *_bound_plt nonan_data_plt discon_p
...
data(60)=[];
        plot(nanmean([c2001.gy_chl; c2002.gy_chl; c2003.gy_chl; data],1),'b','linew',2);
               clearvars *_bound_plt nonan_data_plt discon_p
...
data(60)=[];
        plot(nanmean([c2001.gy_temp; c2002.gy_temp; c2003.gy_temp; data],1),'b','linew',2);
               clearvars *_bound_plt nonan_data_plt discon_p
...
data(60)=[];
        plot(nanmean([c2001.gy_salt; c2002.gy_salt; c2003.gy_salt; data],1),'b','linew',2);
               clearvars *_bound_plt nonan_data_plt discon_p
...
data(60)=[];
        plot(nanmean([c2001.gy_no3_b; c2002.gy_no3_b; c2003.gy_no3_b; data],1),'b','linew',2);
               clearvars *_bound_plt nonan_data_plt discon_p
...
data(60)=[];
        plot(nanmean([c2001.gy_nh4_b; c2002.gy_nh4_b; c2003.gy_nh4_b; data],1),'b','linew',2);
               clearvars *_bound_plt nonan_data_plt discon_p
...
data(60)=[];
        plot(nanmean([c2001.gy_chl_b; c2002.gy_chl_b; c2003.gy_chl_b; data],1),'b','linew',2);
               clearvars *_bound_plt nonan_data_plt discon_p
...
data(60)=[];
        plot(nanmean([c2001.gy_temp_b; c2002.gy_temp_b; c2003.gy_temp_b; data],1),'b','linew',2);
               clearvars *_bound_plt nonan_data_plt discon_p
...
data(60)=[];
        plot(nanmean([c2001.gy_salt_b; c2002.gy_salt_b; c2003.gy_salt_b; data],1),'b','linew',2);
               clearvars *_bound_plt nonan_data_plt discon_p
