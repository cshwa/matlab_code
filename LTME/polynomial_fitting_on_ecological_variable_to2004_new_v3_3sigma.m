...
regime_do_af = regime_do_af - regm_do_af;
regime_chl_af = regime_chl_af - regm_chl_af;
regime_no3_af = regime_no3_af - regm_no3_af;
regime_nh4_af = regime_nh4_af - regm_nh4_af;
...
yp_w_do_af = yp_w_do_af + regm_do_af;
yp_w_chl_af = yp_w_chl_af + regm_chl_af;
yp_w_no3_af = yp_w_no3_af + regm_no3_af;
yp_w_nh4_af = yp_w_nh4_af + regm_nh4_af;
...
%% DO
figure;
scatter(1:366,reg_af_clim_do + regm_do_af);
hold on
plot(1:366, yp_w_do_af,'--','color','r','linew',2)
xlabel('time(days)','fontsize',13)
ylabel('DO (mg/L)','fontsize',13)
...
%% chl
figure;
scatter(1:366,reg_af_clim_chl + regm_chl_af);
hold on
plot(1:366, yp_w_chl_af,'--','color','r','linew',2)
xlabel('time(days)','fontsize',13)
ylabel('Chla (mg/m^3)','fontsize',13)
...
%% no3
figure;
scatter(1:366,reg_af_clim_no3 + regm_no3_af);
hold on
plot(1:366, yp_w_no3_af,'--','color','r','linew',2)
xlabel('time(days)','fontsize',13)
ylabel('NO3 (mg/L)','fontsize',13)
...
%% nh4
figure;
scatter(1:366,reg_af_clim_nh4 + regm_nh4_af);
hold on
plot(1:366, yp_w_nh4_af,'--','color','r','linew',2)
xlabel('time(days)','fontsize',13)
ylabel('NH4 (mg/L)','fontsize',13)
