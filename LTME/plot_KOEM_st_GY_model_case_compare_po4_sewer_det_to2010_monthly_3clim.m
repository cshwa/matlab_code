...
% % mpdata.gy_temp
cd D:\장기생태\Dynamic\KOEM\compare_sewer\det_3clim_monthly
...
%std
    % 1st
    regm_std_1st_no3(i)=std(mer_no3(i:12:84));
    regm_std_1st_nh4(i)=std(mer_nh4(i:12:84));
    regm_std_1st_chl(i)=std(mer_chl(i:12:84));
    regm_std_1st_temp(i)=std(mer_temp(i:12:84));
    regm_std_1st_salt(i)=std(mer_salt(i:12:84));
    % 2nd
    regm_std_2nd_no3(i)=std(mer_no3(84+i:12:156));
    regm_std_2nd_nh4(i)=std(mer_nh4(84+i:12:156));
    regm_std_2nd_chl(i)=std(mer_chl(84+i:12:156));
    regm_std_2nd_temp(i)=std(mer_temp(84+i:12:156));
    regm_std_2nd_salt(i)=std(mer_salt(84+i:12:156));  
  
    % 1st
    regm_std_1st_no3_b(i)=std(mer_no3_b(i:12:84));
    regm_std_1st_nh4_b(i)=std(mer_nh4_b(i:12:84));
    regm_std_1st_chl_b(i)=std(mer_chl_b(i:12:84));
    regm_std_1st_temp_b(i)=std(mer_temp_b(i:12:84));
    regm_std_1st_salt_b(i)=std(mer_salt_b(i:12:84));
    % 2nd
    regm_std_2nd_no3_b(i)=std(mer_no3_b(84+i:12:156));
    regm_std_2nd_nh4_b(i)=std(mer_nh4_b(84+i:12:156));
    regm_std_2nd_chl_b(i)=std(mer_chl_b(84+i:12:156));
    regm_std_2nd_temp_b(i)=std(mer_temp_b(84+i:12:156));
    regm_std_2nd_salt_b(i)=std(mer_salt_b(84+i:12:156)); 
