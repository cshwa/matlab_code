...
mypath='D:\장기생태\yellow_sea\matlab\Model\ROMS\Roms_tools\';
addpath(genpath(mypath));
addpath(genpath(['D:\장기생태\yellow_sea\matlab\Common\netcdf_old']));
addpath(genpath(['D:\장기생태\yellow_sea\matlab\Common\m_map']));
%
