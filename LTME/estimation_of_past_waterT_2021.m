...
load('songjung_regression_yeosu_extract_climate_2021.mat','yp','yp_w','b','r_temp','r_date_txt'); 
...
save('sumjin_recons_water_temp_present_2021.mat');
...
load('hadong_regression_yeosu_extract_climate_2021.mat','yp','yp_w','b','r_temp','r_date_txt'); 
...
xlim([1466 length(temp_air)]);
ylim([-5 35]); xtickangle(45)
save('sumjin_recons_water_temp(hadong)_present_2021.mat');
...
[rawa3 txta3]=xlsread('여수_AWS_1990to2019.xls','yeosu_2010to2019','');
[rawa4 txta4]=xlsread('여수_AWS_2020.xlsx','여수_AWS_2020','');
[rawa5 txta5]=xlsread('여수_AWS_2021.xlsx','여수_AWS_2021','');
% [rawa5 txta5]=xlsread('D:\RIST\2021_RIST_광양만\KMA_ASOS\여수_AWS_2021_10.xlsx','OBS_ASOS_여수_2021_10','');
cd  D:\장기생태\Dynamic\06_river_physics\환경과학원
load('agyang_regression_yeosu_extract_climate_2021.mat','yp','yp_w','b','r_temp','r_date_txt'); 
...
xlim([1466 length(temp_air)]);
ylim([-5 35]); xtickangle(45)
save('sumjin_recons_water_temp(agyang)_present_2021.mat');
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
[rawa5 txta5]=xlsread('여수_AWS_2021_05.xlsx','여수_AWS_2021_05','');
cd  D:\장기생태\Dynamic\06_river_physics\환경과학원
load('jinwal_regression_yeosu_extract_climate_2021.mat','yp','yp_w','b','r_temp','r_date_txt'); 
...
xlim([1466 length(temp_air)]);
ylim([-5 35]); xtickangle(45)
save('sumjin_recons_water_temp(jinwal)_present_2021.mat');
