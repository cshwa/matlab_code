...
save('remake_sewer_data_monthly.mat');
...
find_ttp_wallne = {'1999-11'};
find_ttp2_wallne = {'2008-09'};
...
find_ttn_wallne = {'1999-09'};
find_ttn2_wallne = {'2003-10'};
...
% tp_jungheung = 2008-01
ttp_j_filter=NaN(length(tp_j_2set_re2),1);
ttp2_j_filter=NaN(length(tp_j_2set_re2),1);

find_ttp_jungheung = {'2007-12'};
find_ttp_date=find(strcmp(ref_date,find_ttp_jungheung) == 1);

ttp_j_filter(1:find_ttp_date) = 1; ttp_j_filter(find_ttp_date+1:end) = NaN; % pass to 2007-12 (1st)
ttp2_j_filter(1:find_ttp_date) = NaN; ttp2_j_filter(find_ttp_date+1:end) = 1;  % pass from 2008-01 to end (2nd)
...
find_ttn_jungheung = {'2003-04'};
find_ttn2_jungheung = {'2008-12'};
...
save('sewer_monthly_climate_fix.mat','clim*');
