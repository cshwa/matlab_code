...
mod_file='D:\Àå±â»ıÅÂ\Dynamic\result\2001\2001_mp_p_sewer_det.nc';
...
for j = 1:length(sp_gy)
    sp_gy_no3(j,:,:)=squeeze(mod_no3(near_point_2d(sp_gy(j),1), near_point_2d(sp_gy(j),2),:,:));
    ...
    sp_gy_nh4(j,:,:)=squeeze(mod_nh4(near_point_2d(sp_gy(j),1), near_point_2d(sp_gy(j),2),:,:));
    ...
    sp_gy_chl(j,:,:)=squeeze(mod_chl(near_point_2d(sp_gy(j),1), near_point_2d(sp_gy(j),2),:,:));
    ...
    sp_gy_temp(j,:,:)=squeeze(mod_temp(near_point_2d(sp_gy(j),1), near_point_2d(sp_gy(j),2),:,:));
    ...
    sp_gy_salt(j,:,:)=squeeze(mod_salt(near_point_2d(sp_gy(j),1), near_point_2d(sp_gy(j),2),:,:));
    ...
    sp_gy_do(j,:,:)=squeeze(mod_do(near_point_2d(sp_gy(j),1), near_point_2d(sp_gy(j),2),:,:));
    ...
    sp_gy_po4(j,:,:)=squeeze(mod_po4(near_point_2d(sp_gy(j),1), near_point_2d(sp_gy(j),2),:,:));
...
for j = 1:length(sp_s_gy)
    sp_sgy_no3(j,:,:)=squeeze(mod_no3(near_point_2d(sp_s_gy(j),1), near_point_2d(sp_s_gy(j),2),:,:));
    ...
    sp_sgy_nh4(j,:,:)=squeeze(mod_nh4(near_point_2d(sp_s_gy(j),1), near_point_2d(sp_s_gy(j),2),:,:));
    ...
    sp_sgy_chl(j,:,:)=squeeze(mod_chl(near_point_2d(sp_s_gy(j),1), near_point_2d(sp_s_gy(j),2),:,:));
    ...
    sp_sgy_temp(j,:,:)=squeeze(mod_temp(near_point_2d(sp_s_gy(j),1), near_point_2d(sp_s_gy(j),2),:,:));
    ...
    sp_sgy_salt(j,:,:)=squeeze(mod_salt(near_point_2d(sp_s_gy(j),1), near_point_2d(sp_s_gy(j),2),:,:));
    ...
    sp_sgy_do(j,:,:)=squeeze(mod_do(near_point_2d(sp_s_gy(j),1), near_point_2d(sp_s_gy(j),2),:,:));
    ...
    sp_sgy_po4(j,:,:)=squeeze(mod_po4(near_point_2d(sp_s_gy(j),1), near_point_2d(sp_s_gy(j),2),:,:));
...
for j = 1:length(sp_e_gy)
    sp_egy_no3(j,:,:)=squeeze(mod_no3(near_point_2d(sp_e_gy(j),1), near_point_2d(sp_e_gy(j),2),:,:));
    ...
    sp_egy_nh4(j,:,:)=squeeze(mod_nh4(near_point_2d(sp_e_gy(j),1), near_point_2d(sp_e_gy(j),2),:,:));
    ...
    sp_egy_chl(j,:,:)=squeeze(mod_chl(near_point_2d(sp_e_gy(j),1), near_point_2d(sp_e_gy(j),2),:,:));
    ...
    sp_egy_temp(j,:,:)=squeeze(mod_temp(near_point_2d(sp_e_gy(j),1), near_point_2d(sp_e_gy(j),2),:,:));
    ...
    sp_egy_salt(j,:,:)=squeeze(mod_salt(near_point_2d(sp_e_gy(j),1), near_point_2d(sp_e_gy(j),2),:,:));
    ...
    sp_egy_do(j,:,:)=squeeze(mod_do(near_point_2d(sp_e_gy(j),1), near_point_2d(sp_e_gy(j),2),:,:));
    ...
    sp_egy_po4(j,:,:)=squeeze(mod_po4(near_point_2d(sp_e_gy(j),1), near_point_2d(sp_e_gy(j),2),:,:));
...
for j = 1:length(sp_jj)
    sp_jj_no3(j,:,:)=squeeze(mod_no3(near_point_2d(sp_jj(j),1), near_point_2d(sp_jj(j),2),:,:));
    ...
    sp_jj_nh4(j,:,:)=squeeze(mod_nh4(near_point_2d(sp_jj(j),1), near_point_2d(sp_jj(j),2),:,:));
    ...
    sp_jj_chl(j,:,:)=squeeze(mod_chl(near_point_2d(sp_jj(j),1), near_point_2d(sp_jj(j),2),:,:));
    ...
    sp_jj_temp(j,:,:)=squeeze(mod_temp(near_point_2d(sp_jj(j),1), near_point_2d(sp_jj(j),2),:,:));
    ...
    sp_jj_salt(j,:,:)=squeeze(mod_salt(near_point_2d(sp_jj(j),1), near_point_2d(sp_jj(j),2),:,:));
    ...
    sp_jj_do(j,:,:)=squeeze(mod_do(near_point_2d(sp_jj(j),1), near_point_2d(sp_jj(j),2),:,:));
    ...
    sp_jj_po4(j,:,:)=squeeze(mod_po4(near_point_2d(sp_jj(j),1), near_point_2d(sp_jj(j),2),:,:));
...
for i = 1:size(sp_gy_no3,3)
    for j = 1:20 %vertical layer
    %std
    std_gy_no3(j,i)=nanstd(squeeze(sp_gy_no3(:,j,i)));
    std_gy_nh4(j,i)=nanstd(squeeze(sp_gy_nh4(:,j,i)));
    std_gy_chl(j,i)=nanstd(squeeze(sp_gy_chl(:,j,i)));
    std_gy_temp(j,i)=nanstd(squeeze(sp_gy_temp(:,j,i)));
    std_gy_salt(j,i)=nanstd(squeeze(sp_gy_salt(:,j,i)));
    std_gy_do(j,i)=nanstd(squeeze(sp_gy_do(:,j,i)));
...
%     std_gy_do_b(i)=nanstd(squeeze(sp_gy_do_b(:,i)));
    ...
    std_sgy_no3(j,i)=nanstd(squeeze(sp_sgy_no3(:,j,i)));
%     std_sgy_no3_b(i)=nanstd(squeeze(sp_sgy_no3_b(:,i)));
    std_sgy_nh4(j,i)=nanstd(squeeze(sp_sgy_nh4(:,j,i)));
%     std_sgy_nh4_b(i)=nanstd(squeeze(sp_sgy_nh4_b(:,i)));
    std_sgy_chl(j,i)=nanstd(squeeze(sp_sgy_chl(:,j,i)));
%     std_sgy_chl_b(i)=nanstd(squeeze(sp_sgy_chl_b(:,i)));
    std_sgy_temp(j,i)=nanstd(squeeze(sp_sgy_temp(:,j,i)));
%     std_sgy_temp_b(i)=nanstd(squeeze(sp_sgy_temp_b(:,i)));
    std_sgy_salt(j,i)=nanstd(squeeze(sp_sgy_salt(:,j,i)));
%     std_sgy_salt_b(i)=nanstd(squeeze(sp_sgy_salt_b(:,i)));
    std_sgy_do(j,i)=nanstd(squeeze(sp_sgy_do(:,j,i)));
%     std_sgy_do_b(i)=nanstd(squeeze(sp_sgy_do_b(:,i)));

    std_egy_no3(j,i)=nanstd(squeeze(sp_egy_no3(:,j,i)));
%     std_egy_no3_b(i)=nanstd(squeeze(sp_egy_no3_b(:,i)));
    std_egy_nh4(j,i)=nanstd(squeeze(sp_egy_nh4(:,j,i)));
%     std_egy_nh4_b(i)=nanstd(squeeze(sp_egy_nh4_b(:,i)));
    std_egy_chl(j,i)=nanstd(squeeze(sp_egy_chl(:,j,i)));
%     std_egy_chl_b(i)=nanstd(squeeze(sp_egy_chl_b(:,i)));
    std_egy_temp(j,i)=nanstd(squeeze(sp_egy_temp(:,j,i)));
%     std_egy_temp_b(i)=nanstd(squeeze(sp_egy_temp_b(:,i)));
    std_egy_salt(j,i)=nanstd(squeeze(sp_egy_salt(:,j,i)));
%     std_egy_salt_b(i)=nanstd(squeeze(sp_egy_salt_b(:,i)));
    std_egy_do(j,i)=nanstd(squeeze(sp_egy_do(:,j,i)));
...
%     std_egy_do_mid(i)=nanstd(squeeze(sp_egy_do_mid(:,i)));
    ...
    std_jj_no3(j,i)=nanstd(squeeze(sp_jj_no3(:,j,i)));
%     std_jj_no3_b(i)=nanstd(squeeze(sp_jj_no3_b(:,i)));
    std_jj_nh4(j,i)=nanstd(squeeze(sp_jj_nh4(:,j,i)));
%     std_jj_nh4_b(i)=nanstd(squeeze(sp_jj_nh4_b(:,i)));
    std_jj_chl(j,i)=nanstd(squeeze(sp_jj_chl(:,j,i)));
%     std_jj_chl_b(i)=nanstd(squeeze(sp_jj_chl_b(:,i)));
    std_jj_temp(j,i)=nanstd(squeeze(sp_jj_temp(:,j,i)));
%     std_jj_temp_b(i)=nanstd(squeeze(sp_jj_temp_b(:,i)));
    std_jj_salt(j,i)=nanstd(squeeze(sp_jj_salt(:,j,i)));
%     std_jj_salt_b(i)=nanstd(squeeze(sp_jj_salt_b(:,i)));
    std_jj_do(j,i)=nanstd(squeeze(sp_jj_do(:,j,i)));
...
%     std_jj_do_mid(i)=nanstd(squeeze(sp_jj_do_mid(:,i)));
    ...
    %mean
    gy_no3(j,i)=nanmean(squeeze(sp_gy_no3(:,j,i)));
%     gy_no3_b(i)=nanmean(squeeze(sp_gy_no3_b(:,i)));
    gy_nh4(j,i)=nanmean(squeeze(sp_gy_nh4(:,j,i)));
%     gy_nh4_b(i)=nanmean(squeeze(sp_gy_nh4_b(:,i)));
    gy_chl(j,i)=nanmean(squeeze(sp_gy_chl(:,j,i)));
%     gy_chl_b(i)=nanmean(squeeze(sp_gy_chl_b(:,i)));
    gy_temp(j,i)=nanmean(squeeze(sp_gy_temp(:,j,i)));
%     gy_temp_b(i)=nanmean(squeeze(sp_gy_temp_b(:,i)));
    gy_salt(j,i)=nanmean(squeeze(sp_gy_salt(:,j,i)));
%     gy_salt_b(i)=nanmean(squeeze(sp_gy_salt_b(:,i)));
    gy_do(j,i)=nanmean(squeeze(sp_gy_do(:,j,i)));
%     gy_do_b(i)=nanmean(squeeze(sp_gy_do_b(:,i)));

    sgy_no3(j,i)=nanmean(squeeze(sp_sgy_no3(:,j,i)));
%     sgy_no3_b(i)=nanmean(squeeze(sp_sgy_no3_b(:,i)));
    sgy_nh4(j,i)=nanmean(squeeze(sp_sgy_nh4(:,j,i)));
%     sgy_nh4_b(i)=nanmean(squeeze(sp_sgy_nh4_b(:,i)));
    sgy_chl(j,i)=nanmean(squeeze(sp_sgy_chl(:,j,i)));
%     sgy_chl_b(i)=nanmean(squeeze(sp_sgy_chl_b(:,i)));
    sgy_temp(j,i)=nanmean(squeeze(sp_sgy_temp(:,j,i)));
%     sgy_temp_b(i)=nanmean(squeeze(sp_sgy_temp_b(:,i)));
    sgy_salt(j,i)=nanmean(squeeze(sp_sgy_salt(:,j,i)));
%     sgy_salt_b(i)=nanmean(squeeze(sp_sgy_salt_b(:,i)));
    sgy_do(j,i)=nanmean(squeeze(sp_sgy_do(:,j,i)));
%     sgy_do_b(i)=nanmean(squeeze(sp_sgy_do_b(:,i)));

    egy_no3(j,i)=nanmean(squeeze(sp_egy_no3(:,j,i)));
%     egy_no3_b(i)=nanmean(squeeze(sp_egy_no3_b(:,i)));
    egy_nh4(j,i)=nanmean(squeeze(sp_egy_nh4(:,j,i)));
%     egy_nh4_b(i)=nanmean(squeeze(sp_egy_nh4_b(:,i)));
    egy_chl(j,i)=nanmean(squeeze(sp_egy_chl(:,j,i)));
%     egy_chl_b(i)=nanmean(squeeze(sp_egy_chl_b(:,i)));
    egy_temp(j,i)=nanmean(squeeze(sp_egy_temp(:,j,i)));
%     egy_temp_b(i)=nanmean(squeeze(sp_egy_temp_b(:,i)));
    egy_salt(j,i)=nanmean(squeeze(sp_egy_salt(:,j,i)));
%     egy_salt_b(i)=nanmean(squeeze(sp_egy_salt_b(:,i)));
    egy_do(j,i)=nanmean(squeeze(sp_egy_do(:,j,i)));
%     egy_do_b(i)=nanmean(squeeze(sp_egy_do_b(:,i)));

    jj_no3(j,i)=nanmean(squeeze(sp_jj_no3(:,j,i)));
%     jj_no3_b(i)=nanmean(squeeze(sp_jj_no3_b(:,i)));
    jj_nh4(j,i)=nanmean(squeeze(sp_jj_nh4(:,j,i)));
%     jj_nh4_b(i)=nanmean(squeeze(sp_jj_nh4_b(:,i)));
    jj_chl(j,i)=nanmean(squeeze(sp_jj_chl(:,j,i)));
%     jj_chl_b(i)=nanmean(squeeze(sp_jj_chl_b(:,i)));
    jj_temp(j,i)=nanmean(squeeze(sp_jj_temp(:,j,i)));
%     jj_temp_b(i)=nanmean(squeeze(sp_jj_temp_b(:,i)));
    jj_salt(j,i)=nanmean(squeeze(sp_jj_salt(:,j,i)));
%     jj_salt_b(i)=nanmean(squeeze(sp_jj_salt_b(:,i)));
    jj_do(j,i)=nanmean(squeeze(sp_jj_do(:,j,i)));
...
%     std_egy_po4_mid(i)=nanstd(squeeze(sp_egy_po4_mid(:,i)));
    ...
    std_jj_po4_b(i)=nanstd(squeeze(sp_jj_po4_b(:,i)));
     ...
     gy_po4(j,i)=nanmean(squeeze(sp_gy_po4(:,j,i)));
%     gy_po4_b(i)=nanmean(squeeze(sp_gy_po4_b(:,i)));


     sgy_po4(j,i)=nanmean(squeeze(sp_sgy_po4(:,j,i)));
%     sgy_po4_b(i)=nanmean(squeeze(sp_sgy_po4_b(:,i)));
    
    egy_po4(j,i)=nanmean(squeeze(sp_egy_po4(:,j,i)));
%     egy_po4_b(i)=nanmean(squeeze(sp_egy_po4_b(:,i)));
    
        jj_po4(j,i)=nanmean(squeeze(sp_jj_po4(:,j,i)));
...
%         plot(zeros(365,1),'g--','linew',2); % zero lines
        plot(gy_no3','linew',2);
%make vertical layer legend        
for i = 1:20
        ver_lv{i}=num2str(i);
end        
        nonan_data_plt = find(isnan(obm_gy_no3)==0);
        nonan_data_plt_b = find(isnan(obm_gy_no3_b)==0);
        ...
        upper_bound_plt_b = obm_gy_no3_b./14 + obs_std_gy_no3_b./14;
        lower_bound_plt_b = obm_gy_no3_b./14 - obs_std_gy_no3_b./14;
      
%         plot(obm_gy_no3./14,'r-','linew',2); xlim([1 365]);
        plot(obm_gy_no3_b./14,'b-','linew',2);
%         plot(1:length(obm_gy_no3),upper_bound_plt,'r-','linew',2);
%         plot(1:length(obm_gy_no3),lower_bound_plt,'r-','linew',2);
        plot(1:length(obm_gy_no3_b),upper_bound_plt_b,'b-','linew',2);
        plot(1:length(obm_gy_no3_b),lower_bound_plt_b,'b-','linew',2);
...
%         patch([nonan_data_plt(1:discon_p(1)) fliplr(nonan_data_plt(1:discon_p(1)))], [upper_bound_plt(nonan_data_plt(1:discon_p(1))) lower_bound_plt(nonan_data_plt(1:discon_p(1)))],'r');
        patch([nonan_data_plt_b(1:discon_p_b(1)) fliplr(nonan_data_plt_b(1:discon_p_b(1)))], [upper_bound_plt_b(nonan_data_plt_b(1:discon_p_b(1))) lower_bound_plt_b(nonan_data_plt_b(1:discon_p_b(1)))],'b')
        else
%         patch([nonan_data_plt(discon_p(i-1)+1:discon_p(i)) fliplr(nonan_data_plt(discon_p(i-1)+1:discon_p(i)))], [upper_bound_plt(nonan_data_plt(discon_p(i-1)+1:discon_p(i))) lower_bound_plt(nonan_data_plt(discon_p(i-1)+1:discon_p(i)))],'r');
        patch([nonan_data_plt_b(discon_p_b(i-1)+1:discon_p_b(i)) fliplr(nonan_data_plt_b(discon_p_b(i-1)+1:discon_p_b(i)))], [upper_bound_plt_b(nonan_data_plt_b(discon_p_b(i-1)+1:discon_p_b(i))) lower_bound_plt_b(nonan_data_plt_b(discon_p_b(i-1)+1:discon_p_b(i)))],'b')
        end
        end
        ...
        ylabel('NO3 (umol/m^3)','fontsize',13)
        grid on; 
        legend(ver_lv); %vertical layer legend
        set(gca,'fontsize',13)
...
save('mp_p_sewer_det_result.mat','jj_*', 'gy_*', 'sgy_*', 'egy_*');     
