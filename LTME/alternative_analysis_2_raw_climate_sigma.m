...
for sig=1:6  %sigma
clearvars b1 yCalc1 X b nonan idx nanaxisx *_mth_f idx1 sig_txt *_mi2
% raw
...
title(['sumjin(songjung)-polynomial do raw - climate ' num2str(sig) '-sigma'],'fontsize',13)
print('-dpng', ['sumjin(songjung)_do_raw-climate_' num2str(sig) '-sigma']);

% for sig=1:6  %sigma
% clearvars b1 yCalc1 X b yCalc2 nonan idx nanaxisx *_mth_f idx1 sig_txt *_mi2
% % raw
% idx1 = find(isnan(w_do_mi) == 0);
% w_do_mi2=w_do_mi;
% sig_txt = sig*std(w_do_mi(idx1))
% mean(w_do_mi(idx1))
% w_do_mi2(find(w_do_mi > mean(w_do_mi(idx1)) + sig*std(w_do_mi(idx1))))=NaN;
% w_do_mi2(find(w_do_mi < mean(w_do_mi(idx1)) - sig*std(w_do_mi(idx1))))=NaN;
%  figure; hold on;
...
ylim([-20 inf])
title(['sumjin(songjung)-polynomial chl raw - climate ' num2str(sig) '-sigma'],'fontsize',13)
print('-dpng', ['sumjin(songjung)_chl_raw-climate_' num2str(sig) '-sigma']);
...
ylim([-0.5 inf])
title(['sumjin(songjung)-polynomial nh4 raw - climate ' num2str(sig) '-sigma'],'fontsize',13)
print('-dpng', ['sumjin(songjung)_nh4_raw-climate_' num2str(sig) '-sigma']);
...
% ylim([-0.5 inf])
title(['sumjin(songjung)-polynomial no3 raw - climate ' num2str(sig) '-sigma'],'fontsize',13)
print('-dpng', ['sumjin(songjung)_no3_raw-climate_' num2str(sig) '-sigma']);
...
color_spec = ['k', 'r', 'b', 'g', 'c', 'm'];
figure; hold on;
plot(w_do(indx_12mth{i}),'.','linew',2);
xlabel('time(year)','fontsize',13)
ylabel('DO (mg/L)','fontsize',13)
grid on; 
ylim([0 inf])
...
set(gca,'fontsize',13)
set(gca,'xtick',[1:31*3:length(w_do(indx_12mth{i}))]);
set(gca,'xlim',[1 length(w_do(indx_12mth{i}))]);
set(gca,'xticklabel',1989:3:2019);

    for sig = 1:6 
        clearvars b1 yCalc1 X b nonan idx nanaxisx *_mth_f idx1 w_do_mi_p sig_txt *_mi_p
    ...
    title(['sumjin(songjung)-regression DO raw ' num2str(i) '-month(daily) ' num2str(sig) '-sigma'],'fontsize',13)
    print('-dpng', ['sumjin(songjung)-regression DO_raw ' num2str(i) '-month(daily) ' num2str(sig) '-sigma']);
end
...
color_spec = ['k', 'r', 'b', 'g', 'c', 'm'];
figure; hold on;
plot(w_chl(indx_12mth{i}),'.','linew',2);
xlabel('time(year)','fontsize',13)
ylabel('chl (mg/L)','fontsize',13)
grid on; 
ylim([0 inf])
...
set(gca,'fontsize',13)
set(gca,'xtick',[1:31*3:length(w_chl(indx_12mth{i}))]);
set(gca,'xlim',[1 length(w_chl(indx_12mth{i}))]);
set(gca,'xticklabel',1989:3:2019);

    for sig = 1:6 
    clearvars b1 yCalc1 X b nonan idx nanaxisx *_mth_f idx1 w_chl_mi_p sig_txt *_mi_p
...
title(['sumjin(songjung)-regression chl raw ' num2str(i) '-month(daily) ' num2str(sig) '-sigma'],'fontsize',13)
    print('-dpng', ['sumjin(songjung)-regression chl_raw ' num2str(i) '-month(daily) ' num2str(sig) '-sigma']);
end
...
color_spec = ['k', 'r', 'b', 'g', 'c', 'm'];
figure; hold on;
plot(w_nh4(indx_12mth{i}),'.','linew',2);
xlabel('time(year)','fontsize',13)
ylabel('nh4 (mg/L)','fontsize',13)
grid on; 
ylim([0 inf])
...
set(gca,'fontsize',13)
set(gca,'xtick',[1:31*3:length(w_nh4(indx_12mth{i}))]);
set(gca,'xlim',[1 length(w_nh4(indx_12mth{i}))]);
set(gca,'xticklabel',1989:3:2019);

    for sig = 1:6 
    clearvars b1 yCalc1 X b nonan idx nanaxisx *_mth_f idx1 w_nh4_mi_p sig_txt *_mi_p
...
title(['sumjin(songjung)-regression nh4 raw ' num2str(i) '-month(daily) ' num2str(sig) '-sigma'],'fontsize',13)
    print('-dpng', ['sumjin(songjung)-regression nh4_raw ' num2str(i) '-month(daily) ' num2str(sig) '-sigma']);
...
color_spec = ['k', 'r', 'b', 'g', 'c', 'm'];
figure; hold on;
plot(w_no3(indx_12mth{i}),'.','linew',2);
xlabel('time(year)','fontsize',13)
ylabel('no3 (mg/L)','fontsize',13)
grid on; 
ylim([0 inf])
...
set(gca,'fontsize',13)
set(gca,'xtick',[1:31*3:length(w_no3(indx_12mth{i}))]);
set(gca,'xlim',[1 length(w_no3(indx_12mth{i}))]);
set(gca,'xticklabel',1989:3:2019);

    for sig = 1:6 
    clearvars b1 yCalc1 X b nonan idx nanaxisx *_mth_f idx1 w_no3_mi_p sig_txt *_mi_p
...
title(['sumjin(songjung)-regression no3 raw ' num2str(i) '-month(daily) ' num2str(sig) '-sigma'],'fontsize',13)
    print('-dpng', ['sumjin(songjung)-regression no3_raw ' num2str(i) '-month(daily) ' num2str(sig) '-sigma']);
...
plot(idx,yCalc2,'--','color','r','linew',2)
gtext(['y = ',num2str(b(2),2),'x + ',num2str(b(1),2)],'Color','k','FontSize',16)
print('-dpng', ['sumjin(songjung)-regression DO_raw-climate ' num2str(i) '-month']);
end
...
title(['sumjin(songjung)-regression Chla raw-climate ' num2str(i) '-month'],'fontsize',13)
grid on
set(gca,'fontsize',13)
  ylim([-10 30])
set(gca,'xtick',[1:3:32]);
...
plot(idx,yCalc2,'--','color','r','linew',2)
gtext(['y = ',num2str(b(2),2),'x + ',num2str(b(1),2)],'Color','k','FontSize',16)
print('-dpng', ['sumjin(songjung)-regression Chla_raw-climate ' num2str(i) '-month']);
end
...
plot(idx,yCalc2,'--','color','r','linew',2)
gtext(['y = ',num2str(b(2),2),'x + ',num2str(b(1),2)],'Color','k','FontSize',16)
print('-dpng', ['sumjin(songjung)-regression NH4_raw-climate ' num2str(i) '-month']);
end
...
plot(idx,yCalc2,'--','color','r','linew',2)
gtext(['y = ',num2str(b(2),2),'x + ',num2str(b(1),2)],'Color','k','FontSize',16)
print('-dpng', ['sumjin(songjung)-regression NO3_raw-climate ' num2str(i) '-month']);
end
...
xlabel('time(year)','fontsize',13)
ylabel('DO (mg/L)','fontsize',13)
title(['sumjin(songjung)-polynomial DO raw-climate monthly '  num2str(sig) '-sigma'],'fontsize',13)
grid on; set(gca,'fontsize',13)
...
print('-dpng', ['sumjin(songjung)-polynomial DO_raw-climate monthly '  num2str(sig) '-sigma']);
...
xlabel('time(year)','fontsize',13)
ylabel('Chla (mg/m^3)','fontsize',13)
title(['sumjin(songjung)-polynomial Chla raw-climate monthly '  num2str(sig) '-sigma'],'fontsize',13)
grid on; set(gca,'fontsize',13);
set(gca,'xtick',[1:36:12*31]);
set(gca,'xlim',[1 12*31]);
set(gca,'xticklabel',1989:3:2019);
...
gtext(['y = ',num2str(b(2),2),'x + ',num2str(b(1),2)],'Color','k','FontSize',16)
gtext(['3-sigma = ' num2str(sig_txt)],'Color','k','FontSize',16)
print('-dpng', ['sumjin(songjung)-regression Chla_raw-climate monthly '  num2str(sig) '-sigma']);
...
xlabel('time(year)','fontsize',13)
ylabel('NH4 (mg/L)','fontsize',13)
title(['sumjin(songjung)-polynomial NH4 raw-climate monthly '  num2str(sig) '-sigma'],'fontsize',13)
grid on; set(gca,'fontsize',13);
set(gca,'xtick',[1:36:12*31]);
set(gca,'xlim',[1 12*31]);
set(gca,'xticklabel',1989:3:2019);
...
gtext(['y = ',num2str(b(2),2),'x + ',num2str(b(1),2)],'Color','k','FontSize',16)
gtext(['3-sigma = ' num2str(sig_txt)],'Color','k','FontSize',16)
print('-dpng', ['sumjin(songjung)-regression NH4_raw-climate monthly '  num2str(sig) '-sigma']);
...
xlabel('time(year)','fontsize',13)
ylabel('NO3 (mg/L)','fontsize',13)
title(['sumjin(songjung)-regression NO3 raw-climate monthly '  num2str(sig) '-sigma'],'fontsize',13)
grid on
set(gca,'fontsize',13)
set(gca,'xtick',[1:36:12*31]);
set(gca,'xlim',[1 12*31]);
...
gtext(['y = ',num2str(b(2),2),'x + ',num2str(b(1),2)],'Color','k','FontSize',16)
gtext(['3-sigma = ' num2str(sig_txt)],'Color','k','FontSize',16)
print('-dpng', ['sumjin(songjung)-regression NO3_raw-climate monthly '  num2str(sig) '-sigma']);
...
title(['Namgang-polynomial do raw - climate ' num2str(sig) '-sigma'],'fontsize',13)
print('-dpng', ['Namgang_do_raw-climate_' num2str(sig) '-sigma']);
...
ylim([-20 inf])
title(['Namgang-polynomial chl raw - climate ' num2str(sig) '-sigma'],'fontsize',13)
print('-dpng', ['Namgang_chl_raw-climate_' num2str(sig) '-sigma']);
...
ylim([-0.5 inf])
title(['Namgang-polynomial nh4 raw - climate ' num2str(sig) '-sigma'],'fontsize',13)
print('-dpng', ['Namgang_nh4_raw-climate_' num2str(sig) '-sigma']);
...
% ylim([-0.5 inf])
title(['Namgang-polynomial no3 raw - climate ' num2str(sig) '-sigma'],'fontsize',13)
print('-dpng', ['Namgang_no3_raw-climate_' num2str(sig) '-sigma']);
...
set(gca,'xticklabel',1989:3:2019);
    ...
    title(['Namgang-regression DO raw ' num2str(i) '-month(daily) ' num2str(sig) '-sigma'],'fontsize',13)
    print('-dpng', ['Namgang-regression DO_raw ' num2str(i) '-month(daily) ' num2str(sig) '-sigma']);
end
...
title(['Namgang-regression chl raw ' num2str(i) '-month(daily) ' num2str(sig) '-sigma'],'fontsize',13)
    print('-dpng', ['Namgang-regression chl_raw ' num2str(i) '-month(daily) ' num2str(sig) '-sigma']);
end
...
title(['Namgang-regression nh4 raw ' num2str(i) '-month(daily) ' num2str(sig) '-sigma'],'fontsize',13)
    print('-dpng', ['Namgang-regression nh4_raw ' num2str(i) '-month(daily) ' num2str(sig) '-sigma']);
...
title(['Namgang-regression no3 raw ' num2str(i) '-month(daily) ' num2str(sig) '-sigma'],'fontsize',13)
    print('-dpng', ['Namgang-regression no3_raw ' num2str(i) '-month(daily) ' num2str(sig) '-sigma']);
...
plot(idx,yCalc2,'--','color','r','linew',2)
gtext(['y = ',num2str(b(2),2),'x + ',num2str(b(1),2)],'Color','k','FontSize',16)
print('-dpng', ['Namgang-regression DO_raw-climate ' num2str(i) '-month']);
end
...
w_chl_mth_f = w_chl_mth(i:12:end) - chl_mth_clim(i:12:end);
 figure; hold on;
  ...
  xlabel('time(year)','fontsize',13)
ylabel('Chla (mg/m^3)','fontsize',13)
title(['Namgang-regression Chla raw-climate ' num2str(i) '-month'],'fontsize',13)
grid on
set(gca,'fontsize',13)
  ylim([-10 30])
set(gca,'xtick',[1:3:32]);
...
plot(idx,yCalc2,'--','color','r','linew',2)
gtext(['y = ',num2str(b(2),2),'x + ',num2str(b(1),2)],'Color','k','FontSize',16)
print('-dpng', ['Namgang-regression Chla_raw-climate ' num2str(i) '-month']);
end
...
plot(idx,yCalc2,'--','color','r','linew',2)
gtext(['y = ',num2str(b(2),2),'x + ',num2str(b(1),2)],'Color','k','FontSize',16)
print('-dpng', ['Namgang-regression NH4_raw-climate ' num2str(i) '-month']);
end
...
plot(idx,yCalc2,'--','color','r','linew',2)
gtext(['y = ',num2str(b(2),2),'x + ',num2str(b(1),2)],'Color','k','FontSize',16)
print('-dpng', ['Namgang-regression NO3_raw-climate ' num2str(i) '-month']);
end
...
xlabel('time(year)','fontsize',13)
ylabel('DO (mg/L)','fontsize',13)
title(['Namgang-polynomial DO raw-climate monthly '  num2str(sig) '-sigma'],'fontsize',13)
grid on; set(gca,'fontsize',13)
set(gca,'xtick',[1:36:12*31]);
set(gca,'xlim',[1 12*31]);
set(gca,'xticklabel',1989:3:2019);
...
gtext(['y = ',num2str(b(2),2),'x + ',num2str(b(1),2)],'Color','k','FontSize',16)
gtext(['3-sigma = ' num2str(sig_txt)],'Color','k','FontSize',16)
print('-dpng', ['Namgang-polynomial DO_raw-climate monthly '  num2str(sig) '-sigma']);
...
xlabel('time(year)','fontsize',13)
ylabel('Chla (mg/m^3)','fontsize',13)
title(['Namgang-polynomial Chla raw-climate monthly '  num2str(sig) '-sigma'],'fontsize',13)
grid on; set(gca,'fontsize',13);
set(gca,'xtick',[1:36:12*31]);
set(gca,'xlim',[1 12*31]);
set(gca,'xticklabel',1989:3:2019);
...
gtext(['y = ',num2str(b(2),2),'x + ',num2str(b(1),2)],'Color','k','FontSize',16)
gtext(['3-sigma = ' num2str(sig_txt)],'Color','k','FontSize',16)
print('-dpng', ['Namgang-regression Chla_raw-climate monthly '  num2str(sig) '-sigma']);
...
xlabel('time(year)','fontsize',13)
ylabel('NH4 (mg/L)','fontsize',13)
title(['Namgang-polynomial NH4 raw-climate monthly '  num2str(sig) '-sigma'],'fontsize',13)
grid on; set(gca,'fontsize',13);
set(gca,'xtick',[1:36:12*31]);
set(gca,'xlim',[1 12*31]);
set(gca,'xticklabel',1989:3:2019);
...
gtext(['y = ',num2str(b(2),2),'x + ',num2str(b(1),2)],'Color','k','FontSize',16)
gtext(['3-sigma = ' num2str(sig_txt)],'Color','k','FontSize',16)
print('-dpng', ['Namgang-regression NH4_raw-climate monthly '  num2str(sig) '-sigma']);
...
xlabel('time(year)','fontsize',13)
ylabel('NO3 (mg/L)','fontsize',13)
title(['Namgang-regression NO3 raw-climate monthly '  num2str(sig) '-sigma'],'fontsize',13)
grid on
set(gca,'fontsize',13)
set(gca,'xtick',[1:36:12*31]);
set(gca,'xlim',[1 12*31]);
...
gtext(['y = ',num2str(b(2),2),'x + ',num2str(b(1),2)],'Color','k','FontSize',16)
gtext(['3-sigma = ' num2str(sig_txt)],'Color','k','FontSize',16)
print('-dpng', ['Namgang-regression NO3_raw-climate monthly '  num2str(sig) '-sigma']);
