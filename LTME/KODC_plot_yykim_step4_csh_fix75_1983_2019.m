...
inputyear = [1983:2019]; % % put year which you want to plot [year year ...]
...
load(['D:\장기생태\Dynamic\KOEM\NIFS\model_salt_trend_',num2str(min(inputyear),'%04i'),'_',num2str(max(inputyear),'%04i'),'_fix75.mat']);
...
figrawdir =strcat('D:\장기생태\Dynamic\KOEM\NIFS\fig\');
