...
for i = 1:length(k_f)
     for j = 1:length(em_f{i})
        temp_f(:,:,:,i,j) = ncread(['/data1/cshwa/ext_hdd2/longterm/coco_storage/1982_regrid_v3/ocean_avg_',num2str(em_f{i}(j),'%04d'),'.nc'],'temp');
        salt_f(:,:,:,i,j) = ncread(['/data1/cshwa/ext_hdd2/longterm/coco_storage/1982_regrid_v3/ocean_avg_',num2str(em_f{i}(j),'%04d'),'.nc'],'salt');
        zeta_f(:,:,i,j) = ncread(['/data1/cshwa/ext_hdd2/longterm/coco_storage/1982_regrid_v3/ocean_avg_',num2str(em_f{i}(j),'%04d'),'.nc'],'zeta');
     end
end

for i = 1:length(k_b)
     for j = 1:length(em_b{i})
        temp_b(:,:,:,i,j) = ncread(['/data1/cshwa/ext_hdd2/longterm/coco_storage/1982_regrid_v3/ocean_avg_',num2str(em_b{i}(j),'%04d'),'.nc'],'temp');
        salt_b(:,:,:,i,j) = ncread(['/data1/cshwa/ext_hdd2/longterm/coco_storage/1982_regrid_v3/ocean_avg_',num2str(em_b{i}(j),'%04d'),'.nc'],'salt');
        zeta_b(:,:,i,j) = ncread(['/data1/cshwa/ext_hdd2/longterm/coco_storage/1982_regrid_v3/ocean_avg_',num2str(em_b{i}(j),'%04d'),'.nc'],'zeta');
     end
end
