function create_inifile_no3_nh4(inifile,gridfile,title,...
...
nc{'NH4'}.long_name = ncchar('ammonium');
nc{'NH4'}.long_name = 'ammonium';
nc{'NH4'}.units = ncchar('micro mole N/L');
nc{'NH4'}.units = 'micro mole N/L';

nc{'NO3'}.long_name = ncchar('nitrate');
nc{'NO3'}.long_name = 'nitrate';
nc{'NO3'}.units = ncchar('micro mole N/L');
nc{'NO3'}.units = 'micro mole N/L';
%
