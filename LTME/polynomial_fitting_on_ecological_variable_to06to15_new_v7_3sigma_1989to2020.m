...
regime_tn_2 = raw_tn(cut_2+1:cut_3);                                                              
regime_tn_3 = raw_no3(cut_3+1:end);

regime_tp_1 = raw_tp(cut_0+1:cut_1);
regime_tp_2 = raw_tp(cut_2+1:cut_3);                                                              
regime_tp_3 = raw_tp(cut_3+1:end);

regime_chl_1 = raw_chl(cut_0+1:cut_1);
regime_chl_2 = raw_chl(cut_2+1:cut_3);                                                              
regime_chl_3 = raw_chl(cut_3+1:end);

regime_ss_1 = raw_ss(cut_0+1:cut_1);
regime_ss_2 = raw_ss(cut_2+1:cut_3);                                                              
regime_ss_3 = raw_ss(cut_3+1:end);

regime_po4_1 = raw_po4(cut_0+1:cut_1);
regime_po4_2 = raw_po4(cut_2+1:cut_3);                                                              
regime_po4_3 = raw_po4(cut_3+1:end);

regime_no3_1 = raw_no3(cut_0+1:cut_1);
regime_no3_2 = raw_no3(cut_2+1:cut_3);                                                              
regime_no3_3 = raw_no3(cut_3+1:end);

regime_nh4_1 = raw_nh4(cut_0+1:cut_1);
regime_nh4_2 = raw_nh4(cut_2+1:cut_3);                                                              
regime_nh4_3 = raw_nh4(cut_3+1:end);
