...
% cd D:\장기생태\Dynamic\KOEM\gy_2001\mp_p_ws
...
% % mpdata.gy_temp
cd D:\장기생태\Dynamic\KOEM\gy_2001\mpdata_vs_po4
...
%         plot(zeros(365,1),'g--','linew',2); % zero lines
        ...
        %plot(1:length(ltme__no3_s_mean_d),ltme_no3_s_mean_d + ltme_no3_s_std_d,'y-','linew',2);
        %plot(1:length(ltme__no3_s_mean_d),ltme_no3_s_mean_d - ltme_no3_s_std_d,'y-','linew',2);        
...
%         plot(zeros(365,1),'g--','linew',2); % zero lines
        ...
        %plot(1:length(ltme__nh4_s_mean_d),ltme_nh4_s_mean_d + ltme_nh4_s_std_d,'y-','linew',2);
        %plot(1:length(ltme__nh4_s_mean_d),ltme_nh4_s_mean_d - ltme_nh4_s_std_d,'y-','linew',2);  
...
%         plot(zeros(365,1),'g--','linew',2); % zero lines
        ...
        %plot(1:length(ltme__chl_s_mean_d),ltme_chl_s_mean_d + ltme_chl_s_std_d,'y-','linew',2);
        %plot(1:length(ltme__chl_s_mean_d),ltme_chl_s_mean_d - ltme_chl_s_std_d,'y-','linew',2);  
...
%         plot(zeros(365,1),'g--','linew',2); % zero lines
        ...
        %plot(1:length(ltme__t_s_mean_d),ltme_t_s_mean_d + ltme_t_s_std_d,'y-','linew',2);
        %plot(1:length(ltme__t_s_mean_d),ltme_t_s_mean_d - ltme_t_s_std_d,'y-','linew',2);  
...
%         plot(zeros(365,1),'g--','linew',2); % zero lines
        ...
        %plot(1:length(ltme__s_s_mean_d),ltme_s_s_mean_d + ltme_s_s_std_d,'y-','linew',2);
        %plot(1:length(ltme__s_s_mean_d),ltme_s_s_mean_d - ltme_s_s_std_d,'y-','linew',2);  
...
%         plot(zeros(365,1),'g--','linew',2); % zero lines
        ...
        %plot(1:length(ltme__no3_b_mean_d),ltme_no3_b_mean_d + ltme_no3_b_std_d,'y-','linew',2);
        %plot(1:length(ltme__no3_b_mean_d),ltme_no3_b_mean_d - ltme_no3_b_std_d,'y-','linew',2); 
...
%         plot(zeros(365,1),'g--','linew',2); % zero lines
        ...
        %plot(1:length(ltme__nh4_b_mean_d),ltme_nh4_b_mean_d + ltme_nh4_b_std_d,'y-','linew',2);
        %plot(1:length(ltme__nh4_b_mean_d),ltme_nh4_b_mean_d - ltme_nh4_b_std_d,'y-','linew',2);
...
%         plot(zeros(365,1),'g--','linew',2); % zero lines
        ...
        %plot(1:length(ltme__chl_b_mean_d),ltme_chl_b_mean_d + ltme_chl_b_std_d,'y-','linew',2);
        %plot(1:length(ltme__chl_b_mean_d),ltme_chl_b_mean_d - ltme_chl_b_std_d,'y-','linew',2);  
...
%         plot(zeros(365,1),'g--','linew',2); % zero lines
        ...
        %plot(1:length(ltme__t_b_mean_d),ltme_t_b_mean_d + ltme_t_b_std_d,'y-','linew',2);
        %plot(1:length(ltme__t_b_mean_d),ltme_t_b_mean_d - ltme_t_b_std_d,'y-','linew',2);
...
%         plot(zeros(365,1),'g--','linew',2); % zero lines
        ...
        %plot(1:length(ltme__s_b_mean_d),ltme_s_b_mean_d + ltme_s_s_std_d,'y-','linew',2);
        %plot(1:length(ltme__s_b_mean_d),ltme_s_b_mean_d - ltme_s_s_std_d,'y-','linew',2);
