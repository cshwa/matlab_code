...
b0(sig) = b(1);  b1(sig) = b(2);
yCalc2{sig} = [1:length(w_do_04)].*b1(sig) + b0(sig);
plot([tx_tick(29)+1:1:tx_tick(29)+length(w_do_04)],yCalc2{sig},'-.','color','k','linew',2)
line([tx_tick(29)+1:1:tx_tick(29)+length(w_do_04)], upper_bc(sig),'color', color_spec(sig),'linew',2)
line([tx_tick(29)+1:1:tx_tick(29)+length(w_do_04)], lower_bc(sig),'color', color_spec(sig),'linew',2)
yCalc3 = yCalc2{sig};
plot([tx_tick(29)+1:1:tx_tick(29)+length(w_do_04)],mean(w_do_04(idx1)),'-.','color',color_spec(sig-1),'linew',2);
...
clearvars b1 yCalc1 X b nonan idx nanaxisx *_mth_f idx1 sig_txt *_mi2 *_recon yCalc3
% raw
w_chl_04=w_chl(tx_tick(29)+1:end);
idx1 = find(isnan(w_chl_04) == 0);
w_chl_042=w_chl_04;
upper_bc(sig) = mean(w_chl_04(idx1)) + sig*std(w_chl_04(idx1));
lower_bc(sig) = mean(w_chl_04(idx1)) - sig*std(w_chl_04(idx1));
...
b0(sig) = b(1);  b1(sig) = b(2);
yCalc2{sig} = [1:length(w_chl_04)].*b1(sig) + b0(sig);
plot([tx_tick(29)+1:1:tx_tick(29)+length(w_chl_04)],yCalc2{sig},'-.','color','k','linew',2)
line([tx_tick(29)+1:1:tx_tick(29)+length(w_chl_04)], upper_bc(sig),'color', color_spec(sig),'linew',2)
line([tx_tick(29)+1:1:tx_tick(29)+length(w_chl_04)], lower_bc(sig),'color', color_spec(sig),'linew',2)
yCalc3 = yCalc2{sig};
plot([tx_tick(29)+1:1:tx_tick(29)+length(w_chl_04)],mean(w_chl_04(idx1)),'-.','color',color_spec(sig-1),'linew',2);
...
clearvars b1 yCalc1 X b nonan idx nanaxisx *_mth_f idx1 sig_txt *_mi2 *_recon yCalc3
% raw
w_nh4_04=w_nh4(tx_tick(29)+1:end);
idx1 = find(isnan(w_nh4_04) == 0);
w_nh4_042=w_nh4_04;
upper_bc(sig) = mean(w_nh4_04(idx1)) + sig*std(w_nh4_04(idx1));
lower_bc(sig) = mean(w_nh4_04(idx1)) - sig*std(w_nh4_04(idx1));
...
b0(sig) = b(1);  b1(sig) = b(2);
yCalc2{sig} = [1:length(w_nh4_04)].*b1(sig) + b0(sig);
plot([tx_tick(29)+1:1:tx_tick(29)+length(w_nh4_04)],yCalc2{sig},'-.','color','k','linew',2)
line([tx_tick(29)+1:1:tx_tick(29)+length(w_nh4_04)], upper_bc(sig),'color', color_spec(sig),'linew',2)
line([tx_tick(29)+1:1:tx_tick(29)+length(w_nh4_04)], lower_bc(sig),'color', color_spec(sig),'linew',2)
yCalc3 = yCalc2{sig};
plot([tx_tick(29)+1:1:tx_tick(29)+length(w_nh4_04)],mean(w_nh4_04(idx1)),'-.','color',color_spec(sig-1),'linew',2);
...
clearvars b1 yCalc1 X b nonan idx nanaxisx *_mth_f idx1 sig_txt *_mi2 *_recon yCalc3
% raw
w_no3_04=w_no3(tx_tick(29)+1:end);
idx1 = find(isnan(w_no3_04) == 0);
w_no3_042=w_no3_04;
upper_bc(sig) = mean(w_no3_04(idx1)) + sig*std(w_no3_04(idx1));
lower_bc(sig) = mean(w_no3_04(idx1)) - sig*std(w_no3_04(idx1));
...
b0(sig) = b(1);  b1(sig) = b(2);
yCalc2{sig} = [1:length(w_no3_04)].*b1(sig) + b0(sig);
plot([tx_tick(29)+1:1:tx_tick(29)+length(w_no3_04)],yCalc2{sig},'-.','color','k','linew',2)
line([tx_tick(29)+1:1:tx_tick(29)+length(w_no3_04)], upper_bc(sig),'color', color_spec(sig),'linew',2)
line([tx_tick(29)+1:1:tx_tick(29)+length(w_no3_04)], lower_bc(sig),'color', color_spec(sig),'linew',2)
yCalc3 = yCalc2{sig};
plot([tx_tick(29)+1:1:tx_tick(29)+length(w_no3_04)],mean(w_no3_04(idx1)),'-.','color',color_spec(sig-1),'linew',2);
